...
on ( c.ywbh=b.ywbh and isnull(c.hth,'')= isnull(b.jzxh,'') and  c.yjlxbm=b.yjlxbm ) ) " + strWhere + " group by c.yjlxbm,c.ywbh,c.yjsj,c.ry,c.rymc,c.yjnr,c.ycd,c.sp,c.xq,c.qzyj,c.sfhys,c.jsq,c.jdrjc,c.sfyycyy,c.xh,c.hth,b.sfgx,c.jsqsj ,c.zxsj ,c.zbr ,c.jcgzry ) as t2 where t2.rownumber between  " + rows * (pageIndex - 1) + " and  " + rows * pageIndex;
                     ...
                     string tempsql = @"select count(*) from yw_hddz_yccx c left join yw_hddz_yjxx_sfgx b 
on ( c.ywbh=b.ywbh and isnull(c.hth,'')= isnull(b.jzxh,'') and  c.yjlxbm=b.yjlxbm )  " + strWhere + " group by c.yjlxbm,c.ywbh,c.yjsj,c.ry,c.rymc,c.yjnr,c.ycd,c.sp,c.xq,c.qzyj,c.sfhys,c.jsq,c.jdrjc,c.sfyycyy,c.xh,c.hth,b.sfgx,c.jsqsj ,c.zxsj ,c.zbr ,c.jcgzry";


                     count = conn.Query<int>(tempsql, Parameters).FirstOrDefault();
