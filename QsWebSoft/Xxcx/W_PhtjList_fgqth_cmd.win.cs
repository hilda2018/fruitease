...
{
    public partial class W_PhtjList_fgqth_cmd
    {
        public W_PhtjList_fgqth_cmd()
        {
        ...
        public override void OnLoad()
        {
            ...
            this.ds_2.Retrieve(ShareMode, userid, Dlwtf, "车队");

            //DateTime dt = Convert.ToDateTime(begindate);
            //本月第一天时间   
            //DateTime dt_First = dt.AddDays(-(dt.Day) + 1);

            //this.dp_date.Value = DateTime.Parse(begindate.ToString());

            this.dw_phtj_fgqth_cmd.Retrieve(DateTime.Parse(this.dp_date.Value.ToString()), sscd);
        }
    }
}
