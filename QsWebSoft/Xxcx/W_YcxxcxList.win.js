...
function W_YcxxcxList() {
	 ...
	 var sle_ycyy= new SingleLineEdit( requestor );
	 var sle_lry= new SingleLineEdit( requestor );
	 var sle_sdry= new SingleLineEdit( requestor );
	 var sle_jcgzry= new SingleLineEdit( requestor );
	 ...
	 if(typeof( baseBind )=="function") baseBind(win);
		 ...
		 if(sle_ycyy == null ) sle_ycyy= new SingleLineEdit( requestor );
		 sle_ycyy.Attach( win.Control( "sle_ycyy") ); 
		 if(sle_lry == null ) sle_lry= new SingleLineEdit( requestor );
		 sle_lry.Attach( win.Control( "sle_lry") ); 
		 if(sle_sdry == null ) sle_sdry= new SingleLineEdit( requestor );
		 sle_sdry.Attach( win.Control( "sle_sdry") ); 
		 if(sle_jcgzry == null ) sle_jcgzry= new SingleLineEdit( requestor );
		 sle_jcgzry.Attach( win.Control( "sle_jcgzry") ); 
		 ...
		 if(typeof(self.sle_EditChanged)=="function") 
			 win.AttachEvent("sle_ycyy","EditChanged",self.sle_EditChanged); 

		 if(typeof(self.sle_EditChanged)=="function") 
			 win.AttachEvent("sle_lry","EditChanged",self.sle_EditChanged); 

		 if(typeof(self.sle_EditChanged)=="function") 
			 win.AttachEvent("sle_sdry","EditChanged",self.sle_EditChanged); 

		 if(typeof(self.sle_EditChanged)=="function") 
			 win.AttachEvent("sle_jcgzry","EditChanged",self.sle_EditChanged); 
	 ...
	 if(typeof(baseUnBind)=="function") baseUnBind(); 
		 ...
		 sle_ycyy.Detach(); sle_ycyy=null; 
		 sle_lry.Detach(); sle_lry=null; 
		 sle_sdry.Detach(); sle_sdry=null; 
		 sle_jcgzry.Detach(); sle_jcgzry=null; 
    ...
    this.Retrieve = function () {
        ...
        var sdry = sle_sdry.GetText();
        var jcgzry = sle_jcgzry.GetText();

        dw_list.Retrieve(beginDate.getVarDate(), endDate.getVarDate(), ycyy, lry, sdry, jcgzry, jdrjc);
