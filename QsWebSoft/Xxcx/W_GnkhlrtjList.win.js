...
function W_GnkhlrtjList() {
    ...
    this.dw_List_DoubleClicked = function (xPos, yPos, Row, dwoName) {
        if (Row > 0) {
            if (iw_GnkhlrtjList_Mx == null)
                iw_GnkhlrtjList_Mx = new W_GnkhlrtjList_Mx();
            ...
            iw_GnkhlrtjList_Mx.SetGnkhmc(Gnkhmc);
            iw_GnkhlrtjList_Mx.SetBeginDate(BeginDate);
            iw_GnkhlrtjList_Mx.SetEndDate(EndDate);
            iw_GnkhlrtjList_Mx.SetYsfs(Ysfs);

            requestor.Open("/LoadWindow.ashx?WinName=Xxcx.W_GnkhlrtjList_Mx", iw_GnkhlrtjList_Mx);
        }
    }
    //#endregion
