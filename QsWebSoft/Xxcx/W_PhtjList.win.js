...
function W_PhtjList() {
    ...
    var iw_PhtjList_fgqth_cmd = null;
    var iw_PhtjList_kchx_cmd = null;
    var iw_PhtjList_schx_cmd = null;
    var iw_PhtjList_thmx_cmd = null;
...
//        self.dp_date_Clicked();
    ...
    this.dw_list_DoubleClicked = function (xPos, yPos, Row, dwoName) {
        if (iw_PhtjList_thmx_cmd == null)
            iw_PhtjList_thmx_cmd = new W_PhtjList_thmx_cmd();
        var myDate = new Date(dp_date.GetValue());
        myDate.setDate(1);
        myDate.setHours(0);
        myDate.setMinutes(0);
...
//        var sscd = dw_list.GetItemString(Row, "sscd");

//        iw_PhtjList_thmx_cmd.SetBeginDate(myDate.getVarDate());
//        iw_PhtjList_thmx_cmd.SetSscd(sscd);

//        requestor.Open("/LoadWindow.ashx?WinName=Xxcx.W_PhtjList_thmx_cmd&dp_date=" + myDate.getVarDate() + "&sscd=" + sscd, iw_PhtjList_thmx_cmd);
//        dw_list.SetFocus();
    }
