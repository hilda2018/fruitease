...
function W_Wlgz_DzwltjList() {
	 ...
	 var ddlb_1= new DropDownListBox( requestor );
	 ...
	 if(typeof( baseBind )=="function") baseBind(win);
		 ...
		 if(ddlb_1 == null ) ddlb_1= new DropDownListBox( requestor );
		 ...
		 if(typeof(self.Retrieve)=="function") 
			 win.AttachEvent("ddlb_1","SelectionChanged",self.Retrieve); 
    ...
    var iw_Wlgz_DzwltjMx = null;
    var iw_Wlgz_Dzwltj_Rw = null;
    var iw_Filter = null;
    var begin = "N";
    var fzks_row = 0;
    var fzjs_row = 0;
    ...
    this.Retrieve = function ()
    {
        ...
        dw_list.Retrieve( beginDate.getVarDate(), endDate.getVarDate(), jdrjc, pdy );
    ...
    this.dw_list_DoubleClicked = function ( xPos, yPos, Row, dwoName, Data )
    {
        ...
        //        if ( iw_Wlgz_DzwltjMx == null )
        //            iw_Wlgz_DzwltjMx = new W_Wlgz_DzwltjMx();
        //        var cgqsj = dw_list.GetItemDate( Row, "cgqsj" );
        //        var Dlwtf = requestor.GetParm( "Dlwtf" );

        //        iw_Wlgz_DzwltjMx.SetDataWindow( dw_list );
        //        iw_Wlgz_DzwltjMx.SetData( cgqsj );
        //        iw_Wlgz_DzwltjMx.SetRow( Row );
        //        alert( cgqsj );
        //        requestor.Open( "/LoadWindow.ashx?WinName=Xxcx.W_Wlgz_Dzwltj_Rw", iw_Wlgz_DzwltjMx );

        if ( iw_Wlgz_Dzwltj_Rw == null )
            iw_Wlgz_Dzwltj_Rw = new W_Wlgz_Dzwltj_Rw();
        var cgqsj = dw_list.GetItemString( Row, "cgqsj_jsl" );
        var Dlwtf = requestor.GetParm( "Dlwtf" );
 
        iw_Wlgz_Dzwltj_Rw.SetData( cgqsj );
    
       
        requestor.Open( "/LoadWindow.ashx?WinName=Xxcx.W_Wlgz_Dzwltj_Rw", iw_Wlgz_Dzwltj_Rw );
...
//        dw_list.SetRedraw(true);
    ...
    this.Recover = function () {
        ...
        QsWebSoft.PubMethod.DelColRecord("QsWebSoft.Xxcx.W_Wlgz_DzwltjList", "dw_wlgz_dzwltj_list");
        self.Retrieve();
    }
    //#endregion
    ...
    //#region 获得字段焦点
    this.Help = function () {
        javascript: window.open('\报关统计.txt')
    }
    //#endregion
