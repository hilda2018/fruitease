...
function W_PhtjList_kchx_cmd() {

	 var self=this;
	 var requestor= new PBWindow();
	 var dw_phtj_kchx_cmd= new DataWindow( requestor );
	 ...
	 if(typeof( baseBind )=="function") baseBind(win);
		 ...
		 if(dw_phtj_kchx_cmd == null ) dw_phtj_kchx_cmd= new DataWindow( requestor );
		 dw_phtj_kchx_cmd.Attach( win.Control( "dw_phtj_kchx_cmd") ); 
	 ...
	 if(typeof(baseUnBind)=="function") baseUnBind(); 
		 ...
		 dw_phtj_kchx_cmd.Detach(); dw_phtj_kchx_cmd=null; 
    ...
    this.PostOpen = function () {
        ...
        dw_phtj_kchx_cmd.Retrieve(BeginDate, Sscd);
    }
    //#endregion
    ...
    this.Retrieve = function () {
        ...
        dw_phtj_kchx_cmd.Retrieve(dp_date.GetValue(), Sscd);
    }
    //#endregion
