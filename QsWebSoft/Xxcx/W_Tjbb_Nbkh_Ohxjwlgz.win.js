...
function W_Tjbb_Nbkh_Ohxjwlgz() {
    ...
    this.Retrieve = function () {
        ...
        dw_list.Retrieve("", dp_begin.GetValue()); 
    }
    //#endregion
    ...
    //#region dw_listb Clicked
    this.dw_listb_Clicked = function (xPos, yPos, Row, dwoName) {
    ...
    //#region dw_listb ItemChanged
    this.dw_listb_ItemChanged = function (row, dwoName, data) {
