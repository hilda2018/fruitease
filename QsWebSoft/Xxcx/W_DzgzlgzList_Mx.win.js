...
function W_DzgzlgzList_Mx() {
    ...
    this.bind = function (win) {
        ...
        if (typeof (self.Retrieve) == "function")
            win.AttachEvent("dw_list", "Clicked", self.Retrieve);
    ...
    var Zbr = null;
    this.SetRy = function (parm) {
        Zbr = parm;
    }

    var Ycyybm = null;
    this.SetYcyybm = function (parm) {
        Ycyybm = parm;
    }
    ...
    this.PostOpen = function () {
        ...
        dp_begin.SetValue(BeginDate);
        dp_end.SetValue(EndDate);
        dw_list.Retrieve(BeginDate, EndDate, Zbr, Ycyybm);
    ...
    this.Retrieve = function () {
       ...
       var endDate = new Date(dp_end.GetValue());
        ...
        dw_list.Retrieve(dp_begin.GetValue(), dp_end.GetValue(), Zbr, Ycyybm);
