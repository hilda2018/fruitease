...
function W_Khywqktj_List() {

	 var self=this;
	 var requestor= new PBWindow();
	 var dw_list= new DataWindow( requestor );
	 var dw_cxtj= new DataWindow( requestor );
	 ...
	 if(typeof( baseBind )=="function") baseBind(win);
		 ...
		 if(dw_cxtj == null ) dw_cxtj= new DataWindow( requestor );
		 dw_cxtj.Attach( win.Control( "dw_cxtj") ); 
		 ...
		 if(typeof(self.dw_cxtj_ButtonClicked)=="function") 
			 win.AttachEvent("dw_cxtj","ButtonClicked",self.dw_cxtj_ButtonClicked); 
    ...
    webReq.SetWebServiceUrl( "/Service/Khywqktj.ashx" );   
...
//       self.Retrieve()
    ...
    {
        var sjkgsj_ks = dw_cxtj.GetItemString( 1, "kssj" );
        var sjkgsj_zz = dw_cxtj.GetItemString( 1, "zzsj" );
        var ysfs = dw_cxtj.GetItemString( 1, "ysfs" );
        var mdka = dw_cxtj.GetItemString( 1, "mdka" );
        var khbm = dw_cxtj.GetItemString( 1, "khbm" );
        ...
        dw_list.Retrieve( sjkgsj_ks, sjkgsj_zz, khbm, ysfs, mdka, userid );
        dw_list.PrintPreview();
            ...
            this.dw_cxtj_ButtonClicked = function ( Row, dwoName )
            {
                if ( dwoName == "b_khmc" )
                {
                    ...
                    iw_Wldw_Select.SetDataWindow( dw_cxtj );
                    iw_Wldw_Select.SetData( "khywqkcx" );
...
//        dw_list.SetRedraw(true);
    ...
    this.Recover = function () {
        ...
        QsWebSoft.PubMethod.DelColRecord("QsWebSoft.Xxcx.W_Khywqktj_List", "dw_bgtj_list");
        self.Retrieve();
    }
    //#endregion
