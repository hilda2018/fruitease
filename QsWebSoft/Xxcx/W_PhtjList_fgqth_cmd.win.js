...
function W_PhtjList_fgqth_cmd() {

    var self = this;
    var requestor = new PBWindow();
    var dw_phtj_fgqth_cmd = new DataWindow(requestor);
    ...
    this.bind = function (win) {
        ...
        if (dw_phtj_fgqth_cmd == null) dw_phtj_fgqth_cmd = new DataWindow(requestor);
        dw_phtj_fgqth_cmd.Attach(win.Control("dw_phtj_fgqth_cmd"));
        ...
        if (typeof (self.dw_List_Clicked) == "function")
            win.AttachEvent("window", "Clicked", self.dw_List_Clicked);

        if (typeof (self.dw_List_DoubleClicked) == "function")
            win.AttachEvent("window", "DoubleClicked", self.dw_List_DoubleClicked);
    ...
    this.unbind = function () {
        ...
        dw_phtj_fgqth_cmd.Detach(); dw_phtj_fgqth_cmd = null;
    ...
    this.PostOpen = function () {
        dp_date.SetValue(BeginDate);
        dw_phtj_fgqth_cmd.Retrieve(BeginDate, Sscd);
    }
    //#endregion
...
//        self.dp_date_Clicked();
        ...
        var beginDate = new Date(dp_date.GetValue());
        //把开始日期的时间部分设置为 00:00:00
        beginDate.setHours(0);
        beginDate.setMinutes(0);
        beginDate.setSeconds(0);

        dw_phtj_fgqth_cmd.Retrieve(dp_date.GetValue(), Sscd);
    }
    //#endregion
