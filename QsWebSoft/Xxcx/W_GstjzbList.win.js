...
function W_GstjzbList() {
	 ...
	 var dp_rq= new DatePicker( requestor );
	 ...
	 if(typeof( baseBind )=="function") baseBind(win);
		 ...
		 if(dp_rq == null ) dp_rq= new DatePicker( requestor );
		 dp_rq.Attach( win.Control( "dp_rq") ); 
    ...
    this.Retrieve = function () {
        var rqDate = new Date(dp_rq.GetValue());
        ...
        dw_list.Retrieve(rqDate.getVarDate());
    }
    //#endregion
