...
function W_AAAList() {
    ...
    this.Retrieve = function () {
        ...
        dw_list.Retrieve(beginDate.getVarDate(), endDate.getVarDate(), ysfsdm);
    ...
    this.dw_List_DoubleClicked = function (xPos, yPos, Row, dwoName) {
        if (Row > 0) {
            if (iw_SpgjlrtjList_Mx == null)
                iw_SpgjlrtjList_Mx = new W_SpgjlrtjList_Mx();
            ...
            iw_SpgjlrtjList_Mx.SetSpmc(Spmc);
            iw_SpgjlrtjList_Mx.SetGjmc(Gjmc);
            iw_SpgjlrtjList_Mx.SetBeginDate(BeginDate);
            iw_SpgjlrtjList_Mx.SetEndDate(EndDate);
            iw_SpgjlrtjList_Mx.SetYsfs(Ysfs);
           
            requestor.Open("/LoadWindow.ashx?WinName=Xxcx.W_SpgjlrtjList_Mx", iw_SpgjlrtjList_Mx);
        }
    }
    //#endregion
