...
{
    public partial class W_AAAList
    {
        public W_AAAList()
        {
        }
        public override void OnLoad()
        {
            ...
            // 数据检索
            this.dw_list.Retrieve(DateTime.Parse(this.dp_begin.Value.ToString()), DateTime.Parse(this.dp_end.Value.ToString()),3);
            //注册相关的js文件
            this.RegisterClientScriptInclude("ExtPB_Demo", "/Beta3/ExtPB_Demo.js");
            this.RegisterClientScriptInclude("W_AAAList", "/Xxcx/W_AAAList.win.js");
            this.RegisterClientScriptInclude("W_SpgjlrtjList_Mx", "/Xxcx/W_SpgjlrtjList_Mx.win.js");
