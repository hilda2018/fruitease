...
function W_PhtjList_thmx_cmd() {

	 var self=this;
	 var requestor= new PBWindow();
	 var dw_phtj_thmx_cmd= new DataWindow( requestor );
	 ...
	 if(typeof( baseBind )=="function") baseBind(win);
		 ...
		 if(dw_phtj_thmx_cmd == null ) dw_phtj_thmx_cmd= new DataWindow( requestor );
		 dw_phtj_thmx_cmd.Attach( win.Control( "dw_phtj_thmx_cmd") ); 
	 ...
	 if(typeof(baseUnBind)=="function") baseUnBind(); 
		 ...
		 dw_phtj_thmx_cmd.Detach(); dw_phtj_thmx_cmd=null; 
    ...
    this.PostOpen = function () {
        ...
        dw_phtj_thmx_cmd.Retrieve(BeginDate, Sscd);
    }
    //#endregion
    ...
    this.Retrieve = function () {
        ...
        dw_phtj_thmx_cmd.Retrieve(dp_date.GetValue(), Sscd);
    }
    //#endregion
