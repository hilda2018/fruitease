...
function W_KytjList() {
	 ...
	 var txt_1= new SingleLineEdit( requestor );
	 ...
	 if(typeof( baseBind )=="function") baseBind(win);
		 ...
		 if(txt_1 == null ) txt_1= new SingleLineEdit( requestor );
		 txt_1.Attach( win.Control( "txt_1") ); 
    ...
    this.Retrieve = function () {
        var data = txt_1.GetText();
        var dataRetrieve = data + "/01/01";
        var rqDate = new Date(dataRetrieve);
