...
function W_Kyyctj_Mon_Mx() {
    ...
    var Year = null;
    this.SetYear = function (parm) {
        Year = parm;
    }

    var Sjd = null;
    this.SetSjd = function (parm) {
        Sjd = parm;
    }

    var Kyycyy = null;
    this.SetKyycyy = function (parm) {
        Kyycyy = parm;
    }

    var Yuefen = null;
    this.SetYuefen = function (parm) {
        Yuefen = parm;
    }
    ...
    this.PostOpen = function () {
        ...
        dw_list.Retrieve(Year, Sjd, Kyycyy, Yuefen);
