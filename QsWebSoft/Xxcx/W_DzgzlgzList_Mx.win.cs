...
{
    public partial class W_DzgzlgzList_Mx
    {
        public W_DzgzlgzList_Mx()
        {
        }
        public override void OnLoad()
        {
            ...
            var zbr = this.Request["Ry"].ToString();
            var ycyybm = this.Request["YcyyBm"].ToString();

            //this.dp_begin.Value = DateTime.Parse(begindate.ToString());
            //this.dp_end.Value = DateTime.Parse(enddate.ToString());

            dw_list.Retrieve(DateTime.Parse(this.dp_begin.Value.ToString()), DateTime.Parse(this.dp_end.Value.ToString()), zbr, ycyybm);
        }
    }
}
