...
{
    public partial class W_XtXq_TaskEdit
    {
        public W_XtXq_TaskEdit()
        {
        ...
        public override void OnLoad()
        {
            ...
            if (this.Request["zxbh"] != null)
            {
                var zxbh = this.Request["zxbh"].ToString(); 
                
                this.SetParm("zxbh", zxbh);
                dw_master.Retrieve(zxbh);               
            ...
            //this.RegisterClientScriptInclude("W_Tszx_Hth_Select", "/Xt_Popwin/W_Tszx_Hth_Select.win.js");
            //注册相关的js文件
