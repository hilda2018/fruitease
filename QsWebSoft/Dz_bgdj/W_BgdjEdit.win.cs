...
{
    public partial class W_BgdjEdit
    {
        public W_BgdjEdit()
        {
        ...
        public override void OnLoad()
        {
            ...
            report.RequestorDrawTitle = false;
            report = (ReportService)dw_bg.Services.Add(ServiceName.Report);
            report.RequestorDrawTitle = false;
            report = (ReportService)dw_selected.Services.Add(ServiceName.Report);
            report.RequestorDrawTitle = false;
            ...
            if (this.Request["mxdbh"] != null)
            {
                ...
                dw_bg.Retrieve(mxdbh, bbh);
                dw_fy.Retrieve(mxdbh, bbh);
                dw_tyzss.Retrieve(mxdbh, bbh);
                dw_selected.Retrieve();
                dw_memo.Retrieve(mxdbh);
                dw_1.Retrieve(mxdbh);

            }
            this.tabpage_tyzss.Visible = false;
            ...
            this.RegisterClientScriptInclude("W_Gen_Bgsp", "/Xt_Popwin/W_Gen_Bgsp.win.js");
