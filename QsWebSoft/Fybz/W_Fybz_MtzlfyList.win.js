    ...
    this.dw_List_DoubleClicked = function (xPos, yPos, Row, dwoName) {
        if (Row > 0) {
            if (dwoName == "mtjc") {               
                ...
                iw_Wldw_Select.SetData("fybz_mtzlfy");
...
//        dw_print.PrintPreview();
    ...
    this.slecgs_EditChanged = function (text) {
        ...
        if (text == "")
            ...
            dw_list.SetFilter("( Upper(mtmc) like Upper('%" + text + "%')) or ( Upper(mtjc) like Upper('%" + text + "%')) or ( Upper(mtpym) like Upper('%" + text + "%'))");
        dw_list.Filter();
        dw_list.Sort();
    ...
    this.Save = function () {
        ...
        webReq.Invoke("MtzlfyListSave", "dw_list=" + dw_d_data);
