    ...
    this.dw_List_DoubleClicked = function (xPos, yPos, Row, dwoName) {
        if (Row > 0) {
            if (dwoName == "dcjc") {               
                ...
                iw_Wldw_Select.SetData("fybz_dcfy");
...
//        dw_print.PrintPreview();
    ...
    this.slecgs_EditChanged = function (text) {
        ...
        if (text == "")
            ...
            dw_list.SetFilter("( Upper(jydmc) like Upper('%" + text + "%')) or ( Upper(jydjc) like Upper('%" + text + "%')) or ( Upper(jydpym) like Upper('%" + text + "%'))");
        dw_list.Filter();
        dw_list.Sort();
    ...
    this.Recover = function () {
        ...
        QsWebSoft.PubMethod.DelColRecord("QsWebSoft.Fybz.W_Fybz_HydcfyList", "dw_fybz_hydcfy_list");
        self.Retrieve();
    }
    //#endregion
    ...
    this.Save = function () {
        ...
        webReq.Invoke("HydcfyListSave", "dw_list=" + dw_d_data);
