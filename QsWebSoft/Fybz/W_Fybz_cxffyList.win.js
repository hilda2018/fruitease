    ...
    this.dw_List_DoubleClicked = function (xPos, yPos, Row, dwoName) {
        if (Row > 0) {
            if (dwoName == "cxfjc") {               
                ...
                iw_Wldw_Select.SetData("fybz_cxdfy");
...
//        dw_print.PrintPreview();
    ...
    this.slecgs_EditChanged = function (text) {
        ...
        if (text == "")
            ...
            dw_list.SetFilter("( Upper(cxfmc) like Upper('%" + text + "%')) or ( Upper(xl) like Upper('%" + text + "%')) or ( Upper(fybm) like Upper('%" + text + "%'))");
        dw_list.Filter();
        dw_list.Sort();
    ...
    this.Recover = function () {
        ...
        QsWebSoft.PubMethod.DelColRecord("QsWebSoft.Fybz.W_Fybz_cxffyList", "dw_fybz_cxffy_list");
        self.Retrieve();
    }
    //#endregion
    ...
    this.Save = function () {
        ...
        webReq.Invoke("cxffyListSave", "dw_list=" + dw_d_data);
