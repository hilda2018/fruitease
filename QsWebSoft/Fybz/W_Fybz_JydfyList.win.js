    ...
    this.dw_List_DoubleClicked = function (xPos, yPos, Row, dwoName) {
        if (Row > 0) {
            if (dwoName == "jydjc") {               
                ...
                iw_Wldw_Select.SetData("fybz_jydfy");
...
//        dw_print.PrintPreview();
    ...
    this.Recover = function () {
        ...
        QsWebSoft.PubMethod.DelColRecord("QsWebSoft.Fybz.W_Fybz_JydfyList", "dw_fybz_jydfy_list");
        self.Retrieve();
    }
    //#endregion
    ...
    this.Save = function () {
        ...
        webReq.Invoke("JydfyListSave", "dw_list=" + dw_d_data);
