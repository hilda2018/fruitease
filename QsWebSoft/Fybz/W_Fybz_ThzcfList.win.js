    ...
    this.dw_List_DoubleClicked = function (xPos, yPos, Row, dwoName) {
        if (Row > 0) {
            if (dwoName == "jydjc") {               
                ...
                iw_Wldw_Select.SetData("fybz_thzcf");
...
//        dw_print.PrintPreview();
    ...
    this.Recover = function () {
        ...
        QsWebSoft.PubMethod.DelColRecord("QsWebSoft.Fybz.W_Fybz_ThzcfList", "dw_fybz_thzcf_list");
        self.Retrieve();
    }
    //#endregion
    ...
    this.Save = function () {
        ...
        webReq.Invoke("ThzcfListSave", "dw_list=" + dw_d_data);
