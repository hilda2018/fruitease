    ...
    this.dw_List_DoubleClicked = function (xPos, yPos, Row, dwoName) {
        if (Row > 0) {
            if (dwoName == "xhgqjc") {               
                ...
                iw_Wldw_Select.SetData("fybz_kythfy");
...
//        dw_print.PrintPreview();
    ...
    this.slecgs_EditChanged = function (text) {
        ...
        if (text == "")
            ...
            dw_list.SetFilter("( Upper(xhgqmc) like Upper('%" + text + "%')) or ( Upper(xhgqjc) like Upper('%" + text + "%')) or ( Upper(xhgqpym) like Upper('%" + text + "%'))");
        dw_list.Filter();
        dw_list.Sort();
    ...
    this.Recover = function () {
        ...
        QsWebSoft.PubMethod.DelColRecord("QsWebSoft.Fybz.W_Fybz_KythfyList", "dw_fybz_khthfy_list");
        self.Retrieve();
    }
    //#endregion
    ...
    this.Save = function () {
        ...
        webReq.Invoke("KythfyListSave", "dw_list=" + dw_d_data);
