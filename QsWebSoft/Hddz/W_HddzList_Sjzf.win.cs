...
{
    public partial class W_HddzList_Sjzf
    {
        public W_HddzList_Sjzf()
        {
        }
        public override void OnLoad()
        {
            ...
            DateTime date = System.DateTime.Now.AddDays(-1);
            ...
            // 数据检索
            this.dw_list.Retrieve(DateTime.Parse(this.dp_begin.Value.ToString()), DateTime.Parse(this.dp_end.Value.ToString()), Dlwtf, "全部", Tybm, Sfqytybm,"未确认","全部");
            //注册相关的js文件
            this.RegisterClientScriptInclude("ExtPB_Demo", "/Beta3/ExtPB_Demo.js");
            this.RegisterClientScriptInclude("W_Wldw_Select", "/Xt_Popwin/W_Wldw_Select.win.js");
            this.RegisterClientScriptInclude("W_HddzList_Sjzf", "/Hddz/W_HddzList_Sjzf.win.js");
