...
{
    public partial class W_HddzList_Sd
    {
        public W_HddzList_Sd()
        {
        }
        public override void OnLoad()
        {
            ...
            for (int i = 1; i <= ds_3.RowCount;i++ ) {
                this.ddlb_jdrjc.Items.Add(ds_3.GetItemString(i,"dwjc"));
            }

            this.dw_log.Retrieve(userid, "sdlb");
            // 数据检索
            this.dw_list.Retrieve(DateTime.Parse(this.dp_begin.Value.ToString()), DateTime.Parse(this.dp_end.Value.ToString()), "税单未回", Dlwtf, Tybm, Sfqytybm,userid,"全部");
            //注册相关的js文件
            this.RegisterClientScriptInclude("ExtPB_Demo", "/Beta3/ExtPB_Demo.js");
            this.RegisterClientScriptInclude("W_HddzList_Sd", "/Hddz/W_HddzList_Sd.win.js");
