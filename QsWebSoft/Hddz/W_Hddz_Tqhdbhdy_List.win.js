...
function W_Hddz_Tqhdbhdy_List() {
    ...
    var sle_5 = new SingleLineEdit(requestor);
    var sle_6 = new SingleLineEdit(requestor);
    ...
    this.bind = function (win) {
        ...
        if (sle_5 == null) sle_5 = new SingleLineEdit(requestor);
        sle_5.Attach(win.Control("sle_5"));
        if (sle_6 == null) sle_6 = new SingleLineEdit(requestor);
        sle_6.Attach(win.Control("sle_6"));
        ...
        if (typeof (self.sle_2_EditChanged) == "function")
            win.AttachEvent("sle_2", "EditChanged", self.sle_2_EditChanged);

        if (typeof (self.sle_4_EditChanged) == "function")
            win.AttachEvent("sle_4", "EditChanged", self.sle_4_EditChanged);
        ...
        if (typeof (self.sle_5_EditChanged) == "function")
            win.AttachEvent("sle_5", "EditChanged", self.sle_5_EditChanged);

        if (typeof (self.sle_6_EditChanged) == "function")
            win.AttachEvent("sle_6", "EditChanged", self.sle_6_EditChanged);
    ...
    this.unbind = function () {
        ...
        sle_5.Detach(); sle_5 = null;
        sle_6.Detach(); sle_6 = null;
    ...
    this.sle_EditChanged = function(text){
        ...
        if (text == "")
            ...
            dw_list.SetFilter("(Upper(ywbh) like Upper('%" + text + "%')) or  (Upper(ywbh) like Upper('%" + text + "%'))");
        dw_list.Filter();
        dw_list.Sort();
    ...
    this.sle_2_EditChanged = function (text) {
        dw_list.SetRedraw(false);
        if (text == "")
            dw_list.SetFilter("");
        else
            dw_list.SetFilter("(Upper(hz_jzxh) like Upper('%" + text + "%')) or  (Upper(hz_jzxh) like Upper('%" + text + "%'))");
        dw_list.Filter();
        dw_list.Sort();
        dw_list.SetRedraw(true);
    }
    this.sle_4_EditChanged = function (text) {
        dw_list.SetRedraw(false);
        if (text == "")
            dw_list.SetFilter("");
        else
            dw_list.SetFilter("(Upper(cyrjc) like Upper('%" + text + "%')) or  (Upper(cyrjc) like Upper('%" + text + "%'))");
        dw_list.Filter();
        dw_list.Sort();
        dw_list.SetRedraw(true);
    }
    this.sle_5_EditChanged = function (text) {
        dw_list.SetRedraw(false);
        if (text == "")
            dw_list.SetFilter("");
        else
            dw_list.SetFilter("(Upper(cm) like Upper('%" + text + "%')) or  (Upper(cm) like Upper('%" + text + "%'))");
        dw_list.Filter();
        dw_list.Sort();
        dw_list.SetRedraw(true);
    }
    this.sle_6_EditChanged = function (text) {
        dw_list.SetRedraw(false);
        if (text == "")
            dw_list.SetFilter("");
        else
            dw_list.SetFilter("(Upper(khjc) like Upper('%" + text + "%')) or  (Upper(khjc) like Upper('%" + text + "%'))");
        dw_list.Filter();
        dw_list.Sort();
        dw_list.SetRedraw(true);
    }
    ...
    this.bhdy_Clicked = function () {
        var Row = dw_list.GetRow();
        if (Row > 0) {
            var yjkgsj = dw_list.GetItemDate(Row, "yjkgsj");
            var cyrjc = dw_list.GetItemString(Row, "cyrjc");
            var cm = dw_list.GetItemString(Row, "cm");
            var khjc = dw_list.GetItemString(Row, "khjc");
            var jydwjc = dw_list.GetItemString(Row, "jydwjc");
            var ywbh = dw_list.GetItemString(Row, "ywbh");
            
            if (iW_Hddz_Tqhdbhdy_lxr == null) {
                iW_Hddz_Tqhdbhdy_lxr = new W_Hddz_Tqhdbhdy_lxr();
            }
            iW_Hddz_Tqhdbhdy_lxr.setYjkgsj(yjkgsj);
            iW_Hddz_Tqhdbhdy_lxr.setCyrjc(cyrjc);
            iW_Hddz_Tqhdbhdy_lxr.setCm(cm);
            iW_Hddz_Tqhdbhdy_lxr.setKhjc(khjc);
            iW_Hddz_Tqhdbhdy_lxr.setJydwjc(jydwjc);
            iW_Hddz_Tqhdbhdy_lxr.setYwbh(ywbh);
            
            var operation = requestor.GetParm("operation");
            requestor.Open("/LoadWindow.ashx?WinName=Hddz.W_Hddz_Tqhdbhdy_lxr" + '&operation=' + operation.toString(), iW_Hddz_Tqhdbhdy_lxr);
            dw_list.SetFocus();
        }
    }
    ...
    this.Recover = function () {
        ...
        QsWebSoft.PubMethod.DelColRecord("QsWebSoft.Hddz.W_Hddz_Tqhdbhdy_List", "dw_hddz_list");
        self.Retrieve();
    }
    //#endregion
