...
{
    public partial class W_HddzList_Bzj_Ky
    {
        public W_HddzList_Bzj_Ky()
        {
        }
        public override void OnLoad()
        {
            ...
            // 数据检索
            this.dw_list.Retrieve(DateTime.Parse(this.dp_begin.Value.ToString()), DateTime.Parse(this.dp_end.Value.ToString()), "保证金未处理", Dlwtf, Tybm, Sfqytybm, userid,"全部");
            this.dw_log.Retrieve(userid, "kbzj");
            //注册相关的js文件
            this.RegisterClientScriptInclude("ExtPB_Demo", "/Beta3/ExtPB_Demo.js");
            this.RegisterClientScriptInclude("W_Wldw_Select", "/Xt_Popwin/W_Wldw_Select.win.js");         
            this.RegisterClientScriptInclude("W_HddzList_Bzj_Ky", "/Hddz/W_HddzList_Bzj_Ky.win.js");
