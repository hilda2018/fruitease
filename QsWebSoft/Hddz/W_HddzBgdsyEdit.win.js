...
function W_HddzBgdsyEdit() {
    ...
    webReq.SetWebServiceUrl("/Service/Hddz_bgdsy.ashx");
    ...
    this.InsertRow = function () {
        if (iW_Hddz_Bgdsy_Select == null)
            iW_Hddz_Bgdsy_Select = new W_Hddz_Bgdsy_Select();
        ...
        iW_Hddz_Bgdsy_Select.SetRow(row);
        iW_Hddz_Bgdsy_Select.SetDwo(dwo);
        iW_Hddz_Bgdsy_Select.SetDetailDW(dw_cmd);

        requestor.Open("/LoadWindow.ashx?WinName=Xt_Popwin.W_Hddz_Bgdsy_Select&ShareMode=" + ShareMode + '&ywy=' + ywy + '&Dlwtf=' + Dlwtf + '&Sqdbh=' + sqdbh + '&bb=' + bb, iW_Hddz_Bgdsy_Select);
    ...
    this.AddRow = function () {
        ...
        requestor.Open("/LoadWindow.ashx?WinName=Xt_Popwin.W_Hddz_Bgdsy_Select&ShareMode=" + ShareMode + '&ywy=' + ywy + '&Dlwtf=' + Dlwtf + '&bb=' + bb, iW_Hddz_Bgdsy_Select);
    }
    //#endregion
