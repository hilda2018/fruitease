...
{
    public partial class W_HddzList_Spcx
    {
        public W_HddzList_Spcx()
        {
        }
        public override void OnLoad()
        {
            ...
            // 数据检索
            this.dw_list.Retrieve(DateTime.Parse(this.dp_begin.Value.ToString()), DateTime.Parse(this.dp_end.Value.ToString()), "全部", "已到港未放行", Dlwtf, Tybm, Sfqytybm, userid,"全部");
            //注册相关的js文件
            this.RegisterClientScriptInclude("ExtPB_Demo", "/Beta3/ExtPB_Demo.js");
            this.RegisterClientScriptInclude("W_HddzList_Spcx", "/Hddz/W_HddzList_Spcx.win.js");
