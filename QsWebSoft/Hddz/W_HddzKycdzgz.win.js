...
function W_HddzKycdzgz() {
    ...
    this.Save = function () {
        ...
        webReq.Invoke("HddzKycdzgzSave", "dw_list=" + dw_list_data );
    ...
    this.dw_List_ItemChanged = function (row, dwoName, data) {
        ...
        if (dwoName == "dzyq_sfsdzb") {
            if (data == "Y") {
                ...
                QsWebSoft.PubMethod.UpdateKycdzgzYorN("sfsdzb", "Y", hth, ywbh, 'cdz');
            } else {
                dw_list.SetItem(row, "dzyq_sdzbsj", sj.getVarDate());
                QsWebSoft.PubMethod.UpdateKycdzgzYorN("sfsdzb", "N", hth, ywbh, 'cdz');
            }
        }
        if (dwoName == "dzyq_jc") {
            if (data == "Y") {
                QsWebSoft.PubMethod.UpdateKycdzgzJcYorN("jc", "Y", hth, ywbh, 'cdz');
            } else {
                QsWebSoft.PubMethod.UpdateKycdzgzJcYorN("jc", "N", hth, ywbh, 'cdz');
            }
        }
        if (dwoName == "dzyq_bz") {
