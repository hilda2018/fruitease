...
this.Add = function () {
    ...
    if (sjkgsj >= "2000/00/00 00:00") {
        dw_cxcm.Retrieve(cm, zz_cm, xhgqbm, sjkgsj, hdrbm);
    }
    else { 
        dw_cxcm.Retrieve(cm, zz_cm, xhgqbm, "", hdrbm);
    }
...
this.save = function () {
    ...
    for (var i = 1; i <= dw_cxcm.RowCount(); i++) {
            ...
            dw_log.SetItem(row, "changecols", "xhgqbm,xhgq,xhgqjc,xhgqpym,yjkgsj,zz_hcorhbh,zz_cm,sjkgsj,mtdm,jcka,rjka");
    ...
    webReq.Invoke("UpdateKgsj", "cm=" + cm + "&hcorhbh=" + hcorhbh + "&zz_cm=" + zz_cm + "&zz_hcorhbh=" + zz_hcorhbh + "&xhgqbm=" + xhgqbm + "&xhgq=" + xhgq + "&xhgqjc=" + xhgqjc + "&xhgqjc_old=" + xhgqjc_old + "&xhgqpym=" + xhgqpym + "&yjkgsj=" + yjkgsj + "&sjkgsj=" + sjkgsj + "&ykgsj=" + ykgsj + "&kgbz=" + kgbz + "&zz_cm_new=" + zz_cm_new + "&mtdm=" + mtdm + "&jcka=" + jcka + "&rjka=" + rjka + "&hdrbm=" + hdrbm + "&dw_log=" + dw_log_data);
