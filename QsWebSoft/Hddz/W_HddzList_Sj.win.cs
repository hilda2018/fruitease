...
{
    public partial class W_HddzList_Sj
    {
        public W_HddzList_Sj()
        {
        }
        public override void OnLoad()
        {
            ...
            DateTime date_e = System.DateTime.Now.AddDays(180);
            this.dp_end.Value = date_e;
            ...
            var sfxgbgdh = "N";
            ds_role.Retrieve(userid, "00011502");
            if (ds_role.RowCount > 0)
            {
                sfxgbgdh = "Y";
            }
            this.SetParm("Sfxgbgdh", sfxgbgdh);
            // 数据检索
            this.dw_list.Retrieve(DateTime.Parse(this.dp_begin.Value.ToString()), DateTime.Parse(this.dp_end.Value.ToString()), "税金未支付", Dlwtf, "全部", Tybm, Sfqytybm, "预计到港", "N", userid, "全部", sfxgbgdh);
            this.dw_log.Retrieve(userid, "sjgl");
            //注册相关的js文件
            this.RegisterClientScriptInclude("ExtPB_Demo", "/Beta3/ExtPB_Demo.js");
            this.RegisterClientScriptInclude("W_Wldw_Select", "/Xt_Popwin/W_Wldw_Select.win.js");
            this.RegisterClientScriptInclude("W_HddzList_Sj", "/Hddz/W_HddzList_Sj.win.js");
            this.RegisterClientScriptInclude("W_HddzEdit", "/Hddz/W_HddzEdit.win.js");
            this.RegisterClientScriptInclude("W_Hddz_Sjzf", "/Hddz/W_Hddz_Sjzf.win.js");
