...
{
    public partial class W_HddzList_Bgdgl
    {
        public W_HddzList_Bgdgl()
        {
        }
        public override void OnLoad()
        {
            ...
            // 数据检索
            this.dw_list.Retrieve(DateTime.Parse(this.dp_begin.Value.ToString()), DateTime.Parse(this.dp_end.Value.ToString()), Dlwtf, "全部", Tybm, Sfqytybm, "预计到港","N","已报关","未使用","全部");
            this.dw_log.Retrieve(userid, "bggl");
            //注册相关的js文件
