...
function W_HddzList_Khkygz() {
    ...
    this.bind = function (win) {
        ...
        if (typeof (self.Retrieve) == "function")
            win.AttachEvent("ddlb_khkygz", "Modified", self.Retrieve);

        if (typeof (self.Retrieve) == "function")
            win.AttachEvent("cbx_dtqk", "Clicked", self.Retrieve);
    ...
    this.Retrieve = function () {
        ...
        dw_list.Retrieve(beginDate.getVarDate(), endDate.getVarDate(), Dlwtf, khkygzzt, dtqk, rqlx, Tybm, Sfqytybm);
    ...
    this.Save = function () {
        ...
        webReq.Invoke("ListKhkygzSave", "dw_list=" + dw_d_data);
