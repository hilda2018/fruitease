...
{
    public partial class W_HddzList
    {
        public W_HddzList()
        {
        }
        ...
        public override void OnLoad()
        {
            ...
            ds_role.Retrieve(userid, "00010902");
            var count = ds_role.RowCount; 
            if(count <= 0){
                dw_list.Modify("hxzgtgzt.Protect=1");
            }
            ...
            //目的港
            this.ds_4.DataWindowObject = "dd_cport_select";
            this.ds_4.Retrieve();
            this.ddlb_mdg.Items.Add("全部");
            for (int row = 1; row <= ds_4.RowCount;row++ ) {
                this.ddlb_mdg.Items.Add(this.ds_4.GetItemString(row, "cname"));
            }

            //WebRequest wreq = WebRequest.Create("http://www.fruitease.com:8009/images/799870015563432762.jpg");
            ...
            // 数据检索
            this.dw_list.Retrieve(userid, DateTime.Parse(this.dp_begin.Value.ToString("yyyy/MM/dd hh:mm")), DateTime.Parse(this.dp_end.Value.ToString("yyyy/MM/dd hh:mm")), "zj", "未靠港", Dlwtf, "单证", Tybm, Sfqytybm, "全部", "N", "全部", "全部", "全部", "全部");
            ...
            //注册相关的js文件
            this.RegisterClientScriptInclude("W_Wldw_Tggz_hddz", "/Xt_Popwin/W_Wldw_Tggz_hddz.win.js");
            this.RegisterClientScriptInclude("W_Hddz_lxr", "/Hddz/W_Hddz_lxr.win.js");       
            this.RegisterClientScriptInclude("ExtPB_Demo", "/Beta3/ExtPB_Demo.js");
            this.RegisterClientScriptInclude("W_HddzList", "/Hddz/W_HddzList.win.js");
