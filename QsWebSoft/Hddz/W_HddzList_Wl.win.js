...
function W_HddzList_Wl() {
    ...
    var dw_hddz_wl_select = new DataWindow(requestor);
    ...
    this.bind = function (win) {
        ...
        if (dw_hddz_wl_select == null) dw_hddz_wl_select = new DataWindow(requestor);
        dw_hddz_wl_select.Attach(win.Control("dw_hddz_wl_select"));
    ...
    this.unbind = function () {
        ...
        dw_hddz_wl_select.Detach(); dw_hddz_wl_select = null;
    ...
    this.Retrieve = function () {
        ...
        dw_list.Retrieve(userid, beginDate.getVarDate(), endDate.getVarDate(), lx, fxzt, Dlwtf, rqlx, Tybm, Sfqytybm, ctr_area2, tycj, qgld, jdrjc);
    ...
    this.RetrieveQb = function () {
        ...
        dw_list.Retrieve(userid, beginDate.getVarDate(), endDate.getVarDate(), "qb", fxzt, Dlwtf, rqlx, Tybm, Sfqytybm, ctr_area2, tycj, qgld, jdrjc);
        //        self.slectr_area2_EditChanged();
    }
    //#endregion
    ...
    this.RetrieveHy = function () {
        ...
        dw_list.Retrieve(userid, beginDate.getVarDate(), endDate.getVarDate(), "hy", fxzt, Dlwtf, rqlx, Tybm, Sfqytybm, ctr_area2, tycj, qgld, jdrjc);
        //        self.slectr_area2_EditChanged();
    }
    //#endregion
    ...
    this.RetrieveKy = function () {
        ...
        dw_list.Retrieve(userid, beginDate.getVarDate(), endDate.getVarDate(), "ky", fxzt, Dlwtf, rqlx, Tybm, Sfqytybm, ctr_area2, tycj, qgld,jdrjc);
        //        self.slectr_area2_EditChanged();
    }
    //#endregion
    ...
    this.OpenWindow = function () {
        ...
        var parm = "";
        var label = "";
        var node = dw_list.GetItemString(dw_list.GetRow(), "node");
    ...
    //#region 新建
    this.New = function () {
        if (iw_Hddz_Wl_Select == null)
            iw_Hddz_Wl_Select = new W_Hddz_Wl_Select();

        iw_Hddz_Wl_Select.SetDataWindow(dw_hddz_wl_select);

        requestor.Open("/LoadWindow.ashx?WinName=Xt_Popwin.W_Hddz_Wl_Select", iw_Hddz_Wl_Select);
        dw_hddz_wl_select.AcceptText();
        var node = dw_hddz_wl_select.GetItemString(1, "node");
        var gbms = dw_hddz_wl_select.GetItemString(1, "gbms")
        if (gbms == "QX") {
            return;
        }
        ...
        var label = "";
        var ysfs = "";
        var bg = dw_hddz_wl_select.GetItemString(1, "bg")
        var bj = dw_hddz_wl_select.GetItemString(1, "bj")
        var wl = dw_hddz_wl_select.GetItemString(1, "wl")
        var hd = dw_hddz_wl_select.GetItemString(1, "hd")
        var fx = dw_hddz_wl_select.GetItemString(1, "fx")

        var row = ds_1.Find("id='" + node + "'", 1, ds_1.RowCount());
        var operation = "new";
        var ywbh = null;
        if (dw_hddz_wl_select.RowCount() > 0) {
            ysfs = escape(dw_hddz_wl_select.GetItemString(1, "ysfs"));
...
//        }
    ...
    this.Recover = function () {
        ...
        QsWebSoft.PubMethod.DelColRecord("QsWebSoft.Hddz.W_HddzList_Wl", "dw_hddz_list");
        self.Retrieve();
    }
    //#endregion
