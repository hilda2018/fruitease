...
{
    public partial class W_HddzList_Ocrwjsb
    {
        public W_HddzList_Ocrwjsb()
        {
        }
        public override void OnLoad()
        {
            ...
            //};
            // 数据检索
            this.dw_list.Retrieve(DateTime.Parse(this.dp_begin.Value.ToString()), DateTime.Parse(this.dp_end.Value.ToString()),"Y" );
            //注册相关的js文件
            this.RegisterClientScriptInclude("ExtPB_Demo", "/Beta3/ExtPB_Demo.js");
            this.RegisterClientScriptInclude("W_HddzList_Ocrwjsb", "/Hddz/W_HddzList_Ocrwjsb.win.js");
