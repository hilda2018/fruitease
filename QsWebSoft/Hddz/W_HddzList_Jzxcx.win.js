...
function W_HddzList_Jzxcx() {
    ...
    this.bind = function (win) {
        ...
        if (typeof (self.slejzxh_EditChanged) == "function")
            win.AttachEvent("sle_tdh", "EditChanged", self.slejzxh_EditChanged);
        ...
        if (typeof (self.sleztdh_EditChanged) == "function")
            win.AttachEvent("sle_4", "EditChanged", self.sleztdh_EditChanged);
    ...
    this.Retrieve = function () {
        ...
        dw_list.Retrieve(beginDate.getVarDate(), endDate.getVarDate(), sjzt, Dlwtf, Tybm, Sfqytybm, userid, rqlx,jdrjc);
...
//    //#endregion
//    this.ddlb_jdrjcSelectionChanged = function (text) {
//        dw_list.SetRedraw(false);
//        if (text == "全部")
//            dw_list.SetFilter("");
//        else
//            dw_list.SetFilter("( Upper(yw_hddz_jdrjc) like Upper('%" + text + "%'))");
//        dw_list.Filter();
//        dw_list.Sort();
//        dw_list.SetRedraw(true);
//    }
    ...
    this.Recover = function () {
        ...
        QsWebSoft.PubMethod.DelColRecord("QsWebSoft.Hddz.W_HddzList_Jzxcx", "dw_hddz_list_jzxcx");
        self.Retrieve();
    }
    //#endregion
    ...
    //#region 获得字段焦点
    this.Help = function () {
        javascript: window.open('\按集装箱查询.txt')
    }
    //#endregion
