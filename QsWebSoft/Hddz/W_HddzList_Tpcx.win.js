...
function W_HddzList_Tpcx() {
    ...
    this.Retrieve = function () {
        ...
        dw_list.Retrieve(beginDate.getVarDate(), endDate.getVarDate(), sjzt, Dlwtf, Tybm, Sfqytybm, userid, jdrjc);
...
//        var zbr = dw_list.GetItemString(dw_list.GetRow(), "zbr");
    ...
    //#region 获得字段焦点
    this.Help = function () {
        javascript: window.open('\按托盘查询.txt')
    }
    //#endregion
