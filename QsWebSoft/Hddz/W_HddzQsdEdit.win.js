...
function W_HddzQsdEdit() {
    ...
    webReq.SetWebServiceUrl("/Service/Hddzqsd.ashx");
    ...
    this.Save = function () {
        ...
        var qsdbh = dw_master.GetItemString(row, "qsdbh");
        ...
        for (row = dw_jzxxx.RowCount(); row > 0; row--) {
            dw_jzxxx.SetItem(row, "qsdbh", qsdbh);
        ...
        webReq.Invoke("Save", "dw_master=" + dw_master_data + "&dw_jzxxx=" + dw_jzxxx_data + "&qsdbh=" + qsdbh + "&operation=" + editMode);

        if (webReq.StatusCode() == 200) {
            //服务器成功处理，返回单号
            qsdbh = webReq.ResponseText();
            dw_master.SetItem(1, "qsdbh", qsdbh);
            ...
            dw_master.Modify("qsdbh.Tabsequence=0");
    ...
    this.InsertRow = function () {
        if (iw_Hddz_Qsd_Select == null)
            iw_Hddz_Qsd_Select = new W_Hddz_Qsd_Select();
        var ShareMode = requestor.GetParm("ShareMode");
        var ywy = requestor.GetParm("userid");
        var Dlwtf = requestor.GetParm("Dlwtf");
        row = dw_jzxxx.InsertRow(dw_jzxxx.GetRow());
        var dwo = dw_jzxxx.GetDataObject();
        iw_Hddz_Qsd_Select.SetRow(row);
        iw_Hddz_Qsd_Select.SetDwo(dwo);
        iw_Hddz_Qsd_Select.SetDetailDW(dw_jzxxx);
        requestor.Open("/LoadWindow.ashx?WinName=Xt_Popwin.W_Hddz_Qsd_Select&ShareMode=" + ShareMode + '&ywy=' + ywy + '&Dlwtf=' + Dlwtf, iw_Hddz_Qsd_Select);
    ...
    this.Print = function () {
        ...
        var qsdbh = dw_master.GetItemString(1, "qsdbh");
        ...
        dw_print.SetDataObject("dw_hddz_qsd_print");
        dw_print.Retrieve(qsdbh);
...
//        dw_jzxxx.InsertRow(0);
    ...
    this.dw_master_Clicked = function (xPos, yPos, Row, dwoName) {
        ...
        if (dwoName == "jsdwmc_t") {
            ...
            iw_Wldw_Select.SetData("qsd_jsdwmc");
