...
function W_HddzList_Jjfcx() {
    ...
    this.Retrieve = function () {
        ...
        dw_list.Retrieve(beginDate.getVarDate(), endDate.getVarDate(), jjzt);
    ...
    this.Save = function () {
        ...
        webReq.Invoke("ListJjfcxSave", "dw_list=" + dw_d_data );
