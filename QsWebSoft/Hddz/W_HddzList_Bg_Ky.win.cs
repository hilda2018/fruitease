...
{
    public partial class W_HddzList_Bg_Ky
    {
        public W_HddzList_Bg_Ky()
        {
        }
        public override void OnLoad()
        {
            ...
            // 数据检索
            this.dw_list.Retrieve(DateTime.Parse(this.dp_begin.Value.ToString()), DateTime.Parse(this.dp_end.Value.ToString()), "未报关", Dlwtf, userid,"全部");
            ...
            this.RegisterClientScriptInclude("W_HddzList_Bg_Ky", "/Hddz/W_HddzList_Bg_Ky.win.js");
