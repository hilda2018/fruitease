...
function W_HddzKyzjzgz_zzjc() {
    ...
    this.Save = function () {
        ...
        webReq.Invoke("HddzKyzjzgzSave_Zzjc", "dw_list=" + dw_list_data + "&dw_log=" + dw_log_data);
...
//                QsWebSoft.PubMethod.UpdateKycdzgzYorN("xcsdbz", "Y", hth, ywbh, "zjz");
            } else {
                dw_list.SetItem(row, "dzyq_sdzbsj", sj.getVarDate());
//                QsWebSoft.PubMethod.UpdateKycdzgzYorN("xcsdbz", "N", hth, ywbh, "zjz");
            }
        }

//        if (dwoName == "dzyq_sfsdfb") {
//            if (data == "Y") {
//                QsWebSoft.PubMethod.UpdateKycdzgzYorN("sfsdfb", "Y", hth, ywbh, "zjz");
//            } else {
//                QsWebSoft.PubMethod.UpdateKycdzgzYorN("sfsdfb", "N", hth, ywbh, "zjz");
//            }
//        }
//        if (dwoName == "dzyq_bz") {
...
//        }
    ...
    this.Recover = function () {
        ...
        QsWebSoft.PubMethod.DelColRecord("QsWebSoft.Hddz.W_HddzKyzjzgz_zzjc", "dw_hddz_kycdzgz_zzjc_list");
        self.Retrieve();
    }
    //#endregion
