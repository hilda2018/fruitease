...
function W_HddzList_Hykhyc() {
    ...
    var dw_thyc = new DataWindow(requestor);
    ...
    var dw_bjhthcq = new DataWindow(requestor);
    var dw_mtsjthyc = new DataWindow(requestor);
    ...
    this.bind = function (win) {
        ...
        if (dw_thyc == null) dw_thyc = new DataWindow(requestor);
        dw_thyc.Attach(win.Control("dw_thyc"));
        ...
        if (dw_bjhthcq == null) dw_bjhthcq = new DataWindow(requestor);
        dw_bjhthcq.Attach(win.Control("dw_bjhthcq"));
        if (dw_mtsjthyc == null) dw_mtsjthyc = new DataWindow(requestor);
        dw_mtsjthyc.Attach(win.Control("dw_mtsjthyc"));
        ...
        if (typeof (self.dw_thyc_Clicked) == "function")
            win.AttachEvent("dw_thyc", "Clicked", self.dw_thyc_Clicked);

        if (typeof (self.dw_thyc_DoubleClicked) == "function")
            win.AttachEvent("dw_thyc", "DoubleClicked", self.dw_thyc_DoubleClicked);

        if (typeof (self.dw_DwnMouseMove) == "function")
            win.AttachEvent("dw_thyc", "DwnMouseMove", self.dw_DwnMouseMove);

        if (typeof (self.dw_LButtonDown) == "function")
            win.AttachEvent("dw_thyc", "LButtonDown", self.dw_LButtonDown);

        if (typeof (self.RbuttonDown) == "function")
            win.AttachEvent("dw_thyc", "RButtonDown", self.RbuttonDown);
        ...
        if (typeof (self.dw_thyc_Clicked) == "function")
            win.AttachEvent("dw_bjhthcq", "Clicked", self.dw_thyc_Clicked);

        if (typeof (self.dw_DwnMouseMove) == "function")
            win.AttachEvent("dw_bjhthcq", "DwnMouseMove", self.dw_DwnMouseMove);

        if (typeof (self.dw_LButtonDown) == "function")
            win.AttachEvent("dw_bjhthcq", "LButtonDown", self.dw_LButtonDown);

        if (typeof (self.RbuttonDown) == "function")
            win.AttachEvent("dw_bjhthcq", "RButtonDown", self.RbuttonDown);
        ...
        if (typeof (self.Filter_thyc) == "function")
            win.AttachEvent("m_13", "Clicked", self.Filter_thyc);

        if (typeof (self.Filter_Cancle_thyc) == "function")
            win.AttachEvent("m_15", "Clicked", self.Filter_Cancle_thyc);

        if (typeof (self.Retrieve) == "function")
            win.AttachEvent("m_19", "Clicked", self.Retrieve);

        if (typeof (self.CopyCol_thyc) == "function")
            win.AttachEvent("m_21", "Clicked", self.CopyCol_thyc);

        if (typeof (self.CopySelect_thyc) == "function")
            win.AttachEvent("m_22", "Clicked", self.CopySelect_thyc);

        if (typeof (self.CopyL_thyc) == "function")
            win.AttachEvent("m_23", "Clicked", self.CopyL_thyc);

        if (typeof (self.Recover_thyc) == "function")
            win.AttachEvent("m_18", "Clicked", self.Recover_thyc);
        ...
        if (typeof (self.Filter_bjhthcq) == "function")
            win.AttachEvent("m_145", "Clicked", self.Filter_bjhthcq);

        if (typeof (self.Filter_Cancle_bjhthcq) == "function")
            win.AttachEvent("m_147", "Clicked", self.Filter_Cancle_bjhthcq);

        if (typeof (self.Retrieve) == "function")
            win.AttachEvent("m_150", "Clicked", self.Retrieve);

        if (typeof (self.CopyCol_bjhthcq) == "function")
            win.AttachEvent("m_152", "Clicked", self.CopyCol_bjhthcq);

        if (typeof (self.CopySelect_bjhthcq) == "function")
            win.AttachEvent("m_153", "Clicked", self.CopySelect_bjhthcq);

        if (typeof (self.CopyL_bjhthcq) == "function")
            win.AttachEvent("m_154", "Clicked", self.CopyL_bjhthcq);

        if (typeof (self.Recover_bjhthcq) == "function")
            win.AttachEvent("m_155", "Clicked", self.Recover_bjhthcq);

        if (typeof (self.Filter_thsc) == "function")
            win.AttachEvent("m_156", "Clicked", self.Filter_thsc);

        if (typeof (self.Filter_Cancle_thsc) == "function")
            win.AttachEvent("m_158", "Clicked", self.Filter_Cancle_thsc);

        if (typeof (self.Retrieve) == "function")
            win.AttachEvent("m_161", "Clicked", self.Retrieve);

        if (typeof (self.CopyCol_thsc) == "function")
            win.AttachEvent("m_163", "Clicked", self.CopyCol_thsc);

        if (typeof (self.CopySelect_thsc) == "function")
            win.AttachEvent("m_164", "Clicked", self.CopySelect_thsc);

        if (typeof (self.CopyL_thsc) == "function")
            win.AttachEvent("m_165", "Clicked", self.CopyL_thsc);

        if (typeof (self.Recover_thsc) == "function")
            win.AttachEvent("m_166", "Clicked", self.Recover_thsc);
    ...
    this.unbind = function () {
        ...
        dw_bjhthcq.Detach(); dw_bjhthcq = null;
        dw_mtsjthyc.Detach(); dw_mtsjthyc = null;
    ...
    this.Retrieve = function () {
        ...
        dw_thyc.Retrieve(beginDate.getVarDate(), endDate.getVarDate(), jdr);
        ...
        dw_tgyc.Retrieve(beginDate.getVarDate(), endDate.getVarDate(), jdr);
        self.SelectionChanged_tgyc();
        dw_fxyc.Retrieve(beginDate.getVarDate(), endDate.getVarDate(), jdr);
        self.SelectionChanged_fxyc();
        dw_bjtgyc.Retrieve(beginDate.getVarDate(), endDate.getVarDate(), jdr);
        self.SelectionChanged_bjtgyc();
        dw_gjyc.Retrieve(beginDate.getVarDate(), endDate.getVarDate(), jdr);
        self.SelectionChanged_gjyc();
        dw_hdyc.Retrieve(beginDate.getVarDate(), endDate.getVarDate(), jdr);
        self.SelectionChanged_hdyc();
        dw_thsc.Retrieve(beginDate.getVarDate(), endDate.getVarDate(), jdr);

        dw_mtsjthyc.Retrieve(beginDate.getVarDate(), endDate.getVarDate(), jdr);
        ...
        //        dw_thyc.Retrieve(beginDate.getVarDate(), endDate.getVarDate(), rqlx);
    ...
    this.dw_thyc_DoubleClicked = function (xPos, yPos, Row, dwoName) {
        if (Row > 0) {
            if (dwoName == "htjhthsj_lrsj") {
                if (iw_Wldw_htjhthsj_Select == null)
                    iw_Wldw_htjhthsj_Select = new W_Wldw_htjhthsj_Select();

                var Dlwtf = requestor.GetParm("Dlwtf");
                var row = dw_thyc.GetRow();
                var ywbh = dw_thyc.GetItemString(row, "ywbh");
                var cxh = dw_thyc.GetItemNumber(row, "cxh")
    ...
    this.SelectionChanged_bgyc = function (text) {
        ...
        dw_thyc.SetRedraw(false);
        dw_thyc.SetFilter(ls_filter);
        dw_thyc.Filter();
        dw_thyc.Sort();
        dw_thyc.SetRedraw(true);
    }
    //#endregion 
    ...
    //#region 过滤处理状态
    this.SelectionChanged_thyc = function (text) {
        var ycclzt_thyc = ddlb_ycclzt_thyc.GetText();
        var ls_filter = "";
        if (ycclzt_thyc == "未处理") {
            ls_filter = "ycclzt = 'N'";
        } else if (ycclzt_thyc == "已处理") {
            ls_filter = "ycclzt = 'Y'";
        };
    ...
    //#region 恢复默认列
    this.Recover_bjhthcq = function () {
        QsWebSoft.PubMethod.DelColRecord("QsWebSoft.Hddz.W_HddzList_Hyycgz", "dw_hddz_list_hyycgz_bjhthcq");
        self.Retrieve();
    }
    //#endregion

    //#region 恢复默认列
    this.Recover_thsc = function () {
        QsWebSoft.PubMethod.DelColRecord("QsWebSoft.Hddz.W_HddzList_Hyycgz", "dw_hddz_list_hyycgz_thsc");
        self.Retrieve();
    }
    //#endregion
    ...
    //#region 复制字段内容
    this.CopyCol_thyc = function () {
        var copytext = "";
        var row = dw_thyc.GetRow();
        if (row <= 0)
            return;
        colType = dw_thyc.Describe(cloname + ".colType");
        colType = colType.substring(0, 4);
        if (colType == "char") {
            copytext = dw_thyc.GetItemString(dw_thyc.GetRow(), cloname);
        }
        else if (colType == "date" || colType == "time") {
            var rq = new Date(dw_thyc.GetItemDate(dw_thyc.GetRow(), cloname));
            rq = QsWebSoft.PubMethod.ReturnDateString(rq).value;
            copytext = rq;
        }
        else {
            var num = dw_thyc.GetItemNumber(dw_thyc.GetRow(), cloname);
            copytext = num.toString();
        }
        window.clipboardData.setData("Text", copytext);
    ...
    //#region 复制字段内容
    this.CopyCol_bjhthcq = function () {
        var copytext = "";
        var row = dw_bjhthcq.GetRow();
        if (row <= 0)
            return;
        colType = dw_bjhthcq.Describe(cloname + ".colType");
        colType = colType.substring(0, 4);
        if (colType == "char") {
            copytext = dw_bjhthcq.GetItemString(dw_bjhthcq.GetRow(), cloname);
        }
        else if (colType == "date" || colType == "time") {
            var rq = new Date(dw_bjhthcq.GetItemDate(dw_bjhthcq.GetRow(), cloname));
            rq = QsWebSoft.PubMethod.ReturnDateString(rq).value;
            copytext = rq;
        }
        else {
            var num = dw_bjhthcq.GetItemNumber(dw_bjhthcq.GetRow(), cloname);
            copytext = num.toString();
        }
        window.clipboardData.setData("Text", copytext);
    }
    ...
    this.OpenYcyy_Bgyc = function (Row) {
        ...
        var row = dw_thyc.GetRow();
        var ywbh = dw_thyc.GetItemString(row, "ywbh")
        iw_Hddz_Ycyy.SetDataWindow(dw_thyc);
        iw_Hddz_Ycyy.SetData(ywbh);
        iw_Hddz_Ycyy.SetRow(Row);
    ...
    this.OpenYcyy_thyc = function (Row) {
        if (iw_Hddz_Ycyy == null)
            iw_Hddz_Ycyy = new W_Hddz_Ycyy();

        var Dlwtf = requestor.GetParm("Dlwtf");
        var row = dw_thyc.GetRow();
        var ywbh = dw_thyc.GetItemString(row, "ywbh_jsl")
    ...
    //#region 单击明细单编号
    this.dw_thyc_Clicked = function (xPos, yPos, Row, dwoName, Data) {
        if (Row > 0) {
            fzks_row = Row;
        };
    }
    ...
    this.CopyAll_thyc = function () {
        ...
        for (row = fzks_row; row <= fzjs_row; row++) {
            ...
            colType = colType.substring(0, 4);
            if (colType == "char") {
                copytext = dw_thyc.GetItemString(row, cloname);
            }
            else if (colType == "date" || colType == "time") {
                var rq = new Date(dw_thyc.GetItemDate(row, cloname));
                rq = QsWebSoft.PubMethod.ReturnDateString(rq).value;
                copytext = rq;
            }
            else {
                var num = dw_thyc.GetItemNumber(row, cloname);
                copytext = num.toString();
            }
    ...
    this.CopySelect_thyc = function () {
        ...
        for (row = fzks_row; row <= fzjs_row; row++) {
            ...
            for (row1 = 0; row1 <= arr.length; row1++) {
                colType = dw_thyc.Describe(arr[row1] + ".colType");
                colType = colType.substring(0, 4);
                if (colType == "char") {
                    copytext = dw_thyc.GetItemString(row, arr[row1]);
                }
                else if (colType == "date" || colType == "time") {
                    var rq = new Date(dw_thyc.GetItemDate(row, arr[row1]));
                    rq = QsWebSoft.PubMethod.ReturnDateString(rq).value;
                    copytext = rq;
                } else if (colType == "!") {
                    continue;
                    ...
                    var num = dw_thyc.GetItemNumber(row, arr[row1]);
                    copytext = num.toString();
                };
                if (copytext_sum == "") {
                    copytext_sum = copytext
    ...
    //#region 选择复制
    this.CopySelect_bjhthcq = function () {
        begin = "N";
        ...
        for (row = fzks_row; row <= fzjs_row; row++) {
            ...
            for (row1 = 0; row1 <= arr.length; row1++) {
                colType = dw_bjhthcq.Describe(arr[row1] + ".colType");
                colType = colType.substring(0, 4);
                if (colType == "char") {
                    copytext = dw_bjhthcq.GetItemString(row, arr[row1]);
                }
                else if (colType == "date" || colType == "time") {
                    var rq = new Date(dw_bjhthcq.GetItemDate(row, arr[row1]));
                    rq = QsWebSoft.PubMethod.ReturnDateString(rq).value;
                    copytext = rq;
                } else if (colType == "!") {
                    continue;
                    ...
                    var num = dw_bjhthcq.GetItemNumber(row, arr[row1]);
                    copytext = num.toString();
                };
                if (copytext_sum == "") {
                    copytext_sum = copytext
    ...
    this.CopyL_fscsj = function () {
        ...
        for (row = 1; row <= dw_fscsj.RowCount(); row++) {
    ...
    this.CopyL_bjhthcq = function () {
        ...
        for (row = 1; row <= dw_bjhthcq.RowCount(); row++) {
    ...
    this.CopyL_thyc = function () {
        ...
        for (row = 1; row <= dw_thyc.RowCount(); row++) {
    ...
    this.Filter_thyc = function () {
        ...
        iw_Filter.SetDataWindow(dw_thyc); 
        iw_Filter.SetDataWindowFilter(dw_filter);
        requestor.Open("/LoadWindow.ashx?WinName=Hddz.W_Filter&Zdm=" + cloname + '&colType=' + colType, iw_Filter);
        dw_thyc.SetFocus();
        dw_thyc.ScrollToRow(row)
    ...
    //#region 单列过滤
    this.Filter_bjhthcq = function () {
        dw_bjhthcq.AcceptText();
        var row = dw_bjhthcq.GetRow();
        if (row <= 0)
            return;
        ...
        iw_Filter.SetDataWindow(dw_bjhthcq);
        iw_Filter.SetDataWindowFilter(dw_filter);
        requestor.Open("/LoadWindow.ashx?WinName=Hddz.W_Filter&Zdm=" + cloname + '&colType=' + colType, iw_Filter);
        dw_bjhthcq.SetFocus();
        dw_bjhthcq.ScrollToRow(row)
    ...
    //#endregion
    //#region 过滤取消
    this.Filter_Cancle_thyc = function () {
        dw_thyc.SetFilter("");
        dw_thyc.Filter();
        dw_thyc.SetFocus();
        dw_filter.Reset();
    ...
    //#endregion
    //#region 过滤取消
    this.Filter_Cancle_bjhthcq = function () {
        dw_bjhthcq.SetFilter("");
        dw_bjhthcq.Filter();
        dw_bjhthcq.SetFocus();
        dw_filter.Reset();
    }
