...
function W_HddzKycdzgz_zzjc() {
    ...
    var ddlb_sfsdfb = new DropDownListBox(requestor);
    ...
    this.bind = function (win) {
        ...
        if (ddlb_sfsdfb == null) ddlb_sfsdfb = new DropDownListBox(requestor);
        ddlb_sfsdfb.Attach(win.Control("ddlb_sfsdfb"));
        ...
        if (typeof (self.Retrieve) == "function")
            win.AttachEvent("ddlb_sfsdfb", "SelectionChanged", self.Retrieve);
    ...
    this.unbind = function () {
        ...
        ddlb_sfsdfb.Detach(); ddlb_sfsdfb = null;
    ...
    this.Retrieve = function () {
        ...
        var sfsdfb = ddlb_sfsdfb.GetText();
        ...
        dw_list.Retrieve(beginDate.getVarDate(), endDate.getVarDate(), sfzbzj, ylwl, Dlwtf, sfsdfb, userid,jdrjc);
        var hth = sle_hth.GetText();
        var jsq = sle_jsq.GetText();
        if (hth != null && hth != "") {
            self.sle_EditChanged(hth);
        }
        if (jsq != null && jsq != "" && jsq != 0) {
    ...
    this.Save = function () {
        ...
        webReq.Invoke("HddzKycdzgzSave_Zzjc", "dw_list=" + dw_list_data);
...
//        }
    ...
    this.dw_List_ItemChanged = function (row, dwoName, data) {
        ...
        if (dwoName == "dzyq_xcsdbz") {
            if (data == "Y") {
                QsWebSoft.PubMethod.UpdateKycdzgzYorN("xcsdbz", "Y", hth, ywbh, 'cdz');
            } else {
                QsWebSoft.PubMethod.UpdateKycdzgzYorN("xcsdbz", "N", hth, ywbh, 'cdz');
            }
        }

        if (dwoName == "dzyq_sfsdfb") {
            if (data == "Y") {
                QsWebSoft.PubMethod.UpdateKycdzgzYorN("sfsdfb", "Y", hth, ywbh, 'cdz');
            } else {
                QsWebSoft.PubMethod.UpdateKycdzgzYorN("sfsdfb", "N", hth, ywbh, 'cdz');
            }
        }
        if (dwoName == "dzyq_bz") {
            QsWebSoft.PubMethod.UpdateKycdzbz(hth, ywbh, data, "cdz");
        }
        if (dwoName == "dzyq_dzbh") {
            QsWebSoft.PubMethod.UpdateKyzjzDzbh(hth, ywbh, data, "cdz");
        }
    }
    ...
    this.Recover = function () {
        ...
        QsWebSoft.PubMethod.DelColRecord("QsWebSoft.Hddz.W_HddzKycdzgz_zzjc", "dw_hddz_kycdzgz_zzjc_list");
        self.Retrieve();
    }
    //#endregion
