...
{
    public partial class W_HddzList_Scsxg
    {
        public W_HddzList_Scsxg()
        {
        }
        ...
        public override void OnLoad()
        {
            ...
            // 数据检索
            this.dw_list.Retrieve(  DateTime.Parse(this.dp_begin.Value.ToString()), DateTime.Parse(this.dp_end.Value.ToString()),"单证", "未生成");
            //注册相关的js文件
