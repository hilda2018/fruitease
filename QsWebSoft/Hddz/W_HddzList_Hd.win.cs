...
{
    public partial class W_HddzList_Hd
    {
        public W_HddzList_Hd()
        {
        }
        public override void OnLoad()
        {
            ...
            // 数据检索
            this.dw_list.Retrieve(DateTime.Parse(this.dp_begin.Value.ToString()), DateTime.Parse(this.dp_end.Value.ToString()), "未换单","N","N",userid,"全部");
            this.dw_log.Retrieve(userid, "hyhd");
            //注册相关的js文件
            this.RegisterClientScriptInclude("ExtPB_Demo", "/Beta3/ExtPB_Demo.js");
            this.RegisterClientScriptInclude("W_HddzList_Hd", "/Hddz/W_HddzList_Hd.win.js");
            ...
            this.RegisterClientScriptInclude("W_Set_Rq", "/Hddz/W_Set_Rq.win.js");
