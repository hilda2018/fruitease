...
function W_HddzList_Bzj() {
	 ...
	 if(typeof( baseBind )=="function") baseBind(win);
		 ...
		 if(typeof(self.slebgdh_EditChanged)=="function") 
			 win.AttachEvent("sle_tdh","EditChanged",self.slebgdh_EditChanged); 

		 if(typeof(self.slebzjsjh_EditChanged)=="function") 
			 win.AttachEvent("sle_2","EditChanged",self.slebzjsjh_EditChanged); 
    ...
    this.Save = function () {
        ...
        for (var i = 1; i <= dw_list.RowCount(); i++) {
            ...
            if (dw_list.GetItemStatus(i, 0, DWBUFFER.Primary) == 1) {
                ...
                dw_log.SetItem(row, "changecols", "bzjdjh,bzj,sjzfrq,bzjjzsj,zgs,zzzs,tbzj,tkdzsj,hgclsj");
        ...
        webReq.Invoke("ListBzjSave", "dw_list=" + dw_d_data + "&dw_log=" + dw_log_data);
    ...
    //#region 获得字段焦点
    this.Help = function () {
        javascript: window.open('\海运保证金.txt')
    }
    //#endregion
}
