...
{
    public partial class W_HddzKyzjzgz_zzjc
    {
        public W_HddzKyzjzgz_zzjc()
        {
        }
        public override void OnLoad()
        {
            ...
            // 数据检索
            this.dw_list.Retrieve(DateTime.Parse(this.dp_begin.Value.ToString()), DateTime.Parse(this.dp_end.Value.ToString()), "N", "未收到", Dlwtf, "全部", userid,"全部");
            ...
            this.RegisterClientScriptInclude("W_HddzKyzjzgz_zzjc", "/Hddz/W_HddzKyzjzgz_zzjc.win.js");
