...
{
    public partial class W_HddzList_Bg
    {
        public W_HddzList_Bg()
        {
        }
        public override void OnLoad()
        {
            ...
            // 数据检索
            this.dw_list.Retrieve(DateTime.Parse(this.dp_begin.Value.ToString()), DateTime.Parse(this.dp_end.Value.ToString()), "未报关", "N", userid,"全部");
            this.dw_log.Retrieve(userid, "bg01");
            ...
            this.RegisterClientScriptInclude("W_HddzEdit_Ytjk", "/Hddz/W_HddzEdit_Ytjk.win.js");
            this.RegisterClientScriptInclude("W_HddzYtjkEdit", "/Hddz/W_HddzYtjkEdit.win.js");
            this.RegisterClientScriptInclude("W_HddzYtjkEdit2018", "/Hddz/W_HddzYtjkEdit2018.win.js");           
            this.RegisterClientScriptInclude("W_HddzList_Bg", "/Hddz/W_HddzList_Bg.win.js");
            this.RegisterClientScriptInclude("W_Wldw_Select", "/Xt_Popwin/W_Wldw_Select.win.js");
            this.RegisterClientScriptInclude("W_Hddz_Ycyy", "/Hddz/W_Hddz_Ycyy.win.js");
            this.RegisterClientScriptInclude("W_Hddz_Ytsjjk_cmd", "/Hddz/W_Hddz_Ytsjjk_cmd.win.js");
