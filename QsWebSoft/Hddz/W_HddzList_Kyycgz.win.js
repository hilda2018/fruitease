...
function W_HddzList_Kyycgz() {
    ...
    this.bind = function (win) {
        ...
        if (typeof (self.Cyfxplcl) == "function")
            win.AttachEvent("btn_cyfxplcl", "Clicked", self.Cyfxplcl);
        ...
        if (typeof (self.Retrieve) == "function")
            win.AttachEvent("ddlb_jydzt_bqqk", "SelectionChanged", self.Retrieve);

        if (typeof (self.Retrieve) == "function")
            win.AttachEvent("ddlb_jyd_bqqk", "SelectionChanged", self.Retrieve);
        ...
        if (typeof (self.Retrieve) == "function")
            win.AttachEvent("ddlb_wd", "SelectionChanged", self.Retrieve);

        if (typeof (self.Retrieve) == "function")
            win.AttachEvent("ddlb_jydzt_wdqk", "SelectionChanged", self.Retrieve);

        if (typeof (self.Retrieve) == "function")
            win.AttachEvent("ddlb_jyd_wdqk", "SelectionChanged", self.Retrieve);
        ...
        if (typeof (self.Retrieve) == "function")
            win.AttachEvent("ddlb_jydzt_gqjyd", "SelectionChanged", self.Retrieve);

        if (typeof (self.Retrieve) == "function")
            win.AttachEvent("ddlb_jyd_gqjyd", "SelectionChanged", self.Retrieve);
        ...
        if (typeof (self.OpenYcyy_Fyqk) == "function")
            win.AttachEvent("btn_3", "Clicked", self.OpenYcyy_Fyqk);

        if (typeof (self.SelectionChanged_fyqk) == "function")
            win.AttachEvent("ddlb_ycclzt_fyqk", "SelectionChanged", self.SelectionChanged_fyqk);
        ...
        if (typeof (self.InsertRow_qtwt) == "function")
            win.AttachEvent("btn_rowadd", "Clicked", self.InsertRow_qtwt);

        if (typeof (self.DeleteRow_qtwt) == "function")
            win.AttachEvent("btn_rowdelete", "Clicked", self.DeleteRow_qtwt);

        if (typeof (self.CopyRow_qtwt) == "function")
            win.AttachEvent("btn_5", "Clicked", self.CopyRow_qtwt);

        if (typeof (self.Save_qtwt) == "function")
            win.AttachEvent("btn_save", "Clicked", self.Save_qtwt);
