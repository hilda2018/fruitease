...
{
    public partial class W_HddzList_Lhxx
    {
        public W_HddzList_Lhxx()
        {
        }
        public override void OnLoad()
        {
            ...
            // 数据检索
            this.dw_list.Retrieve(DateTime.Parse(this.dp_begin.Value.ToString()), DateTime.Parse(this.dp_end.Value.ToString()), "已到港", "确报动态", "正常理货", "未申请状态",userid,"全部");
            this.dw_log.Retrieve(userid, "lhxx");
            //注册相关的js文件
            this.RegisterClientScriptInclude("ExtPB_Demo", "/Beta3/ExtPB_Demo.js");
            this.RegisterClientScriptInclude("W_HddzList_Lhxx", "/Hddz/W_HddzList_Lhxx.win.js");
