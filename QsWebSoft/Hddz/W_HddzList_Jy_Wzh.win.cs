...
{
    public partial class W_HddzList_Jy_Wzh
    {
        public W_HddzList_Jy_Wzh()
        {
        }
        public override void OnLoad()
        {
            ...
            // 数据检索
            this.dw_list.Retrieve(DateTime.Parse(this.dp_begin.Value.ToString()), DateTime.Parse(this.dp_end.Value.ToString()), "未无纸化放行", "全部", userid,"全部");
            //注册相关的js文件
