...
{
    public partial class W_HddzList_Hd_Ky
    {
        public W_HddzList_Hd_Ky()
        {
        }
        public override void OnLoad()
        {
            ...
            // 数据检索
            this.dw_list.Retrieve(DateTime.Parse(this.dp_begin.Value.ToString()), DateTime.Parse(this.dp_end.Value.ToString()), "未换单", userid,"全部");
            this.dw_log.Retrieve(userid, "kyhd");
            //注册相关的js文件
            this.RegisterClientScriptInclude("ExtPB_Demo", "/Beta3/ExtPB_Demo.js");
            this.RegisterClientScriptInclude("W_HddzList_Hd_Ky", "/Hddz/W_HddzList_Hd_Ky.win.js");
            this.RegisterClientScriptInclude("W_HddzList_Hd_Kycf", "/Hddz/W_HddzList_Hd_Kycf.win.js");
