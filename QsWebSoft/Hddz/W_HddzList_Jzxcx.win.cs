...
{
    public partial class W_HddzList_Jzxcx
    {
        public W_HddzList_Jzxcx()
        {
        }
        public override void OnLoad()
        {
            ...
            // 数据检索
            //this.dw_list.Retrieve(DateTime.Parse(this.dp_begin.Value.ToString()), DateTime.Parse(this.dp_end.Value.ToString()), "已到港未放行", Dlwtf, Tybm, Sfqytybm, userid, "全部", "制单日期");
            this.dw_list.Retrieve(DateTime.Parse(this.dp_begin.Value.ToString()), DateTime.Parse(this.dp_end.Value.ToString()), "已到港未放行", Dlwtf, Tybm, Sfqytybm, userid,"制单日期","全部");
            //注册相关的js文件
            this.RegisterClientScriptInclude("ExtPB_Demo", "/Beta3/ExtPB_Demo.js");
            this.RegisterClientScriptInclude("W_HddzList_Jzxcx", "/Hddz/W_HddzList_Jzxcx.win.js");
