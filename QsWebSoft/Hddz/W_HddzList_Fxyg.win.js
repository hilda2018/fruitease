...
function W_HddzList_Fxyg() {
    ...
    this.bind = function (win) {
        ...
        if (typeof (self.Szyjfxsj) == "function")
            win.AttachEvent("btn_szyjfxsj", "Clicked", self.Szyjfxsj);
    ...
    this.Retrieve = function () {
        ...
        dw_list.Retrieve(beginDate.getVarDate(), endDate.getVarDate(), fxzt, jdrjc);
    ...
    this.slebgdh_EditChanged = function (text) {
        ...
        if (text == "")
            ...
            dw_list.SetFilter("( Upper(bgdh) like '%" + text + "%')  or ( Lower(bgdh) like '%" + text + "%')");
        dw_list.Filter();
        dw_list.Sort();
        dw_list.SetRedraw(true);
    }
    ...
    this.sle_cm_EditChanged = function (text) {
        ...
        if (text == "")
            ...
            dw_list.SetFilter("( Upper(cm) like '%" + text + "%')  or ( Lower(cm) like '%" + text + "%') or ( Upper(zz_cm) like '%" + text + "%')  or ( Lower(zz_cm) like '%" + text + "%')");
        dw_list.Filter();
        dw_list.Sort();
        dw_list.SetRedraw(true);
    }
    ...
    this.Save = function () {
        ...
        webReq.Invoke("ListFxygSave", "dw_list=" + dw_d_data);
