...
function W_Ky_TdqrzhList() {
    ...
    this.Retrieve = function () {
        ...
        dw_list.Retrieve(beginDate.getVarDate(), endDate.getVarDate(), gqzt, Dlwtf, qrzt, userid, jdrjc);
    ...
    this.dw_List_ItemChanged = function (row, dwoName, data) {
        if (dwoName == "cdqrbz") {
            var date = new Date();
            var userid = requestor.GetParm("userid");
            dw_list.SetItem(row, "cdqrry", userid)
            dw_list.SetItem(row, "cdqrsj", date.getVarDate())
    ...
    this.Recover = function () {
        ...
        QsWebSoft.PubMethod.DelColRecord("QsWebSoft.Wlxx.W_Ky_TdqrzhList", "dw_ky_tdqrzh_list");
        self.Retrieve();
    }
    //#endregion
    ...
    this.Save = function () {
        ...
        webReq.Invoke("TdqrzhListSave", "dw_list=" + dw_d_data );
