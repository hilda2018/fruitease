...
function W_Hy_FscwlList() {
    ...
    var ddlb_fscwlzt = new DropDownListBox(requestor);
    ...
    this.bind = function (win) {
        ...
        if (ddlb_fscwlzt == null) ddlb_fscwlzt = new DropDownListBox(requestor);
        ddlb_fscwlzt.Attach(win.Control("ddlb_fscwlzt"));
        ...
        if (typeof (self.Retrieve) == "function")
            win.AttachEvent("ddlb_fscwlzt", "SelectionChanged", self.Retrieve);
    ...
    this.unbind = function () {
        ...
        ddlb_fscwlzt.Detach(); ddlb_fscwlzt = null;
    ...
    this.Retrieve = function () {
        ...
        var fscwlzt = ddlb_fscwlzt.GetText();
        ...
        dw_list.Retrieve(beginDate.getVarDate(), endDate.getVarDate(), fscwlzt, userid, jdrjc);
    ...
    this.dw_List_DoubleClicked = function (xPos, yPos, Row, dwoName) {
        if (Row > 0)
            ...
            if (dwoName == "fscwl_sj") {
                ...
                iw_Sj_Select.SetData("hy_fscwl_sj");
            ...
            if (dwoName == "jzxxx_fxdcjc") {
                ...
                iw_Wldw_Select.SetData("hy_fscwl_dc");
    ...
    this.Recover = function () {
        ...
        QsWebSoft.PubMethod.DelColRecord("QsWebSoft.Wlxx.W_Hy_FscwlList", "dw_hy_fscwl_list");
        self.Retrieve();
    }
    //#endregion
    ...
    this.Save = function () {
        ...
        webReq.Invoke("FscwlListSave", "dw_list=" + dw_d_data);
...
//        if (syrw > 0) {
//            requestor.MessageBox("提示", "前一节点尚未下任务，不能做进市场任务");
//            return
//        }

//        var jzxxx_zjfscwld_bz = dw_list.GetItemString(row, "jzxxx_zjfscwld_bz");
//        if (jzxxx_zjfscwld_bz == "Y") {
//            var rwbh = QsWebSoft.PubMethod.ReadRwbh(ywbh, hddz_cxh.toString(), "zjfscwld_rwbh").value; // dw_list.GetItemString(row, "jzxxx_zjfscwld_rwbh");
//        }
//        var jzxxx_jschfscwld_bz = dw_list.GetItemString(row, "jzxxx_jschfscwld_bz");
//        if (jzxxx_jschfscwld_bz == "Y") {
//            var rwbh = QsWebSoft.PubMethod.ReadRwbh(ywbh, hddz_cxh.toString(), "jschfscwld_rwbh").value; // dw_list.GetItemString(row, "jzxxx_jschfscwld_rwbh");
//        }
