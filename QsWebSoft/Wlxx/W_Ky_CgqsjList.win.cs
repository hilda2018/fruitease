...
{ 
    public partial class W_Ky_CgqsjList
    {
        public W_Ky_CgqsjList()
        {
        }
        public override void OnLoad()
        {
            ...
            // 数据检索
            this.dw_list.Retrieve(DateTime.Parse(this.dp_begin.Value.ToString()), DateTime.Parse(this.dp_end.Value.ToString()), "未出港区", Dlwtf, userid, "全部", "全部");
            this.dw_log.Retrieve(userid,"kycg");
            //注册相关的js文件
            this.RegisterClientScriptInclude("ExtPB_Demo", "/Beta3/ExtPB_Demo.js");
            this.RegisterClientScriptInclude("W_Ky_CgqsjList", "/Wlxx/W_Ky_CgqsjList.win.js");
