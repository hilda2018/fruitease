...
function W_Hy_HgcydList() {
    ...
    var ddlb_hgcyd = new DropDownListBox(requestor);
    ...
    this.bind = function (win) {
        ...
        if (ddlb_hgcyd == null) ddlb_hgcyd = new DropDownListBox(requestor);
        ddlb_hgcyd.Attach(win.Control("ddlb_hgcyd"));
        ...
        if (typeof (self.dw_List_Clicked) == "function")
            win.AttachEvent("ddlb_hgcyd", "SelectionChanged", self.dw_List_Clicked);
    ...
    this.unbind = function () {
        ...
        ddlb_hgcyd.Detach(); ddlb_hgcyd = null;
    ...
    this.Retrieve = function () {
        ...
        dw_list.Retrieve(beginDate.getVarDate(), endDate.getVarDate(), hgcyd, userid, jdrjc, sc);
    ...
    this.dw_List_DoubleClicked = function (xPos, yPos, Row, dwoName) {
        ...
        if (dwoName == "jzxxx_hgcyd_sj") {
            ...
            iw_Sj_Select.SetData("hy_hgcyd_sj");
    ...
    this.Recover = function () {
        ...
        QsWebSoft.PubMethod.DelColRecord("QsWebSoft.Wlxx.W_Hy_HgcydList", "dw_hy_hgcyd_list");
        self.Retrieve();
    }
    //#endregion
    ...
    this.Save = function () {
        ...
        webReq.Invoke("HgcydListSave", "dw_list=" + dw_d_data);
...
//        if (syrw > 0) {
//            requestor.MessageBox("提示", "前一节点尚未下任务，不能做进海关查验点任务");
//            return
//        }
//        var rwbh = QsWebSoft.PubMethod.ReadRwbh(ywbh, hddz_cxh.toString(), "hgcyd_rwbh").value; // dw_list.GetItemString(row, "jzxxx_jyd_c_rwbh");
