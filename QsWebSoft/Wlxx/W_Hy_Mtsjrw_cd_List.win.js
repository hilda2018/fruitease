...
function W_Hy_Mtsjrw_cd_List() {
    ...
    this.Retrieve = function () {
        ...
        dw_list.Retrieve(beginDate.getVarDate(), endDate.getVarDate(), mtywcl, dhzt, tgzt, userid, jdrjc);
...
//    //#endregion
    ...
    //#region 打开
    var iW_Hy_cd_Wlgz = null;
    this.OpenWlgz = function (Row) {
        if (iW_Hy_cd_Wlgz == null)
            iW_Hy_cd_Wlgz = new W_Hy_cd_Wlgz();
...
//        if (sfkxrw == "Y") {
            ...
            iW_Hy_cd_Wlgz.SetDataWindow(dw_list);
            iW_Hy_cd_Wlgz.SetData(ywbh);
            iW_Hy_cd_Wlgz.SetRow(hddz_cxh);
            iW_Hy_cd_Wlgz.SetRwlx("码头司机任务");

            requestor.Open("/LoadWindow.ashx?WinName=Wlxx.W_Hy_cd_Wlgz&Rwbh=" + rwbh + '&Ywbh=' + ywbh + '&Hddz_cxh=' + hddz_cxh.toString() + '&Rwmc=' + rwmc, iW_Hy_cd_Wlgz);
