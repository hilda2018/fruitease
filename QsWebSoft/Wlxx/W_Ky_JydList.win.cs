...
{
    public partial class W_Ky_JydList
    {
        public W_Ky_JydList()
        {
        }
        public override void OnLoad()
        {
            ...
            // 数据检索
            this.dw_list.Retrieve(DateTime.Parse(this.dp_begin.Value.ToString()), DateTime.Parse(this.dp_end.Value.ToString()), "未到检疫点", "辉展物流",userid,"全部");
            this.dw_bak.Retrieve(DateTime.Parse(this.dp_begin.Value.ToString()), DateTime.Parse(this.dp_end.Value.ToString()), "未到检疫点", "辉展物流", userid);
            this.dw_log.Retrieve(userid,"kyjy");
            //注册相关的js文件
            this.RegisterClientScriptInclude("ExtPB_Demo", "/Beta3/ExtPB_Demo.js");
            this.RegisterClientScriptInclude("W_Ky_JydList", "/Wlxx/W_Ky_JydList.win.js");
            this.RegisterClientScriptInclude("W_Ky_JydEdit_Bak", "/Wlxx/W_Ky_JydEdit_Bak.win.js");
