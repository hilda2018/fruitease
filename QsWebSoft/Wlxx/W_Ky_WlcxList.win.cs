...
{
    public partial class W_Ky_WlcxList
    {
        public W_Ky_WlcxList()
        {
        }
        public override void OnLoad()
        {
            ...
            // 数据检索
            this.dw_list.Retrieve(DateTime.Parse(this.dp_begin.Value.ToString()), DateTime.Parse(this.dp_end.Value.ToString()),userid,"全部","单证");
            //注册相关的js文件
            this.RegisterClientScriptInclude("ExtPB_Demo", "/Beta3/ExtPB_Demo.js");
            this.RegisterClientScriptInclude("W_Ky_WlcxList", "/Wlxx/W_Ky_WlcxList.win.js");
