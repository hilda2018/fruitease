...
function W_Hy_LclglList() {
    ...
    var ddlb_lclzt = new DropDownListBox(requestor);
    ...
    this.bind = function (win) {
        ...
        if (ddlb_lclzt == null) ddlb_lclzt = new DropDownListBox(requestor);
        ddlb_lclzt.Attach(win.Control("ddlb_lclzt"));
        ...
        if (typeof (self.Retrieve) == "function")
            win.AttachEvent("ddlb_lclzt", "SelectionChanged", self.Retrieve);
    ...
    this.unbind = function () {
        ...
        ddlb_lclzt.Detach(); ddlb_lclzt = null;
    ...
    this.Retrieve = function () {
        ...
        dw_list.Retrieve(beginDate.getVarDate(), endDate.getVarDate(), lclzt, userid,jdrjc);
    ...
    //#endregion
        ...
        this.dw_List_ItemChanged = function (row, dwoName, data) {
            if (dwoName == "jzxxx_sffsbz") {
                var date = new Date();
                dw_list.SetItem(row, "jzxxx_yqfssj", date.getVarDate())
            }
            if (dwoName == "jzxxx_sfsdxxbz") {
                var date = new Date();
                dw_list.SetItem(row, "jzxxx_sdxxsj", date.getVarDate())
            }
    ...
    this.Recover = function () {
        ...
        QsWebSoft.PubMethod.DelColRecord("QsWebSoft.Wlxx.W_Hy_CgqsjList", "dw_hy_cgqsj_list");
        self.Retrieve();
    }
    //#endregion
    ...
    this.Save = function () {
        ...
        webReq.Invoke("LclglListSave", "dw_list=" + dw_d_data);
