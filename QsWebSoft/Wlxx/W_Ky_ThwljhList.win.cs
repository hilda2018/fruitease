...
{
    public partial class W_Ky_ThwljhList
    {
        public W_Ky_ThwljhList()
        {
        }
        public override void OnLoad()
        {
            ...
            // 数据检索
            this.dw_list.Retrieve(DateTime.Parse(this.dp_begin.Value.ToString()), DateTime.Parse(this.dp_end.Value.ToString()), "全部", "N", DateTime.Parse(this.dp_yjkgsj.Value.ToString()), Dlwtf, "全部", userid, "全部");
