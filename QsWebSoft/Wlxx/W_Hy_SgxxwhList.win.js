...
function W_Hy_SgxxwhList() {
    ...
    var ddlb_cgqsj = new DropDownListBox(requestor);
    ...
    this.bind = function (win) {
        ...
        if (ddlb_cgqsj == null) ddlb_cgqsj = new DropDownListBox(requestor);
        ddlb_cgqsj.Attach(win.Control("ddlb_cgqsj"));
        ...
        if (typeof (self.Retrieve) == "function")
            win.AttachEvent("ddlb_cgqsj", "SelectionChanged", self.Retrieve);
        ...
        if (typeof (self.Retrieve) == "function")
            win.AttachEvent("sle_jzxh", "Modified", self.Retrieve);
    ...
    this.unbind = function () {
        ...
        ddlb_cgqsj.Detach(); ddlb_cgqsj = null;
    ...
    webReq.SetWebServiceUrl("/Service/Hy_Sgxxwh.ashx");   
    ...
    this.Retrieve = function () {
        ...
        var cgqsj = ddlb_cgqsj.GetText();
        var ywbh = sle_1.GetText();
        ...
        dw_list.Retrieve(beginDate.getVarDate(), endDate.getVarDate(), cgqsj, ywbh, jzxh);
    ...
    this.dw_List_DoubleClicked = function (xPos, yPos, Row, dwoName) {
        ...
        if (Row > 0) {
            if (dwoName == "ywbh") {
                ...
                iw_Wldw_Select.SetData("SgxxwhList");
    ...
    this.Recover = function () {
        ...
        QsWebSoft.PubMethod.DelColRecord("QsWebSoft.Wlxx.W_Hy_SgxxwhList", "dw_hy_sgxxwh_list");
        self.Retrieve();
    }
    //#endregion
    ...
    this.Save = function () {
        ...
        webReq.Invoke("CgqsjListSave", "dw_list=" + dw_d_data);
