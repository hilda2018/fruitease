...
{
    public partial class W_Hy_WlgzList
    {
        public W_Hy_WlgzList()
        {
        }
        public override void OnLoad()
        {
            ...
            // 数据检索
            this.dw_list.Retrieve(DateTime.Parse(this.dp_begin.Value.ToString()), DateTime.Parse(this.dp_end.Value.ToString()),"制表",userid,"全部");
            //注册相关的js文件
            this.RegisterClientScriptInclude("ExtPB_Demo", "/Beta3/ExtPB_Demo.js");
            this.RegisterClientScriptInclude("W_Hy_ScList", "/Hddz/W_Hy_ScList.win.js");
            ...
            this.RegisterClientScriptInclude("W_Hy_WlgzEdit", "/Wlxx/W_Hy_WlgzEdit.win.js");
            this.RegisterClientScriptInclude("W_Hy_Wlgz_Fyqr", "/Wlxx/W_Hy_Wlgz_Fyqr.win.js");
            this.RegisterClientScriptInclude("W_Hy_Wlgz_Fyqr_old", "/Wlxx/W_Hy_Wlgz_Fyqr_old.win.js");
            this.RegisterClientScriptInclude("W_Hy_WlgzList", "/Wlxx/W_Hy_WlgzList.win.js");
