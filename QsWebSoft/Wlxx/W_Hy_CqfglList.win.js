...
function W_Hy_CqfglList() {
    ...
    this.Retrieve = function () {
        ...
        dw_list.Retrieve(beginDate.getVarDate(), endDate.getVarDate(), cqfzt, Dlwtf, Tybm, Sfqytybm);
    ...
    this.Recover = function () {
        ...
        QsWebSoft.PubMethod.DelColRecord("QsWebSoft.Wlxx.W_Hy_WlcxList", "dw_hy_wlcx_list");
        self.Retrieve();
    }
    //#endregion
    ...
    this.Save = function () {
        ...
        webReq.Invoke("CqfglListSave", "dw_list=" + dw_d_data);
