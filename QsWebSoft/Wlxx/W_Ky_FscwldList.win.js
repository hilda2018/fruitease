...
function W_Ky_FscwldList() {
    ...
    this.bind = function (win) {
        ...
        if (typeof (self.OpenWlgz_C) == "function")
            win.AttachEvent("btn_open_c_rw", "Clicked", self.OpenWlgz_C);
    ...
    this.Retrieve = function () {
        ...
        dw_list.Retrieve(beginDate.getVarDate(), endDate.getVarDate(), fscwlzt, Dlwtf, userid,jdrjc);
...
//        var status = dw_list.GetItemString(dw_list.GetRow(), 'state')
    ...
    this.Save = function () {
        ...
        webReq.Invoke("FscwldListSave", "dw_list=" + dw_d_data);
    ...
    this.OpenWlgz_J = function (Row) {
        ...
        if (jzxxx_zjfscwld_bz == "Y") {
            rwbh = dw_list.GetItemString(row, "jzxxx_zjfscwld_rwbh");
        }
        var jzxxx_jschfscwld_bz = dw_list.GetItemString(row, "jzxxx_jschfscwld_bz");
        if (jzxxx_jschfscwld_bz == "Y") {
            rwbh = dw_list.GetItemString(row, "jzxxx_jschfscwld_bz");
        }

        iw_Hy_Wlgz.SetDataWindow(dw_list);
        iw_Hy_Wlgz.SetData(ywbh);
        iw_Hy_Wlgz.SetRow(hddz_cxh);
        iw_Hy_Wlgz.SetRwlx("物流转运");

        requestor.Open("/LoadWindow.ashx?WinName=Wlxx.W_Hy_Wlgz&Rwbh=" + rwbh + '&Ywbh=' + ywbh + '&Hddz_cxh=' + hddz_cxh.toString(), iw_Hy_Wlgz);
