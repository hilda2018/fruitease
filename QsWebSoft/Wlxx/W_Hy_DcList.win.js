...
function W_Hy_DcList() {
    ...
    var ddlb_dcrwzt = new DropDownListBox(requestor);
    ...
    this.bind = function (win) {
        ...
        if (ddlb_dcrwzt == null) ddlb_dcrwzt = new DropDownListBox(requestor);
        ddlb_dcrwzt.Attach(win.Control("ddlb_dcrwzt"));
        ...
        if (typeof (self.ddlb_dcrwzt_SelectionChanged) == "function")
            win.AttachEvent("ddlb_dcrwzt", "SelectionChanged", self.ddlb_dcrwzt_SelectionChanged);
    ...
    this.unbind = function () {
        ...
        ddlb_dcrwzt.Detach(); ddlb_dcrwzt = null;
    ...
    this.Retrieve = function () {
        ...
        var dcrwzt = ddlb_dcrwzt.GetText();
        ...
        dw_list.Retrieve(beginDate.getVarDate(), endDate.getVarDate(), dcrwzt, userid, jdrjc, sc);
    ...
    this.dw_List_DoubleClicked = function (xPos, yPos, Row, dwoName) {
        if (Row > 0)
            ...
            if (dwoName == "jzxxx_fxdcjc") {
                ...
                iw_Wldw_Select.SetData("hy_dc_dcmc");
    ...
    //#region 过滤堆场任务状态
    this.ddlb_dcrwzt_SelectionChanged = function () {
        ...
        if (dcrwzt == "全部") {
            ...
            dw_list.SetFilter("( Upper(dcrwzt) like Upper('%" + dcrwzt + "%'))")
        };
        dw_list.Filter();
        dw_list.Sort();
        dw_list.SetRedraw(true);
    ...
    this.Recover = function () {
        ...
        QsWebSoft.PubMethod.DelColRecord("QsWebSoft.Wlxx.W_Hy_DcList", "dw_hy_dc_list");
        self.Retrieve();
    }
    //#endregion
    ...
    this.Save = function () {
        ...
        webReq.Invoke("DcListSave", "dw_list=" + dw_d_data + "&dw_log=" + dw_log_data);
...
//        if (syrw > 0) {
//            requestor.MessageBox("提示", "前一节点尚未下任务，不能做堆场任务");
//            return
//        }
        
//        var rwbh = QsWebSoft.PubMethod.ReadRwbh(ywbh, hddz_cxh.toString(), "dc_rwbh").value; // dw_list.GetItemString(row, "jzxxx_dc_rwbh");
//        if (rwbh == "" || rwbh == null) {
