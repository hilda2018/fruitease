...
{
    public partial class W_Hy_ThwljhList
    {
        public W_Hy_ThwljhList()
        {
        }
        public override void OnLoad()
        {
            ...
            // 数据检索
            this.dw_list.Retrieve(DateTime.Parse(this.dp_begin.Value.ToString()), DateTime.Parse(this.dp_end.Value.ToString()), "物流未排", "全部", "全部", userid, "全部", "全部");
            this.dw_log.Retrieve(userid, "hyth");
            ...
            this.RegisterClientScriptInclude("W_Hy_ThwljhList", "/Wlxx/W_Hy_ThwljhList.win.js");
