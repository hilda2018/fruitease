...
function W_Hy_Wlgz_KhdzList() {
	 ...
	 var sle_fymdd= new SingleLineEdit( requestor );
	 ...
	 if(typeof( baseBind )=="function") baseBind(win);
		 ...
		 if(sle_fymdd == null ) sle_fymdd= new SingleLineEdit( requestor );
		 sle_fymdd.Attach( win.Control( "sle_fymdd") ); 
		 ...
		 if(typeof(self.slefymdd_EditChanged)=="function") 
			 win.AttachEvent("sle_fymdd","EditChanged",self.slefymdd_EditChanged); 
	 ...
	 if(typeof(baseUnBind)=="function") baseUnBind(); 
		 ...
		 sle_fymdd.Detach(); sle_fymdd=null; 
    ...
    webReq.SetWebServiceUrl("/Service/Wlgz_Khdz.ashx");   
    ...
    this.sle_EditChanged = function (text) {
        ...
        if (text == "")
            ...
            dw_list.SetFilter("( Upper(shdz) like Upper('%" + text + "%'))");
        dw_list.Filter();
        dw_list.Sort();
    ...
    //#region 过滤客户
    this.slefymdd_EditChanged = function (text) {
        dw_list.SetRedraw(false);
        if (text == "")
            dw_list.SetFilter("");
        else
            dw_list.SetFilter("( Upper(fymdd) like Upper('%" + text + "%'))");
        dw_list.Filter();
        dw_list.Sort();
        dw_list.SetRedraw(true);
    }
    ...
    this.Recover = function () {
        ...
        QsWebSoft.PubMethod.DelColRecord("QsWebSoft.Wlxx.W_Hy_Wlgz_KhdzList", "dw_wlgz_khdz_list");
        self.Retrieve();
    }
    //#endregion
