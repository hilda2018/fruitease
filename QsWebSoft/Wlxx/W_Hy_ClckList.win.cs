...
{
    public partial class W_Hy_ClckList
    {
        public W_Hy_ClckList()
        {
        }
        public override void OnLoad()
        {
            ...
            // 数据检索
            this.dw_list.Retrieve(DateTime.Parse(this.dp_begin.Value.ToString()), DateTime.Parse(this.dp_end.Value.ToString()), "未到市场", "全部");
            //注册相关的js文件
