...
function W_Ky_ThwljhList() {
    ...
    this.Retrieve = function () {
        ...
        if (cbx_dt.GetChecked()) {
         ...
         dw_list.Retrieve(beginDate.getVarDate(), endDate.getVarDate(), thwljhzt, dt, yjkgsj.getVarDate(), Dlwtf, jdr,userid,mdg);
...
//    }
    ...
    this.Dcrz = function ()
    {
        ...
        var num = QsWebSoft.PubMethod.Dcrq( userid, "空运提货计划", sjts ).value;
    ...
    this.Recover = function () {
        ...
        QsWebSoft.PubMethod.DelColRecord("QsWebSoft.Wlxx.W_Ky_ThwljhList", "dw_ky_thwljh_list");
        self.Retrieve();
    }
    //#endregion
