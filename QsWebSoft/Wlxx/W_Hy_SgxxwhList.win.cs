...
{
    public partial class W_Hy_SgxxwhList
    {
        public W_Hy_SgxxwhList()
        {
        }
        public override void OnLoad()
        {
            ...
            // 数据检索
            this.dw_list.Retrieve(DateTime.Parse(this.dp_begin.Value.ToString()), DateTime.Parse(this.dp_end.Value.ToString()), "未出港区", "", "");
            //注册相关的js文件
            this.RegisterClientScriptInclude("ExtPB_Demo", "/Beta3/ExtPB_Demo.js");
            this.RegisterClientScriptInclude("W_Hy_SgxxwhList", "/Wlxx/W_Hy_SgxxwhList.win.js");
