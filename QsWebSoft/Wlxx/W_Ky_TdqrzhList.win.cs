...
{
    public partial class W_Ky_TdqrzhList
    {
        public W_Ky_TdqrzhList()
        {
        }
        public override void OnLoad()
        {
            ...
            DateTime date = System.DateTime.Now.AddDays(-3);
            ...
            // 数据检索
            this.dw_list.Retrieve(DateTime.Parse(this.dp_begin.Value.ToString()), DateTime.Parse(this.dp_end.Value.ToString()), "已出港区", Dlwtf,"未确认",userid,"全部");
             //注册相关的js文件
            this.RegisterClientScriptInclude("ExtPB_Demo", "/Beta3/ExtPB_Demo.js");
            this.RegisterClientScriptInclude("W_Ky_TdqrzhList", "/Wlxx/W_Ky_TdqrzhList.win.js");
