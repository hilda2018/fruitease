...
function W_Ky_WlcxList() {
    ...
    this.Retrieve = function () {
        ...
        dw_list.Retrieve(beginDate.getVarDate(), endDate.getVarDate(), userid, jdrjc, rqlx);
    ...
    this.Print = function () {
        ...
        if (row <= 0)
            return;
        dw_print.SetDataObject("dw_ky_wlcx_list");
        var beginDate = new Date(dp_begin.GetValue());
        var endDate = new Date(dp_end.GetValue());
        ...
        dw_print.Retrieve(beginDate.getVarDate(), endDate.getVarDate());
    ...
    this.Save = function () {
        ...
        webReq.Invoke("WlcxListSave", "dw_list=" + dw_d_data );
