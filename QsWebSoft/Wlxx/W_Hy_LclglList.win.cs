...
{
    public partial class W_Hy_LclglList
    {
        public W_Hy_LclglList()
        {
        }
        public override void OnLoad()
        {
            ...
            DateTime date2 = System.DateTime.Now.AddDays(+3);
            this.dp_end.Value = date2; 
            ...
            // 数据检索
            this.dw_list.Retrieve(DateTime.Parse(this.dp_begin.Value.ToString()), DateTime.Parse(this.dp_end.Value.ToString()), "未发送",userid,"全部");
            //注册相关的js文件
            this.RegisterClientScriptInclude("ExtPB_Demo", "/Beta3/ExtPB_Demo.js");
            this.RegisterClientScriptInclude("W_Hy_LclglList", "/Wlxx/W_Hy_LclglList.win.js");
