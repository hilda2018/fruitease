...
function W_Ky_DtgzList() {
    ...
    this.Retrieve = function () {
        ...
        dw_list.Retrieve(beginDate.getVarDate(), endDate.getVarDate(), thwljhzt, dt, yjkgsj.getVarDate(), Dlwtf, jdr);
...
//    }
    ...
    this.Recover = function () {
        ...
        QsWebSoft.PubMethod.DelColRecord("QsWebSoft.Wlxx.W_Ky_DtgzList", "dw_ky_thwljh_list");
        self.Retrieve();
    }
    //#endregion
