...
{ 
    public partial class W_Hy_MtsjrwList
    {
        public W_Hy_MtsjrwList()
        {
        }
        public override void OnLoad()
        {
            ...
            // 数据检索
            this.dw_list.Retrieve(DateTime.Parse(this.dp_begin.Value.ToString()), DateTime.Parse(this.dp_end.Value.ToString()), "全部", "已到港", "已放行", userid, "全部", "全部", "全部");
            //注册相关的js文件
            this.RegisterClientScriptInclude("json2", "/Scripts/json2.js");
            this.RegisterClientScriptInclude("ExtPB_Demo", "/Beta3/ExtPB_Demo.js");
            this.RegisterClientScriptInclude("W_Hy_MtsjrwList", "/Wlxx/W_Hy_MtsjrwList.win.js");
