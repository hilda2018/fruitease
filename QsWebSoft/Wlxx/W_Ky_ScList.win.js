...
function W_Ky_ScList() {
    ...
    this.Retrieve = function () {
        ...
        dw_list.Retrieve(beginDate.getVarDate(), endDate.getVarDate(), sczt, userid, jdrjc);
    ...
    this.Recover = function () {
        ...
        QsWebSoft.PubMethod.DelColRecord("QsWebSoft.Wlxx.W_Ky_ScList", "dw_ky_sc_list");
        self.Retrieve();
    }
    //#endregion
