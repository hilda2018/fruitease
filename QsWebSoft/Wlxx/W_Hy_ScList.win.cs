...
{
    public partial class W_Hy_ScList
    {
        public W_Hy_ScList()
        {
        }
        public override void OnLoad()
        {
            ...
            // 数据检索
            this.dw_list.Retrieve(DateTime.Parse(this.dp_begin.Value.ToString()), DateTime.Parse(this.dp_end.Value.ToString()), "未到市场", "全部", userid, "全部", "全部");
            //注册相关的js文件
