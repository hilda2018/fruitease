...
function W_Hy_ClgzList() {
    ...
    this.Retrieve = function () {
        ...
        dw_list.Retrieve(beginDate.getVarDate(), endDate.getVarDate(), sczt, hxfs);
    ...
    this.Recover = function () {
        ...
        QsWebSoft.PubMethod.DelColRecord("QsWebSoft.Wlxx.W_Hy_ClgzList", "dw_hy_sc_list");
        self.Retrieve();
    }
    //#endregion
