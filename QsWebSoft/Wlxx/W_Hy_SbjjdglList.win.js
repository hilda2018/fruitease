...
function W_Hy_SbjjdglList() {
    ...
    var ddlb_sbjjdzt = new DropDownListBox(requestor);
    ...
    this.bind = function (win) {
        ...
        if (ddlb_sbjjdzt == null) ddlb_sbjjdzt = new DropDownListBox(requestor);
        ddlb_sbjjdzt.Attach(win.Control("ddlb_sbjjdzt"));
        ...
        if (typeof (self.Retrieve) == "function")
            win.AttachEvent("ddlb_sbjjdzt", "SelectionChanged", self.Retrieve);
    ...
    this.unbind = function () {
        ...
        ddlb_sbjjdzt.Detach(); ddlb_sbjjdzt = null;
    ...
    this.Retrieve = function () {
        ...
        var sbjjdzt = ddlb_sbjjdzt.GetText();
        ...
        dw_list.Retrieve(beginDate.getVarDate(), endDate.getVarDate(), sbjjdzt, userid, jdrjc);
    ...
    this.Save = function () {
        ...
        webReq.Invoke("SbjjdglListSave", "dw_list=" + dw_d_data);
