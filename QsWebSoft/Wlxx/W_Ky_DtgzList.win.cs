...
{
    public partial class W_Ky_DtgzList
    {
        public W_Ky_DtgzList()
        {
        }
        public override void OnLoad()
        {
            ...
            // 数据检索
            this.dw_list.Retrieve(DateTime.Parse(this.dp_begin.Value.ToString()), DateTime.Parse(this.dp_end.Value.ToString()), "全部", "N", DateTime.Parse(this.dp_yjkgsj.Value.ToString()), Dlwtf, "全部");
            this.dw_log.Retrieve(userid, "kyth");
            
            //注册相关的js文件
            this.RegisterClientScriptInclude("ExtPB_Demo", "/Beta3/ExtPB_Demo.js");
            this.RegisterClientScriptInclude("W_Ky_DtgzList", "/Wlxx/W_Ky_DtgzList.win.js");
