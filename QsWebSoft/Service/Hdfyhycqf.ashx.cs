...
namespace QsWebSoft.Service
{
    ...
    /// SalesOrder 的摘要说明
    /// </summary>
    public class Hdfyhycqf : ServiceBase
    {
        //单据删除
        ...
        protected void Tbsxg()
        {
            ...
            //{
                ...
                Interfaces.GeneralPortal.DataToFreshPort("yw_hddz_fksqd", null, sqdbh, out strErr);
        ...
        protected  void Save()
        {
            ...
            SafeDS ds_master = new SafeDS("dw_hddz_hdfyhycqf_edit");
            SafeDS ds_jzxxx = new SafeDS("dw_hddz_hdfyhycqf_edit_cmd"); 
        ...
        protected void ListSave()
        {
            ...
            SafeDS ds_list = new SafeDS("dw_hddz_hdfyhycqf_list");
            try
            {
        ...
        //#region 列表存盘
        protected void dw_2Save()
        {
            string userID = AppService.GetUserID();
            string dw_list = Request.Form["dw_2"].ToString();
            SafeDS ds_list = new SafeDS("dw_hddz_list_ygj_ywbh");
            try 
            {
                ds_list.SetChanges(dw_list);
                ds_list.SetTransaction(this.DBHelp.TransAction);
