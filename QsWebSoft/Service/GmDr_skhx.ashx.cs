...
namespace QsWebSoft.Service
{
    ...
    /// SalesOrder 的摘要说明
    /// </summary>
    public class GmDr_skhx : ServiceBase
    {
        //单据删除
        ...
        protected  void Save()
        {
            ...
            SafeDS ds_master = new SafeDS("dw_gmdr_skhx_edit");
            SafeDS ds_jzxxx = new SafeDS("dw_gmdr_skhx_edit_cmd"); 
            try
            {
        ...
        protected void ListSave()
        {
            ...
            SafeDS ds_list = new SafeDS("dw_GmDr_skhx_list");
            try
            {
