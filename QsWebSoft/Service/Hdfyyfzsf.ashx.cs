...
namespace QsWebSoft.Service
{
    ...
    /// SalesOrder 的摘要说明
    /// </summary>
    public class Hdfyyfzsf : ServiceBase
    {
        //单据删除
        ...
        protected  void Save()
        {
            ...
            SafeDS ds_master = new SafeDS("dw_hddz_hdfyyfzsf_edit");
            SafeDS ds_jzxxx = new SafeDS("dw_hddz_hdfyyfzsf_edit_cmd"); 
            try
            {
        ...
        protected void ListSave()
        {
            ...
            SafeDS ds_list = new SafeDS("dw_hddz_hdfyyfzsf_list");
            try
            {
