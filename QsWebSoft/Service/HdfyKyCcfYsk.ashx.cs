...
namespace QsWebSoft.Service
{
    ...
    /// SalesOrder 的摘要说明
    /// </summary>
    public class HdfyKyCcfYsk : ServiceBase
    {
        //单据删除
        ...
        protected  void Save()
        {
            ...
            SafeDS ds_master = new SafeDS("dw_hddz_hdfykyccfysk_edit");
            //SafeDS ds_jzxxx = new SafeDS("dw_hddz_HdfyKyCcfYsk_edit_cmd");
        ...
        protected void ListSave()
        {
            ...
            SafeDS ds_list = new SafeDS("dw_hddz_HdfyKyCcfYsk_list");
            try
            {
