...
namespace QsWebSoft.Service
{
    ...
    /// SalesOrder 的摘要说明
    /// </summary>
    public class Hdfybhxjhxxxfy : ServiceBase
    {
        //单据删除
        protected  void Delete()
        {
            ...
            if (successed)
            {
                Response.Write("包坏污箱费用编号为<" + sqdbh + ">,已被成功删除");
             
            }
            else
            {
                this.SetErrorInfo("包坏污箱费用编号为<" + sqdbh + ">,删除失败");
            }
        }
        ...
        protected  void Save()
        {
            ...
            SafeDS ds_master = new SafeDS("dw_hddz_hdfybhxjhxxxfy_edit");
            SafeDS ds_jzxxx = new SafeDS("dw_hddz_hdfybhxjhxxxfy_edit_cmd"); 
        ...
        protected void ListSave()
        {
            ...
            SafeDS ds_list = new SafeDS("dw_hddz_hdfybhxjhxxxfy_list");
            try
            {
                ...
                {
                    this.DBHelp.Rollback(); ;
                    this.SetErrorInfo("包坏污箱费用信息保存失败!\n\n详细错误信息：\n" + ds_list.DBError);
                }
