...
namespace QsWebSoft.Service
{
    ...
    /// SalesOrder 的摘要说明
    /// </summary>
    public class HddzYtjk :  ServiceBase
    {
        ...
        protected  void Save()
        {
            ...
            SafeDS ds_master = new SafeDS("dw_hddz_ytjk_edit");
            SafeDS ds_jzxxx = new SafeDS("dw_hddz_ytjk_edit_jzxxx");
            SafeDS ds_spxx = new SafeDS("dw_hddz_ytjk_edit_spxx");
            SafeDS ds_zzxx = new SafeDS("dw_hddz_ytjk_edit_zzxx");
            SafeDS ds_fsdz = new SafeDS("dw_hddz_ytjk_edit_fsdz");
            try
            {
