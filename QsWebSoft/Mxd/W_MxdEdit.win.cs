...
namespace QsWebSoft.Mxd
{
    public partial class W_MxdEdit
    {
        public W_MxdEdit()
        {
        ...
        public override void OnLoad()
        {
            ...
            report.RequestorDrawTitle = false;
            report = (ReportService)dw_wlxx.Services.Add(ServiceName.Report);
            report.RequestorDrawTitle = false;
            ...
            if (this.Request["mxdbh"] != null)
            {
                ...
                dw_cbyc.Retrieve(mxdbh, bbh);
                dw_fy.Retrieve(mxdbh, bbh);
                dw_tyzss.Retrieve(mxdbh, bbh);
                dw_wlxx.Retrieve(mxdbh);
            }
            this.tabpage_cbyc.Visible = false;
