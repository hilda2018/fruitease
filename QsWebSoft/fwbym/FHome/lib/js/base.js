!function(e, t) {
    ...
    return "function" == typeof require ? require("common/ui/Keyboard") : !window.Keyboard && window.console && window.console.warn("you may forget include Keyboard.js"),
    $.fn.zIndex = function() {
    ...
    $.fn.enabled = function() {
        return $(this).each(function() {
            ...
            if (e.is(":input"))
                ...
                e.attr("href", e.data("href") || "javascript:"),
