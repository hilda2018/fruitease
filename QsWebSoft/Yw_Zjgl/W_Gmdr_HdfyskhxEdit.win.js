...
//            return;
//        };
        if (iW_GmDr_Skhx_Select == null)
            iW_GmDr_Skhx_Select = new W_Yw_Zjgl_Skhx_Select();
        ...
        iW_GmDr_Skhx_Select.SetRow( row );
        iW_GmDr_Skhx_Select.SetDwo( dwo );
        iW_GmDr_Skhx_Select.SetDetailDW( dw_jzxxx );

//        var num = QsWebSoft.PubMethod.p_hddz_skhx_select_sjk(jsdwbm, parseInt(jsbm), fydlbm);
//        if (num == "[object Object]") {
        requestor.Open( "/LoadWindow.ashx?WinName=Xt_Popwin.W_Yw_Zjgl_Skhx_Select&ShareMode=" + ShareMode + '&ywy=' + ywy + '&Dlwtf=' + Dlwtf, iW_GmDr_Skhx_Select );
//         }
    }
    //#endregion
    ...
    this.AddRow = function () {
        ...
        if (iW_GmDr_Skhx_Select == null)
            iW_GmDr_Skhx_Select = new W_GmDr_Skhx_Select();
        ...
        iW_GmDr_Skhx_Select.SetRow(0);
        iW_GmDr_Skhx_Select.SetDwo(dwo);
        iW_GmDr_Skhx_Select.SetDetailDW( dw_jzxxx );

        requestor.Open("/LoadWindow.ashx?WinName=Xt_Popwin.W_GmDr_Skhx_Select&ShareMode=" + ShareMode + '&ywy=' + ywy + '&Dlwtf=' + Dlwtf, iW_GmDr_Skhx_Select);
