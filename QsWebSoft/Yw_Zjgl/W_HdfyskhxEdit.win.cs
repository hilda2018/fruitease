...
{
    public partial class W_HdfyskhxEdit
    {
        public W_HdfyskhxEdit()
        {
        ...
        public override void OnLoad()
        {
            ...
            if (this.Request["skdbh"] != null)
            {
                ...
                int skd_cxh = int.Parse(this.Request["skd_cxh"]);
                this.SetParm("skdbh", skdbh);
                this.SetParm("skd_cxh", skd_cxh.ToString());
                dw_master.Retrieve(skdbh, skd_cxh);
                dw_jzxxx.Retrieve(skdbh, skd_cxh);
            ...
            this.RegisterClientScriptInclude("W_Hddz_Skhx_Select", "/Xt_Popwin/W_Hddz_Skhx_Select.win.js");
            //注册相关的js文件
