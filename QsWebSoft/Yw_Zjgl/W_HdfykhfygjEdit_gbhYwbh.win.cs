...
{
    public partial class W_HdfykhfygjEdit_gbhYwbh
    {
        public W_HdfykhfygjEdit_gbhYwbh()
        {
        ...
        public override void OnLoad()
        {
            ...
            if (gbh_ywbh != "")
            {
                ...
                ywbh = this.Request["ywbh"].ToString();
            }
            
            var cxh = this.Request["cxh"].ToString();
            dw_master.Retrieve(ywbh, int.Parse(cxh));
            dw_jzxxx.Retrieve(gbh_ywbh,ywbh, int.Parse(cxh));
