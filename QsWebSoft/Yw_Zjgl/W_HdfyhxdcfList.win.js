...
//    }
    ...
    this.Delete = function () {
        ...
        if (requestor.MessageBox("提示", "删除还箱堆场费用申请单号为<" + sqdbh + ">,是否确定?", ICON.Question, BUTTON.YesNo) == 2)
            return;
    ...
    this.Recover = function () {
        ...
        QsWebSoft.PubMethod.DelColRecord("QsWebSoft.Wlxx.W_HdfyhxdcfList", "dw_hddz_hdfyhxdcf_list");
        self.Retrieve();
    }
    //#endregion
