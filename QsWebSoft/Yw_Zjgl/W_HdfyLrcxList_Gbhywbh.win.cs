...
{
    public partial class W_HdfyLrcxList_Gbhywbh
    {
        public W_HdfyLrcxList_Gbhywbh()
        {
        }
        public override void OnLoad()
        {
            ...
            this.dw_list.Retrieve("已靠港", DateTime.Parse(this.dp_begin.Value.ToString()), DateTime.Parse(this.dp_end.Value.ToString()), Dlwtf, "全部", "全部", "全部", userid, "全部");
            //注册相关的js文件
            this.RegisterClientScriptInclude("ExtPB_Demo", "/Beta3/ExtPB_Demo.js");
            this.RegisterClientScriptInclude("W_HdfyLrcxList_Gbhywbh", "/Yw_Zjgl/W_HdfyLrcxList_Gbhywbh.win.js");
