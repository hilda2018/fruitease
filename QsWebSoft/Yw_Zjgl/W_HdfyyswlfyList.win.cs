...
{
    public partial class W_HdfyyswlfyList
    {
        public W_HdfyyswlfyList()
        {
        }
        public override void OnLoad()
        {
            ...
            // 数据检索
            this.dw_list.Retrieve(DateTime.Parse(this.dp_begin.Value.ToString()), DateTime.Parse(this.dp_end.Value.ToString()), "未到港", Dlwtf);
            //注册相关的js文件
            this.RegisterClientScriptInclude("ExtPB_Demo", "/Beta3/ExtPB_Demo.js");
            this.RegisterClientScriptInclude("W_HdfyyswlfyList", "/Yw_Zjgl/W_HdfyyswlfyList.win.js");
