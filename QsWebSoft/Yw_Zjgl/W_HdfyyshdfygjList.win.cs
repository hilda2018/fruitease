...
{
    public partial class W_HdfyyshdfygjList
    {
        public W_HdfyyshdfygjList()
        {
        }
        public override void OnLoad()
        {
            ...
            // 数据检索
            this.dw_list.Retrieve("无归集时间", DateTime.Parse(this.dp_begin.Value.ToString()), DateTime.Parse(this.dp_end.Value.ToString()), Dlwtf, "全部", "全部", 0, userid);
            dw_log.Retrieve(userid, "hdgj");
            //注册相关的js文件
            this.RegisterClientScriptInclude("ExtPB_Demo", "/Beta3/ExtPB_Demo.js");
            this.RegisterClientScriptInclude("W_Hddz_Ycyy", "/Hddz/W_Hddz_Ycyy.win.js");
            this.RegisterClientScriptInclude("W_HdfyyshdfygjList", "/Yw_Zjgl/W_HdfyyshdfygjList.win.js");
