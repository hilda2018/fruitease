...
function W_HdfyKyCcfYskEdit() {
    ...
    //#region 变量定义
    var editMode = "";
    var iW_Hddz_Kyccfysk_Select = null;
    ...
    webReq.SetWebServiceUrl("/Service/HdfyKyCcfYsk.ashx");
    ...
    this.Save = function () {
        ...
        //        webReq.Invoke(",", "dw_master=" + dw_master_data + "&dw_jzxxx=" + dw_jzxxx_data + "&sqdbh=" + sqdbh + "&operation=" + editMode);
    ...
    this.InsertRow = function () {
        if (iW_Hddz_Kyccfysk_Select == null)
            iW_Hddz_Kyccfysk_Select = new W_Hddz_Kyccfysk_Select();
        var ShareMode = requestor.GetParm("ShareMode");
        var ywy = requestor.GetParm("userid");
        var Dlwtf = requestor.GetParm("Dlwtf");
        row = dw_jzxxx.InsertRow(dw_jzxxx.GetRow());
        var dwo = dw_jzxxx.GetDataObject();
        iW_Hddz_Kyccfysk_Select.SetRow(row);
        iW_Hddz_Kyccfysk_Select.SetDwo(dwo);
        iW_Hddz_Kyccfysk_Select.SetDetailDW(dw_jzxxx);
        requestor.Open("/LoadWindow.ashx?WinName=Xt_Popwin.W_Hddz_Kyccfysk_Select&ShareMode=" + ShareMode + '&ywy=' + ywy + '&Dlwtf=' + Dlwtf, iW_Hddz_Kyccfysk_Select);
    ...
    this.Print = function () {
        ...
        dw_print.SetDataObject("dw_hddz_hdfyqtysk_print");
