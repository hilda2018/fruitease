...
{
    public partial class W_WlgzJzxlrcxList
    {
        public W_WlgzJzxlrcxList()
        {
        }
        public override void OnLoad()
        {
            ...
            // 数据检索
            this.dw_list.Retrieve(DateTime.Parse(this.dp_begin.Value.ToString()), DateTime.Parse(this.dp_end.Value.ToString()), "全部", "全部","全部");
            //注册相关的js文件
            this.RegisterClientScriptInclude("ExtPB_Demo", "/Beta3/ExtPB_Demo.js");
            this.RegisterClientScriptInclude("W_WlgzJzxlrcxList", "/Yw_Zjgl/W_WlgzJzxlrcxList.win.js");
            this.RegisterClientScriptInclude("W_WlgzJzxlrcxEdit", "/Yw_Zjgl/W_WlgzJzxlrcxEdit.win.js");
