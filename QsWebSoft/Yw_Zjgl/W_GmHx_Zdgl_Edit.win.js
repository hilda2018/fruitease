...
//        if (iW_GmHx_Zdgl_Edit_pop == null)
//            iW_GmHx_Zdgl_Edit_pop = new W_GmHx_Zdgl_Edit_pop();
...
//        iW_GmHx_Zdgl_Edit_pop.SetRow(row);
//        iW_GmHx_Zdgl_Edit_pop.SetDwo(dwo);
//        iW_GmHx_Zdgl_Edit_pop.SetDetailDW(dw_jzxxx);
//        requestor.Open("/LoadWindow.ashx?WinName=Xt_Popwin.W_GmHx_Zdgl_Edit_pop&ShareMode=" + ShareMode + '&ywy=' + ywy + '&Dlwtf=' + Dlwtf + '&Sjskrbm=' + Sjskrbm, iW_GmHx_Zdgl_Edit_pop);
...
//            var dwo = dw_jzxxx.GetDataObject();
//            var Sjskrbm = dw_master.GetItemString(1, "sjskrbm");
//            iW_GmHx_Zdgl_Edit_pop.SetRow(0);
//            iW_GmHx_Zdgl_Edit_pop.SetDwo(dwo);
//            iW_GmHx_Zdgl_Edit_pop.SetDetailDW(dw_jzxxx);
//            requestor.Open("/LoadWindow.ashx?WinName=Yw_Zjgl.W_GmHx_Zdgl_Edit_pop&ShareMode=" + ShareMode + '&ywy=' + ywy + '&Dlwtf=' + Dlwtf + '&Sjskrbm=' + Sjskrbm, iW_GmHx_Zdgl_Edit_pop);
