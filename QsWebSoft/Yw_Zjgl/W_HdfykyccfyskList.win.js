...
function W_HdfykyccfyskList() {
    ...
    webReq.SetWebServiceUrl("/Service/Hdfyqt.ashx");   
...
//    }
    ...
    this.Print = function () {
        ...
        dw_print.SetDataObject("dw_hddz_hdfyqt_print");
    ...
    this.Recover = function () {
        ...
        QsWebSoft.PubMethod.DelColRecord("QsWebSoft.Yw_Zjgl.W_HdfykyccfyskList", "dw_hddz_hdfyqt_list");
        self.Retrieve();
    }
    //#endregion
    ...
    this.Tj = function () {
        ...
        if (state == "提交") {
            var sqdbh = dw_list.GetItemString(row, "sqdbh")
            var num = QsWebSoft.PubMethod.GenQtysk(sqdbh, "新制").value;
            if (num == "1") {
            ...
            var sqdbh = dw_list.GetItemString(row, "sqdbh")
            var num = QsWebSoft.PubMethod.GenQtysk(sqdbh, "提交").value;
            if (num == "1") {
                dw_list.SetItem(row, "state", "提交")
