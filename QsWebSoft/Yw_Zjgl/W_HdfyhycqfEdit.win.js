...
function W_HdfyhycqfEdit() {
    ...
    webReq.SetWebServiceUrl("/Service/Hdfyhycqf.ashx");
    ...
    this.InsertRow = function () {
        if (iw_Hddz_Hycqf_Select == null)
            iw_Hddz_Hycqf_Select = new W_Hddz_Hycqf_Select();
        var ShareMode = requestor.GetParm("ShareMode");
        var ywy = requestor.GetParm("userid");
        var Dlwtf = requestor.GetParm("Dlwtf");
        row = dw_jzxxx.InsertRow(dw_jzxxx.GetRow());
        var dwo = dw_jzxxx.GetDataObject();
        iw_Hddz_Hycqf_Select.SetRow(row);
        iw_Hddz_Hycqf_Select.SetDwo(dwo);
        iw_Hddz_Hycqf_Select.SetDetailDW(dw_jzxxx);
        requestor.Open("/LoadWindow.ashx?WinName=Xt_Popwin.W_Hddz_Hycqf_Select&ShareMode=" + ShareMode + '&ywy=' + ywy + '&Dlwtf=' + Dlwtf, iw_Hddz_Hycqf_Select);
...
//        dw_jzxxx.InsertRow(0);
    ...
    this.dw_master_Clicked = function (xPos, yPos, Row, dwoName) {
        ...
        if (dwoName == "sjskrkhyh_t") {
            ...
            iw_Wldw_Yh_Select.SetData("hdfyhycqf_sjskryh");
    ...
    this.dw_jzxxx_DoubleClicked = function (xPos, yPos, Row, dwoName) {
        if (dwoName == "zfdxjc") {
            ...
            iw_Wldw_Zfdx_Select.SetData("hdfyhycqf_zfdx");
    ...
    this.Tbsxg = function () {
        ...
        webReq.Invoke("Tbsxg", "sqdbh=" + sqdbh );
