...
function W_HdfybzjzfEdit() {
    ...
    webReq.SetWebServiceUrl("/Service/Hdfybzjzf.ashx");
...
//        dw_jzxxx.InsertRow(0);
    ...
    this.dw_master_Clicked = function (xPos, yPos, Row, dwoName) {
        ...
        if (dwoName == "sjskrbm_t") {
            ...
            iw_Wldw_Select.SetData("hdfybzjzf_sjskr");
        ...
        if (dwoName == "sjskrkhyh_t") {
            ...
            iw_Wldw_Yh_Select.SetData("hdfybzjzf_sjskryh");
    ...
    this.dw_jzxxx_DoubleClicked = function (xPos, yPos, Row, dwoName) {
        if (dwoName == "zfdxjc") {
            ...
            iw_Wldw_Select.SetData("hdfybzjzf_zfdx");
    ...
    this.dw_jzxxx_ItemChanged = function (row, dwoName, data) {
        if (dwoName == "fybm") {
            var zfdxbm = dw_jzxxx.GetItemString(row, "zfdxbm");
            var fkcs = 0;
            var sqdbh = dw_master.GetItemString(1,"sqdbh")
            if (sqdbh == null) {
                sqdbh = ""
            ...
            fkcs = QsWebSoft.PubMethod.ReadZfdxFycs(zfdxbm, data, sqdbh).value;

            for (var rowfind = 1; rowfind <= dw_jzxxx.RowCount(); rowfind++) {
                if (dw_jzxxx.Find("zfdxbm = '" + zfdxbm + "' and fybm = '" + data + "'", rowfind, rowfind) > 0) {
                    fkcs++
                }
            };
