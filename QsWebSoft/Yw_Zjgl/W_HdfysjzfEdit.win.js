...
function W_HdfysjzfEdit() {
    ...
    webReq.SetWebServiceUrl("/Service/Hdfysjzf.ashx");
    ...
    this.Save = function ()
    {
        ...
        for ( row = dw_jzxxx.RowCount(); row > 0; row-- )
        {
            ...
            if ( zfdxjc == null || zfdxjc == "" )
            {
                alert( "第" + row.toString() + "行的结算单位没有确认，不能保存！" );
                return;
            }
        }
        ...
        if ( webReq.StatusCode() == 200 )
        {
            ...
            alert( sqdbh );
            var num = QsWebSoft.PubMethod.Sjzf_sfwc( sqdbh );
    ...
    this.InsertRow = function () {
        if (iw_Hddz_Sjzf_Select == null)
            iw_Hddz_Sjzf_Select = new W_Hddz_Sjzf_Select();
        var ShareMode = requestor.GetParm("ShareMode");
        var ywy = requestor.GetParm("userid");
        var Dlwtf = requestor.GetParm("Dlwtf");
        var row = dw_jzxxx.GetRow();
        var dwo = dw_jzxxx.GetDataObject();
        iw_Hddz_Sjzf_Select.SetRow(row);
        iw_Hddz_Sjzf_Select.SetDwo(dwo);
        iw_Hddz_Sjzf_Select.SetDetailDW(dw_jzxxx);
        requestor.Open("/LoadWindow.ashx?WinName=Xt_Popwin.W_Hddz_Sjzf_Select&ShareMode=" + ShareMode + '&ywy=' + ywy + '&Dlwtf=' + Dlwtf, iw_Hddz_Sjzf_Select);
    ...
    this.Print = function () {
        ...
        dw_print.SetDataObject("dw_hddz_hdfysjzf_print");
...
//        dw_jzxxx.InsertRow(0);
    ...
    this.dw_master_Clicked = function (xPos, yPos, Row, dwoName) {
        ...
        if (dwoName == "sjskrbm_t") {
            ...
            iw_Wldw_Select.SetData("hdfysjzf_sjskr");
        ...
        if (dwoName == "sjskrkhyh_t") {
            ...
            iw_Wldw_Yh_Select.SetData("hdfysjzf_sjskryh");
    ...
    this.dw_jzxxx_DoubleClicked = function (xPos, yPos, Row, dwoName) {
        if (dwoName == "zfdxjc") {
            ...
            iw_Wldw_Zfdx_Select.SetData("hdfysjzf_zfdx");
    ...
    this.dw_jzxxx_Clicked = function (xPos, yPos, Row, dwoName) {
        ...
        if (dwoName == "zfdx_jsbm") {
            ...
            iw_Wldw_Jsbm_Select.SetData("sjzf_jsdw");
