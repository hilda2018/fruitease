...
function W_HdfyLrcxList_Gbhywbh() {
    ...
    var sle_jdr = new SingleLineEdit(requestor);
    ...
    this.bind = function (win) {
        ...
        if (sle_jdr == null) sle_jdr = new SingleLineEdit(requestor);
        sle_jdr.Attach(win.Control("sle_jdr"));
        ...
        if (typeof (self.jdr_EditChanged) == "function")
            win.AttachEvent("sle_jdr", "EditChanged", self.jdr_EditChanged);
    ...
    this.Retrieve = function () {
        ...
        dw_list.Retrieve(kgzt, beginDate.getVarDate(), endDate.getVarDate(), Dlwtf, ysfs, jsqk, zydl, userid, qrqk);
    ...
    this.OpenWindow = function () {
        ...
        var gbh_ywbh = dw_list.GetItemString(dw_list.GetRow(), 'yw_hddz_gbh_ywbh');
        ...
        if (openStyle == "2")
            ...
            ts_1.Open(node, label, "", "/OpenWindow.aspx?FunID=" + node + '&ywbh=' + ywbh + '&cxh=' + cxh + '&ysfs=' + ysfs + '&gbh_ywbh=' + gbh_ywbh + '&operation=' + operation.toString(), true);
