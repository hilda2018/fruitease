...
function W_HdfyxdfEdit() {
    ...
    this.InsertRow = function () {
        if (iw_Hddz_Xdf_Select == null)
            iw_Hddz_Xdf_Select = new W_Hddz_Xdf_Select();
        ...
        if (Sjskrbm == "" || Sjskrbm == null) {
            requestor.MessageBox("提示", "请选择实际收款人");
            return;
        };
        iw_Hddz_Xdf_Select.SetRow(row);
        iw_Hddz_Xdf_Select.SetDwo(dwo);
        iw_Hddz_Xdf_Select.SetSfytj("Y");
        iw_Hddz_Xdf_Select.SetDetailDW(dw_jzxxx);
        requestor.Open("/LoadWindow.ashx?WinName=Xt_Popwin.W_Hddz_Xdf_Select&ShareMode=" + ShareMode + '&ywy=' + ywy + '&Dlwtf=' + Dlwtf + '&Sjskrbm=' + Sjskrbm+'&Sfytj=Y', iw_Hddz_Xdf_Select);
...
//        dw_jzxxx.InsertRow(0);
    ...
    this.dw_master_Clicked = function (xPos, yPos, Row, dwoName) {
        ...
        if (dwoName == "sjskrbm_t") {
            ...
            iw_Wldw_Select.SetData("hdfyxdf_sjskr");
    ...
    this.dw_jzxxx_DoubleClicked = function (xPos, yPos, Row, dwoName) {
        if (dwoName == "zfdxjc") {
            ...
            iw_Wldw_Zfdx_Select.SetData("hdfyxdf_zfdx");
