...
{
    public partial class W_HdfyfywfyList
    {
        public W_HdfyfywfyList()
        {
        }
        public override void OnLoad()
        {
            ...
            // 数据检索
            this.dw_list.Retrieve(userid, DateTime.Parse(this.dp_begin.Value.ToString()), DateTime.Parse(this.dp_end.Value.ToString()));
            //注册相关的js文件
            this.RegisterClientScriptInclude("ExtPB_Demo", "/Beta3/ExtPB_Demo.js");
            this.RegisterClientScriptInclude("W_HdfyfywfyList", "/Yw_Zjgl/W_HdfyfywfyList.win.js");
            this.RegisterClientScriptInclude("W_HdfyfywfyEdit", "/Yw_Zjgl/W_HdfyfywfyEdit.win.js");
