...
function W_HdfyfymxList() {
    ...
    var sle_jzxhz = new SingleLineEdit(requestor);
    var tb_1 = new ToolStrip(requestor);
    var ddlb_fymx = new DropDownListBox(requestor);
    var sle_tgdh = new SingleLineEdit(requestor);
    var sle_bgdh = new SingleLineEdit(requestor);
    var sle_2 = new SingleLineEdit(requestor);
    var sle_sqrgsmc = new SingleLineEdit(requestor);
    ...
    this.bind = function (win) {
        ...
        if (sle_jzxhz == null) sle_jzxhz = new SingleLineEdit(requestor);
        sle_jzxhz.Attach(win.Control("sle_jzxhz"));
        if (tb_1 == null) tb_1 = new ToolStrip(requestor);
        tb_1.Attach(win.Control("tb_1"));
        if (ddlb_fymx == null) ddlb_fymx = new DropDownListBox(requestor);
        ddlb_fymx.Attach(win.Control("ddlb_fymx"));
        ...
        if (sle_sqrgsmc == null) sle_sqrgsmc = new SingleLineEdit(requestor);
        sle_sqrgsmc.Attach(win.Control("sle_sqrgsmc"));
        ...
        if (typeof (self.slejzxhz_EditChanged) == "function")
            win.AttachEvent("sle_jzxhz", "EditChanged", self.slejzxhz_EditChanged);
        ...
        if (typeof (self.Retrieve) == "function")
            win.AttachEvent("ddlb_fymx", "SelectionChanged", self.Retrieve);
        ...
        if (typeof (self.slesqdbh_EditChanged) == "function")
            win.AttachEvent("sle_2", "EditChanged", self.slesqdbh_EditChanged);

        if (typeof (self.slesqrgsmc_EditChanged) == "function")
            win.AttachEvent("sle_sqrgsmc", "EditChanged", self.slesqrgsmc_EditChanged);
    ...
    this.unbind = function () {
        ...
        sle_jzxhz.Detach(); sle_jzxhz = null;
        tb_1.Detach(); tb_1 = null;
        ddlb_fymx.Detach(); ddlb_fymx = null;
        sle_tgdh.Detach(); sle_tgdh = null;
        sle_bgdh.Detach(); sle_bgdh = null;
        sle_2.Detach(); sle_2 = null;
        sle_sqrgsmc.Detach(); sle_sqrgsmc = null;
    ...
    this.Retrieve = function () {
        ...
        dw_list.Retrieve(beginDate.getVarDate(), endDate.getVarDate(), fymx, Dlwtf, userid);
...
//        }
    ...
    this.sle_EditChanged = function (text) {
        ...
        if (text == "")
            ...
            dw_list.SetFilter("( Upper(cmd_ywbh) like Upper('%" + text + "%'))");
        dw_list.Filter();
        dw_list.Sort();
    ...
    this.slekh_EditChanged = function (text) {
        ...
        if (text == "")
            ...
            dw_list.SetFilter("( Upper(cmd_khjc) like Upper('%" + text + "%')) or ( Upper(cmd_khpym) like Upper('%" + text + "%'))");
        dw_list.Filter();
        dw_list.Sort();
        dw_list.SetRedraw(true);
    }
    ...
    this.slehth_EditChanged = function (text) {
        ...
        if (text == "")
            ...
            dw_list.SetFilter("( Upper(cmd_hth) like Upper('%" + text + "%'))");
        dw_list.Filter();
        dw_list.Sort();
        dw_list.SetRedraw(true);
    }
    ...
    //#region 过滤申请人公司名称
    this.slesqrgsmc_EditChanged = function (text) {
        dw_list.SetRedraw(false);
        if (text == "")
            dw_list.SetFilter("");
        else
    ...
    this.sleztdh_EditChanged = function (text) {
        ...
        if (text == "")
            ...
            dw_list.SetFilter("( Upper(cmd_ztdh) like Upper('%" + text + "%'))");
        dw_list.Filter();
        dw_list.Sort();
        dw_list.SetRedraw(true);
    }
    ...
    this.slejzxh_EditChanged = function (text) {
        ...
        if (text == "")
            ...
            dw_list.SetFilter("( Upper(cmd_jzxh) like Upper('%" + text + "%'))");
        dw_list.Filter();
        dw_list.Sort();
        dw_list.SetRedraw(true);
    }
    ...
    //#region 过滤集装箱号总
    this.slejzxhz_EditChanged = function (text) {
        dw_list.SetRedraw(false);
        if (text == "")
            dw_list.SetFilter("");
        else
            dw_list.SetFilter("( Upper(cmd_hz_jzxh) like Upper('%" + text + "%'))");
        dw_list.Filter();
        dw_list.Sort();
        dw_list.SetRedraw(true);
    }
    ...
    this.sletgdh_EditChanged = function (text) {
        ...
        if (text == "")
            ...
            dw_list.SetFilter("( Upper(cmd_tgdh) like Upper('%" + text + "%'))");
        dw_list.Filter();
        dw_list.Sort();
        dw_list.SetRedraw(true);
    }
    ...
    this.slebgdh_EditChanged = function (text) {
        ...
        if (text == "")
            ...
            dw_list.SetFilter("( Upper(cmd_bgdh) like Upper('%" + text + "%'))");
        dw_list.Filter();
        dw_list.Sort();
        dw_list.SetRedraw(true);
    }
...
//            ts_1.Open(node, label, "", "/OpenWindow.aspx?FunID=" + node + '&ywbh=' + ywbh  + '&operation=' + operation.toString() , true);
    ...
    this.Recover = function () {
        ...
        QsWebSoft.PubMethod.DelColRecord("QsWebSoft.Yw_Zjgl.W_HdfyfymxList", "dw_hddz_hdfyfymx_list");
        self.Retrieve();
    }
    //#endregion
