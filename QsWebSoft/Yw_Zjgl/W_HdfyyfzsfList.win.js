...
function W_HdfyyfzsfList() {
    ...
    webReq.SetWebServiceUrl("/Service/Hdfyyfzsf.ashx");   
...
//    }
    ...
    this.Delete = function () {
        ...
        if (requestor.MessageBox("提示", "删除应付转实付费用申请单号为<" + sqdbh + ">,是否确定?", ICON.Question, BUTTON.YesNo) == 2)
            return;
    ...
    this.Recover = function () {
        ...
        QsWebSoft.PubMethod.DelColRecord("QsWebSoft.Yw_Zjgl.W_HdfyyfzsfList", "dw_hddz_hdfyyfzsf_list");
        self.Retrieve();
    }
    //#endregion
