...
{
    public partial class W_HdfyLrcxEdit
    {
        public W_HdfyLrcxEdit()
        {
        ...
        public override void OnLoad()
        {
            ...
            //{
            //     string ywbh1 = this.Request["ywbh"].ToString();
            //     string[] m = ywbh1.Split(',');
            //     var dd = m[0];
            //     var mm = m[1];
            ...
            dw_master.Retrieve(ywbh, int.Parse(cxh), ysfs);
            dw_jzxxx.Retrieve(ywbh, int.Parse(cxh), ysfs);
            dw_cbmx.Retrieve(ywbh, int.Parse(cxh), ysfs);
