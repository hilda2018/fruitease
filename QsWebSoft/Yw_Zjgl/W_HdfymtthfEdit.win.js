...
function W_HdfymtthfEdit() {
    ...
    this.InsertRow = function () {
        if (iw_Hddz_Mtthf_Select == null)
            iw_Hddz_Mtthf_Select = new W_Hddz_Mtthf_Select();
        var ShareMode = requestor.GetParm("ShareMode");
        var ywy = requestor.GetParm("userid");
        var Dlwtf = requestor.GetParm("Dlwtf");
        row = dw_jzxxx.InsertRow(dw_jzxxx.GetRow());
        var dwo = dw_jzxxx.GetDataObject();
        iw_Hddz_Mtthf_Select.SetRow(row);
        iw_Hddz_Mtthf_Select.SetDwo(dwo);
        iw_Hddz_Mtthf_Select.SetDetailDW(dw_jzxxx);
        requestor.Open("/LoadWindow.ashx?WinName=Xt_Popwin.W_Hddz_Mtthf_Select&ShareMode=" + ShareMode + '&ywy=' + ywy + '&Dlwtf=' + Dlwtf, iw_Hddz_Mtthf_Select);
...
//            iw_Wldw_Zfdx_Select.SetDwo("dw_hddz_hdfymtthf_edit_cmd");
...
//        dw_jzxxx.InsertRow(0);
    ...
    this.dw_master_Clicked = function (xPos, yPos, Row, dwoName) {
        ...
        if (dwoName == "sjskrbm_t") {
            ...
            iw_Wldw_Select.SetData("hdfymtthf_sjskr");
        ...
        if (dwoName == "sjskrkhyh_t") {
            ...
            iw_Wldw_Yh_Select.SetData("hdfymtthf_sjskryh");
    ...
    this.dw_jzxxx_DoubleClicked = function (xPos, yPos, Row, dwoName) {
        if (dwoName == "zfdxjc") {
            ...
            iw_Wldw_Zfdx_Select.SetData("hdfymtthf_zfdx");
    ...
    this.dw_jzxxx_ItemChanged = function (row, dwoName, data) {
        if (dwoName == "fybm") {
            ...
            var mtjc = dw_jzxxx.GetItemString(row, "xhgqjc");
            ...
            var mtsyts = dw_jzxxx.GetItemNumber(row, "mtsyts");
            if (data == "010205") {
                
                var mtzlfy = ds_mtzlfy.Retrieve(mtjc, xx, xl, data, sjkgsj.getVarDate(), je, mtsyts);
                if (mtzlfy == 0) {
                ...
                var mtfy = ds_mtfy.Retrieve(mtjc, xx, xl, data, sjkgsj.getVarDate(), je);
                if (mtfy == 0) {
                    dw_jzxxx.SetItem(row, "fysfhl", "Y")
                } else {
                    dw_jzxxx.SetItem(row, "fysfhl", "N")
        ...
        if (dwoName == "je") {
            ...
            var mtsyts = dw_jzxxx.GetItemNumber(row, "mtsyts");
            if (fybm == "010205") {
                 var mtzlfy = ds_mtzlfy.Retrieve(mtjc, xx, xl, fybm, sjkgsj.getVarDate(), data, mtsyts);
                 if (mtzlfy == 0) {
                    dw_jzxxx.SetItem(row, "fysfhl", "Y")
                } else {
                    dw_jzxxx.SetItem(row, "fysfhl", "N")
                ...
                var mtfy = ds_mtfy.Retrieve(mtjc, xx, xl, fybm, sjkgsj.getVarDate(), data);
                if (mtfy == 0) {
                    dw_jzxxx.SetItem(row, "fysfhl", "Y")
                } else {
                    dw_jzxxx.SetItem(row, "fysfhl", "N")
