...
function W_WlgzsjfkEdit() {
    ...
    this.InsertRow = function () {
        if (iw_Wlgz_Sjfk_Select == null)
            iw_Wlgz_Sjfk_Select = new W_Wlgz_Sjfk_Select();
        ...
        iw_Wlgz_Sjfk_Select.SetRow(row);
        iw_Wlgz_Sjfk_Select.SetDwo(dwo);
        iw_Wlgz_Sjfk_Select.SetDetailDW(dw_jzxxx);
        requestor.Open("/LoadWindow.ashx?WinName=Xt_Popwin.W_Wlgz_Sjfk_Select&ShareMode=" + ShareMode + '&ywy=' + ywy + '&Dlwtf=' + Dlwtf + '&Sjskrbm=' + Sjskrbm, iw_Wlgz_Sjfk_Select);
