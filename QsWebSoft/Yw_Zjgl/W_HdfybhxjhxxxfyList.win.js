...
//    }
    ...
    this.Delete = function () {
        ...
        if (requestor.MessageBox("提示", "删除包坏污箱费用申请单号为<" + sqdbh + ">,是否确定?", ICON.Question, BUTTON.YesNo) == 2)
            return;
    ...
    this.Recover = function () {
        ...
        QsWebSoft.PubMethod.DelColRecord("QsWebSoft.Yw_Zjgl.W_HdfybhxjhxxxfyList", "dw_hddz_hdfybhxjhxxxfy_list");
        self.Retrieve();
    }
    //#endregion
