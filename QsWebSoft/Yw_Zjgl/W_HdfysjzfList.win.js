...
//        }
        ...
        if (requestor.MessageBox("提示", "删除税金支付申请单号为<" + sqdbh + ">,是否确定?", ICON.Question, BUTTON.YesNo) == 2)
            return;
    ...
    this.Recover = function () {
        ...
        QsWebSoft.PubMethod.DelColRecord("QsWebSoft.Yw_Zjgl.W_HdfysjzfList", "dw_hddz_hdfysjzf_list");
        self.Retrieve();
    }
    //#endregion
