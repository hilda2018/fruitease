...
function W_WlgzfywfyEdit() {
    ...
    this.Save = function () {
        ...
        for (row = dw_jzxxx.RowCount(); row > 0; row--) {
            ...
            var cd = dw_jzxxx.GetItemString(row, "zfdxlx");
    ...
    this.InsertRow = function () {
        ...
        var zfdxlx = dw_master.GetItemString(1, "zfdxlx");
        ...
        dw_jzxxx.SetItem(row, "zfdxlx", zfdxlx);
...
//        dw_jzxxx.InsertRow(0);
    ...
    this.dw_master_Clicked = function (xPos, yPos, Row, dwoName) {
        ...
        if (dwoName == "sjskrbm_t") {
            ...
            iw_Wldw_Select.SetData("wlgzfywfy_sjskr");
    ...
    this.dw_jzxxx_DoubleClicked = function (xPos, yPos, Row, dwoName) {
        if (dwoName == "zfdxjc") {
            ...
            iw_Wldw_Zfdx_Select.SetData("wlgz_fywfy_zfdx");
            iw_Wldw_Zfdx_Select.SetRow(Row);
            requestor.Open("/LoadWindow.ashx?WinName=Xt_Popwin.W_Wldw_Select&ShareMode=" + ShareMode + "&ywy=" + ywy + "&Dlwtf=" + Dlwtf + "&ywbh=" + ywbh, iw_Wldw_Zfdx_Select);
            dw_master.SetFocus();
