...
{
    public partial class W_HdfykhxxzdList
    {
        public W_HdfykhxxzdList()
        {
        }
        public override void OnLoad()
        {
            ...
            // 数据检索
            this.dw_list.Retrieve(Dlwtf, DateTime.Parse(this.dp_begin.Value.ToString()), DateTime.Parse(this.dp_end.Value.ToString()),"all","N");
            //注册相关的js文件
            this.RegisterClientScriptInclude("ExtPB_Demo", "/Beta3/ExtPB_Demo.js");
            this.RegisterClientScriptInclude("W_HdfykhxxzdList", "/Yw_Zjgl/W_HdfykhxxzdList.win.js");
