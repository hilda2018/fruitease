...
function W_HdfybgbjfyEdit() {
    ...
    //#region 变量定义
    var editMode = "";
    var iw_Hddz_Bgbjfy_Select = null;
    ...
    webReq.SetWebServiceUrl("/Service/Hdfybgbjfy.ashx");
    ...
    this.InsertRow = function () {
        if (iw_Hddz_Bgbjfy_Select == null)
            iw_Hddz_Bgbjfy_Select = new W_Hddz_Bgbjfy_Select();
        var ShareMode = requestor.GetParm("ShareMode");
        var ywy = requestor.GetParm("userid");
        var Dlwtf = requestor.GetParm("Dlwtf");
        row = dw_jzxxx.InsertRow(dw_jzxxx.GetRow());
        var dwo = dw_jzxxx.GetDataObject();
        iw_Hddz_Bgbjfy_Select.SetRow(row);
        iw_Hddz_Bgbjfy_Select.SetDwo(dwo);
        iw_Hddz_Bgbjfy_Select.SetDetailDW(dw_jzxxx);
        requestor.Open("/LoadWindow.ashx?WinName=Xt_Popwin.W_Hddz_Bgbjfy_Select&ShareMode=" + ShareMode + '&ywy=' + ywy + '&Dlwtf=' + Dlwtf, iw_Hddz_Bgbjfy_Select);
    ...
    this.Print = function () {
        ...
        dw_print.SetDataObject("dw_hddz_hdfybgbjfy_print");
...
//        dw_jzxxx.InsertRow(0);
    ...
    this.dw_master_Clicked = function (xPos, yPos, Row, dwoName) {
        ...
        if (dwoName == "sjskrbm_t") {
            ...
            iw_Wldw_Select.SetData("hdfybgbjfy_sjskr");
        ...
        if (dwoName == "sjskrkhyh_t") {
            ...
            iw_Wldw_Yh_Select.SetData("hdfybgbjfy_sjskryh");
    ...
    this.dw_jzxxx_DoubleClicked = function (xPos, yPos, Row, dwoName) {
        if (dwoName == "zfdxjc") {
            ...
            iw_Wldw_Zfdx_Select.SetData("hdfybgbjfy_zfdx");
    ...
    this.Recover = function () {
        ...
        QsWebSoft.PubMethod.DelColRecord("QsWebSoft.Yw_Zjgl.W_HdfybgbjfyEdit", "dw_hddz_hdfybgbjfy_edit_cmd");
        self.Retrieve();
    }
    //#endregion
