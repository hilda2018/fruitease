...
function W_HdfyqtyskEdit() {
    ...
    webReq.SetWebServiceUrl("/Service/Hdfyqtysk.ashx");
    ...
    this.InsertRow = function () {
        if (iw_Hddz_Qtysk_Select == null)
            iw_Hddz_Qtysk_Select = new W_Hddz_Qtysk_Select();
        var ShareMode = requestor.GetParm("ShareMode");
        var ywy = requestor.GetParm("userid");
        var Dlwtf = requestor.GetParm("Dlwtf");
        row = dw_jzxxx.InsertRow(dw_jzxxx.GetRow());
        var dwo = dw_jzxxx.GetDataObject();
        iw_Hddz_Qtysk_Select.SetRow(row);
        iw_Hddz_Qtysk_Select.SetDwo(dwo);
        iw_Hddz_Qtysk_Select.SetDetailDW(dw_jzxxx);
        requestor.Open("/LoadWindow.ashx?WinName=Xt_Popwin.W_Hddz_Qtysk_Select&ShareMode=" + ShareMode + '&ywy=' + ywy + '&Dlwtf=' + Dlwtf, iw_Hddz_Qtysk_Select);
