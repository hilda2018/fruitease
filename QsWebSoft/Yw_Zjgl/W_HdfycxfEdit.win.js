...
function W_HdfycxfEdit() {
    ...
    webReq.SetWebServiceUrl("/Service/Hdfycxf.ashx");
    ...
    this.InsertRow = function () {
        if (iW_Hddz_cxf_Select == null)
            iW_Hddz_cxf_Select = new W_Hddz_cxf_Select();
        var ShareMode = requestor.GetParm("ShareMode");
        var ywy = requestor.GetParm("userid");
        var Dlwtf = requestor.GetParm("Dlwtf");
        row = dw_jzxxx.InsertRow(dw_jzxxx.GetRow());
        var dwo = dw_jzxxx.GetDataObject();
        iW_Hddz_cxf_Select.SetRow(row);
        iW_Hddz_cxf_Select.SetDwo(dwo);
        iW_Hddz_cxf_Select.SetDetailDW(dw_jzxxx);
        requestor.Open("/LoadWindow.ashx?WinName=Xt_Popwin.W_Hddz_cxf_Select&ShareMode=" + ShareMode + '&ywy=' + ywy + '&Dlwtf=' + Dlwtf, iW_Hddz_cxf_Select);
