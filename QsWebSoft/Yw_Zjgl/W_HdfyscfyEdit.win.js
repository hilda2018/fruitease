...
function W_HdfyscfyEdit() {
    ...
    webReq.SetWebServiceUrl("/Service/Hdfyscfy.ashx");
    ...
    this.InsertRow = function () {
        if (iw_Hddz_Scfy_Select == null)
            iw_Hddz_Scfy_Select = new W_Hddz_Scfy_Select();
        var ShareMode = requestor.GetParm("ShareMode");
        var ywy = requestor.GetParm("userid");
        var Dlwtf = requestor.GetParm("Dlwtf");
        row = dw_jzxxx.InsertRow(dw_jzxxx.GetRow());
        var dwo = dw_jzxxx.GetDataObject();
        iw_Hddz_Scfy_Select.SetRow(row);
        iw_Hddz_Scfy_Select.SetDwo(dwo);
        iw_Hddz_Scfy_Select.SetDetailDW(dw_jzxxx);
        requestor.Open("/LoadWindow.ashx?WinName=Xt_Popwin.W_Hddz_Scfy_Select&ShareMode=" + ShareMode + '&ywy=' + ywy + '&Dlwtf=' + Dlwtf, iw_Hddz_Scfy_Select);
    ...
    this.Print = function () {
        ...
        dw_print.SetDataObject("dw_hddz_hdfyscfy_print");
    ...
    this.dw_jzxxx_ItemChanged = function (row, dwoName, data) {
        if (dwoName == "fybm") {        
            ...
            if (ysfs == "海运") {
                fkcs = QsWebSoft.PubMethod.ReadJzxFycs(ywbh, jzxh, data, yfkdbh).value;
                ...
                fkcs = QsWebSoft.PubMethod.ReadKyFycs(ywbh, tpxx, zhlx, data, yfkdbh).value;
                for (var rowfind = 1; rowfind <= dw_jzxxx.RowCount(); rowfind++) {
