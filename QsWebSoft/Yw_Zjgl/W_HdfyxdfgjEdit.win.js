...
function W_HdfyxdfgjEdit() {
	 ...
	 if(typeof( baseBind )=="function") baseBind(win);
		 ...
		 if(typeof(self.slegj_EditChanged)=="function") 
			 win.AttachEvent("sle_gj","EditChanged",self.slegj_EditChanged); 
...
this.save = function () {
    ...
    webReq.Invoke("GjSave", "dw_list=" + dw_d_data);
...
this.slegj_EditChanged = function (text) {
    ...
    if (text == "")
        ...
        dw_list.SetFilter("( Upper(ctr_cname) like Upper('%" + text + "%')) or ( Upper(ctr_ename) like Upper('%" + text + "%'))");
    dw_list.Filter();
    dw_list.Sort();
