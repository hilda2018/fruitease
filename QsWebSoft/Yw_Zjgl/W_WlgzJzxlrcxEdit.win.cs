...
{
    public partial class W_WlgzJzxlrcxEdit
    {
        public W_WlgzJzxlrcxEdit()
        {
        ...
        public override void OnLoad()
        {
            ...
            DataWindowChild dwc_fkxx_fybm = dw_fkxx.GetChild("fybm");
            dwc_fkxx_fybm.SetTransaction(this.AdoTransaction);
            dwc_fkxx_fybm.Retrieve("06");
            ...
            if (this.Request["ywbh"] != null)
            {
                ...
                dw_jzxxx.Retrieve(yfkdbh,ywbh,cxh);
                dw_fkxx.Retrieve(ywbh, cxh);   
            }
