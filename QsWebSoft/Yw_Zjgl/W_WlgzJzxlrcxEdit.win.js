...
function W_WlgzJzxlrcxEdit() {
	 ...
	 var dw_fkxx= new DataWindow( requestor );
	 ...
	 if(typeof( baseBind )=="function") baseBind(win);
		 ...
		 if(dw_fkxx == null ) dw_fkxx= new DataWindow( requestor );
		 dw_fkxx.Attach( win.Control( "dw_fkxx") ); 
