...
{
    public partial class W_KptzsList
    {
        public W_KptzsList()
        {
        }
        public override void OnLoad()
        {
            ...
            // 数据检索
            this.dw_list.Retrieve(ShareMode,userid, userid, DateTime.Parse(this.dp_begin.Value.ToString()), DateTime.Parse(this.dp_end.Value.ToString()));
            //注册相关的js文件
            this.RegisterClientScriptInclude("ExtPB_Demo", "/Beta3/ExtPB_Demo.js");
            this.RegisterClientScriptInclude("W_KptzsList", "/Yw_Zjgl/W_KptzsList.win.js");
            this.RegisterClientScriptInclude("W_KptzsEdit", "/Yw_zjgl/W_KptzsEdit.win.js");
