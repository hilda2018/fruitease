...
function W_HdfyhycdfyEdit() {
    ...
    webReq.SetWebServiceUrl("/Service/Hdfyhycdfy.ashx");
    ...
    this.Save = function () {
        ...
        var yfkdbh = dw_master.GetItemString(row, "jzxxx_yfkdbh");
        dw_master.SetItem(row, "jzxxx_sfyyfk", "Y");
        ...
        //更新行号
        var hz_jzxh = ""
        var hdcsj = dw_master.GetItemDate(1, "jzxxx_hdcsj");
        var hddz_cxh = dw_master.GetItemNumber(1, "jzxxx_cxh");
        for (row = dw_jzxxx.RowCount(); row > 0; row--) {
            ...
            dw_jzxxx.SetItem(row, "hdcsj", hdcsj);
        ...
        if (webReq.StatusCode() == 200) {
            //服务器成功处理，返回单号
            yfkdbh = webReq.ResponseText();
            dw_master.SetItem(1, "jzxxx_yfkdbh", yfkdbh);
            ...
            dw_master.Modify("jzxxx_yfkdbh.Tabsequence=0");
    ...
    this.InsertRow = function () {
        ...
        var li_insert = dw_jzxxx.InsertRow(dw_jzxxx.GetRow());
        dw_jzxxx.ScrollToRow(li_insert);
        dw_jzxxx.SetItem(li_insert, "ywbh", dw_master.GetItemString(1, "ywbh"));
        dw_jzxxx.SetItem(li_insert, "hth", dw_master.GetItemString(1, "hth"));
        dw_jzxxx.SetItem(li_insert, "khbm", dw_master.GetItemString(1, "khbm"));
        dw_jzxxx.SetItem(li_insert, "khmc", dw_master.GetItemString(1, "khmc"));
        dw_jzxxx.SetItem(li_insert, "khjc", dw_master.GetItemString(1, "khjc"));
        dw_jzxxx.SetItem(li_insert, "khpym", dw_master.GetItemString(1, "khpym"));
        dw_jzxxx.SetItem(li_insert, "jzxh", dw_master.GetItemString(1, "jzxxx_jzxh"));
        dw_jzxxx.SetItem(li_insert, "xx", dw_master.GetItemString(1, "jzxxx_xx"));
        dw_jzxxx.SetItem(li_insert, "xl", dw_master.GetItemString(1, "jzxxx_xl"));
        dw_jzxxx.SetItem(li_insert, "sjshrbm", dw_master.GetItemString(1, "jzxxx_sjshrbm"));
        dw_jzxxx.SetItem(li_insert, "sjshrmc", dw_master.GetItemString(1, "jzxxx_sjshrmc"));
        dw_jzxxx.SetItem(li_insert, "xhgqbm", dw_master.GetItemString(1, "xhgqbm"));
        dw_jzxxx.SetItem(li_insert, "xhgq", dw_master.GetItemString(1, "xhgq"));
        dw_jzxxx.SetItem(li_insert, "xhgqjc", dw_master.GetItemString(1, "xhgqjc"));
        dw_jzxxx.SetItem(li_insert, "xhgqpym", dw_master.GetItemString(1, "xhgqpym"));
        dw_jzxxx.SetItem(li_insert, "sc_bz", dw_master.GetItemString(1, "jzxxx_sc_bz"));
        dw_jzxxx.SetItem(li_insert, "hxfs", dw_master.GetItemString(1, "jzxxx_hxfs"));
        dw_jzxxx.SetItem(li_insert, "zjfscwld_bz", dw_master.GetItemString(1, "jzxxx_zjfscwld_bz"));
        dw_jzxxx.SetItem(li_insert, "zjfscwld_zyxx", dw_master.GetItemString(1, "jzxxx_zjfscwld_zyxx"));
        dw_jzxxx.SetItem(li_insert, "fscwl_ddsj", dw_master.GetItemDate(1, "jzxxx_fscwl_ddsj"));
        dw_jzxxx.SetItem(li_insert, "fscwl_lksj", dw_master.GetItemDate(1, "jzxxx_fscwl_lksj"));
        dw_jzxxx.SetItem(li_insert, "zlsj", dw_master.GetItemNumber(1, "zlsj"));
        dw_jzxxx.SetItem(li_insert, "hdcsj", dw_master.GetItemDate(1, "jzxxx_hdcsj"));
        dw_jzxxx.SetItem(li_insert, "jdrbm", dw_master.GetItemString(1, "jdrbm"));
        dw_jzxxx.SetItem(li_insert, "jdrjc", dw_master.GetItemString(1, "jdrjc"));
        dw_jzxxx.SetItem(li_insert, "jdrmc", dw_master.GetItemString(1, "jdrmc"));
        dw_jzxxx.SetItem(li_insert, "jdrpym", dw_master.GetItemString(1, "jdrpym"));
        dw_jzxxx.SetFocus();
    }
    //#endregion
