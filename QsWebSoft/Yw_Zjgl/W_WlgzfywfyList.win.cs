...
{
    public partial class W_WlgzfywfyList
    {
        public W_WlgzfywfyList()
        {
        }
        public override void OnLoad()
        {
            ...
            ds_role.Retrieve(userid, "084");
            var wlbjl = "N";
            if (ds_role.RowCount > 0) {
                wlbjl = "Y";
            }
            this.SetParm("Wlbjl", wlbjl);
            ...
            ds_role.Retrieve(userid, "08401");
            if (ds_role.RowCount > 0)
            {
                btn_cxtj.Visible = true;
            }
            else {
                btn_cxtj.Visible = false;
            }

            

            // 数据检索
            this.dw_list.Retrieve(userid, DateTime.Parse(this.dp_begin.Value.ToString()), DateTime.Parse(this.dp_end.Value.ToString()),"Y");
            //注册相关的js文件
            this.RegisterClientScriptInclude("ExtPB_Demo", "/Beta3/ExtPB_Demo.js");
            this.RegisterClientScriptInclude("W_WlgzfywfyList", "/Yw_Zjgl/W_WlgzfywfyList.win.js");
            this.RegisterClientScriptInclude("W_WlgzfywfyEdit", "/Yw_Zjgl/W_WlgzfywfyEdit.win.js");
