...
function W_Hdfyyshdfygj_Gbh_Ywbh_List() {
    ...
    this.Retrieve = function () {
        ...
        dw_list.Retrieve(gjzt, beginDate.getVarDate(), endDate.getVarDate(), Dlwtf, ysfs, jdr, jsq);
...
//        }
    ...
    this.OpenWindow = function () {
        ...
        if (openStyle == "2")
            ...
            ts_1.Open(node, label, "", "/OpenWindow.aspx?FunID=" + node + '&ywbh=' + ywbh + '&cxh_hddz=' + cxh_hddz + '&yshdfygjbh=' + yshdfygjbh + '&gbh_ywbh=' + gbh_ywbh + '&operation=' + operation.toString(), true);
...
//    }
    ...
    this.Recover = function () {
        ...
        QsWebSoft.PubMethod.DelColRecord("QsWebSoft.Yw_Zjgl.W_Hdfyyshdfygj_Gbh_Ywbh_List", "dw_hddz_hdfyyshdfygj_list");
        self.Retrieve();
    }
    //#endregion
