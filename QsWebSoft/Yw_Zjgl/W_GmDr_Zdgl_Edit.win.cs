...
{
    public partial class W_GmDr_Zdgl_Edit
    {
        public W_GmDr_Zdgl_Edit()
        {
        ...
        public override void OnLoad()
        {
            ...
            if (this.Request["zdbm"] != null)
            {
                var zdbm = this.Request["zdbm"].ToString();
                this.SetParm("zdbm", zdbm);
                dw_master.Retrieve(zdbm);
                dw_jzxxx.Retrieve(zdbm); 
            }

            this.RegisterClientScriptInclude("W_Wldw_Select", "/Xt_Popwin/W_Wldw_Select.win.js"); 
            this.RegisterClientScriptInclude("W_GmDr_Zdgl_Edit", "/Szyw/W_GmDr_Zdgl_Edit.win.js");
