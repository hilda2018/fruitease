...
//    }
    ...
    this.Delete = function () {
        ...
        if (requestor.MessageBox("提示", "删除空运空港提货费用申请单号为<" + sqdbh + ">,是否确定?", ICON.Question, BUTTON.YesNo) == 2)
            return;
    ...
    this.Recover = function () {
        ...
        QsWebSoft.PubMethod.DelColRecord("QsWebSoft.Yw_Zjgl.W_HdfykykgthfyList", "dw_hddz_hdfykykgthfy_list");
        self.Retrieve();
    }
    //#endregion
 ...
 //#region 提交
    this.Tj = function () {
        ...
        if (sfsp == "Y") {
            ...
            num = QsWebSoft.PubMethod.GenFksqdKytdJzxxx(sqdbh).value;
        }
