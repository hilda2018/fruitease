...
function W_HdfyjydfyyfkEdit() {
    ...
    //#region 变量定义
    var editMode = "";
    var iw_Hddz_Jydfyyfk_Select = null;
    ...
    webReq.SetWebServiceUrl("/Service/Hdfyjydfyyfk.ashx");
    ...
    this.Save = function () {
        ...
        var yfkdbh = dw_master.GetItemString(row, "yfkdbh");
        ...
        for (row = dw_jzxxx.RowCount(); row > 0; row--) {
            dw_jzxxx.SetItem(row, "yfkdbh", yfkdbh);
            dw_jzxxx.SetItem(row, "sqdbh", yfkdbh);
        ...
        webReq.Invoke("Save", "dw_master=" + dw_master_data + "&dw_jzxxx=" + dw_jzxxx_data + "&yfkdbh=" + yfkdbh + "&operation=" + editMode);

        if (webReq.StatusCode() == 200) {
            //服务器成功处理，返回单号
            sqdbh = webReq.ResponseText();
            dw_master.SetItem(1, "yfkdbh", yfkdbh);
...
//    //#region
//    this.dw_jzxxx_Retrieve = function () {
//        var ywbh = requestor.GetParm("ywbh"); 
//        var li_rowcount = ds_2.Retrieve(ywbh); 
//        for (i = 1; i <= li_rowcount; i++) {
//            var ll_insertrow = dw_jzxxx.InsertRow(0);
//            dw_jzxxx.SetItem(ll_insertrow, "ywbh", ds_2.GetItemString(i, "ywbh"));
//            dw_jzxxx.SetItem(ll_insertrow, "hth", ds_2.GetItemString(i, "hth"));
//            dw_jzxxx.SetItem(ll_insertrow, "khbm", ds_2.GetItemString(i, "khbm"));
//            dw_jzxxx.SetItem(ll_insertrow, "khmc", ds_2.GetItemString(i, "khmc"));
//            dw_jzxxx.SetItem(ll_insertrow, "khjc", ds_2.GetItemString(i, "khjc"));
//            dw_jzxxx.SetItem(ll_insertrow, "khpym", ds_2.GetItemString(i, "khpym"));
//            dw_jzxxx.SetItem(ll_insertrow, "jzxh", ds_2.GetItemString(i, "jzxxx_jzxh"));
//            dw_jzxxx.SetItem(ll_insertrow, "tgdh", ds_2.GetItemString(i, "tgdh"));
//            dw_jzxxx.SetItem(ll_insertrow, "zhlx", ds_2.GetItemString(i, "jzxxx_zhlx"));
//            dw_jzxxx.SetItem(ll_insertrow, "tpxx", ds_2.GetItemNumber(i, "jzxxx_tpxx"));
//            dw_jzxxx.SetItem(ll_insertrow, "jyd_bz", ds_2.GetItemString(i, "jzxxx_jyd_bz"));
//            dw_jzxxx.SetItem(ll_insertrow, "jydbm", ds_2.GetItemString(i, "jzxxx_jyd_bm"));
//            dw_jzxxx.SetItem(ll_insertrow, "jydmc", ds_2.GetItemString(i, "jzxxx_jyd_mc"));
//            dw_jzxxx.SetItem(ll_insertrow, "jydjc", ds_2.GetItemString(i, "jzxxx_jyd_jc"));
//            dw_jzxxx.SetItem(ll_insertrow, "jydpym", ds_2.GetItemString(i, "jzxxx_jyd_pym"));
//            tgjysj = ds_2.GetItemDate(i, "jzxxx_tgjysj")
//            if (new Date(tgjysj) > new Date("1900/1/1")) {
//                dw_jzxxx.SetItem(ll_insertrow, "tgjysj", ds_2.GetItemDate(i, "jzxxx_tgjysj"));
//                dw_jzxxx.SetItem(ll_insertrow, "fkts", ds_2.GetItemNumber(i, "fkts"));
//            }
//            dw_jzxxx.SetItem(ll_insertrow, "ztdh", ds_2.GetItemString(i, "ztdh"));
//            dw_jzxxx.SetItem(ll_insertrow, "ftdh", ds_2.GetItemString(i, "ftdh"));

//            dw_jzxxx.SetItem(ll_insertrow, "ysfs", ds_2.GetItemString(i, "ysfs"));
//            dw_jzxxx.SetItem(ll_insertrow, "zydl", ds_2.GetItemString(i, "zydl"));
//            dw_jzxxx.SetItem(ll_insertrow, "zfdxbm", ds_2.GetItemString(i, "jzxxx_jyd_bm"));
//            dw_jzxxx.SetItem(ll_insertrow, "zfdxmc", ds_2.GetItemString(i, "jzxxx_jyd_mc"));
//            dw_jzxxx.SetItem(ll_insertrow, "zfdxjc", ds_2.GetItemString(i, "jzxxx_jyd_jc"));
//            dw_jzxxx.SetItem(ll_insertrow, "zfdxpym", ds_2.GetItemString(i, "jzxxx_jyd_pym"));
...
//    //#endregion
    ...
    this.InsertRow = function () {
        if (iw_Hddz_Jydfyyfk_Select == null)
            iw_Hddz_Jydfyyfk_Select = new W_Hddz_Jydfyyfk_Select();
        var ShareMode = requestor.GetParm("ShareMode");
        var ywy = requestor.GetParm("userid");
        var Dlwtf = requestor.GetParm("Dlwtf");
        row = dw_jzxxx.InsertRow(dw_jzxxx.GetRow());
        var dwo = dw_jzxxx.GetDataObject();
        iw_Hddz_Jydfyyfk_Select.SetRow(row);
        iw_Hddz_Jydfyyfk_Select.SetDwo(dwo);
        iw_Hddz_Jydfyyfk_Select.SetDetailDW(dw_jzxxx);
        requestor.Open("/LoadWindow.ashx?WinName=Xt_Popwin.W_Hddz_Jydfyyfk_Select&ShareMode=" + ShareMode + '&ywy=' + ywy + '&Dlwtf=' + Dlwtf, iw_Hddz_Jydfyyfk_Select);
    ...
    this.AddRow = function () {
        ...
        alert("张三");
        requestor.Open("/LoadWindow.ashx?WinName=Xt_Popwin.W_Hddz_Jydfyyfk_Select&ShareMode=" + ShareMode + '&ywy=' + ywy + '&Dlwtf=' + Dlwtf, iw_Hddz_Jydfyyfk_Select);
        // requestor.Open("/LoadWindow.ashx?WinName=Xt_Popwin.W_Hddz_Scfy_Select&ShareMode=" + ShareMode + '&ywy=' + ywy + '&Dlwtf=' + Dlwtf, iw_Hddz_Jydfyyfk_Select);
        alert("李四");
    }
    ...
    this.Print = function () {
        ...
        dw_print.SetDataObject("dw_hddz_hdfyjydfy_print");
    ...
    this.dw_jzxxx_ItemChanged = function (row, dwoName, data) {
        if (dwoName == "fybm") {
            var ywbh = dw_jzxxx.GetItemString(row, "ywbh")
            var sqdbh = dw_master.GetItemString(1, "yfkdbh")
            var ysfs = dw_jzxxx.GetItemString(row, "ysfs")
            var jzxh = dw_jzxxx.GetItemString(row, "jzxh")
            var tpxx = dw_jzxxx.GetItemNumber(row, "tpxx")
            ...
            if (ysfs == "海运") {
                ...
                for (var rowfind = 1; rowfind <= dw_jzxxx.RowCount(); rowfind++) {
                    if (dw_jzxxx.Find("ywbh = '" + ywbh + "' and jzxh = '" + jzxh + "' and  fybm = '" + data + "'", rowfind, rowfind) > 0) {
                        fkcs++
                    }
                };
            } else {
                ...
                for (var rowfind = 1; rowfind <= dw_jzxxx.RowCount(); rowfind++) {
                    if (dw_jzxxx.Find("ywbh = '" + ywbh + "' and tpxx = " + tpxx + " and zhlx = '" +zhlx + "' and  fybm = '" + data + "'", rowfind, rowfind) > 0) {
                        fkcs++
                    }
                };
            }            
