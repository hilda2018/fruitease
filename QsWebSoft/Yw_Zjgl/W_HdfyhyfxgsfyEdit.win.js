...
function W_HdfyhyfxgsfyEdit() {
    ...
    var ds_fxf = new DataStore(requestor);
    ...
    this.bind = function (win) {
        ...
        if (ds_fxf == null) ds_fxf = new DataStore(requestor);
        ds_fxf.Attach(win.Control("ds_fxf"));
    ...
    //#region 变量定义
    var editMode = "";
    var iw_Hddz_Hyfxgsfy_Select = null;
    ...
    webReq.SetWebServiceUrl("/Service/Hdfyhyfxgsfy.ashx");
    ...
    this.InsertRow = function () {
        if (iw_Hddz_Hyfxgsfy_Select == null)
            iw_Hddz_Hyfxgsfy_Select = new W_Hddz_Hyfxgsfy_Select();
        var ShareMode = requestor.GetParm("ShareMode");
        var ywy = requestor.GetParm("userid");
        var Dlwtf = requestor.GetParm("Dlwtf");
        row = dw_jzxxx.InsertRow(dw_jzxxx.GetRow());
        var dwo = dw_jzxxx.GetDataObject();
        iw_Hddz_Hyfxgsfy_Select.SetRow(row);
        iw_Hddz_Hyfxgsfy_Select.SetDwo(dwo);
        iw_Hddz_Hyfxgsfy_Select.SetDetailDW(dw_jzxxx);
        requestor.Open("/LoadWindow.ashx?WinName=Xt_Popwin.W_Hddz_Hyfxgsfy_Select&ShareMode=" + ShareMode + '&ywy=' + ywy + '&Dlwtf=' + Dlwtf, iw_Hddz_Hyfxgsfy_Select);
    ...
    this.Print = function () {
        ...
        dw_print.SetDataObject("dw_hddz_hdfyhyfxgsfy_print");
    ...
    this.dw_master_Clicked = function (xPos, yPos, Row, dwoName) {
        ...
        if (dwoName == "sjskrbm_t") {
            ...
            iw_Wldw_Select.SetData("hdfyhyfxgsfy_sjskr");
        ...
        if (dwoName == "sjskrkhyh_t") {
            ...
            iw_Wldw_Yh_Select.SetData("hdfyhyfxgsfy_sjskryh");
    ...
    this.dw_jzxxx_DoubleClicked = function (xPos, yPos, Row, dwoName) {
        if (dwoName == "zfdxjc") {
            ...
            iw_Wldw_Zfdx_Select.SetData("hdfyhyfxgsfy_zfdx");
    ...
    this.dw_jzxxx_ItemChanged = function (row, dwoName, data) {      
        if (dwoName == "fybm") {
           ...
           for (var rowfind = 1; rowfind <= dw_jzxxx.RowCount(); rowfind++) {
            ...
            var hdf = ds_fxf.Retrieve(cdgsjc, cyrjc, xx, xl, data, yjkgsj.getVarDate(), je, jzxsl);
            if (hdf == 0) {
