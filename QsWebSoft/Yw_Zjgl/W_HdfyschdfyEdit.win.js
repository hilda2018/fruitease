...
function W_HdfyschdfyEdit() {
    ...
    webReq.SetWebServiceUrl("/Service/Hdfyschdfy.ashx");
    ...
    this.InsertRow = function () {
        if (iw_Hddz_Scfy_Select == null)
            iw_Hddz_Scfy_Select = new W_Hddz_Schdfy_Select();
        ...
        requestor.Open("/LoadWindow.ashx?WinName=Xt_Popwin.W_Hddz_Schdfy_Select&ShareMode=" + ShareMode + '&ywy=' + ywy + '&Dlwtf=' + Dlwtf, iw_Hddz_Scfy_Select);
    ...
    this.Print = function () {
        ...
        dw_print.SetDataObject("dw_hddz_hdfyschdfy_print");
