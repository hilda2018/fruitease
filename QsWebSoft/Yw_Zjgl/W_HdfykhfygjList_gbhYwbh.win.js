...
function W_HdfykhfygjList_gbhYwbh() {
    ...
    webReq.SetWebServiceUrl("/Service/Hdfykhfygj.ashx");   
    ...
    this.Retrieve = function () {
        ...
        dw_list.Retrieve(kgzt, beginDate.getVarDate(), endDate.getVarDate(), Dlwtf);
    ...
    this.OpenWindow = function () {
        ...
        var gbh_ywbh = dw_list.GetItemString(dw_list.GetRow(), 'gbh_ywbh');
        ...
        if (openStyle == "2")
            ...
            ts_1.Open(node, label, "", "/OpenWindow.aspx?FunID=" + node + '&ywbh=' + ywbh + '&cxh=' + cxh + '&gbh_ywbh=' + gbh_ywbh + '&operation=' + operation.toString(), true);
