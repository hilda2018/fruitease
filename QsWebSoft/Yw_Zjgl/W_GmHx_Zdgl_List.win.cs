...
{
    public partial class W_GmHx_Zdgl_List 
    {
        public W_GmHx_Zdgl_List()
        {
        }
        public override void OnLoad()
        {
            ...
            // 数据检索
            this.dw_list.Retrieve("N", DateTime.Parse(this.dp_begin.Value.ToString()), DateTime.Parse(this.dp_end.Value.ToString()));
            //注册相关的js文件
            this.RegisterClientScriptInclude("ExtPB_Demo", "/Beta3/ExtPB_Demo.js");  

            this.RegisterClientScriptInclude("W_GmHx_Zdgl_List", "/Yw_Zjgl/W_GmHx_Zdgl_List.win.js");
                //this.RegisterClientScriptInclude("W_GmDr_Zdgl_Edit", "/Yw_Zjgl/W_GmDr_Zdgl_Edit.win.js");
