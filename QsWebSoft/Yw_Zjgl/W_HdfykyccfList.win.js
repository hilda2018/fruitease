...
function W_HdfykyccfList() {
    ...
    webReq.SetWebServiceUrl("/Service/Hdfykyccf.ashx");   
...
//    }
    ...
    this.Delete = function () {
        ...
        if (requestor.MessageBox("提示", "删除空运仓储费编号为<" + sqdbh + ">,是否确定?", ICON.Question, BUTTON.YesNo) == 2)
            return;
    ...
    this.Print = function () {
        ...
        dw_print.SetDataObject("dw_hddz_hdfykyccf_print");
