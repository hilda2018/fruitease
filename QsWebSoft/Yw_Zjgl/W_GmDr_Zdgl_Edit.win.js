...
//        if (iW_GmDr_Zdgl_Edit_pop == null)
//            iW_GmDr_Zdgl_Edit_pop = new W_GmDr_Zdgl_Edit_pop();
...
//        iW_GmDr_Zdgl_Edit_pop.SetRow(row);
//        iW_GmDr_Zdgl_Edit_pop.SetDwo(dwo);
//        iW_GmDr_Zdgl_Edit_pop.SetDetailDW(dw_jzxxx);
//        requestor.Open("/LoadWindow.ashx?WinName=Xt_Popwin.W_GmDr_Zdgl_Edit_pop&ShareMode=" + ShareMode + '&ywy=' + ywy + '&Dlwtf=' + Dlwtf + '&Sjskrbm=' + Sjskrbm, iW_GmDr_Zdgl_Edit_pop);
...
//            var dwo = dw_jzxxx.GetDataObject();
//            var Sjskrbm = dw_master.GetItemString(1, "sjskrbm");
//            iW_GmDr_Zdgl_Edit_pop.SetRow(0);
//            iW_GmDr_Zdgl_Edit_pop.SetDwo(dwo);
//            iW_GmDr_Zdgl_Edit_pop.SetDetailDW(dw_jzxxx);
//            requestor.Open("/LoadWindow.ashx?WinName=Yw_Zjgl.W_GmDr_Zdgl_Edit_pop&ShareMode=" + ShareMode + '&ywy=' + ywy + '&Dlwtf=' + Dlwtf + '&Sjskrbm=' + Sjskrbm, iW_GmDr_Zdgl_Edit_pop);
