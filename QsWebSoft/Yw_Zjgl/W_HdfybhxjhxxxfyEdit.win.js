...
function W_HdfybhxjhxxxfyEdit() {
    ...
    //#region 变量定义
    var editMode = "";
    var iw_Hddz_Bhxjhxxxfy_Select = null;
    ...
    webReq.SetWebServiceUrl("/Service/Hdfybhxjhxxxfy.ashx");
    ...
    this.InsertRow = function () {
        if (iw_Hddz_Bhxjhxxxfy_Select == null)
            iw_Hddz_Bhxjhxxxfy_Select = new W_Hddz_Bhxjhxxxfy_Select();
        var ShareMode = requestor.GetParm("ShareMode");
        var ywy = requestor.GetParm("userid");
        var Dlwtf = requestor.GetParm("Dlwtf");
        row = dw_jzxxx.InsertRow(dw_jzxxx.GetRow());
        var dwo = dw_jzxxx.GetDataObject();
        iw_Hddz_Bhxjhxxxfy_Select.SetRow(row);
        iw_Hddz_Bhxjhxxxfy_Select.SetDwo(dwo);
        iw_Hddz_Bhxjhxxxfy_Select.SetDetailDW(dw_jzxxx);
        requestor.Open("/LoadWindow.ashx?WinName=Xt_Popwin.W_Hddz_Bhxjhxxxfy_Select&ShareMode=" + ShareMode + '&ywy=' + ywy + '&Dlwtf=' + Dlwtf, iw_Hddz_Bhxjhxxxfy_Select);
    ...
    this.Print = function () {
        ...
        dw_print.SetDataObject("dw_hddz_hdfybhxjhxxxfy_print");
    ...
    this.dw_master_Clicked = function (xPos, yPos, Row, dwoName) {
        ...
        if (dwoName == "sjskrbm_t") {
            ...
            iw_Wldw_Select.SetData("hdfybhxjhxxxfy_sjskr");
        ...
        if (dwoName == "sjskrkhyh_t") {
            ...
            iw_Wldw_Yh_Select.SetData("hdfybhxjhxxxfy_sjskryh");
    ...
    this.dw_jzxxx_DoubleClicked = function (xPos, yPos, Row, dwoName) {
        if (dwoName == "zfdxjc") {
            ...
            iw_Wldw_Zfdx_Select.SetData("hdfybhxjhxxxfy_zfdx");
