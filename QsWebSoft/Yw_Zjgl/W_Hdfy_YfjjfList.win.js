...
//    }
    ...
    this.Recover = function () {
        ...
        QsWebSoft.PubMethod.DelColRecord("QsWebSoft.Yw_Zjgl.W_Hdfy_YfjjfList", "dw_hddz_yfjjf_list");
        self.Retrieve();
    }
    //#endregion
    ...
    this.Tj = function () {
        ...
        if (state == "提交") {
            var sqdbh = dw_list.GetItemString(row, "sqdbh")
            var num = QsWebSoft.PubMethod.GenYfjjf(sqdbh,"新制").value;
            if (num == "1") {
            ...
            var sqdbh = dw_list.GetItemString(row, "sqdbh")
            var num = QsWebSoft.PubMethod.GenYfjjf(sqdbh,"提交").value;
            if (num == "1") {
                dw_list.SetItem(row, "state", "提交")
