...
function W_HdfykycdfyEdit() {
    ...
    //#region 变量定义
    var editMode = "";
    var iw_Hddz_Kycdfy_Select = null;
    ...
    webReq.SetWebServiceUrl("/Service/Hdfykycdfy.ashx");
    ...
    this.InsertRow = function () {
        if (iw_Hddz_Kycdfy_Select == null)
            iw_Hddz_Kycdfy_Select = new W_Hddz_Kycdfy_Select();
        ...
        if (Sjskrbm == null || Sjskrbm == "") {
            requestor.MessageBox("提示", "请选择实际收款人");
            return;
        }
        iw_Hddz_Kycdfy_Select.SetRow(row);
        iw_Hddz_Kycdfy_Select.SetDwo(dwo);
        iw_Hddz_Kycdfy_Select.SetDetailDW(dw_jzxxx);
        requestor.Open("/LoadWindow.ashx?WinName=Xt_Popwin.W_Hddz_Kycdfy_Select&ShareMode=" + ShareMode + '&ywy=' + ywy + '&Dlwtf=' + Dlwtf + '&Sjskrbm=' + Sjskrbm, iw_Hddz_Kycdfy_Select);
    ...
    this.Print = function () {
        ...
        dw_print.SetDataObject("dw_hddz_hdfykycdfy_print");
...
//        dw_jzxxx.InsertRow(0);
    ...
    this.dw_master_Clicked = function (xPos, yPos, Row, dwoName) {
        ...
        if (dwoName == "sjskrbm_t") {
            ...
            iw_Wldw_Select.SetData("hdfykycdfy_sjskr");
        ...
        if (dwoName == "sjskrkhyh_t") {
            ...
            iw_Wldw_Yh_Select.SetData("hdfykycdfy_sjskryh");
        ...
        if (dwoName == "sqrgsbm_t") {
            ...
            iw_Wldw_Select.SetData("hdfykycd_sqrgsbm");
            requestor.Open("/LoadWindow.ashx?WinName=Xt_Popwin.W_Wldw_Select&ShareMode=" + ShareMode + "&ywy=" + ywy + "&Dlwtf=" + Dlwtf + "&khlx=" + khlx, iw_Wldw_Select);
            dw_master.SetFocus();
        }  
    ...
    this.dw_jzxxx_DoubleClicked = function (xPos, yPos, Row, dwoName) {
        if (dwoName == "zfdxjc") {
            ...
            iw_Wldw_Zfdx_Select.SetData("hdfykycdfy_zfdx");
