...
{ 
    public partial class W_GmHx_DbysList
    {
        public W_GmHx_DbysList()
        {
        }
        public override void OnLoad()
        {
            ...
            dw_log.Retrieve(userid, "drys");
            // 数据检索
            this.dw_list.Retrieve("N", DateTime.Parse(this.dp_begin.Value.ToString()), DateTime.Parse(this.dp_end.Value.ToString()), "还柜日期");
            //注册相关的js文件
            this.RegisterClientScriptInclude("ExtPB_Demo", "/Beta3/ExtPB_Demo.js");
            this.RegisterClientScriptInclude("W_GmHx_DbysList", "/Yw_Zjgl/W_GmHx_DbysList.win.js");
            this.RegisterClientScriptInclude("W_GmHx_DbysEdit", "/Yw_Zjgl/W_GmHx_DbysEdit.win.js");
