...
{
    public partial class W_Hdfy_CzdEdit
    {
        public W_Hdfy_CzdEdit()
        {
        ...
        public override void OnLoad()
        {
            ...
            if (this.Request["czdbh"] != null)
            {
                var czdbh = this.Request["czdbh"].ToString();
                this.SetParm("czdbh", czdbh);
                dw_master.Retrieve(czdbh);
                dw_cmd.Retrieve(czdbh);
              
               
            }

            dw_log.Retrieve(userid, "zdgj");
