...
function W_HdfyfywfyList() {
    ...
    this.Retrieve = function () {
        ...
        dw_list.Retrieve(userid,beginDate.getVarDate(), endDate.getVarDate());
...
//    }
    ...
    this.Copy = function () {
        ...
        if (dw_list.RowCount() <= 0)
            return;
        var ywbh = dw_list.GetItemString(dw_list.GetRow(), 'sqdbh') 
        var operation
            operation = "copy";
 ...
 //#region 提交
    this.Tj = function () {
        ...
        var num = QsWebSoft.PubMethod.GenFksqdFywfyJzxxx(sqdbh).value;
        if (num == "1") {
