...
{ 
    public partial class W_GmHx_Zdcx_List
    {
        public W_GmHx_Zdcx_List()
        {
        }
        public override void OnLoad()
        {
           ...
           // this.dw_list.Retrieve(DateTime.Parse(this.dp_begin.Value.ToString()), DateTime.Parse(this.dp_end.Value.ToString()));
            ...
            this.RegisterClientScriptInclude("W_Yw_ZjglFkglEdit_pop", "/Yw_Zjgl/W_Yw_ZjglFkglEdit_pop.win.js");
            this.RegisterClientScriptInclude("W_Yw_Zjgl_yfzsf", "/Yw_Zjgl/W_Yw_Zjgl_yfzsf.win.js");
            this.RegisterClientScriptInclude("W_Yw_ZjglFkglEdit", "/Yw_Zjgl/W_Yw_ZjglFkglEdit.win.js");
            this.RegisterClientScriptInclude("W_GmHx_Zdcx_List", "/Yw_Zjgl/W_GmHx_Zdcx_List.win.js");
            this.RegisterClientScriptInclude("W_Yw_ZjglFkglEdit_pop", "/Yw_Zjgl/W_Yw_ZjglFkglEdit_pop.win.js");
            this.RegisterClientScriptInclude("W_WlgzsjfkEdit", "/Yw_Zjgl/W_WlgzsjfkEdit.win.js");
            this.RegisterClientScriptInclude("W_WlgzsjfkEdit", "/Yw_Zjgl/W_WlgzsjfkEdit.win.js");
            this.RegisterClientScriptInclude("W_GmHx_Zdcx_List", "/Yw_Zjgl/W_GmHx_Zdcx_List.win.js");
            this.RegisterClientScriptInclude("W_WlgzsjfkEdit", "/Yw_Zjgl/W_WlgzsjfkEdit.win.js");
            this.RegisterClientScriptInclude("W_Yw_Zjgl_Zdcx_Edit", "/Yw_Zjgl/W_Yw_Zjgl_Zdcx_Edit.win.js");
