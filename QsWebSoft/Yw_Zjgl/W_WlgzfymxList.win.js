...
function W_WlgzfymxList() {
	 ...
	 if(typeof( baseBind )=="function") baseBind(win);
		 ...
		 if(typeof(self.slesjskrmc_EditChanged)=="function") 
			 win.AttachEvent("sle_kh","EditChanged",self.slesjskrmc_EditChanged); 

		 if(typeof(self.slefymc_EditChanged)=="function") 
			 win.AttachEvent("sle_hth","EditChanged",self.slefymc_EditChanged); 

		 if(typeof(self.slezfdxmc_EditChanged)=="function") 
			 win.AttachEvent("sle_tdh","EditChanged",self.slezfdxmc_EditChanged); 
    ...
    webReq.SetWebServiceUrl("/Service/Wlgzfymx.ashx");   
    ...
    //#region 过滤支付对象名称
    this.slezfdxmc_EditChanged = function (text) {
        dw_list.SetRedraw(false);
        if (text == "")
            dw_list.SetFilter("");
        else
            dw_list.SetFilter("( Upper(zfdxmc) like Upper('%" + text + "%'))");
        dw_list.Filter();
        dw_list.Sort();
        dw_list.SetRedraw(true);
    }
