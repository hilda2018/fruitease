...
function W_WlgzJzxlrcxList() {
    ...
    var ddlb_yszt = new DropDownListBox(requestor);
    ...
    this.bind = function (win) {
        ...
        if (ddlb_yszt == null) ddlb_yszt = new DropDownListBox(requestor);
        ddlb_yszt.Attach(win.Control("ddlb_yszt"));
        ...
        if (typeof (self.Retrieve) == "function")
            win.AttachEvent("ddlb_yszt", "SelectionChanged", self.Retrieve);
    ...
    this.unbind = function () {
        ...
        ddlb_yszt.Detach(); ddlb_yszt = null;
    ...
    this.Retrieve = function () {
        ...
        dw_list.Retrieve(beginDate.getVarDate(), endDate.getVarDate(), yszt, yfzt, jdrjc);
    ...
    this.dw_List_ItemChanged = function (row, dwoName, data) {
        var date = new Date();
        if (dwoName == "yw_hddz_jzxxx_lrcx_qrbz") {
            dw_list.SetItem(row, "yw_hddz_jzxxx_lrcx_qrrq", date.getVarDate())
...
//    }
    ...
    this.Save = function () {
        ...
        //执行保存的WebService
        webReq.SetFunctionID(requestor.GetFunctionID());
        webReq.Invoke("jzxlrcxListSave", "dw_list=" + dw_d_data);
