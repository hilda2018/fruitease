...
function W_DrDbysEdit() {
    ...
    webReq.SetWebServiceUrl("/Service/GmDr_Dbys.ashx");
    ...
    this.PostOpen = function () {
        ...
        dw_master.SetItem(1, "lr", compute_3 - je_sum);
    ...
    this.Save = function () {
        ...
        webReq.Invoke("Save", "dw_master=" + dw_master_data + "&dw_jzxxx=" + dw_jzxxx_data + "&dw_log=" + dw_log_data + "&dw_cb_cmd=" + dw_cb_cmd_data + "&yshdfygjbh=" + yshdfygjbh + "&operation=" + editMode);
