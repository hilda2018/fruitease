...
function W_HdfyjyfyEdit() {
    ...
    webReq.SetWebServiceUrl("/Service/Hdfyjyfy.ashx");
    ...
    this.InsertRow = function () {
        if (iw_Hddz_Jyfy_Select == null)
            iw_Hddz_Jyfy_Select = new W_Hddz_Jyfy_Select();
        var ShareMode = requestor.GetParm("ShareMode");
        var ywy = requestor.GetParm("userid");
        var Dlwtf = requestor.GetParm("Dlwtf");
        row = dw_jzxxx.InsertRow(dw_jzxxx.GetRow());
        var dwo = dw_jzxxx.GetDataObject();
        iw_Hddz_Jyfy_Select.SetRow(row);
        iw_Hddz_Jyfy_Select.SetDwo(dwo);
        iw_Hddz_Jyfy_Select.SetDetailDW(dw_jzxxx);
        requestor.Open("/LoadWindow.ashx?WinName=Xt_Popwin.W_Hddz_Jyfy_Select&ShareMode=" + ShareMode + '&ywy=' + ywy + '&Dlwtf=' + Dlwtf, iw_Hddz_Jyfy_Select);
    ...
    this.Print = function () {
        ...
        dw_print.SetDataObject("dw_hddz_hdfyjyfy_print");
...
//        dw_jzxxx.InsertRow(0);
    ...
    this.dw_master_Clicked = function (xPos, yPos, Row, dwoName) {
        ...
        if (dwoName == "sjskrbm_t") {
            ...
            iw_Wldw_Select.SetData("hdfyjyfy_sjskr");
        ...
        if (dwoName == "sjskrkhyh_t") {
            ...
            iw_Wldw_Yh_Select.SetData("hdfyjyfy_sjskryh");
        ...
        if (dwoName == "sqrgsbm_t") {
            ...
            iw_Wldw_Select.SetData("hdfyjyfy_sqrgs");
            requestor.Open("/LoadWindow.ashx?WinName=Xt_Popwin.W_Wldw_Select&ShareMode=" + ShareMode + "&ywy=" + ywy + "&Dlwtf=" + Dlwtf + "&khlx=" + khlx, iw_Wldw_Select);
            dw_master.SetFocus();
