...
function W_SzywFkglEdit() {
    ...
    this.InsertRow = function () {
        if (iW_SzywFkglEdit_pop == null)
            iW_SzywFkglEdit_pop = new W_SzywFkglEdit_pop();
        ...
        iW_SzywFkglEdit_pop.SetRow(row);
        iW_SzywFkglEdit_pop.SetDwo(dwo);
        iW_SzywFkglEdit_pop.SetDetailDW(dw_jzxxx);
        requestor.Open("/LoadWindow.ashx?WinName=Xt_Popwin.W_SzywFkglEdit_pop&ShareMode=" + ShareMode + '&ywy=' + ywy + '&Dlwtf=' + Dlwtf + '&Sjskrbm=' + Sjskrbm, iW_SzywFkglEdit_pop);
...
//            alert("fkcs = " + fkcs);
    ...
    this.AddRow = function () {
        if (iW_SzywFkglEdit_pop == null)
            ...
            var Dlwtf = requestor.GetParm("Dlwtf");     
            var Sjskrbm = dw_master.GetItemString(1, "sjskrbm");
            iW_SzywFkglEdit_pop.SetRow(0);
            iW_SzywFkglEdit_pop.SetDwo(dw_master);
            iW_SzywFkglEdit_pop.SetDetailDW(dw_jzxxx);
            requestor.Open("/LoadWindow.ashx?WinName=Szyw.W_SzywFkglEdit_pop&ShareMode=" + ShareMode + '&ywy=' + ywy + '&Dlwtf=' + Dlwtf + '&Sjskrbm=' + Sjskrbm, iW_SzywFkglEdit_pop);
...
//        dw_jzxxx.InsertRow(0);
    ...
    this.dw_master_Clicked = function (xPos, yPos, Row, dwoName) {
        ...
        if ( dwoName == "zfyh_t" )
        {
            ...
            var Dlwtf = requestor.GetParm( "Dlwtf" );
            iw_Wldw_Yh_Select.SetDataWindow( dw_master );
            iw_Wldw_Yh_Select.SetData( "szywfkgl_zfyh" );
