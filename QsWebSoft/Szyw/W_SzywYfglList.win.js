...
//    }
    ...
    this.Delete = function () {
        ...
        if (requestor.MessageBox("提示", "删除应付管理应付单号为<" + yfkdbh + ">,是否确定?", ICON.Question, BUTTON.YesNo) == 2)
            return;
...
//    }
    ...
    this.Recover = function () {
        ...
        QsWebSoft.PubMethod.DelColRecord("QsWebSoft.Szyw.W_SzywYfglList", "dw_szyw_sjyf_list");
        self.Retrieve();
    }
    //#endregion
    ...
    this.Tj = function () {
        ...
        var yfkdbh = dw_list.GetItemString(row, "yfkdbh")
        var num = 0;
        num = QsWebSoft.PubMethod.GenFksqdJzxxx_bp(yfkdbh).value;
        if (num == "1") {
