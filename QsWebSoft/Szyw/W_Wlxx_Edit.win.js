...
function W_Wlxx_Edit() {
    ...
    webReq.SetWebServiceUrl("/Service/Szyw_Wlxx.ashx");
        ...
        if ( dwoName == "xgjb_t" )
                {
                    ...
                    {
                        zdmc = zdmc + ',' + "xgjbbm,xgjb";
                    };  
                    
                    iw_Wldw_Select_Sz.SetDataWindow( dw_master );
                    iw_Wldw_Select_Sz.SetData( "wlxx_xgjb" );
                ...
                if ( dwoName == "szjb_t" )
                {
                    ...
                    {
                        zdmc = zdmc + ',' + "szjbbm,szjb";
                    };

                    iw_Wldw_Select_Sz.SetDataWindow( dw_master );
                    iw_Wldw_Select_Sz.SetData( "wlxx_szjb" );
...
//            iw_Wldw_Select.SetData( "hddz_kh_sz" );
...
//            iw_Wldw_Select.SetDataWindow( dw_master );
//            iw_Wldw_Select.SetData( "ywxx_sxkh" );
...
//        }
    ...
    this.dw_master_ItemChanged = function ( row, dwoName, data )
    {
        ...
        if ( dwoName == "tgrq" )
        {
            dw_jzxxx.SetItem( 1, "cgqsj", data );
            dw_wlgz_cmd.SetItem( 1, "cdzwlsj", data);
        }

        if ( dwoName == "jhrq" )
        {
            dw_jzxxx.SetItem( 1, "rscsj", data );
            dw_wlgz_cmd.SetItem( 2, "jrdwlsj", data );
        }

        if ( dwoName == "clxx" )
        {
            dw_jzxxx.SetItem( 1, "gq_cp", data );
            dw_wlgz.SetItem( 1, "cph", data );
        }

        if ( dwoName == "jhdd" )
        {
            dw_wlgz_cmd.SetItem( 2, "dz_xx", data );
        }
    ...
    this.dw_master_EditChanged = function ( row, dwoName, data )
    {
        ...
        if ( dwoName == "clxx" )
        {
            dw_master.GetChild( "clxx", dwc );
            dwc.Retrieve( data );
        }

        if ( dwoName == "xgcp" )
        {
            dw_master.GetChild( "xgcp", dwc );
            dwc.Retrieve( data );
        }
        ...
        if ( dwoName == "hgcp" )
        {
            dw_master.GetChild( "hgcp", dwc );
            dwc.Retrieve( data );
        }
        if ( dwoName == "hgtjhm" )
        {
            dw_master.GetChild( "hgtjhm", dwc );
            dwc.Retrieve( data );
        }
    }
    //#endregion
    ...
    this.Recover = function ()
    {
        ...
        QsWebSoft.PubMethod.DelColRecord( "QsWebSoft.Hddz.W_Wlxx_Edit", "dW_Wlxx_Edit" );
        self.Retrieve();
    }
    //#endregion
    ...
    this.Recover_spxx = function ()
    {
        ...
        QsWebSoft.PubMethod.DelColRecord( "QsWebSoft.Hddz.W_Wlxx_Edit", "dW_Wlxx_Edit_spxx" );
        self.Retrieve();
    }
    //#endregion
