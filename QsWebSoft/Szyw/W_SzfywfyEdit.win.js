...
function W_SzfywfyEdit() {
	 ...
	 var ds_fybxtt= new DataStore( requestor );
	 ...
	 if(typeof( baseBind )=="function") baseBind(win);
		 ...
		 if(ds_fybxtt == null ) ds_fybxtt= new DataStore( requestor );
		 ds_fybxtt.Attach( win.Control( "ds_fybxtt") ); 
	 ...
	 if(typeof(baseUnBind)=="function") baseUnBind(); 
		 ...
		 ds_fybxtt.Detach(); ds_fybxtt=null; 
    ...
    webReq.SetWebServiceUrl("/Service/Szfywfy.ashx");
...
//            dw_master.Modify("DataWindow.Readonly=yes");
    ...
    this.Save = function () {
        ...
        if (dw_master.GetItemString(1, "sfyp") == null || dw_master.GetItemString(1, "sfyp") == "") {
            requestor.MessageBox("", "请选择有无发票!");
            return;
        }
        ...
        for (row = dw_jzxxx.RowCount(); row > 0; row--) {
            ...
            dw_jzxxx.SetItem(row, "jdrbm", jdrbm);
            dw_jzxxx.SetItem(row, "jdrmc", jdrmc);
            dw_jzxxx.SetItem(row, "jdrjc", jdrjc);
            dw_jzxxx.SetItem(row, "jdrpym", jdrpym);
        }
    ...
    this.Print = function () {
        ...
        dw_print.SetDataObject("dw_hddz_hdfyfywfy_print");
...
//        var li_rowcount = ds_fybxtt.Retrieve(userid);
//        if (li_rowcount > 0) {
//            var sqrgsbm = ds_fybxtt.GetItemString(1, "yw_khbm");
//            var sqrgsmc = ds_fybxtt.GetItemString(1, "khmc");
//            var sqrgsjc = ds_fybxtt.GetItemString(1, "khjc");
//            var sqrgspym = ds_fybxtt.GetItemString(1, "pym");

//            dw_master.SetItem(1, 'sqrgsbm', sqrgsbm);
//            dw_master.SetItem(1, 'sqrgsmc', sqrgsmc);
//            dw_master.SetItem(1, 'sqrgsjc', sqrgsjc);
//            dw_master.SetItem(1, 'sqrgspym', sqrgspym);
...
//        }
    ...
    this.dw_master_Clicked = function (xPos, yPos, Row, dwoName) {
        ...
        if (dwoName == "sqrgsmc_t") {
            ...
            iw_Wldw_Select.SetData("hdfyfywfy_sqr");
            requestor.Open("/LoadWindow.ashx?WinName=Xt_Popwin.W_Wldw_Select&ShareMode=" + ShareMode + "&ywy=" + ywy + "&Dlwtf=" + Dlwtf + "&khlx=" + khlx, iw_Wldw_Select);
            dw_master.SetFocus();
        ...
        if ( dwoName == "zfyh_t" )
        {
            ...
            var Dlwtf = requestor.GetParm( "Dlwtf" );
            iw_Wldw_Yh_Select.SetDataWindow( dw_master );
            iw_Wldw_Yh_Select.SetData( "szfywfy_zfyh" );
