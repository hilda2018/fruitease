...
function W_Szyw_yfzsf()
{
    ...
    var em_je = new EditMask( requestor );
    ...
    this.bind = function ( win )
    {
        ...
        if ( em_je == null ) em_je = new EditMask( requestor );
        em_je.Attach( win.Control( "em_je" ) );
        ...
        if ( typeof ( self.cbx_qx_Clicked ) == "function" )
            win.AttachEvent( "cbx_qx", "Clicked", self.cbx_qx_Clicked );

        if ( typeof ( self.em_EditChanged ) == "function" )
            win.AttachEvent( "em_je", "Modified", self.em_EditChanged );
    ...
    webReq.SetWebServiceUrl( "/Service/Szhdfy_sffy.ashx" );  
    ...
    this.Save = function () {
        ...
        webReq.Invoke("Szyw_Yfzsf_Save", "dw_master=" + dw_master_data + "&dw_jzxxx=" + dw_jzxxx_data + "&sqdbh=" + sqdbh + "&operation=" + editMode);
    ...
    this.InsertRow = function () {
        if (iW_Szyw_yfzsf_pop == null)
            iW_Szyw_yfzsf_pop = new W_Szyw_yfzsf_pop();
        ...
        iW_Szyw_yfzsf_pop.SetRow(row);
        iW_Szyw_yfzsf_pop.SetDwo(dwo);
        iW_Szyw_yfzsf_pop.SetDetailDW(dw_jzxxx);
        requestor.Open("/LoadWindow.ashx?WinName=Xt_Popwin.W_Szyw_yfzsf_pop&ShareMode=" + ShareMode + '&ywy=' + ywy + '&Dlwtf=' + Dlwtf + '&Sjskrbm=' + Sjskrbm, iW_Szyw_yfzsf_pop);
    ...
    this.AddRow = function () {
        ...
        dw_jzxxx.Retrieve( sqdbh, sjskrbm,'Y' );

    }
    //#endregion


    this.cbx_qx_Clicked = function ()
    {
        if ( cbx_qx.GetChecked() )
        {
            dw_jzxxx.SetRedraw( false );
            for ( var row = 1; row <= dw_jzxxx.RowCount(); row++ )
            {

                dw_jzxxx.SetItem( row, "xz", "Y" )
            }
            dw_jzxxx.SetRedraw( true );
    ...
    this.em_EditChanged = function ()
    {
      
        var xzje = parseFloat( em_je.GetText());
        dw_jzxxx.SetRedraw( false );
