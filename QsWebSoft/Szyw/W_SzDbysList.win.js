...
//    }
    ...
    this.slejhdd_EditChanged = function ( text )
    {
        ...
        if ( text == "" )
            ...
            dw_list.SetFilter( "( Upper(jhdd) like Upper('%" + text + "%'))" );
        dw_list.Filter();
        dw_list.Sort();
        dw_list.SetRedraw( true );
    }
    ...
    this.Recover = function () {
        ...
        QsWebSoft.PubMethod.DelColRecord("QsWebSoft.Wlxx.W_SzDbysList", "dw_hddz_hdfyhxdcf_list");
        self.Retrieve();
    }
    //#endregion
