...
function W_SzywYfglEdit() {
    ...
    webReq.SetWebServiceUrl("/Service/Wlgzsjyf.ashx");
    ...
    this.Save = function ()
    {
        ...
        {
            requestor.MessageBox( "提示", "请输入应收汇率" );
            return;
        }
        ...
        //        var sfsp_jsl = dw_jzxxx.GetItemString(1, "sfsp_jsl");
        //        dw_master.SetItem(1, "sfsp", sfsp_jsl);
        ...
        for ( row = dw_jzxxx.RowCount(); row > 0; row-- )
        {
            ...
            {
                if ( hz_jzxh.indexOf( jzxh ) < 0 )
                {
                    hz_jzxh = hz_jzxh + "," + jzxh
                }
            }
        }
        ...
        if ( webReq.StatusCode() == 200 )
        {
            ...
            dw_master.Modify( "yfkdbh.Tabsequence=0" );
    ...
    this.InsertRow = function () {
        if (iW_SzywYfglEdit_pop == null)
            iW_SzywYfglEdit_pop = new W_SzywYfglEdit_pop();
        ...
        iW_SzywYfglEdit_pop.SetRow(row);
        iW_SzywYfglEdit_pop.SetDwo(dwo);
        iW_SzywYfglEdit_pop.SetDetailDW(dw_jzxxx);
        requestor.Open("/LoadWindow.ashx?WinName=Xt_Popwin.W_SzywYfglEdit_pop&ShareMode=" + ShareMode + '&ywy=' + ywy + '&Dlwtf=' + Dlwtf + '&Sjskrbm=' + Sjskrbm, iW_SzywYfglEdit_pop);
    ...
    this.AddRow = function () {
        ...
        var Dlwtf = requestor.GetParm("Dlwtf");     
        var Sjskrbm = dw_master.GetItemString(1, "sjskrbm");
        iW_SzywYfglEdit_pop.SetRow(0);
        iW_SzywYfglEdit_pop.SetDwo( dw_master );
        iW_SzywYfglEdit_pop.SetDetailDW(dw_jzxxx);
        requestor.Open("/LoadWindow.ashx?WinName=Szyw.W_SzywYfglEdit_pop&ShareMode=" + ShareMode + '&ywy=' + ywy + '&Dlwtf=' + Dlwtf + '&Sjskrbm=' + Sjskrbm, iW_SzywYfglEdit_pop);
    ...
    this.Print = function () {
        ...
        dw_print.SetDataObject("dw_wlgz_sjyf_print");
...
//        dw_jzxxx.InsertRow(0);
    ...
    this.dw_master_Clicked = function (xPos, yPos, Row, dwoName) {
        ...
        if (dwoName == "sjskrbm_t") {
            ...
            iw_Wldw_Select.SetData("wlgzsjyf_sjskr");
        ...
        if (dwoName == "sjskrkhyh_t") {
            ...
            iw_Wldw_Yh_Select.SetData("wlgzsjyf_sjskryh");
            ...
            iw_Wldw_Select.SetData("wlgzsjyfd_sqrgs");
            requestor.Open("/LoadWindow.ashx?WinName=Xt_Popwin.W_Wldw_Select&ShareMode=" + ShareMode + "&ywy=" + ywy + "&Dlwtf=" + Dlwtf + "&khlx=" + khlx, iw_Wldw_Select);
            dw_master.SetFocus();
        }
        ...
        if ( dwoName == "zfyh_t" )
        {
            if ( iw_Wldw_Yh_Select == null )
                iw_Wldw_Yh_Select = new W_Wldw_Yh_Select();
            var sqrgsbm = dw_master.GetItemString( 1, "sqrgsbm" );
            var ywy = requestor.GetParm( "userid" );
            var ShareMode = requestor.GetParm( "ShareMode" );
            var Dlwtf = requestor.GetParm( "Dlwtf" );
            iw_Wldw_Yh_Select.SetDataWindow( dw_master );
            iw_Wldw_Yh_Select.SetData( "szywyfgl_zfyh" );
    ...
    this.dw_jzxxx_DoubleClicked = function (xPos, yPos, Row, dwoName) {
        if (dwoName == "zfdxjc") {
            ...
            iw_Wldw_Zfdx_Select.SetData("wlgzsjyf_zfdx");
...
//            fkcs = QsWebSoft.PubMethod.ReadSjyfcs(ywbh, jzxh, data, yfkdbh).value;
            ...
            //            var dcjc = dw_jzxxx.GetItemString(row, "fxdcjc");
            //            var xx = dw_jzxxx.GetItemString(row, "xx");
            //            var xl = dw_jzxxx.GetItemString(row, "xl");
            //            var hdcsj = new Date(dw_jzxxx.GetItemDate(row, "hdcsj"));
            //            var je = dw_jzxxx.GetItemNumber(row, "je");

            //            var hydcf = ds_hydcf.Retrieve(dcjc, xx, xl, data, hdcsj.getVarDate(), je);
            //            if (hydcf == 0) {
            //                dw_jzxxx.SetItem(row, "fysfhl", "Y")
            //            } else {
            //                dw_jzxxx.SetItem(row, "fysfhl", "N")
            //            }
        ...
        //            var hydcf = ds_hydcf.Retrieve(dcjc, xx, xl, fybm, hdcsj.getVarDate(), data);
        //            if (hydcf == 0) {
        //                dw_jzxxx.SetItem(row, "fysfhl", "Y")
        //            } else {
        //                dw_jzxxx.SetItem(row, "fysfhl", "N")
    ...
    this.Sp = function () {
        ...
        if (message_num == 1) {
            var num = QsWebSoft.PubMethod.GenFksqdJzxxx_sp(yfkdbh, userid, "提交", "部门审批通过").value;
            if (num == 1) {
                self.Exit();
            }
