...
function W_Hgxx_List() {
    ...
    this.Retrieve = function ()
    {
        ...
        dw_list.Retrieve( beginDate.getVarDate(), endDate.getVarDate(), rqlx, wtkh, xskhmc, ztdh, hz_jzxh, dqzt, bm );
...
//        }
  ...
  function GMTToStr(time){
    ...
    this.Recover = function () {
        ...
        QsWebSoft.PubMethod.DelColRecord("QsWebSoft.Hddz.W_Hgxx_List", "dW_Hgxx_List");
        self.Retrieve();
    }
    //#endregion
