...
{
    public partial class W_SzfywfyList
    {
        public W_SzfywfyList()
        {
        }
        public override void OnLoad()
        {
            ...
            ds_role.Retrieve(userid, "00201702");
            var ckqb = "N";
            if (ds_role.RowCount > 0)
            {
                ckqb = "Y";
            ...
            // 数据检索
            this.dw_list.Retrieve(userid, DateTime.Parse(this.dp_begin.Value.ToString()), DateTime.Parse(this.dp_end.Value.ToString()),"N");
            //注册相关的js文件
            this.RegisterClientScriptInclude("ExtPB_Demo", "/Beta3/ExtPB_Demo.js");
            this.RegisterClientScriptInclude("W_SzfywfyList", "/Szyw/W_SzfywfyList.win.js");
            this.RegisterClientScriptInclude("W_HdfyfywfyEdit", "/Szyw/W_HdfyfywfyEdit.win.js");
