...
{
    public partial class W_Ywxx_List
    {
        public W_Ywxx_List()
        {
        }
        ...
        public override void OnLoad()
        {
            ...
            this.ds_lbgs.Retrieve(userid, "QsWebSoft.Szyw.W_Ywxx_List", "dw_ywxx_list");
            ...
            // 数据检索
            //this.dw_list.Retrieve("单证", DateTime.Parse(this.dp_begin.Value.ToString("yyyy/MM/dd hh:mm")), DateTime.Parse(this.dp_end.Value.ToString("yyyy/MM/dd hh:mm")), "");
            ...
            this.RegisterClientScriptInclude("W_Ywxx_List", "/Hddz/W_Ywxx_List.win.js");
            ...
            this.RegisterClientScriptInclude("W_Lbgs_Edit", "/Szyw/W_Lbgs_Edit.win.js");
