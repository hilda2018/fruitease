...
{
    public partial class W_SzDbysList
    {
        public W_SzDbysList() 
        {
        }
        public override void OnLoad()
        {
            ...
            dw_log.Retrieve(userid, "SzDbys");
            // 数据检索
             this.dw_list.Retrieve("N",DateTime.Parse(this.dp_begin.Value.ToString()), DateTime.Parse(this.dp_end.Value.ToString()),"报关日期");
            //注册相关的js文件
            this.RegisterClientScriptInclude("ExtPB_Demo", "/Beta3/ExtPB_Demo.js");
            this.RegisterClientScriptInclude("W_SzDbysList", "/Szyw/W_SzDbysList.win.js");
            this.RegisterClientScriptInclude("W_SzDbysEdit", "/Szyw/W_SzDbysEdit.win.js");
