...
function W_Ywxx_List() {
	 ...
	 var dw_xfxx_print= new DataWindow( requestor );
	 ...
	 if(typeof( baseBind )=="function") baseBind(win);
		 ...
		 if(dw_xfxx_print == null ) dw_xfxx_print= new DataWindow( requestor );
		 dw_xfxx_print.Attach( win.Control( "dw_xfxx_print") ); 
		 ...
		 if(typeof(self.Xfxx_print)=="function") 
			 win.AttachEvent("btn_xfdy","Clicked",self.Xfxx_print); 
	 ...
	 if(typeof(baseUnBind)=="function") baseUnBind(); 
		 ...
		 dw_xfxx_print.Detach(); dw_xfxx_print=null; 
    ...
    this.Retrieve = function ()
    {
        ...
        if ( czy = userid )
        {
            QsWebSoft.PubMethod.Ywxx_glsc( userid, "dw_ywxx_list" );
            QsWebSoft.PubMethod.Ywxx_gl( userid, "dw_ywxx_list", gwgysmc, hdzt, bgzt, pz, cm, cyr, hz_spmc, mygb, clxx, xgjb, szjb, jhdd, rjka, mtxx, ysfs, lry, hcorhbh );
        } else
        {
            QsWebSoft.PubMethod.Ywxx_glsc( userid, "dw_ywxx_list" );
        }
    ...
    this.OpenWindow = function ()
    {
        ...
        if ( index > 0 )
        {
            requestor.MessageBox( "提示", "模块已经打开，先关闭才能打开！" );
            return;
        }
  ...
  //#region 新增格式
    this.ddlb_gsxz_SelectionChanged = function ( text )
    {
        ...
        QsWebSoft.PubMethod.InsertColRecordLsjl( "QsWebSoft.Szyw.W_Ywxx_List", "dw_ywxx_list", gsxz );
        var wjmc = window.location.href;
...
//        ds_lbgs.Retrieve( userid, "QsWebSoft.Szyw.W_Ywxx_List", "dw_ywxx_list" )
//        ddlb_gsxz.Reset();
...
//        }
    ...
    this.em_gsmc_Modified = function ( text )
    {
        ...
        QsWebSoft.PubMethod.InsertColRecord( "QsWebSoft.Szyw.W_Ywxx_List", "dw_ywxx_list", text );
    ...
    this.Scgs = function ()
    {
         ...
         if ( gsmc != "" && gsmc != null )
        {
            ...
            QsWebSoft.PubMethod.DeleteColRecordLsjl( "QsWebSoft.Szyw.W_Ywxx_List", "dw_ywxx_list", gsmc );
...
//        }
  ...
  function GMTToStr(time){
    ...
    this.Recover = function () {
        ...
        QsWebSoft.PubMethod.DelColRecord( "QsWebSoft.Szyw.W_Ywxx_List", "dw_ywxx_list" );
        self.Retrieve();
    }
    //#endregion
    ...
    //#region 合同打印 
    this.Xfxx_print = function ()
    {
        var ywbh = dw_list.GetItemString( 1, "ywbh" );
        dw_xfxx_print.SetDataObject( "dw_xfxx_print" );
        dw_xfxx_print.Retrieve( ywbh );
        dw_xfxx_print.PrintPreview();
    }
    //#endregion
    ...
    //#endregion
     ...
     //#region
    this.dw_gl_ButtonClicked = function ( Row, dwoName )
    {
        if ( dwoName == "b_cx" )
        {
            self.Retrieve();
