...
{
    public partial class W_SzywYsglEdit_pop
    {
        public W_SzywYsglEdit_pop()
        {
        }
        public override void OnLoad()
        {
            ...
            dw_1.Retrieve(DateTime.Parse(this.dp_begin.Value.ToString("yyyy/MM/dd hh:mm")), DateTime.Parse(this.dp_end.Value.ToString("yyyy/MM/dd hh:mm")), "接单日期");
            dw_list.Retrieve();
            ...
            this.RegisterClientScriptInclude("W_SzywYsglEdit_pop", "/Szyw/W_SzywYsglEdit_pop.win.js");
            ...
            this.RegisterClientScriptInclude("W_Filter", "/Szyw/W_Filter.win.js");
