...
function W_SzywYfglEdit_pop()
{
    ...
    this.bind = function ( win )
    {
        ...
        if ( typeof ( self.dw_List_Clicked ) == "function" )
            win.AttachEvent( "dw_fymc", "Clicked", self.dw_List_Clicked );

        if ( typeof ( self.dw_List_DoubleClicked ) == "function" )
            win.AttachEvent( "dw_fymc", "DoubleClicked", self.dw_List_DoubleClicked );

        if ( typeof ( self.dw_List_DwnMouseMove ) == "function" )
            win.AttachEvent( "dw_fymc", "DwnMouseMove", self.dw_List_DwnMouseMove );

        if ( typeof ( self.dw_List_ItemChanged ) == "function" )
            win.AttachEvent( "dw_fymc", "ItemChanged", self.dw_List_ItemChanged );

        if ( typeof ( self.dw_List_LButtonDown ) == "function" )
            win.AttachEvent( "dw_fymc", "LButtonDown", self.dw_List_LButtonDown );

        if ( typeof ( self.dw_List_MouseMove ) == "function" )
            win.AttachEvent( "dw_fymc", "MouseMove", self.dw_List_MouseMove );

        if ( typeof ( self.RbuttonDown ) == "function" )
            win.AttachEvent( "dw_fymc", "RButtonDown", self.RbuttonDown );
...
//    }
            ...
            if ( xz1 == 'Y' )
            {
                ...
                for ( var j = 1; j <= count1; j++ )
                {
                    ...
                    if ( zx2 == 'Y' )
                    {
                        ...
                        ll_insertrow = yfgl_dw_jzxxx.InsertRow( 0 );
                        yfgl_dw_jzxxx.SetItem( ll_insertrow, "jzxh", hz_jzxh );
                        yfgl_dw_jzxxx.SetItem( ll_insertrow, "ztdh", ztdh );
                        yfgl_dw_jzxxx.SetItem( ll_insertrow, "ywbh", ywbh );
                        yfgl_dw_jzxxx.SetItem( ll_insertrow, "je", mrfy );
                        yfgl_dw_jzxxx.SetItem( ll_insertrow, "wbbb", wbbb );
                        yfgl_dw_jzxxx.SetItem( ll_insertrow, "fymc", fymc );
                        yfgl_dw_jzxxx.SetItem( ll_insertrow, "fybm", fybm );
                        yfgl_dw_jzxxx.SetItem( ll_insertrow, "khjc", khjc );
                        yfgl_dw_jzxxx.SetItem( ll_insertrow, "khbm", khbm );
                        yfgl_dw_jzxxx.SetItem( ll_insertrow, "ycd", ycd );
                        yfgl_dw_jzxxx.SetItem( ll_insertrow, "sjkgsj", sjkgsj );

                        fkcs = QsWebSoft.PubMethod.ReadFycs( ywbh, fybm, "" ).value;

                        yfgl_dw_jzxxx.SetItem( ll_insertrow, "fkcs", fkcs + 1 );
                        if ( fkcs > 1 )
                        {
    ...
    this.Recover = function () {
        ...
        QsWebSoft.PubMethod.DelColRecord( "QsWebSoft.Szyw.W_SzywYfglEdit_pop", "dw_hddz_fklx_list" );
        self.Retrieve();
    }
    //#endregion
