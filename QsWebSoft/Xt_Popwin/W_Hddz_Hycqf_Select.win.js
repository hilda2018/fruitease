...
function W_Hddz_Hycqf_Select() {
    ...
    //获取数据窗口
     ...
     this.OK = function () {
         ...
         //空运车队配货信息
         if (dwo == "dw_hddz_hdfyhycqf_edit_cmd") {
             self.Ky_Cdph();
         };    
     ...
     this.Ky_Cdph = function () {
         ...
         for (row = 1; row <= dw_1.RowCount(); row++) {
             ...
             dw_d.SetItem(ll_insertrow, "mxq", dw_1.GetItemNumber(row, "mxq"));
             dw_d.SetItem(ll_insertrow, "cqts", dw_1.GetItemNumber(row, "cqts"));
             dw_d.SetItem(ll_insertrow, "gscqfje", dw_1.GetItemNumber(row, "gscqfje"));
