...
//                 ll_insertrow = dw_d.InsertRow(0);
	 ...
	 this.sle_EditChanged = function (text) {
	     ...
	     if (text == "")
	         ...
	         dw_1.SetFilter("(Upper(ywbh) like Upper('%" + text + "%')) or (Upper(hz_jzxh) like Upper('%" + text + "%')) or (Upper(hth) like Upper('%" + text + "%')) or (Upper(ztdh) like Upper('%" + text + "%')) or (Upper(ftdh) like Upper('%" + text + "%')) or (Upper(tgdh) like Upper('%" + text + "%'))");
	     dw_1.Filter();
	     dw_1.Sort();
	     dw_1.SetRedraw(true);
	 }
