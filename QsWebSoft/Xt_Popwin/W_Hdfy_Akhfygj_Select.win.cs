...
{
    public partial class W_Hdfy_Akhfygj_Select
    {
        public W_Hdfy_Akhfygj_Select()
        {
        ...
        public override void OnLoad()
        {
            ...
            dw_1.Retrieve(DateTime.Parse(this.dp_begin.Value.ToString()), DateTime.Parse(this.dp_end.Value.ToString()), jdrbm);
