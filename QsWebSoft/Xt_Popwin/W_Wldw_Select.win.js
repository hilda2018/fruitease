...
function W_Wldw_Select() {
    ...
    this.OK = function ()
    {
        ...
        if ( dw_mx != null )
        {
            ...
            if ( column == "hddz_sygq" )
            {
                dw_mx.SetItem( 1, 'sggqbm', code );
                dw_mx.SetItem( 1, 'sggqmc', cname );
                dw_mx.SetItem( 1, 'sggqjc', khjc );
                dw_mx.SetItem( 1, 'sggqpym', pym );
                requestor.Close();
            }
            if ( column == "hddz_xhgq" )
            {
        ...
        this.sle_EditChanged = function (text) {
            ...
            if (column == "gnkh_tybm") {
                ...
                if (text == "") {
                    ...
                    dw_1.SetFilter("tybm = '" + tybm + "' and (( Upper(khmc) like '%" + text + "%') or ( Lower(khmc) like '%" + text + "%') or ( Upper(khmc_yw) like '%" + text + "%') or ( Lower(yw_khbm) like '%" + text + "%')  or ( Lower(khmc_yw) like '%" + text + "%') or ( Upper(pym) like '%" + text + "%')  or ( Lower(sh) like '%" + text + "%') or ( Upper(sh) like '%" + text + "%') or ( Lower(pym) like '%" + text + "%') or ( Upper(khjc) like '%" + text + "%') or ( Lower(khjc) like '%" + text + "%'))");
                    dw_1.Filter();
                    dw_1.Sort();
                }
                ...
                if (text == "") {
                    ...
                    dw_1.SetFilter("( Upper(khjc) like '%" + text + "%') or ( Lower(khjc) like '%" + text + "%') or( Upper(khmc) like '%" + text + "%') or ( Lower(khmc) like '%" + text + "%') or ( Upper(yw_khbm) like '%" + text + "%') or ( Upper(khmc_yw) like '%" + text + "%') or ( Lower(khmc_yw) like '%" + text + "%') or ( Upper(pym) like '%" + text + "%')  or ( Lower(sh) like '%" + text + "%') or ( Upper(sh) like '%" + text + "%') or ( Lower(pym) like '%" + text + "%')");
                    dw_1.Filter();
                    dw_1.Sort();
                }
            }
