...
function W_Wldw_Jsbm_Select() {
    ...
    this.OK = function () {
        ...
        var jsbm = dw_1.GetItemString(row, 'jsbm'); 
        if (dw_mx != null) {
            ...
            if (column == "gjyfzf_jsdw") {
                dw_mx.SetItem(RowData, 'zfdx_jsbm', zfdx_jsbm);
                requestor.Close();
            };
            if (column == "sjzf_jsdw") {
                dw_mx.SetItem(RowData, 'zfdx_jsbm', zfdx_jsbm);
            ...
            if (column == "sjgl_jsdw") {
                dw_mx.SetItem(RowData, 'sjzfkh_jsbm', sjzfkh_jsbm);
                requestor.Close();
            };
        ...
        this.sle_EditChanged = function (text) {
            ...
            if (text == "") {
                ...
                dw_1.SetFilter("( Upper(jsbm) like '%" + text + "%') or ( Lower(jsbm) like '%" + text + "%') ");
                dw_1.Filter();
                dw_1.Sort();
            }
            dw_1.SetRedraw(true);
