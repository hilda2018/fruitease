    ...
    //获取数据窗口
     ...
     this.Ky_Cdph = function () {
         ...
         for (row = 1; row <= dw_1.RowCount(); row++) {
             ...
             dw_d.SetItem(ll_insertrow, "hdrbm", dw_1.GetItemString(row, "hdrbm"));
             dw_d.SetItem(ll_insertrow, "hdrmc", dw_1.GetItemString(row, "hdrmc"));
             dw_d.SetItem(ll_insertrow, "hdrjc", dw_1.GetItemString(row, "hdrjc"));
             dw_d.SetItem(ll_insertrow, "hdrpym", dw_1.GetItemString(row, "hdrpym"));
	 ...
	 this.Retrieve = function () {
	     ...
	     dw_1.Retrieve(beginDate.getVarDate(), endDate.getVarDate(), hdrbm1);
	 ...
	 this.sle_EditChanged = function (text) {
	     ...
	     if (text == "") {
	         ...
	         dw_1.SetFilter("( Upper(ywbh) like '%" + text.toUpperCase() + "%')  or ( Lower(ywbh) like '%" + text.toLowerCase() + "%') or ( Upper(ftdh) like '%" + text.toUpperCase() + "%')  or ( Lower(ftdh) like '%" + text.toLowerCase() + "%') or ( Upper(ztdh) like '%" + text.toUpperCase() + "%')  or ( Lower(ztdh) like '%" + text.toLowerCase() + "%') or ( Upper(hth) like '%" + text.toUpperCase() + "%') or ( Lower(hth) like '%" + text.toLowerCase() + "%')");
	         dw_1.Filter();
	         dw_1.Sort();
	     }
	     dw_1.SetRedraw(true);
