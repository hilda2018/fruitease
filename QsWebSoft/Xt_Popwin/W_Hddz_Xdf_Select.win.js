...
function W_Hddz_Xdf_Select() {
    ...
    //获取数据窗口
     ...
     this.OK = function () {
         ...
         //空运车队配货信息
         if (dwo == "dw_hddz_hdfyxdf_edit_cmd") {
             self.Ky_Cdph();
         };    
     ...
     this.Ky_Cdph = function () {
         ...
         for (row = 1; row <= dw_1.RowCount(); row++) {
             ...
             var jzxsl = dw_1.GetItemNumber(row, "jzxsl");
             dw_d.SetItem(ll_insertrow, "jzxsl", jzxsl);
             ...
             dw_d.SetItem(ll_insertrow, "bjh", dw_1.GetItemString(row, "bjh"));
             dw_d.SetItem(ll_insertrow, "xx", dw_1.GetItemString(row, "hz_xx"));
             dw_d.SetItem(ll_insertrow, "ycd", dw_1.GetItemString(row, "ycd"));
             ...
             dw_d.SetItem(ll_insertrow, "fybm", "0118");
             var hz_xx = dw_1.GetItemString(row, "hz_xx");
             var dj = dw_1.GetItemNumber(row, "dj");
             if (hz_xx == "20尺柜") {
                 dw_d.SetItem(ll_insertrow, "je", dj * jzxsl);
             } else {
                 dw_d.SetItem(ll_insertrow, "je", dj * jzxsl);
             }
             count++;
	 ...
	 this.Retrieve = function () {
	     ...
	     var Sfytj = requestor.GetParm("Sfytj");

	     dw_1.Retrieve(beginDate.getVarDate(), endDate.getVarDate(), Sjskrbm, Sfytj);
	     var tgdh = sle_tgdh.GetText();
	     ...
	     if (tgdh == "" || tgdh == null) {
	         ...
	         dw_1.SetFilter("Upper(tgdh) like '%" + tgdh.toUpperCase() + "%'");
	         dw_1.Filter();
	         dw_1.Sort();
	     }
	     dw_1.SetRedraw(true);
	 ...
	 this.sletgdh_EditChanged = function (text) {
	     ...
	     if (text == "") {
	         ...
	         dw_1.SetFilter("Upper(tgdh) like '%" + text.toUpperCase() + "%'");
	         dw_1.Filter();
	         dw_1.Sort();
	     }
	     dw_1.SetRedraw(true);
