...
function W_Hddz_Hgcyfy_Select() {
    ...
    //获取数据窗口
     ...
     this.OK = function () {
         ...
         //空运车队配货信息
         if (dwo == "dw_hddz_hdfyhgcyfy_edit_cmd") {
             self.Ky_Cdph();
         };    
     ...
     this.Ky_Cdph = function () {
         ...
         for (row = 1; row <= dw_1.RowCount(); row++) {
             ...
             dw_d.SetItem(ll_insertrow, "zfdxbm", dw_1.GetItemString(row, "bghgbm"));
             dw_d.SetItem(ll_insertrow, "zfdxmc", dw_1.GetItemString(row, "bghg"));
             dw_d.SetItem(ll_insertrow, "zfdxjc", dw_1.GetItemString(row, "bghgjc"));
             dw_d.SetItem(ll_insertrow, "zfdxpym", dw_1.GetItemString(row, "bghgpym"));
