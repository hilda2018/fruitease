...
function W_Hddz_Hxdcf_Select() {
    ...
    //获取数据窗口
     ...
     this.OK = function () {
         ...
         //空运车队配货信息
         if (dwo == "dw_hddz_hdfyhxdcf_edit_cmd") {
             self.Ky_Cdph();
         };    
     ...
     this.Ky_Cdph = function () {
         ...
         for (row = 1; row <= dw_1.RowCount(); row++) {
             ...
             dw_d.SetItem(ll_insertrow, "fxdcbm", dw_1.GetItemString(row, "jzxxx_fxdcbm"));
             dw_d.SetItem(ll_insertrow, "fxdcmc", dw_1.GetItemString(row, "jzxxx_fxdcmc"));
             dw_d.SetItem(ll_insertrow, "fxdcjc", dw_1.GetItemString(row, "jzxxx_fxdcjc"));
             dw_d.SetItem(ll_insertrow, "fxdcpym", dw_1.GetItemString(row, "jzxxx_fxdcpym"));
             ...
             dw_d.SetItem(ll_insertrow, "zfdxbm", dw_1.GetItemString(row, "jzxxx_fxdcbm"));
             dw_d.SetItem(ll_insertrow, "zfdxmc", dw_1.GetItemString(row, "jzxxx_fxdcmc"));
             dw_d.SetItem(ll_insertrow, "zfdxjc", dw_1.GetItemString(row, "jzxxx_fxdcjc"));
             dw_d.SetItem(ll_insertrow, "zfdxpym", dw_1.GetItemString(row, "jzxxx_fxdcpym"));
             count++;
