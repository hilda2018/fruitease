...
function W_Hddz_Qtmx_Select() {
    ...
    //获取数据窗口
     ...
     this.OK = function () {
         ...
         //空运车队配货信息
         if (dwo == "dw_hddz_hdfyqtmx_edit_cmd") {
             self.Ky_Cdph();
         };    
     ...
     this.Ky_Cdph = function () {
         ...
         for (row = 1; row <= dw_1.RowCount(); row++) {
             ...
             dw_d.SetItem(ll_insertrow, "hddz_cxh", dw_1.GetItemNumber(row, "jzxxx_cxh"));
             ...
             dw_d.SetItem(ll_insertrow, "sjshrbm", dw_1.GetItemString(row, "jzxxx_sjshrbm"));
             dw_d.SetItem(ll_insertrow, "sjshrmc", dw_1.GetItemString(row, "jzxxx_sjshrmc"));
