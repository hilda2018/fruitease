...
function W_Hddz_Jyfy_Select() {
    ...
    //获取数据窗口
     ...
     this.OK = function () {
         ...
         //空运车队配货信息
         if (dwo == "dw_hddz_hdfyjyfy_edit_cmd") {
             self.Ky_Cdph();
         };    
     ...
     this.Ky_Cdph = function () {
         ...
         for (row = 1; row <= dw_1.RowCount(); row++) {
             ...
             dw_d.SetItem(ll_insertrow, "zfdxbm", dw_1.GetItemString(row, "jyjbm"));
             dw_d.SetItem(ll_insertrow, "zfdxmc", dw_1.GetItemString(row, "jyjmc"));
             dw_d.SetItem(ll_insertrow, "zfdxjc", dw_1.GetItemString(row, "jyjjc"));
             dw_d.SetItem(ll_insertrow, "zfdxpym", dw_1.GetItemString(row, "jyjpym"));
             dw_d.SetItem(ll_insertrow, "fybm",  "010801");
             dw_d.SetItem(ll_insertrow, "fymc", "商检费");
             dw_d.SetItem(ll_insertrow, "fymc", "商检费");
	 ...
	 this.sle_EditChanged = function (text) {
	     ...
	     if (text == "") {
	         ...
	         dw_1.SetFilter("( pos(hz_jzxh,'" + text.toUpperCase() + "')>0  or  pos(hth,'" + text.toUpperCase() + "')>0 or  pos(ztdh,'" + text.toUpperCase() + "')>0  or  pos(ftdh,'" + text.toUpperCase() + "')>0  or pos(tgdh,'" + text.toUpperCase() + "')>0 or pos(bjh , '" + text.toUpperCase() + "')>0)");
