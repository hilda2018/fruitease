...
{
    public partial class W_Hddz_Bhxjhxxxfy_Select
    {
        public W_Hddz_Bhxjhxxxfy_Select()
        {
        ...
        public override void OnLoad()
        {
            ...
            DataWindowChild dwc_fybm = dw_2.GetChild("fybm");
            ...
            dw_2.Retrieve(DateTime.Parse(this.dp_begin.Value.ToString()), DateTime.Parse(this.dp_end.Value.ToString()));
