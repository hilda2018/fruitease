...
//        }
    ...
    this.dw_2_RowFocusChanged = function (Row) {
        if (Row > 0) {
            ...
            dw_3.Filter();
            if (dw_3.RowCount() > 0) {
                var rwbh = dw_3.GetItemString(1, "rwbh");
                dw_4.SetFilter("rwbh = '" + rwbh + "'");
                dw_4.Filter();
            }
        }
...
//    }
    ...
    this.AddRow_dw_3 = function () {
        ...
        var row = dw_2.GetRow();
        var cxh = dw_2.GetItemNumber(row, "cxh");        
        var xh = dw_3.RowCount();
        var bh = ywbh + cxh + xh;
        dw_3.SetItem(xh, "rwbh", bh);
        dw_3.SetItem(xh, "hddz_cxh", cxh);
        dw_3.SetItem(xh, "ywbh", ywbh);
        dw_3.SetItem(xh, "zbr", ywy);
        dw_3.SetItem(xh, "zbsj", date.getVarDate());
        dw_3.SetItem(xh, "rwlx", cxh.toString());
    ...
    this.AddRow_dw_4 = function () {
        ...
        dw_4.SetFocus();
        var bh = dw_3.GetItemString(dw_3.GetRow(), "rwbh");
        dw_4.SetItem(dw_4.RowCount(), "rwbh", bh);
        var xh = dw_4.RowCount();
        var row = dw_2.GetRow();
        var hddz_cxh = dw_2.GetItemNumber(row, "hddz_cxh");
        dw_4.SetItem(xh, "hddz_cxh", hddz_cxh);
        dw_4.SetItem(xh, "ywbh", ywbh);
        dw_4.SetItem(xh, "rwxh", xh);
        dw_4.SetItem(xh, "rwlx",cxh.toString());
