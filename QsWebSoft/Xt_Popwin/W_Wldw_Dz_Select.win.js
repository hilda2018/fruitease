...
function W_Wldw_Dz_Select() {
    ...
    this.OK = function () {
        ...
        var khdz = dw_1.GetItemString(row, 'khdz'); 
        if (dw_mx != null) {
            if (column == "hddz_gwgysdz") {
                dw_mx.SetItem(RowData, 'gwgysdz', khdz);                  
                requestor.Close();
            };
            if (column == "hddz_zjsdz") {
                dw_mx.SetItem(RowData, 'zjsdz', khdz);
                requestor.Close();
            };
