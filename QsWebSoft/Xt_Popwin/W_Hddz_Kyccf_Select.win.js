...
function W_Hddz_Kyccf_Select() {
    ...
    //获取数据窗口
     ...
     this.OK = function () {
         ...
         //空运车队配货信息
         if (dwo == "dw_hddz_hdfykyccf_edit_cmd") {
             self.Ky_Cdph();
         };    
...
//             }
             ...
             dw_d.SetItem(ll_insertrow, "je", dw_1.GetItemNumber(row, "yfje_jsl"));
             dw_d.SetItem(ll_insertrow, "cxh_hddz", dw_1.GetItemNumber(row, "kyhd_cxh"));
