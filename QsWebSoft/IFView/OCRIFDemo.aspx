...
<head runat="server">
    ...
    <script>
        ...
        function fun_wldw() {
            $("#grid_wldw").datagrid({
                idField: "yw_khbm", url: 'AjaxHandler.ashx', queryParams: { action: "GetWldwList", name: $("#txtwldwfilter").val() },
        ...
        function fun_country() {
            $("#grid_country").datagrid({
                idField: "ctr_hgcode", url: 'AjaxHandler.ashx', queryParams: { action: "GetCountryList", name: $("#txtcountryfilter").val() },
                toolbar: [{ type: "" }],
                columns: [
                    [
...
<body class="easyui-layout">
    ...
    <div id="sjcl_wldw" style="display: none; height: 264px; width: 540px;">
        <div style="height: 32px; overflow: hidden; background-color: transparent; padding: 5px; border: 0px; width: 500px;">
        ...
        <div style="height: 222px; width: 540px;">
            <div id="grid_wldw"></div>
        </div>
    </div>
    <div id="sjcl_country"  style="display: none; height: 264px; width: 540px;">
        <div  style="height: 32px; overflow: hidden; background-color: transparent; padding: 5px; border: 0px; width: 500px;">
            <span class="lableTxt">名称：</span>
