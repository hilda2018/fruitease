//和界面交互的主文件
var parm = document.getElementById("Div1").innerHTML;
var user = document.getElementById("user").innerHTML;

//初始化树
var nd = new TreeNode(parm); //创建树对象
...
function del() {
    ...
    dialog.OK = function () {
        var url = defaultURL + "?action=DELETE&user=" + user + "&value1=" + encodeURIComponent(list.join("|"));
...
function downLoad() {
    ...
    window.onbeforeunload = function () { }
    window.location.href = defaultURL + "?action=DOWNLOAD&value1=" + list.join("|");
    window.onbeforeunload = function () {
        return "cuole ";
    };
}
