...
function W_BjgjpzcxList() {
	 ...
	 var sle_pz= new SingleLineEdit( requestor );
	 ...
	 if(typeof( baseBind )=="function") baseBind(win);
		 ...
		 if(sle_pz == null ) sle_pz= new SingleLineEdit( requestor );
		 sle_pz.Attach( win.Control( "sle_pz") ); 
		 ...
		 if(typeof(self.sle_EditChanged)=="function") 
			 win.AttachEvent("sle_pz","EditChanged",self.sle_EditChanged); 
    ...
    this.sle_EditChanged = function () {
        ...
        var pz = sle_pz.GetText();
        var gj = sle_gj.GetText();


        if (gj != "" && gj != null) {
            ls_filter = "(( Upper(gj) like '%" + gj + "%')  or ( Lower(gj) like '%" + gj + "%'))"
        }
        ...
        if (pz != "" && pz != null) {
            if (ls_filter == "") {
                ls_filter = "(( Upper(pz) like '%" + pz + "%')  or ( Lower(pz) like '%" + pz + "%'))"
            } else {
                ls_filter = ls_filter + " and (( Upper(pz) like '%" + pz + "%')  or ( Lower(pz) like '%" + pz + "%'))"
            }
        }
