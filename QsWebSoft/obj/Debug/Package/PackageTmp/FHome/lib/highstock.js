...
(function(V, L) {
    ...
    function(V) {
        ...
        (function(a) {
            ...
            a.Fx.prototype = {
                ...
                run: function(p, m, g) {
                    var v = this,
                        z = v.options,
                        u = function(a) { return u.stopped ? !1 : v.step(a) },
                        y = G.requestAnimationFrame || function(a) { setTimeout(a, 13) },
                        l = function() {
                            for (var b = 0; b < a.timers.length; b++) a.timers[b]() || a.timers.splice(b--, 1);
                            a.timers.length && y(l)
                        };
                    p !== m ||
                        this.elem["forceAnimate:" +
                            this.prop]
                        ? (this.startTime = +new Date, this.start = p, this.end = m, this.unit = g, this.now =
                            this.start, this.pos = 0, u.elem = this.elem, u.prop =
                            this.prop, u() && 1 === a.timers.push(u) && y(l))
                        : (delete z.curAnim[this.prop], z.complete &&
                            0 === a.keys(z.curAnim).length &&
                ...
                step: function(p) {
                    ...
                    z.attr && !z.element
                        ? p = !1
                        : p || m >= y + this.startTime
                        ? (this.now = this.end, this.pos = 1, this.update(), g = l[this.prop] = !0, a.objectEach(l,
                            function(a) {
                                !0 !==
                                    a &&
                                    (g = !1)
                            }), g && u && u.call(z), p = !1)
                        : (this.pos = v.easing((m - this.startTime) / y), this.now =
                            this.start + (this.end - this.start) * this.pos, this.update(), p = !0);
                    return p
                },
                initPath: function(p, m, g) {
                    ...
                    function u(a, b) {
                        for (var c = (n - a.length) / t; 0 < c && c--;)
                            f = a.slice().splice(a.length / w - t, t * w), f[0] =
                                b[n - t - c * t], e && (f[t - 6] = f[t - 2], f[t - 5] = f[t - 1]), [].splice.apply(a,
                                [a.length / w, 0].concat(f)), h && c--
                    }
            ...
            a.merge = function() {
                var p,
                    ...
                    z = function(g, y) {
                        ...
                        a.objectEach(y,
                            function(l, b) {
                                !a.isObject(l, !0) || a.isClass(l) || a.isDOMElement(l)
                                    ? g[b] = y[b]
                                    : g[b] = z(g[b] || {}, l)
                            });
                        return g
            ...
            a.attr = function(p, m, g) {
                ...
                a.isString(m)
                    ...
                    : p &&
                    p.getAttribute &&
                    ((v = p.getAttribute(m)) || "class" !== m || (v = p.getAttribute(m + "Name")))
                    : a.defined(m) && a.isObject(m) && a.objectEach(m, function(a, g) { p.setAttribute(g, a) });
                return v
            };
            ...
            a.clearTimeout = function(p) { a.defined(p) && clearTimeout(p) };
            ...
            a.wrap = function(a, m, g) {
                ...
                a[m] = function() {
                    ...
                    y.proceed = function() { v.apply(y, arguments.length ? arguments : u) };
                    a.unshift(v);
                    a = g.apply(this, a);
                    y.proceed = null;
                    return a
            ...
            a.formatSingle = function(p, m, g) {
                ...
                /f$/.test(p)
                    ? (g = (g = p.match(v)) ? g[1] : -1, null !== m &&
                        (m = a.numberFormat(m, g, z.decimalPoint, -1 < p.indexOf(",") ? z.thousandsSep : "")))
                    : m = (g || a.time).dateFormat(p, m);
                return m
            };
            ...
            a.normalizeTickInterval = function(p, m, g, v, z) {
                ...
                u = p / g;
                m ||
                (m = z ? [1, 1.2, 1.5, 2, 2.5, 3, 4, 5, 6, 8, 10] : [1, 2, 2.5, 5, 10], !1 === v &&
                    (1 === g ? m = a.grep(m, function(a) { return 0 === a % 1 }) : .1 >= g && (m = [1 / g])));
                for (v = 0;
                    v < m.length &&
                        !(y = m[v], z && y * g >= p ||
                            !z && u <= (m[v] + (m[v + 1] || m[v])) / 2);
            ...
            a.correctFloat = function(a, m) { return parseFloat(a.toPrecision(m || 14)) };
            a.setAnimation = function(p, m) { m.renderer.globalAnimation = a.pick(p, m.options.chart.animation, !0) };
            ...
            a.numberFormat = function(p, m, g, v) {
                ...
                -1 === m
                    ...
                    0 > b[1] &&
                    (y = m + +b[1], 0 <= y
                        ? (b[0] = (+b[0]).toExponential(y).split("e")[0], m = y)
                        : (b[0] = b[0].split(".")[0] || 0, p =
                            20 > m ? (b[0] * Math.pow(10, b[1])).toFixed(m) : 0, b[1] = 0))
                    : m = 2;
            ...
            a.getStyle = function(p, m, g) {
                if ("width" === m)
                    return Math.min(p.offsetWidth, p.scrollWidth) -
                        a.getStyle(p, "padding-left") -
                        a.getStyle(p, "padding-right");
                if ("height" === m)
                    return Math.min(p.offsetHeight, p.scrollHeight) -
                        a.getStyle(p, "padding-top") -
                        a.getStyle(p,
                            "padding-bottom");
                G.getComputedStyle || a.error(27, !0);
                if (p = G.getComputedStyle(p, void 0))
                    p = p.getPropertyValue(m), a.pick(g, "opacity" !== m) && (p = a.pInt(p));
                return p
            };
            a.inArray = function(p, m, g) { return(a.indexOfPolyfill || Array.prototype.indexOf).call(m, p, g) };
            a.grep = function(p, m) { return(a.filterPolyfill || Array.prototype.filter).call(p, m) };
            a.find = Array.prototype.find
                ? function(a, m) { return a.find(m) }
                : function(a, m) {
                    var g, v = a.length;
            ...
            a.reduce = function(p, m, g) { return(a.reducePolyfill || Array.prototype.reduce).call(p, m, g) };
            a.offset = function(a) {
            ...
            a.each = function(p, m, g) { return(a.forEachPolyfill || Array.prototype.forEach).call(p, m, g) };
            a.objectEach = function(a, m, g) { for (var v in a) a.hasOwnProperty(v) && m.call(g || a[v], a[v], v, a) };
            a.addEvent = function(p, m, g) {
                var v, z = p.addEventListener || a.addEventListenerPolyfill;
                v = "function" === typeof p && p.prototype
                    ? p.prototype.protoEvents = p.prototype.protoEvents || {}
                    : p.hcEvents = p.hcEvents ||
                    {};
                z && z.call(p, m, g, !1);
                v[m] || (v[m] = []);
                v[m].push(g);
                return function() { a.removeEvent(p, m, g) }
            };
            a.removeEvent = function(p, m, g) {
                ...
                function z(l) {
                    var b, e;
                    p.nodeName &&
                    (m ? (b = {}, b[m] = !0) : b = l, a.objectEach(b,
                        function(a, b) { if (l[b]) for (e = l[b].length; e--;) v(b, l[b][e]) }))
                }
                ...
                a.each(["protoEvents", "hcEvents"],
                    function(l) {
                        ...
                        (m
                            ? (u = b[m] || [], g
                                ? (y = a.inArray(g, u), -1 < y && (u.splice(y, 1), b[m] = u), v(m, g))
                                : (z(b), b[m] =
                                    []))
                            : (z(b), p[l] = {}))
                    })
            ...
            a.fireEvent = function(p, m, g, v) {
                var z, u, y, l, b;
                g = g || {};
                C.createEvent && (p.dispatchEvent || p.fireEvent)
                    ? (z =
                            C.createEvent("Events"), z.initEvent(m, !0, !0), a.extend(z, g),
                        p.dispatchEvent ? p.dispatchEvent(z) : p.fireEvent(m, z))
                    : a.each(["protoEvents", "hcEvents"],
                        function(e) {
                            if (p[e])
                                for (u = p[e][m] || [], y =
                                    ...
                                    l < y;
                                    l++) (b = u[l]) && !1 === b.call(p, g) && g.preventDefault()
                        });
                v &&
                    !g.defaultPrevented &&
                    v.call(p,
            ...
            a.animate = function(p, m, g) {
                ...
                a.objectEach(m,
                    function(b, e) {
                        ...
                        u = null;
                        "d" === e
                            ? (y.paths = y.initPath(p, p.d, m.d), y.toD = m.d, v = 0, u = 1)
                            : p.attr
                            ? v = p.attr(e)
                            : (v = parseFloat(a.getStyle(p, e)) || 0, "opacity" !== e && (z = "px"));
                        u || (u = b);
                        u &&
                            u.match &&
                            u.match("px") &&
            ...
            a.uniqueKey = function() {
                ...
                return function() { return"highcharts-" + a + "-" + m++ }
            }();
            G.jQuery &&
            (G.jQuery.fn.highcharts = function() {
                ...
                if (this[0])
                    return p[0]
                        ? (new (a[a.isString(p[0]) ? p.shift() : "Chart"])(this[0], p[0], p[1]), this)
            ...
            a.Color.prototype = {
                parsers: [
                    {
                        ...
                        parse: function(a) { return[m(a[1]), m(a[2]), m(a[3]), parseFloat(a[4], 10)] }
                    }, {
                ...
                init: function(g) {
                    ...
                    if ((this.input = g = this.names[g && g.toLowerCase ? g.toLowerCase() : ""] || g) && g.stops)
                        this.stops = G(g.stops, function(l) { return new a.Color(l[1]) });
                    else if (g &&
                        g.charAt &&
                        "#" === g.charAt() &&
                        (m = g.length, g = parseInt(g.substr(1), 16), 7 === m
                            ? z = [(g & 16711680) >> 16, (g & 65280) >> 8, g & 255, 1]
                            : 4 === m &&
                            (z = [
                                (g & 3840) >> 4 | (g & 3840) >> 8, (g & 240) >> 4 | g & 240, (g & 15) << 4 | g & 15, 1
                            ])), !z)
                        for (u = this.parsers.length;
                            u-- &&
                                !z;
                        ) y = this.parsers[u], (m = y.regex.exec(g)) && (z = y.parse(m));
                    this.rgba = z || []
                },
                get: function(a) {
                    ...
                    this.stops
                        ? (u = p(g), u.stops =
                                [].concat(u.stops), B(this.stops,
                                function(g, l) { u.stops[l] = [u.stops[l][0], g.get(a)] })
                        )
                        : u = m && C(m[0])
                        ? "rgb" === a || !a && 1 === m[3]
                        ? "rgb(" + m[0] + "," + m[1] + "," + m[2] + ")"
                ...
                brighten: function(a) {
                    var g, z = this.rgba;
                    if (this.stops) B(this.stops, function(g) { g.brighten(a) });
                    else if (C(a) && 0 !== a)
                        for (g = 0; 3 > g; g++)
                            z[g] += m(255 * a), 0 >
                                z[g] &&
                                (z[g] = 0), 255 < z[g] && (z[g] = 255);
                    return this
                },
                ...
                tweenTo: function(a, m) {
                    ...
                    u.length && g && g.length
                        ? (a = 1 !== u[3] || 1 !== g[3], m = (a ? "rgba(" : "rgb(") +
                            Math.round(u[0] + (g[0] - u[0]) * (1 - m)) +
                            "," +
                            Math.round(u[1] + (g[1] - u[1]) * (1 - m)) +
                            "," +
                            Math.round(u[2] + (g[2] - u[2]) * (1 - m)) +
                            (a ? "," + (u[3] + (g[3] - u[3]) * (1 - m)) : "") +
                            ")")
                        : m = a.input || "none";
                    return m
        ...
        (function(a) {
            ...
            n(B.prototype,
                {
                    ...
                    SVG_NS: I,
                    textProps:
                        "direction fontSize fontWeight fontFamily fontStyle color lineHeight width textAlign textDecoration textOverflow textOutline"
                            .split(" "),
                    init: function(a, k) {
                            ...
                            function() {
                                ...
                                (c = k[f], I = M.gradients, n = k.stops, w =
                                    ...
                                    (k[f] = c = {
                                        ...
                                        w &&
                                        !y(c.gradientUnits) &&
                                        (h = c, c = K(c, M.getRadialAttr(w, h), { gradientUnits: "userSpaceOnUse" })),
                                    H(c, function(a, k) { "id" !== k && q.push(k, a) }),
                                    H(n, function(a) { q.push(a) }),
                                    q = q.join(","), I[q]
                                        ? E = I[q].attr("id")
                                        : (c.id = E = a.uniqueKey(), I[q] = x =
                                            M.createElement(f).attr(c).add(M.defs), x.radAttr = h, x.stops = [], t(n,
                                            function(k) {
                                                0 === k[1].indexOf("rgba")
                                                    ? (b = a.color(k[1]),
                                                        r = b.get("rgb"), e = b.get("a"))
                                                    : (r = k[1], e = 1);
                                                k = M.createElement("stop")
                                                    .attr({ offset: k[0], "stop-color": r, "stop-opacity": e }).add(x);
                                                x.stops.push(k)
                                            })), l = "url(" + M.url + "#" + E + ")", A.setAttribute(d, l), A.gradient =
                                        q, k.toString = function() { return l })
                            })
                    },
                    applyTextOutline: function(k) {
                        var d = this.element, M, A, b, c, h;
                        -1 !== k.indexOf("contrast") &&
                            (k = k.replace(/contrast/g, this.renderer.getContrast(d.style.fill)));
                        k = k.split(" ");
                        A = k[k.length - 1];
                        if ((b = k[0]) && "none" !== b && a.svg) {
                            ...
                            b = b.replace(/(^[\d\.]+)(.*?)$/g, function(a, k, d) { return 2 * k + d });
                            for (h = k.length; h--;)
                                M = k[h], "highcharts-text-outline" === M.getAttribute("class") &&
                                    f(k, d.removeChild(M));
                            c = d.firstChild;
                            t(k,
                                function(a, k) {
                                    0 === k &&
                                    (a.setAttribute("x", d.getAttribute("x")), k =
                                        d.getAttribute("y"), a.setAttribute("y", k || 0), null === k &&
                                        d.setAttribute("y", 0));
                                    a = a.cloneNode(1);
                                    m(a,
                                        {
                    ...
                    attr: function(a,
                        ...
                        "string" === typeof a
                            ? c = (this[a + "Getter"] || this._defaultGetter).call(this, a, b)
                            : (H(a,
                                function(k, d) {
                                    h = !1;
                                    A || P(this, d);
                                    ...
                                    h ||
                                    (I = this[d + "Setter"] || this._defaultSetter, I.call(this, k, d, b),
                                        this.shadows &&
                    ...
                    updateShadows: function(a, k, d) {
                        for (var M = this.shadows, A = M.length; A--;)
                            d.call(M[A],
                                "height" === a ? Math.max(k - (M[A].cutHeight || 0), 0) : "d" === a ? this.d : k,
                                a,
                                M[A])
                    },
                    addClass: function(a, k) {
                        ...
                        -1 === d.indexOf(a) &&
                            (k || (a = (d + (d ? " " : "") + a).replace("  ", " ")), this.attr("class", a));
                        return this
                    },
                    hasClass: function(a) {
                        return-1 !==
                    ...
                    symbolAttr: function(a) {
                        var k = this;
                        t("x y r start end width height innerR anchorX anchorY".split(" "),
                            function(d) { k[d] = E(a[d], k[d]) });
                    ...
                    css: function(a) {
                        ...
                        d && H(a, function(a, k) { a !== d[k] && (A[k] = a, h = !0) });
                        h &&
                        (d && (a = n(d, A)), f = this.textWidth = a &&
                                a.width &&
                                "auto" !== a.width &&
                                "text" === b.nodeName.toLowerCase() &&
                                k(a.width),
                            this.styles =
                                a, f && !R && this.renderer.forExport && delete a.width, b.namespaceURI === this.SVG_NS
                                ? (M = function(a, k) { return"-" + k.toLowerCase() }, H(a,
                                    function(a, k) {
                                        -1 === w(k, I) && (c += k.replace(/([A-Z])/g, M) + ":" + a + ";")
                                    }), c && m(b, "style", c))
                                : z(b, a), this.added &&
                            ("text" === this.element.nodeName && this.renderer.buildText(this), a &&
                                a.textOutline &&
                    ...
                    updateTransform: function() {
                        ...
                        b
                            ...
                            a.push("rotate(" +
                                f +
                                " " +
                                E(this.rotationOriginX, h.getAttribute("x"), 0) +
                                " " +
                                E(this.rotationOriginY, h.getAttribute("y") || 0) +
                                ")");
                        (y(d) || y(A)) &&
                            a.push("scale(" +
                                E(d, 1) +
                    ...
                    align: function(a, k, d) {
                        ...
                        if (a) {
                            if (this.alignOptions = a, this.alignByTranslate =
                                k, !d || F(d)) this.alignTo = A = d || "renderer", f(c, this), c.push(this), d = null
                        ...
                        if (!d) {
                            if (c.namespaceURI === this.SVG_NS || A.forExport) {
                                try {
                                    (M = this.fakeTS &&
                                            function(a) {
                                                t(c.querySelectorAll(".highcharts-text-outline"),
                                                    function(k) { k.style.display = a })
                                            }) &&
                                        M("none"), d =
                                        c.getBBox
                                        ? n({}, c.getBBox())
                                        : { width: c.offsetWidth, height: c.offsetHeight }, M && M("")
                                } catch (fa) {
                                }
                                if (!d || 0 > d.width) d = { width: 0, height: 0 }
                            } else d = this.htmlGetBBox();
                            A.isSVG &&
                            (a = d.width, A = d.height, f &&
                                "11px" === f.fontSize &&
                                17 === Math.round(A) &&
                                (d.height = A =
                                    14), k &&
                            (d.width = Math.abs(A * Math.sin(b)) + Math.abs(a * Math.cos(b)), d.height =
                                Math.abs(A * Math.cos(b)) + Math.abs(a * Math.sin(b))));
                            if (e && 0 < d.height) {
                    ...
                    destroy: function() {
                        ...
                        b &&
                            A &&
                            (t(A.querySelectorAll("[clip-path],[CLIP-PATH]"),
                                function(a) {
                                    var k = a.getAttribute("clip-path"), d = b.element.id;
                                    (-1 < k.indexOf("(#" + d + ")") || -1 < k.indexOf('("#' + d + '")')) &&
                        ...
                        for (a.destroyShadows(); d && d.div && 0 === d.div.childNodes.length;)
                            k = d.parentGroup, a.safeRemoveChild(d.div), delete d.div, d = k;
                        a.alignTo &&
                            f(a.renderer.alignedObjects,
                                a);
                        H(a, function(k, d) { delete a[d] });
                        return null
                    },
                        ...
                        if (!a) this.destroyShadows();
                            ...
                            for (b = 1; b <= I; b++)
                                c = f.cloneNode(0), h =
                                    ...
                                    ? k.element.appendChild(c)
                                    : f.parentNode && f.parentNode.insertBefore(c, f), A.push(c);
                            this.shadows = A
                        }
                        return this
                    },
                    destroyShadows: function() {
                        t(this.shadows || [], function(a) { this.safeRemoveChild(a) }, this);
                        this.shadows = void 0
                    },
                    xGetter: function(a) {
                            ...
                            for (n = d.length - 1; 0 <= n && !I; n--)
                                if (b = d[n], f = b.zIndex, x = !y(f), b !== h)
                                    if (0 > a && x && !A && !n) c.insertBefore(h, d[n]), I = !0;
                                        ...
                                        c.insertBefore(h, d[n + 1] || null), I = !0;
                            I || (c.insertBefore(h, d[A ? 3 : 0] || null), I = !0)
                        }
                        return I
                    },
                    _defaultSetter: function(a, k, d) { d.setAttribute(k, a) }
                });
            B.prototype.yGetter = B.prototype.xGetter;
            B.prototype.translateXSetter = B.prototype.translateYSetter =
                B.prototype.rotationSetter = B.prototype.verticalAlignSetter = B.prototype.rotationOriginXSetter =
                B.prototype.rotationOriginYSetter = B.prototype.scaleXSetter = B.prototype.scaleYSetter =
                B.prototype.matrixSetter = function(a, k) {
                    this[k] = a;
                    this.doTransform = !0
                };
            B.prototype["stroke-widthSetter"] = B.prototype.strokeSetter = function(a, k, d) {
                ...
                this.stroke && this["stroke-width"]
                    ? (B.prototype.fillSetter.call(this, this.stroke, "stroke", d), d.setAttribute("stroke-width",
            ...
            n(C.prototype,
                {
                    ...
                    init: function(a, k, d, A, b, c) {
                        var f;
                        A = this.createElement("svg").attr({ version: "1.1", "class": "highcharts-root" })
                            .css(this.getStyle(A));
                        f = A.element;
                        a.appendChild(f);
                        m(a, "dir", "ltr");
                        ...
                        this.url = (r || x) && e.getElementsByTagName("base").length
                            ? N.location.href.replace(/#.*?$/, "").replace(/<[^>]*>/g, "").replace(/([\('\)])/g, "\\$1")
                            .replace(/ /g, "%20")
                            : "";
                        this.createElement("desc").add().element
                            .appendChild(e.createTextNode("Created with Highstock 6.1.0"));
                    ...
                    applyEllipsis: function(a, k, d, A) {
                        ...
                        if (n =
                            c > A) {
                            for (; h <= I;)
                                f = Math.ceil((h + I) / 2), c = d.substring(0, f) + "\u2026", x(c), c =
                                    this.getSpanWidth(a, k), h === I ? h = I + 1 : c > A ? I = f - 1 : h = f;
                            0 === I && x("")
                        }
                        a.rotation = b;
                        return n
                    ...
                    buildText: function(a) {
                        ...
                        if (J !== a.textCache) {
                            ...
                            h || F || P || l || -1 !== f.indexOf(" ")
                                ? (q && q.appendChild(d), f =
                                        h
                                        ? f.replace(/<(b|strong)>/g, '\x3cspan style\x3d"font-weight:bold"\x3e')
                                        .replace(/<(i|em)>/g, '\x3cspan style\x3d"font-style:italic"\x3e')
                                        .replace(/<a/g, "\x3cspan").replace(/<\/(b|strong|i|em|a)>/g, "\x3c/span\x3e")
                                        .split(/<br.*?>/g)
                                        : [f], f = c(f, function(a) { return"" !== a }), t(f,
                                        function(k, f) {
                                            var c, h = 0;
                                            k = k.replace(/^\s+|\s+$/g,
                                            ...
                                            t(c,
                                                function(k) {
                                                    if ("" !== k || 1 === c.length) {
                                                        ...
                                                        if (w = N(k, "style"))
                                                            w = w.replace(/(;| |^)color([ :])/, "$1fill$2"), m(q,
                                                                "style",
                                                                w);
                                                        (E = N(k, "href")) &&
                                                            !b &&
                                                            (m(q, "onclick", 'location.href\x3d"' + E + '"'), m(q,
                                                                "class",
                                                                "highcharts-anchor"), z(q, { cursor: "pointer" }));
                                                        ...
                                                        if (" " !== k) {
                                                            ...
                                                            !h &&
                                                                g &&
                                                                (!R && b && z(q, { display: "block" }), m(q, "dy", u(q))
                                                                );
                                                            if (l) {
                                                                x = k.replace(/([^\^])-/g, "$1- ").split(" ");
                                                                E = 1 < c.length || f || 1 < x.length && !K;
                                                                var H = [], D, t = u(q), F = a.rotation;
                                                                for (P && (n = A.applyEllipsis(a, q, k, l));
                                                                    !P && E && (x.length || H.length);
                                                                )
                                                                    a.rotation = 0, D = A.getSpanWidth(a, q), k =
                                                                        D > l, void 0 === n && (n = k), k &&
                                                                        1 !== x.length
                                                                        ? (q.removeChild(q.firstChild), H.unshift(
                                                                            x.pop()))
                                                                        : (x = H, H = [], x.length &&
                                                                                !K &&
                                                                                (q = e.createElementNS(I, "tspan"), m(q,
                                                                                    { dy: t, x: r }), w &&
                                                                                    m(q, "style", w), d
                                                                                    .appendChild(q)),
                                                                            D > l && (l = D)), x.length &&
                                                                        q.appendChild(
                                                                            e.createTextNode(x.join(" ")
                                                                                .replace(/- /g, "-")));
                                                                a.rotation = F
                                                            }
                                                            h++
                                        ...
                                        }), n && a.attr("title", y(a.textStr, ["\x26lt;", "\x26gt;"])), q &&
                                        q.removeChild(d),
                                    F && a.applyTextOutline && a.applyTextOutline(F))
                                : d.appendChild(e.createTextNode(y(f)))
                        }
                    },
                    ...
                    button: function(a, k, d, A, b, f, c, h, x) {
                        ...
                        E = h.style;
                        delete h.style;
                        G(I.element, J ? "mouseover" : "mouseenter", function() { 3 !== q && I.setState(1) });
                        G(I.element, J ? "mouseout" : "mouseleave", function() { 3 !== q && I.setState(q) });
                        I.setState =
                            function(a) {
                                1 !== a && (I.state = q = a);
                                I.removeClass(/highcharts-button-(normal|hover|pressed|disabled)/)
                        ...
                        return I.on("click", function(a) { 3 !== q && A.call(I, a) })
                    },
                    ...
                    circle: function(a, k, d) {
                        ...
                        k.xSetter = k.ySetter = function(a, k, d) { d.setAttribute("c" + k, a) };
                        return k.attr(a)
                    },
                    ...
                    rect: function(a, k, d, A, b, f) {
                        ...
                        a = q(a)
                            ...
                            : void 0 === a
                            ? {}
                            : { x: a, y: k, width: Math.max(d, 0), height: Math.max(A, 0) };
                        void 0 !== f &&
                        (a.strokeWidth =
                            f, a = c.crisp(a));
                        a.fill = "none";
                        b && (a.r = b);
                        c.rSetter = function(a, k, d) { m(d, { rx: a, ry: a }) };
                        return c.attr(a)
                    },
                    ...
                    image: function(a, k, d, A, b, f) {
                        var c = { preserveAspectRatio: "none" },
                            ...
                            I = function(a, k) {
                                a.setAttributeNS
                                    ? a.setAttributeNS("http://www.w3.org/1999/xlink", "href", k)
                                    : a.setAttribute("hc-svg-href", k)
                            };
                        1 < arguments.length && n(c, { x: k, y: d, width: A, height: b });
                        h = this.createElement("image").attr(c);
                        f
                            ? (I(h.element,
                                "data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw\x3d\x3d"), c =
                                new N.Image, G(c,
                                "load",
                                function(k) {
                                    I(h.element, a);
                    ...
                    symbol: function(a, k, d, A, b, c) {
                        ...
                        r
                            ? (h =
                                    this.path(w), h.attr("fill", "none"),
                                n(h, { symbolName: q, x: k, y: d, width: A, height: b }), c && n(h, c))
                            : x &&
                            (l = a.match(I)[1], h = this.image(l), h.imgwidth =
                                E(Q[l] && Q[l].width, c && c.width), h.imgheight =
                                E(Q[l] && Q[l].height, c && c.height), H =
                                function() { h.attr({ width: h.width, height: h.height }) }, t(["width", "height"],
                                function(a) {
                                    h[a + "Setter"] = function(a, k) {
                                        ...
                                        this[k] = a;
                                        y(A) &&
                                        (this.element && this.element.setAttribute(k, A), this.alignByTranslate ||
                                            (d[b] = ((this[k] || 0) - A) / 2, this.attr(d)))
                                    }
                                }), y(k) && h.attr({ x: k, y: d }), h.isImg = !0, y(h.imgwidth) && y(h.imgheight)
                                ? H()
                                : (h.attr({ width: 0, height: 0 }), u("img",
                                    {
                                        onload: function() {
                                            var a = g[f.chartIndex];
                                            0 === this.width &&
                                            (z(this,
                                                { position: "absolute", top: "-999em" }), e.body.appendChild(this));
                    ...
                    symbols: {
                        circle: function(a, k, d, A) {
                            return this.arc(a + d / 2,
                                k + A / 2,
                                d / 2,
                                A / 2,
                                { start: 0, end: 2 * Math.PI, open: !1 })
                        },
                        square: function(a, k, d, A) { return["M", a, k, "L", a + d, k, a + d, k + A, a, k + A, "Z"] },
                        triangle: function(a, k, d, A) { return["M", a + d / 2, k, "L", a + d, k + A, a, k + A, "Z"] },
                        ...
                        arc: function(a,
                            ...
                            y(d) &&
                                f.push(A ? "M" : "L", a + d * q, k + d * I, "A", d, d, 0, b, 0, a + d * x, k + d * n);
                            f.push(A ? "" : "Z");
                            return f
                        },
                        callout: function(a, k, d, A, b) {
                            ...
                            var I;
                            I = [
                                "M", a + c, k, "L", a + d - c, k, "C", a + d, k, a + d, k, a + d, k + c, "L", a + d, k +
                                A -
                                c, "C", a + d, k + A, a + d, k + A, a + d - c, k + A, "L", a + c, k + A, "C", a, k + A,
                                a, k + A, a, k + A - c, "L", a, k + c, "C", a, k, a, k, a + c, k
                            ];
                            h && h > d
                                ? b > k + f && b < k + A - f
                                ? I.splice(13, 3, "L", a + d, b - 6, a + d + 6, b, a + d, b + 6, a + d, k + A - c)
                                : I.splice(13, 3, "L", a + d, A / 2, h, b, a + d, A / 2, a + d, k + A - c)
                                : h && 0 > h
                                ? b > k + f && b < k + A - f
                                ? I.splice(33, 3, "L", a, b + 6, a - 6, b, a, b - 6, a, k + c)
                                : I.splice(33, 3, "L", a, A / 2, h, b, a, A / 2, a, k + c)
                                : b && b > A && h > a + f && h < a + d - f
                                ? I.splice(23, 3, "L", h + 6, k + A, h, k + A + 6, h - 6, k + A, a + c, k + A)
                                : b &&
                                0 > b &&
                                h > a + f &&
                                h < a + d - f &&
                                I.splice(3, 3, "L", h - 6, k, h, k - 6, h + 6, k, d - c, k);
                            return I
                        }
                    },
                    clipRect: function(k,
                    ...
                    fontMetrics: function(a, d) {
                        ...
                        a = /px/.test(a)
                            ? k(a)
                            : /em/.test(a)
                            ? parseFloat(a) * (d ? this.fontMetrics(null, d.parentNode).f : 16)
                            : 12;
                    ...
                    label: function(k, d, b, c, f, h, I, x, q) {
                        var r = this,
                            ...
                            w = e.text = r.text("", 0, 0, I).attr({ zIndex: 1 }),
                            E,
                            l,
                            H = 0,
                            D = 3,
                        ...
                        p = function() {
                            ...
                            (E ||
                            (e.box = E =
                                r.symbols[c] || v ? r.symbol(c) : r.rect(), E.addClass(
                                ("button" === q ? "" : "highcharts-label-box") +
                                (q ? " highcharts-" + q + "-box" : "")), E.add(e), a = M(), k.x = a, k.y =
                                (x ? -N : 0) + a), k.width = Math.round(e.width), k.height =
                                Math.round(e.height), E.attr(n(k, m)), m = {})
                        };
                        S = function() {
                            var a = F + D, k;
                            k = x ? 0 : N;
                            y(R) &&
                                l &&
                                ("center" === Q || "right" === Q) &&
                                (a += { center: .5, right: 1 }[Q] * (R - l.width));
                            if (a !== w.x || k !== w.y) w.attr("x", a), void 0 !== k && w.attr("y", k);
                            w.x = a;
                            w.y = k
                        };
                        O = function(a, k) { E ? E.attr(a, k) : m[a] = k };
                        e.onAdd = function() {
                            w.add(e);
                            e.attr({ text: k || 0 === k ? k : "", x: d, y: b });
                            E && y(f) && e.attr({ anchorX: f, anchorY: h })
                        };
                        e.widthSetter = function(k) { R = a.isNumber(k) ? k : null };
                        e.heightSetter = function(a) { P = a };
                        e["text-alignSetter"] =
                            function(a) { Q = a };
                        e.paddingSetter = function(a) { y(a) && a !== D && (D = e.padding = a, S()) };
                        e.paddingLeftSetter = function(a) { y(a) && a !== F && (F = a, S()) };
                        ...
                        return n(e,
                            {
                                css: function(a) {
                                    if (a) {
                                        var k = {};
                                        a = K(a);
                                        t(e.textProps, function(d) { void 0 !== a[d] && (k[d] = a[d], delete a[d]) });
                                        w.css(k);
                                        "width" in k && p()
                                    }
                                    return ea.call(e, a)
            ...
            g(a.SVGElement.prototype,
                {
                    htmlCss: function(a) {
                        ...
                        if (b = a &&
                            "SPAN" ===
                            b.tagName &&
                            a.width) delete a.width, this.textWidth = b, this.htmlUpdateTransform();
                    ...
                    htmlUpdateTransform: function() {
                        if (this.added) {
                            var a = this.renderer,
                                ...
                                r = this.textAlign ||
                                    "left",
                                t = { left: 0, center: .5, right: 1 }[r],
                                q = this.styles,
                                F = q && q.whiteSpace;
                            G(b, { marginLeft: c, marginTop: h });
                            this.shadows &&
                                m(this.shadows, function(a) { G(a, { marginLeft: c + 1, marginTop: h + 1 }) });
                            this.inverted && m(b.childNodes, function(d) { a.invertChild(d, b) });
                            if ("SPAN" === b.tagName) {
                                var q = this.rotation,
                                    x = this.textWidth && l(this.textWidth),
                                    K = [q, r, b.innerHTML, this.textWidth, this.textAlign].join(),
                                    d;
                                (d = x !== this.oldTextWidth) &&
                                    !(d = x > this.oldTextWidth) &&
                                    ((d = this.textPxLength) ||
                                    (G(b, { width: "", whiteSpace: F || "nowrap" }), d =
                                        b.offsetWidth), d = d > x);
                                d &&
                                    /[ \-]/.test(b.textContent || b.innerText) &&
                                    (G(b, { width: x + "px", display: "block", whiteSpace: F || "normal" }), this
                                        .oldTextWidth = x);
                                K !== this.cTT &&
                                (F = a.fontMetrics(b.style.fontSize).b, p(q) &&
                                    q !== (this.oldRotation || 0) &&
                                    this.setSpanRotation(q, t, F), this.getSpanCorrection(
                                    !p(q) && this.textPxLength || b.offsetWidth,
                                    F,
                                    t,
                                    q,
                                    r));
            ...
            g(b.prototype,
                {
                    getTransformKey: function() {
                        return z && !/Edge/.test(e.navigator.userAgent)
                            ? "-ms-transform"
                            : u
                            ? "-webkit-transform"
                            : v
        ...
        (function(a) {
            ...
            a.Time.prototype = {
                ...
                update: function(g) {
                    ...
                    (this.variableTimezone = !(u && !g.getTimezoneOffset && !g.timezone)) || this.timezoneOffset
                        ? (this.get = function(a, b) {
                            ...
                            this.set = function(l, b, e) {
                                ...
                                if (-1 !== a.inArray(l, ["Milliseconds", "Seconds", "Minutes"])) b["set" + l](e);
                                    ...
                                    t = y.getTimezoneOffset(b), t =
                                        b.getTime() - t, b.setTime(t), b["setUTC" + l](e), l =
                                        y.getTimezoneOffset(b), t = b.getTime() + l, b.setTime(t)
                            })
                        : u
                        ? (this.get = function(a, b) { return b["getUTC" + a]() }, this.set =
                            function(a, b, e) { return b["setUTC" + a](e) })
                        : (this.get = function(a, b) { return b["get" + a]() }, this.set = function(a, b, e) {
                            return b["set" + a](e)
                        })
                },
                makeTime: function(g, u, y, l, b, e) {
                    var t, n, f;
                    this.useUTC
                        ? (t = this.Date.UTC.apply(0,
                            arguments), n = this.getTimezoneOffset(t), t += n, f =
                            this.getTimezoneOffset(t), n !== f
                            ? t += f - n
                            : n - 36E5 !== this.getTimezoneOffset(t - 36E5) || a.isSafari || (t -= 36E5))
                        : t = (new this.Date(g, u, m(y, 1), m(l, 0), m(b, 0), m(e, 0))).getTime();
                    return t
                },
                timezoneOffsetFunction: function() {
                    ...
                    if (m.timezone) {
                        if (y) return function(a) { return 6E4 * -y.tz(a, m.timezone).utcOffset() };
                        a.error(25)
                    }
                    return this.useUTC && m.getTimezoneOffset
                        ? function(a) { return 6E4 * m.getTimezoneOffset(a) }
                        : function() { return 6E4 * (g.timezoneOffset || 0) }
                },
                ...
                getTimeTicks: function(a, u, y, l) {
                    ...
                    if (B(u)) {
                        b.set("Milliseconds",
                            f,
                            c >= g.second ? 0 : h * Math.floor(b.get("Milliseconds", f) / h));
                        c >= g.second &&
                            b.set("Seconds", f, c >= g.minute ? 0 : h * Math.floor(b.get("Seconds", f) / h));
                        ...
                        c >= g.month &&
                        (b.set("Month", f, c >= g.year ? 0 : h * Math.floor(b.get("Month", f) / h)), n =
                            b.get("FullYear", f));
                        ...
                        u = f.getTime();
                        b.variableTimezone &&
                            (w = y - u > 4 * g.month || b.getTimezoneOffset(u) !== b.getTimezoneOffset(y));
                        f = f.getTime();
                        for (u = 1; f < y;)
                            e.push(f), f = c === g.year
                                ? b.makeTime(n + u * h, 0)
                                ...
                                : !w || c !== g.day && c !== g.week
                                ? w && c === g.hour && 1 < h
                                ? b.makeTime(n, l, D, r + u * h)
                                : f + c * h
                                : b.makeTime(n, l, D + u * h * (c === g.day ? 1 : 7)), u++;
                        e.push(f);
                        c <= g.hour &&
                            1E4 > e.length &&
                            C(e,
        ...
        (function(a) {
            ...
            a.dateFormat = function(C, p, m) { return a.time.dateFormat(C, p, m) }
        })(L);
        (function(a) {
            ...
            a.Tick.prototype = {
                addLabel: function() {
                    ...
                    if (C(b)) b && b.attr({ text: m });
                    else {
                        if (this.label = b =
                            C(m) && n.enabled
                            ? l.renderer.text(m, 0, 0, n.useHTML).css(g(n.style)).add(a.labelGroup)
                ...
                handleOverflow: function(a) {
                    var g = this.axis,
                        ...
                        f = this.label,
                        c = this.rotation,
                        h = { left: 0, center: .5, right: 1 }[g.labelAlign || f.attr("align")],
                        w = f.getBBox().width,
                        D = g.getSlotWidth(),
                        r = D,
                        J = 1,
                    ...
                    if (c || !1 === l.overflow)
                        0 > c && b - h * w < n
                            ? q = Math.round(b /
                                Math.cos(c * z) -
                                n)
                            : 0 < c && b + h * w > t && (q = Math.round((e - b) / Math.cos(c * z)));
                    else if (e =
                            b + (1 - h) * w,
                        b - h * w < n ? r = a.x + r * (1 - h) - n : e > t && (r = t - a.x + r * h, J = -1), r =
                            Math.min(D, r), r < D &&
                            "center" === g.labelAlign &&
                            (a.x += J * (D - r - h * (D - Math.min(w, r)))), w > r ||
                            g.autoRotation && (f.styles || {}).width) q = r;
                ...
                getPosition: function(g, m, l, b) {
                    ...
                    g = {
                        x: g
                            ? a.correctFloat(e.translate(m + l, null, null, b) + e.transB)
                            : e.left +
                            e.offset +
                            (e.opposite ? (b && t.oldChartWidth || t.chartWidth) - e.right - e.left : 0),
                        y: g
                            ? n - e.bottom + e.offset - (e.opposite ? e.height : 0)
                            : a.correctFloat(n - e.translate(m + l, null, null, b) - e.transB)
                    };
                ...
                getLabelPosition: function(a, g, l, b, e, t, n, f) {
                    ...
                    (J = 0 === c.side
                        ...
                        : 2 === c.side
                        ? r.y + 8
                        : Math.cos(l.rotation * z) * (r.y - l.getBBox(!1, 0).height / 2));
                ...
                renderGridLine: function(a, g, l) {
                    var b = this.axis,
                        ...
                        e = e[D + "LineDashStyle"];
                    t ||
                    (n.stroke = J, n["stroke-width"] =
                        r, e && (n.dashstyle = e), c || (n.zIndex = 1), a && (n.opacity = 0), this.gridLine = t =
                        w.path().attr(n).addClass("highcharts-" + (c ? c + "-" : "") + "grid-line").add(b.gridGroup));
                    if (!a && t && (a = b.getPlotLinePath(f + h, t.strokeWidth() * l, a, !0)))
                        t[this.isNew ? "attr" : "animate"]({ d: a, opacity: g })
                },
                renderMark: function(a, g, l) {
                    ...
                    c &&
                    (b.opposite && (c[0] = -c[0]), w &&
                    (this.mark = h =
                        t.path().addClass("highcharts-" + (n ? n + "-" : "") + "tick").add(b.axisGroup), h.attr({
                        stroke: e,
                        "stroke-width": r
                    })), h[w ? "attr" : "animate"]({
                ...
                renderLabel: function(a, g, l, b) {
                    ...
                    f &&
                        m(D) &&
                        (f.xy = a = this.getLabelPosition(D,
                                a,
                                f,
                                t,
                                c,
                                e,
                                b,
                                h), this.isFirst && !this.isLast && !v(n.showFirstLabel, 1) ||
                                this.isLast && !this.isFirst && !v(n.showLastLabel, 1)
                                ? w = !1
                                : !t || c.step || c.rotation || g || 0 === l || this.handleOverflow(a),
                            h && b % h && (w = !1), w && m(a.y)
                                ? (a.opacity = l, f[this.isNewLabel ? "attr" : "animate"](a), this.isNewLabel = !1)
            ...
            a.extend(E.prototype,
                {
                    ...
                    defaultLabelFormatter: function() {
                        ...
                        if (n) r = t(n, this, b);
                            ...
                            for (; e-- && void 0 === r;)
                                b = Math.pow(h, e + 1), k >= b &&
                                    0 === 10 * d % b &&
                                    null !== x[e] &&
                                    0 !== d &&
                                    (r = a.numberFormat(d / b,
                                            -1) +
                                        x[e]);
                        void 0 === r &&
                            (r = 1E4 <= Math.abs(d) ? a.numberFormat(d, -1) : a.numberFormat(d, -1, void 0, ""));
                        return r
                    },
                                            ...
                                            if (a.isXAxis)
                                                b = k.xData,
                                                    ...
                                                    (k = p(b), c =
                                                        G(b), w(k) ||
                                                        k instanceof Date ||
                                                        (b = f(b, w), k = p(b), c = G(b)), b.length &&
                                                    (a.dataMin = Math.min(F(a.dataMin, b[0], k), k), a.dataMax =
                                                        Math.max(F(a.dataMax, b[0], c), c)));
                                            else if (k.getExtremes(), c = k.dataMax, k =
                                                k.dataMin, z(k) &&
                                                z(c) &&
                                                (a.dataMin = Math.min(F(a.dataMin, k), k), a.dataMax =
                                                    Math.max(F(a.dataMax, c), c)), z(A) && (a.threshold = A), !b
                                                .softThreshold ||
                    ...
                    translate: function(a, d, b, c, f, h) {
                        var k = this.linkedParent || this, A = 1, x = 0, I = c ? k.oldTransA : k.transA;
                        c = c ? k.oldMin : k.min;
                        ...
                        d
                            ? (a = (a * A + x - e) / I + c, f && (a = k.lin2val(a)))
                            : (f && (a = k.val2lin(a)), a =
                                w(c) ? A * (a - c) * I + x + A * e + (w(h) ? I * h : 0) : void 0);
                        return a
                    },
                    ...
                    getPlotLinePath: function(a,
                        ...
                        w(f)
                            ? this.horiz
                            ? (x = h, I = e - this.bottom, a = b = q(a, A, A + this.width))
                            : (a = A, b = r - this.right, x = I = q(x, h, h + this.height))
                            : (n = !0, c = !1);
                        return n && !c
                            ? null
                    ...
                    getMinorTickPositions: function() {
                        ...
                        if (e && e / c < a.len / 3)
                            ...
                            else for (d = x + (b[0] - x) % c; d <= h && d !== f[0]; d += c) f.push(d);
                    ...
                    adjustForMinRange: function() {
                        ...
                        b - d < this.minRange &&
                        (f = this.dataMax - this.dataMin >= this.minRange, q = this.minRange, c = (q - b + d) / 2, c =
                                [d - c, F(a.min, d - c)],
                            f && (c[2] = this.isLog ? this.log2lin(this.dataMin) : this.dataMin), d = G(c), b =
                                [d + q, F(a.max, d + q)], f &&
                                (b[2] = this.isLog ? this.log2lin(this.dataMax) : this.dataMax), b = p(b), b - d < q &&
                            (c[0] = b - q, c[1] =
                                F(a.min, b - q), d = G(c)));
                        this.min = d;
                        this.max = b
                    ...
                    updateNames: function() {
                        ...
                        0 < d.length &&
                        (l(a.keys(d.keys), function(a) { delete d.keys[a] }), d.length = 0, this.minRange =
                            this.userMinRange, l(this.series || [],
                            function(a) {
                                a.xIncrement = null;
                                ...
                                l(a.points,
                                    function(d, b) {
                                        var c;
                                        d.options &&
                                            (c = k.nameToX(d), void 0 !== c && c !== d.x && (d.x = c, a.xData[b] = c))
                                    })
                            }))
                    },
                    setAxisTranslation: function(a) {
                        ...
                        if (q || r || b)
                            c = k.getClosest(), x
                                ? (f = x.minPointOffset, h = x.pointRangePadding)
                                : l(k.series,
                                    function(a) {
                                        ...
                                        b = Math.max(b, d);
                                        k.single ||
                                            (f = Math.max(f, D(a) ? 0 : d / 2), h = Math.max(h, "on" === a ? 0 : d))
                                    }), x = k.ordinalSlope && c ? k.ordinalSlope / c : 1, k.minPointOffset =
                                f *= x, k.pointRangePadding = h *= x, k.pointRange =
                                Math.min(b, d), q && (k.closestPointRange = c);
                        a &&
                        (k.oldTransA =
                            n);
                    ...
                    setTickInterval: function(k) {
                        ...
                        p = F(d.userMax, c.max);
                        r
                            ? (d.linkedParent = b[d.coll][c.linkedTo], b = d.linkedParent.getExtremes(), d.min =
                                F(b.min, b.dataMin), d.max =
                                F(b.max, b.dataMax), c.type !== d.linkedParent.options.type && a.error(11, 1))
                            : (!m && z(K) && (d.dataMin >= K ? (y = K, E = 0) : d.dataMax <= K && (v = K, q = 0)),
                                d.min = F(u, y, d.dataMin), d.max = F(p, v, d.dataMax));
                        f &&
                        (d.positiveValuesOnly && !k && 0 >= Math.min(d.min, F(d.dataMin, d.min)) && a.error(10, 1),
                            d.min = g(d.log2lin(d.min), 15), d.max = g(d.log2lin(d.max), 15));
                        d.range &&
                            z(d.max) &&
                            (d.userMin = d.min =
                        ...
                        d.adjustForMinRange();
                        !(t || d.axisPointRange || d.usePercentage || r) &&
                            z(d.min) &&
                            z(d.max) &&
                            (b = d.max - d.min) &&
                            (!z(u) && E && (d.min -= b * E), !z(p) && q && (d.max += b * q));
                        ...
                        m &&
                            z(d.dataMin) &&
                            (K = K || 0, !z(u) && d.min < K && d.dataMin >= K
                                ? d.min = K
                                : !z(p) && d.max > K && d.dataMax <= K && (d.max = K));
                        d.tickInterval = d.min === d.max || void 0 === d.min || void 0 === d.max
                            ? 1
                            : r && !D && H === d.linkedParent.options.tickPixelInterval
                            ? D = d.linkedParent.tickInterval
                            : F(D,
                                this.tickAmount ? (d.max - d.min) / Math.max(this.tickAmount - 1, 1) : void 0,
                                t ? 1 : (d.max - d.min) * H / Math.max(d.len, H));
                        x && !k && l(d.series, function(a) { a.processData(d.min !== d.oldMin || d.max !== d.oldMax) });
                        ...
                        h ||
                            f ||
                            D ||
                            (d.tickInterval = J(d.tickInterval,
                                null,
                                n(d.tickInterval),
                                F(c.allowDecimals,
                                    !(.5 < d.tickInterval && 5 > d.tickInterval && 1E3 < d.max && 9999 > d.max)),
                                !!this.tickAmount));
                    ...
                    setTickPositions: function() {
                        ...
                        !d &&
                            (d = this.isDatetimeAxis
                                ...
                                : this.getLinearTickPositions(this.tickInterval, this.min, this.max), d.length >
                                this.len &&
                                (d = [d[0], d.pop()], d[0] === d[1] && (d.length = 1)), this.tickPositions =
                                d, c && (c = c.apply(this, [this.min, this.max]))) &&
                            (this.tickPositions = d = c);
                        this.paddedTicks = d.slice(0);
                        this.trimTicks(d, f, h);
                        this.isLinked ||
                        (this.single && 2 > d.length && (this.min -= .5, this.max += .5), b ||
                            c ||
                    ...
                    adjustTickAmount: function() {
                        ...
                        if (this.hasData()) {
                            if (f < b) {
                                for (; d.length < b;)
                                    d.length % 2 || this.min === h
                                        ? d.push(g(d[d.length - 1] + a))
                                        : d.unshift(g(d[0] - a));
                                this.transA *= (f - 1) / (b - 1);
                                this.min = d[0];
                    ...
                    setScale: function() {
                        ...
                        l(this.series, function(d) { if (d.isDirtyData || d.isDirty || d.xAxis.isDirty) a = !0 });
                        d ||
                            a ||
                            this.isLinked ||
                            this.forceRedraw ||
                            ...
                            this.alignToOthers()
                            ? (this.resetStacks && this.resetStacks(), this.forceRedraw =
                                !1, this.getSeriesExtremes(), this.setTickInterval(), this.oldUserMin =
                                this.userMin, this.oldUserMax = this.userMax, this.isDirty ||
                            (this.isDirty =
                                d || this.min !== this.oldMin || this.max !== this.oldMax))
                    ...
                    setExtremes: function(a, d, c, f, h) {
                        ...
                        c = F(c, !0);
                        l(k.series, function(a) { delete a.kdTree });
                        h = b(h, { min: a, max: d });
                        e(k,
                            "setExtremes",
                            h,
                    ...
                    zoom: function(a, d) {
                        ...
                        if (a !== this.min || d !== this.max)
                            this.allowZoomOutside ||
                                (z(k) &&
                                    (a < f && (a = f), a > c && (a = c)), z(b) && (d < f && (d = f), d > c && (d = c))),
                                this.displayBtn =
                                    void 0 !== a || void 0 !== d, this.setExtremes(a,
                                    d,
                                    !1,
                                    void 0,
                                    { trigger: "zoom" });
                    ...
                    setAxisSize: function() {
                        var d = this.chart,
                            ...
                            f = this.horiz,
                            h = this.width =
                                Math.round(a.relativeLength(F(b.width, d.plotWidth - c[3] + c[1]), d.plotWidth)),
                            x = this.height =
                                Math.round(a.relativeLength(F(b.height, d.plotHeight - c[0] + c[2]), d.plotHeight)),
                            e = this.top =
                                Math.round(a.relativeLength(F(b.top, d.plotTop + c[0]), d.plotHeight, d.plotTop)),
                            b = this.left =
                                Math.round(a.relativeLength(F(b.left, d.plotLeft + c[3]), d.plotWidth, d.plotLeft));
                    ...
                    unsquish: function() {
                        ...
                        d
                            ? (n = !a.staggerLines &&
                                !a.step &&
                                (z(x) ? [x] : f < F(a.autoRotationLimit, 80) && a.autoRotation)) &&
                            l(n,
                                function(a) {
                                    var d;
                                    if (a === x || a && -90 <= a && 90 >= a)
                                        r = w(Math.abs(e.h / Math.sin(u * a))), d =
                    ...
                    getSlotWidth: function() {
                        var a = this.chart,
                            ...
                            f = a.margin[3];
                        return d && 2 > (b.step || 0) && !b.rotation && (this.staggerLines || 1) * this.len / c ||
                            !d &&
                            (b.style && parseInt(b.style.width, 10) || f && f - a.spacing[3] || .33 * a.chartWidth)
                    },
                    renderUnsquish: function() {
                        ...
                        if (this.autoRotation)
                            ...
                            for (E = "clip", e = b.length; !h && e--;)
                                if (t = b[e], t = c[t].label)
                                    t.styles &&
                                        "ellipsis" ===
                                        t.styles.textOverflow
                                        ? t.css({ textOverflow: "clip" })
                                        : t.textPxLength > x && t.css({ width: x + "px" }), t.getBBox().height >
                                        this.len / b.length - (q.h - q.f) &&
                                        (t.specificTextOverflow = "ellipsis");
                        r.rotation &&
                            (w = H > .5 * a.chartHeight ? .33 * a.chartHeight : a.chartHeight, n || (E = "ellipsis"));
                        if (this.labelAlign =
                            f.align || this.autoLabelAlign(this.labelRotation)) r.align = this.labelAlign;
                        l(b,
                            function(a) {
                                ...
                                (d.attr(r), !w ||
                                    ...
                                    (b.width = w, n ||
                                        (b.textOverflow = d.specificTextOverflow || E), d.css(b)), delete d
                                    .specificTextOverflow, a.rotation = r.rotation)
                            });
                        this.tickRotCorr = d.rotCorr(q.b, this.labelRotation || 0, 0 !== this.side)
                    },
                    hasData: function() {
                        return this.hasVisibleSeries ||
                            z(this.min) && z(this.max) && this.tickPositions && 0 < this.tickPositions.length
                    },
                    addTitle: function(a) {
                        ...
                        (f = (b
                            ...
                            d.text(c.text, 0, 0, c.useHTML).attr({ zIndex: 7, rotation: c.rotation || 0, align: f })
                            .addClass("highcharts-axis-title").css(r(c.style))
                            .add(this.axisGroup), this.axisTitle.isNew = !0);
                    ...
                    getOffset: function() {
                        ...
                        a.axisGroup ||
                        (a.gridGroup =
                            b.g("grid").attr({ zIndex: c.gridZIndex || 1 })
                            .addClass("highcharts-" + this.coll.toLowerCase() + "-grid " + (y || ""))
                            .add(v), a.axisGroup = b.g("axis").attr({ zIndex: c.zIndex || 2 }).addClass("highcharts-" +
                            this.coll.toLowerCase() +
                            " " +
                            (y || "")).add(v), a.labelGroup = b.g("axis-labels").attr({ zIndex: K.zIndex || 7 })
                            .addClass("highcharts-" + a.coll.toLowerCase() + "-labels " + (y || "")).add(v));
                        n || a.isLinked
                            ? (l(f, function(d, b) { a.generateTick(d, b) }), a.renderUnsquish(),
                                a.reserveSpaceDefault =
                                    0 === e || 2 === e || { 1: "left", 3: "right" }[e] === a.labelAlign, F(
                                        K.reserveSpace,
                                        "center" === a.labelAlign ? !0 : null,
                                        a.reserveSpaceDefault) &&
                                    l(f, function(a) { g = Math.max(h[a].getLabelSize(), g) }), a.staggerLines &&
                                    (g *= a.staggerLines), a.labelOffset = g *
                                    (a.opposite ? -1 : 1))
                            : q(h,
                                function(a, d) {
                                    a.destroy();
                        ...
                        t &&
                            ...
                            (a.addTitle(w), w &&
                                !1 !== t.reserveSpace &&
                                (a.titleOffset = E = a.axisTitle.getBBox()[x ? "height" : "width"], D = t.offset, H =
                                    z(D) ? 0 : F(t.margin, x ? 5 : 10)));
                        a.renderLine();
                        ...
                        J[e] = Math.max(J[e],
                            a.axisTitleMargin + E + m * a.offset,
                            H,
                            n && f.length && u ? u[0] + m * a.offset : 0);
                    ...
                    getLinePath: function(a) {
                        ...
                        return d.renderer.crispLine([
                                "M", c ? this.left : f, c ? k : this.top, "L", c ? d.chartWidth - this.right : f,
                                c ? k : d.chartHeight - this.bottom
                            ],
                            a)
                    },
                    renderLine: function() {
                    ...
                    renderTick: function(a, d) {
                        ...
                        if (!b || a >= this.min && a <= this.max)
                            k[a] || (k[a] = new H(this, a)), c && k[a].isNew && k[a].render(d, !0, .1), k[a].render(d)
                    },
                    render: function() {
                        var b =
                                this,
                        ...
                        b.overlap = !1;
                        l([E, D, t], function(a) { q(a, function(a) { a.isActive = !1 }) });
                        if (b.hasData() || x)
                            b.minorTickInterval &&
                                !b.categories &&
                                l(b.getMinorTickPositions(), function(a) { b.renderMinorTick(a) }), r.length &&
                            (l(r, function(a, d) { b.renderTick(a, d) }),
                                g &&
                                    (0 === b.min || b.single) &&
                                    (E[-1] || (E[-1] = new H(b, -1, null, !0)), E[-1].render(-1))), F &&
                                l(r,
                                    function(d, k) {
                                        ...
                                        0 === k % 2 &&
                                            d < b.max &&
                                            u <= b.max + (c.polar ? -g : g) &&
                                            (t[d] || (t[d] = new a.PlotLineOrBand(b)), v = d + g, t[d].options =
                                                { from: h ? b.lin2log(v) : v, to: h ? b.lin2log(u) : u, color: F }, t[d]
                                                .render(), t[d].isActive = !0)
                                    }), b._addedPlotLB ||
                            (l((f.plotLines || []).concat(f.plotBands || []),
                                function(a) { b.addPlotBandOrLine(a) }), b._addedPlotLB = !0);
                        l([E, D, t],
                            function(a) {
                        ...
                        J &&
                        (J[J.isPlaced ? "animate" : "attr"]({ d: this.getLinePath(J.strokeWidth()) }), J.isPlaced =
                            !0, J[m ? "show" : "hide"](!0));
                        n &&
                            m &&
                            (f = b.getTitlePosition(), w(f.y)
                                ? (n[n.isNew ? "attr" : "animate"](f), n.isNew = !1)
                    ...
                    redraw: function() {
                        this.visible &&
                            (this.render(), l(this.plotLinesAndBands, function(a) { a.render() }));
                        l(this.series, function(a) { a.isDirty = !0 })
                    },
                    ...
                    drawCrosshair: function(a, d) {
                        ...
                        if (this.crosshair && !1 !== (z(d) || !k)) {
                            k
                                ? z(d) && (f = F(d.crosshairPos, this.isXAxis ? d.plotX : this.len - d.plotY))
                                : f = a &&
                                (this.horiz
                                    ? a.chartX - this.pos
                                    : this.len -
                                    ...
                                    this.pos);
                            z(f) &&
                            (b = this.getPlotLinePath(d && (this.isXAxis ? d.x : F(d.stackY, d.y)),
                                    null,
                                    null,
                                    null,
                                    f) ||
                            ...
                            (this.cross = h =
                                ...
                                .addClass("highcharts-crosshair highcharts-crosshair-" +
                                    (k ? "category " : "thin ") +
                                    c.className).attr({ zIndex: F(c.zIndex, 2) })
                                .add(), h.attr({
        ...
        (function(a) {
            ...
            B.prototype.normalizeTimeTickInterval = function(a, g) {
                ...
                for (y = 0;
                    y < m.length &&
                        !(g = m[y], z = p[g[0]], u = g[1], m[y + 1] && a <= (z * u[u.length - 1] + p[m[y + 1][0]]) / 2);
                    y++);
        ...
        (function(a) {
            ...
            B.prototype.getLogTickPositions = function(a, v, z, u) {
                ...
                if (.5 <= a) a = Math.round(a), b = this.getLinearTickPositions(a, v, z);
                    ...
                    for (var l = Math.floor(v),
                        e,
                        t,
                        n,
                        f,
                        c,
                        g = .3 < a ? [1, 2, 4] : .15 < a ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9];
                        l < z + 1 && !c;
                        l++)
                        for (t = g.length, e = 0; e < t && !c; e++)
                            n = this.log2lin(this.lin2log(l) * g[e]), n > v &&
                                (!u || f <= z) &&
                                void 0 !== f &&
                                b.push(f), f > z && (c = !0), f = n;
                else
                    v = this.lin2log(v), z = this.lin2log(z), a = u ? this.getMinorTickInterval() : g.tickInterval, a =
                        m("auto" === a ? null : a,
                            this._minorAutoInterval,
                            g.tickPixelInterval /
                            (u ? 5 : 1) *
                            (z - v) /
                            ((u ? l / this.tickPositions.length : l) || 1)), a = p(a, null, C(a)), b =
                        G(this.getLinearTickPositions(a, v, z), this.log2lin), u || (this._minorAutoInterval = a / 5);
            ...
            a.PlotLineOrBand.prototype = {
                render: function() {
                    var g = this,
                        ...
                        x = u(e.zIndex, 0),
                        K = e.events,
                        q = { "class": "highcharts-plot-" + (w ? "band " : "line ") + (e.className || "") },
                        d = {},
                        H = l.chart.renderer,
                        E = w ? "bands" : "lines";
                    l.isLog && (c = l.log2lin(c), f = l.log2lin(f), h = l.log2lin(h));
                    D
                        ? (q = { stroke: F, "stroke-width": e.width },
                            e.dashStyle && (q.dashstyle = e.dashStyle))
                        : w &&
                        (F && (q.fill = F), e.borderWidth &&
                            (q.stroke = e.borderColor, q["stroke-width"] = e.borderWidth));
                    d.zIndex = x;
                    E += "-" + x;
                    (F = l.plotLinesAndBandsGroups[E]) ||
                        (l.plotLinesAndBandsGroups[E] = F = H.g("plot-" + E).attr(d).add());
                    ...
                    J && q && q.length
                        ? (r.attr({ d: q }), K &&
                            a.objectEach(K, function(a, d) { r.on(d, function(a) { K[d].apply(g, [a]) }) }))
                        : r &&
                        (q
                            ? (r.show(),
                                r.animate({ d: q }))
                            : (r.hide(), n && (g.label = n = n.destroy())));
                    t && p(t.text) && q && q.length && 0 < l.width && 0 < l.height && !q.flat
                        ? (t = z({
                                align: b && w && "center",
                                x: b ? !w && 4 : 10,
            ...
            a.extend(B.prototype,
                {
                    getPlotBandPath: function(a, l) {
                        ...
                        if (e &&
                            b)
                            for (a && (c = e.toString() === b.toString(), f = 0), a = 0; a < e.length; a += 6)
                                n && b[a + 1] === e[a + 1]
                                    ? (b[a + 1] += f, b[a + 4] += f)
                                    : n || b[a + 2] !== e[a + 2] || (b[a + 2] += f, b[a + 5] += f), t.push("M",
                                    e[a + 1],
                                    e[a + 2],
                                    "L",
                                    e[a + 4],
                    ...
                    removePlotBandOrLine: function(a) {
                        ...
                        g([b.plotLines || [], e.plotLines || [], b.plotBands || [], e.plotBands || []],
                            function(b) { for (t = b.length; t--;) b[t].id === a && v(b, b[t]) })
                    },
            ...
            a.Tooltip.prototype = {
                ...
                getLabel: function() {
                    ...
                    (this.split
                        ...
                        : (this.label =
                            a.label("", 0, 0, b.shape || "callout", null, null, b.useHTML, null, "tooltip")
                            .attr({ padding: b.padding, r: b.borderRadius }), this.label
                            .attr({ fill: b.backgroundColor, "stroke-width": b.borderWidth }).css(b.style)
                ...
                move: function(l, b, e, t) {
                    var n = this,
                        f = n.now,
                        c = !1 !== n.options.animation &&
                            !n.isHidden &&
                            (1 < Math.abs(l - f.x) || 1 < Math.abs(b - f.y)),
                ...
                getAnchor: function(a, b) {
                    ...
                    this.followPointer &&
                        b &&
                        (void 0 === b.chartX && (b = l.pointer.normalize(b)), e =
                            [b.chartX - l.plotLeft, b.chartY - f]);
                    e ||
                    (B(a,
                        function(a) {
                            D = a.series.yAxis;
                        ...
                        }), h /= a.length, w /= a.length, e = [
                        n ? l.plotWidth - w : h,
                        this.shared && !n && 1 < a.length && b ? b.chartY - f : n ? l.plotHeight - h : w
                    ]);
                ...
                refresh: function(l, b) {
                    ...
                    (a.clearTimeout(this.hideTimer), this.followPointer =
                        z(f)[0].series.tooltipOptions.followPointer, c = this.getAnchor(f, b), b = c[0], n =
                        c[1], !h || f.series && f.series.noSharedTooltip
                        ? h = f.getLabelConfig()
                        : (B(f,
                                function(a) {
                                    a.setState("hover");
                            ...
                            h = { x: f[0].category, y: f[0].y }, h.points = w, f = f[0]), this.len = w.length, h =
                        e.call(h, this), D = f.series, this.distance = v(D.tooltipOptions.distance, 16), !1 === h
                        ? this.hide()
                        : (e = this.getLabel(), this.isHidden && e.attr({ opacity: 1 }).show(), this.split
                            ? this.renderSplit(h, z(l))
                            : (t.style.width || e.css({ width: this.chart.spacingBox.width }),
                                e.attr({ text: h && h.join ? h.join("") : h }), e.removeClass(/highcharts-color-[\d]+/g)
                                    .addClass("highcharts-color-" + v(f.colorIndex, D.colorIndex)), e.attr({
                    ...
                    B(l.slice(0, b.length + 1),
                        function(a, l) {
                            if (!1 !== a) {
                                ...
                                F ||
                                (r.tt = F = f.label(null, null, null, "callout", null, null, h.useHTML).addClass(
                                ...
                                l.isHeader
                                    ? (w = a.height, x =
                                        Math.max(0, Math.min(l.plotX + n.plotLeft - x / 2, n.chartWidth - x)))
                                    : x = l.plotX + n.plotLeft - v(h.distance, 16) - x;
                                0 > x && (c = !1);
                ...
                tooltipFooterHeaderFormatter: function(a, b) {
                    ...
                    c &&
                        n &&
                        B(a.point && a.point.tooltipDateKeys || ["key"],
                            function(a) {
                                h = h.replace("{point." + a + "}",
                                    "{point." +
                                    a +
                ...
                bodyFormatter: function(a) {
                    return m(a,
                        function(a) {
                            ...
                            return(b[(a.point.formatPrefix || "point") + "Formatter"] || a.point.tooltipFormatter).call(
                                a.point,
        ...
        (function(a) {
            ...
            a.Pointer.prototype = {
                        ...
                        function(a) {
                            ...
                            if ((h = b(a, !0)) && !(h = !b(c, !0)))
                                var h = c.distX - a.distX,
                                    n = c.dist - a.dist,
                                    r = (a.series.group && a.series.group.zIndex) -
                ...
                getChartCoordinatesFromPoint: function(a, b) {
                    ...
                    if (f && c)
                        return b
                            ? { chartX: f.len + f.pos - h, chartY: c.len + c.pos - a.plotY }
                            : { chartX: h + f.pos, chartY: a.plotY + c.pos };
                    if (e && e.x && e.y) return{ chartX: e.x, chartY: e.y }
                },
                getHoverData: function(c, f, e, n, r, l, q) {
                    var h, x = [], w = q && q.isBoosting;
                    n = !(!n || !c);
                    q = f && !f.stickyTracking
                        ? [f]
                        : a.grep(e,
                            function(a) {
                                return a.visible &&
                                    !(!r && a.directTouch) &&
                                    t(a.options.enableMouseTracking, !0) &&
                                    a.stickyTracking
                            });
                    ...
                    (r && !f.noSharedTooltip
                        ? (q = a.grep(e,
                            ...
                            function(a) {
                                var d = u(a.points, function(a) { return a.x === h.x && !a.isNull });
                ...
                runPointActions: function(b, f) {
                    var c = this.chart,
                        ...
                        q = this.getHoverData(n,
                            q,
                            c.series,
                            !!f || q && q.directTouch && this.isDirectTouch,
                            e,
                            b,
                    ...
                    if (n && (n !== c.hoverPoint || h && h.isHidden)) {
                        v(c.hoverPoints || [], function(b) { -1 === a.inArray(b, l) && b.setState() });
                        v(l || [], function(a) { a.setState("hover") });
                    ...
                    this.unDocMouseMove ||
                    (this.unDocMouseMove = B(c.container.ownerDocument,
                        "mousemove",
                        function(b) {
                    ...
                    v(c.axes,
                        function(c) {
                            var f = t(c.crosshair.snap, !0),
                                d = f ? a.find(l, function(a) { return a.series[c.coll] === c }) : void 0;
                ...
                reset: function(a, b) {
                    var c = this.chart,
                        ...
                        q = c.tooltip,
                        l = q && q.shared ? e : h;
                    a && l && v(n(l), function(b) { b.series.isCartesian && void 0 === b.plotX && (a = !1) });
                    if (a)
                        q &&
                            l &&
                            (q.refresh(l), h &&
                            (h.setState(h.state, !0), v(c.axes,
                                function(a) { a.crosshair && a.drawCrosshair(null, h) })));
                    else {
                        if (h) h.onMouseOut();
                    ...
                    v(c.series,
                        function(h) {
                            ...
                            h.xAxis &&
                                h.xAxis.zoomEnabled &&
                                h.group &&
                                (h.group.attr(f), h.markerGroup &&
                                    (h.markerGroup.attr(f), h.markerGroup.clip(b ? c.clipRect : null)), h
                                    .dataLabelsGroup &&
                ...
                drag: function(a) {
                    ...
                    E && E.touch ||
                    (f < l ? f = l : f > l + t && (f = l + t), e < x ? e = x : e > x + d && (e = x + d),
                        this.hasDragged = Math.sqrt(Math.pow(k - f, 2) + Math.pow(A - e, 2)), 10 < this.hasDragged &&
                        (H = b.isInsidePlot(k - l, A - x), b.hasCartesianSeries &&
                            (this.zoomX || this.zoomY) &&
                            H &&
                            !g &&
                            !E &&
                            (this.selectionMarker = E = b.renderer.rect(l, x, n ? 1 : t, q ? 1 : d, 0).attr({
                                fill: c.selectionMarkerFill || p("#335cad").setOpacity(.25).get(),
                                "class": "highcharts-selection-marker",
                                zIndex: 7
                            }).add()), E && n && (f -= k, E.attr({ width: Math.abs(f), x: (0 < f ? 0 : f) + k })), E &&
                            q &&
                            (f = e - A, E.attr({ height: Math.abs(f), y: (0 < f ? 0 : f) + A })), H &&
                            !E &&
                            c.panning &&
                            b.pan(a, c.panning)))
                },
                    ...
                    if (this.selectionMarker) {
                        ...
                        if (this.hasDragged || f)
                            v(c.axes,
                                ...
                                y(c, "selection", e, function(a) { c.zoom(z(a, f ? { animation: !1 } : null)) });
                        l(c.index) && (this.selectionMarker = this.selectionMarker.destroy());
                        f && this.scaleGroups()
                    }
                    c &&
                        l(c.index) &&
                        (m(c.container, { cursor: c._cursor }), c.cancelClick = 10 < this.hasDragged, c.mouseIsDown =
                            this.hasDragged = this.hasPinched =
                            !1, this.pinchDown = [])
                },
                ...
                onContainerMouseMove: function(b) {
                    var c = this.chart;
                    g(a.hoverChartIndex) && G[a.hoverChartIndex] && G[a.hoverChartIndex].mouseIsDown ||
                ...
                onContainerClick: function(a) {
                    ...
                    (f && this.inClass(a.target, "highcharts-tracker")
                        ? (y(f.series, "click", z(a, { point: f })), b.hoverPoint && f.firePointEvent("click", a))
                        : (z(a, this.getCoordinates(a)), b.isInsidePlot(a.chartX - c, a.chartY - e) && y(b, "click", a))
                    )
                },
                setDOMEvents: function() {
                    var b = this, f = b.chart.container, e = f.ownerDocument;
                    f.onmousedown = function(a) { b.onContainerMouseDown(a) };
                    ...
                    a.hasTouch &&
                    (f.ontouchstart = function(a) { b.onContainerTouchStart(a) }, f.ontouchmove =
                        function(a) { b.onContainerTouchMove(a) }, a.unbindDocumentTouchEnd ||
                        (a.unbindDocumentTouchEnd = B(e, "touchend", b.onDocumentTouchEnd)))
                },
                destroy: function() {
                    var b = this;
                    ...
                    a.chartCount ||
                    (a.unbindDocumentMouseUp && (a.unbindDocumentMouseUp = a.unbindDocumentMouseUp()), a
                        .unbindDocumentTouchEnd &&
                        (a.unbindDocumentTouchEnd = a.unbindDocumentTouchEnd()));
                    clearInterval(b.tooltipTimeout);
                    a.objectEach(b, function(a, f) { b[f] = null })
                }
            }
        })(L);
        (function(a) {
            ...
            G(a.Pointer.prototype,
                {
                    ...
                    pinch: function(a) {
                        var v =
                            ...
                            f = {},
                            c = 1 === b &&
                                (v.inClass(a.target, "highcharts-tracker") && u.runTrackerClick || v.runChartClick),
                            h = {};
                        1 < b && (v.initiated = !0);
                        t && v.initiated && !c && a.preventDefault();
                        p(l, function(a) { return v.normalize(a) });
                        "touchstart" === a.type
                            ? (C(l, function(a, b) { y[b] = { chartX: a.chartX, chartY: a.chartY } }), e.x =
                                [y[0].chartX, y[1] && y[1].chartX], e.y = [y[0].chartY, y[1] && y[1].chartY], C(u.axes,
                                function(a) {
                                    if (a.zoomEnabled) {
                                        var b =
                            ...
                            : v.followTouchMove && 1 === b
                            ? this.runPointActions(v.normalize(a))
                            : y.length &&
                            (n || (v.selectionMarker = n = G({ destroy: m, touch: !0 }, u.plotBox)),
                                v.pinchTranslate(y, l, f, n, h, e), v.hasPinched =
                                    t, v.scaleGroups(f, h), v.res && (v.res = !1, this.reset(!1, 0)))
                    },
                    touch: function(m, p) {
                        ...
                        1 === m.touches.length
                            ? (m =
                                    this.normalize(m),
                                (l = u.isInsidePlot(m.chartX - u.plotLeft, m.chartY - u.plotTop)) && !u.openMenu
                                    ? (p && this.runPointActions(m), "touchmove" === m.type &&
                                    (p = this.pinchDown, v =
                                        p[0]
                                        ? 4 <=
                                        Math.sqrt(Math.pow(p[0].chartX - m.chartX, 2) +
                                            Math.pow(p[0].chartY - m.chartY, 2))
                                        : !1), g(v, !0) && this.pinch(m))
                                    : p && this.reset())
                    ...
                    onDocumentTouchEnd: function(g) { B[a.hoverChartIndex] && B[a.hoverChartIndex].pointer.drop(g) }
                })
        })(L);
        (function(a) {
            var B = a.addEvent,
            ...
            if (!a.hasTouch && (u.PointerEvent || u.MSPointerEvent)) {
                var l = {},
                    ...
                    e = function() {
                        ...
                        a.objectEach(l, function(a) { b.push({ pageX: a.pageX, pageY: a.pageY, target: a.target }) });
                        return b
                    },
                    t = function(b, f, c, h) {
                        "touch" !== b.pointerType && b.pointerType !== b.MSPOINTER_TYPE_TOUCH ||
                            !C[a.hoverChartIndex] ||
                            (h(b), h = C[a.hoverChartIndex].pointer, h[f]({
                                type: c,
                ...
                m(v.prototype,
                    {
                        ...
                        onDocumentPointerUp: function(a) {
                            t(a, "onDocumentTouchEnd", "touchend", function(a) { delete l[a.pointerId] })
                        },
        ...
        (function(a) {
            ...
            a.Legend.prototype =
            {
                init: function(a, b) {
                    ...
                    this.setOptions(b);
                    b.enabled &&
                        (this.render(), B(this.chart, "endResize", function() { this.legend.positionCheckboxes() }))
                },
                setOptions: function(a) {
                    var b = y(a.padding, 8);
                    this.options = a;
                ...
                positionCheckboxes: function() {
                    var a = this.group && this.group.alignAttr,
                        ...
                        h = this.titleHeight;
                    a &&
                    (b = a.translateY, m(this.allItems,
                        function(f) {
                            var e = f.checkbox, n;
                            e &&
                            (n = b + h + e.y + (this.scrollOffset || 0) + 3, C(e,
                                {
                ...
                renderTitle: function() {
                    ...
                    (this.title = this.chart.renderer
                        ...
                        .attr({ zIndex: 1 }).css(c.style).add(this.group)), a = this.title.getBBox(), h =
                        a.height, this.offsetWidth = a.width, this.contentGroup.attr({ translateY: h }));
                    this.titleHeight = h
                },
                setText: function(b) {
                    var f = this.options;
                ...
                renderItem: function(a) {
                    ...
                    (a.legendGroup = c.g("legend-item")
                            .addClass("highcharts-" +
                                ...
                                a.colorIndex +
                                (k ? " " + k : "") +
                                (K ? " highcharts-series-" + a.index : "")).attr({ zIndex: 1 }).add(this.scrollGroup),
                        a.legendItem = x =
                            c.text("", g ? e + l : -l, this.baseline || 0, E).css(u(a.visible ? n : t))
                            .attr({ align: g ? "left" : "right", zIndex: 2 })
                            .add(a.legendGroup), this.baseline ||
                        (e = n.fontSize, this.fontMetrics = c.fontMetrics(e, x), this.baseline =
                            this.fontMetrics.f + 3 + this.itemMarginTop, x.attr("y", this.baseline)),
                        this.symbolHeight =
                            h.symbolHeight || this.fontMetrics.f, d.drawLegendSymbol(this, a), this.setItemEvents &&
                            this.setItemEvents(a, x, E), H && this.createCheckboxForItem(a));
                ...
                layoutItem: function(a) {
                    ...
                    h &&
                        this.itemX - c + b > g &&
                        (this.itemX = c, this.itemY += n + this.lastLineHeight + l, this.lastLineHeight = 0);
                    this.lastItemY = n + this.itemY + l;
                    this.lastLineHeight = Math.max(e, this.lastLineHeight);
                    a._legendItemPos = [this.itemX, this.itemY];
                    h ? this.itemX += b : (this.itemY += n + e + l, this.lastLineHeight = e);
                    this.offsetWidth =
                        q || Math.max((h ? this.itemX - c - (a.checkbox ? 0 : t) : b) + c, this.offsetWidth)
                },
                    ...
                    m(this.chart.series,
                        function(b) {
                            var c =
                                b && b.options;
                            b &&
                                y(c.showInLegend, p(c.linkedTo) ? !1 : void 0, !0) &&
                ...
                adjustMargins: function(a, b) {
                    ...
                    e &&
                        m([/(lth|ct|rth)/, /(rtv|rm|rbv)/, /(rbh|cb|lbh)/, /(lbv|lm|ltv)/],
                            function(h, l) {
                                h.test(e) &&
                                    !p(a[l]) &&
                                    (c[z[l]] = Math.max(c[z[l]],
                                        c.legend[(l + 1) % 2 ? "legendHeight" : "legendWidth"] +
                                        [1, -1, -1, 1][l] * f[l % 2 ? "x" : "y"] +
                                        y(f.margin, 12) +
                                        b[l] +
                                        (0 === l && void 0 !== c.options.title.margin
                                            ? c.titleOffset + c.options.title.margin
                                            : 0)))
                            })
                },
                render: function() {
                    ...
                    c ||
                    (this.group = c = f.g("legend").attr({ zIndex: 7 }).add(), this.contentGroup =
                        f.g().attr({ zIndex: 1 }).add(c), this.scrollGroup = f.g().add(this.contentGroup));
                    this.renderTitle();
                    e = this.getAllItems();
                    b(e,
                        function(a, b) {
                    ...
                    r += F;
                    g ||
                    (this.box = g = f.rect().addClass("highcharts-legend-box").attr({ r: q.borderRadius }).add(c),
                        g.isNew = !0);
                    g.attr({
                    ...
                    0 < t &&
                        0 < r &&
                        (g[g.isNew ? "attr" : "animate"](g.crisp.call({},
                            { x: 0, y: 0, width: t, height: r },
                    ...
                    l &&
                    (f = a.spacingBox, /(lth|ct|rth)/.test(this.getAlignment()) &&
                        (f = u(f, { y: f.y + a.titleOffset + a.options.title.margin })), c.align(u(q,
                            { width: t, height: r }),
                        !0,
                        f));
                ...
                handleOverflow: function(a) {
                    var b = this,
                        ...
                        A = function(a) {
                            ...
                            (b.contentGroup.div.style.clip =
                                a ? "rect(" + r + "px,9999px," + (r + a) + "px,0)" : "auto")
                        };
                    "horizontal" !== l.layout ||
                    ...
                    H.length = 0;
                    a > c && !1 !== g.enabled
                        ? (this.clipHeight = t = Math.max(c - 20 - this.titleHeight - r, 0), this.currentPage =
                                y(this.currentPage, 1), this.fullHeight = a, m(k,
                                function(a, b) {
                            ...
                            (q = b.clipRect = e.clipRect(0,
                                r,
                                9999,
                                0), b.contentGroup.clip(q)), A(t), d ||
                            (this.nav = d = e.g().attr({ zIndex: 1 }).add(this.group), this.up =
                                    e.symbol("triangle", 0, 0, K, K).on("click", function() { b.scroll(-1, x) }).add(d),
                                this.pager =
                                    e.text("", 15, 10).addClass("highcharts-legend-navigation").css(g.style)
                                    .add(d), this.down =
                                    e.symbol("triangle-down", 0, 0, K, K).on("click", function() { b.scroll(1, x) })
                                    .add(d)),
                            b.scroll(0), a = c)
                        : d &&
                        (A(), this.nav = d.destroy(), this.scrollGroup.attr({ translateY: 1 }), this.clipHeight = 0);
                    return a
                },
                scroll: function(a, b) {
                    var c = this.pages,
                    ...
                    (void 0 !== b && l(b, this.chart),
                        this.nav.attr({
                        ...
                        }), r.attr({ text: a + "/" + f }), this.down.attr({
                            ...
                            .attr({ fill: a === f ? n.inactiveColor : n.activeColor })
                            .css({ cursor: a === f ? "default" : "pointer" }), this.scrollOffset =
                            -c[a - 1] + this.initialItemY, this.scrollGroup.animate({ translateY: this.scrollOffset }),
            ...
            a.LegendSymbolMixin = {
                drawRectangle: function(a, b) {
                    ...
                    b.legendSymbol = this.chart.renderer.rect(f ? (a.symbolWidth - c) / 2 : 0,
                            a.baseline - c + 1,
                            f ? c : a.symbolWidth,
                            c,
                            y(a.options.symbolRadius, c / 2)).addClass("highcharts-point").attr({ zIndex: 3 })
                        .add(b.legendGroup)
                },
                drawLineMarker: function(a) {
                    ...
                    c &&
                        !1 !== c.enabled &&
                        (b = Math.min(y(c.radius, n), n), 0 === this.symbol.indexOf("url") &&
                            (c = u(c, { width: l, height: l }), b = 0), this.legendSymbol = c =
                            r.symbol(this.symbol, e / 2 - b, a - b, 2 * b, 2 * b, c).addClass("highcharts-point")
                            .add(t), c.isMarker = !0)
                }
            };
            (/Trident\/7\.0/.test(e.navigator.userAgent) || v) &&
                t(a.Legend.prototype,
                    "positionItem",
                    function(a, b) {
                        var c = this, f = function() { b._legendItemPos && a.call(c, b) };
                        f();
                        setTimeout(f)
                    })
        })(L);
        (function(a) {
            ...
            a.chart = function(a, b, d) { return new R(a, b, d) };
            t(R.prototype,
                {
                    callbacks: [],
                    getArgs: function() {
                    ...
                    redraw: function(b) {
                        ...
                        e(k,
                            function(a) {
                                a.isDirty &&
                                    ...
                                    (a.updateTotals && a.updateTotals(), x = !0);
                        ...
                        this.getMargins();
                        E &&
                        (e(d, function(a) { a.isDirty && (r = !0) }), e(d,
                            function(a) {
                                var b = a.min + "," + a.max;
                                a.extKey !== b &&
                                (a.extKey = b, A.push(function() {
                                    f(a,
                                        "afterSetExtremes",
                                        t(a.eventArgs,
                                            a.getExtremes()));
                    ...
                    getAxes: function() {
                        ...
                        e(b, function(a, b) { a.index = b });
                        d = d.concat(b);
                        e(d, function(b) { new g(a, b) });
                        f(this, "afterGetAxes")
                    },
                    getSelectedPoints: function() {
                        var a = [];
                        e(this.series,
                            function(b) { a = a.concat(c(b.data || [], function(a) { return a.selected })) });
                        return a
                    },
                    ...
                    setTitle: function(a, b, d) {
                        ...
                        e([["title", a, f], ["subtitle", b, c]],
                            function(a, b) {
                                ...
                                a &&
                                    !c &&
                                    (k[d] = k.renderer.text(a.text, 0, 0, a.useHTML).attr({
                                        align: a.align,
                                        "class": "highcharts-" + d,
                                        zIndex: a.zIndex || 4
                                    }).add(), k[d].update =
                                        function(a) { k.setTitle(!b && a, b && a) }, k[d].css(a.style))
                            });
                        k.layOutTitles(d)
                    },
                    layOutTitles: function(a) {
                        ...
                        e(["title", "subtitle"],
                            function(a) {
                                ...
                                var e;
                                d &&
                                (e = f.style.fontSize, e =
                                    k.fontMetrics(e, d).b, d.css({ width: (f.width || c.width + f.widthAdjust) + "px" })
                                    .align(t({ y: a + e }, f), !1, "spacingBox"), f.floating ||
                                    f.verticalAlign ||
                                    (b = Math.ceil(b + d.getBBox(f.useHTML).height)))
                            },
                            this);
                        ...
                        !this.isDirtyBox &&
                            d &&
                            (this.isDirtyBox = this.isDirtyLegend =
                                d, this.hasRendered && K(a, !0) && this.isDirtyBox && this.redraw())
                    },
                    ...
                    temporaryDisplay: function(b) {
                        ...
                        if (b)
                            for (; d && d.style;)
                                d.hcOrigStyle && (a.css(d, d.hcOrigStyle), delete d.hcOrigStyle), d.hcOrigDetached &&
                                (m.body.removeChild(d), d.hcOrigDetached =
                                    !1), d = d.parentNode;
                        else
                            for (; d && d.style;) {
                                    ...
                                    d.hcOrigStyle =
                                        {
                                            ...
                                            { display: "block", overflow: "hidden" }, d !== this.renderTo &&
                                            (b.height = 0),
                                        a.css(d, b), d.offsetWidth ||
                    ...
                    getContainer: function() {
                        ...
                        this.renderer = new (a[c.renderer] || a.Renderer)(b,
                            e,
                            x,
                            null,
                            c.forExport,
                    ...
                    getMargins: function(a) {
                        ...
                        c &&
                            !b(k[0]) &&
                            (this.plotTop = Math.max(this.plotTop, c + this.options.title.margin + d[0]));
                    ...
                    getAxisMargins: function() {
                        ...
                        a.hasCartesianSeries && e(a.axes, function(a) { a.visible && a.getOffset() });
                        e(J, function(c, f) { b(k[f]) || (a[c] += d[f]) });
                        a.setChartSize()
                    },
                    reflow: function(d) {
                        var k = this,
                        ...
                        if (!e && !k.isPrinting && h && c && (f === P || f === m)) {
                            if (h !== k.containerWidth || c !== k.containerHeight)
                                a.clearTimeout(k.reflowTimeout), k.reflowTimeout = A(function() {
                    ...
                    setReflow: function(a) {
                        ...
                        !1 === a || this.unbindReflow
                            ...
                            : (this.unbindReflow =
                                B(P, "resize", function(a) { b.reflow(a) }), B(this, "destroy", this.unbindReflow))
                    },
                    setSize: function(b, d, k) {
                        ...
                        f(c, "resize");
                        A(function() { c && f(c, "endResize", null, function() { --c.isResizing }) }, G(b).duration)
                    },
                    setChartSize: function(a) {
                        ...
                        this.spacingBox = d.spacingBox =
                            { x: x[3], y: x[0], width: c - x[3] - x[1], height: k - x[0] - x[2] };
                    ...
                    resetMargins: function() {
                        ...
                        e(["margin", "spacing"],
                            function(d) {
                                ...
                                e(["Top", "Right", "Bottom", "Left"], function(c, f) { a[d][f] = K(b[d + c], k[f]) })
                            });
                        e(J, function(b, d) { a[b] = K(a.margin[d], a.spacing[d]) });
                        ...
                        e(b,
                            function(b) {
                                ...
                                D(d) &&
                                    ...
                                    d.linkedParent !== b &&
                                    (d.linkedSeries.push(b), b.linkedParent = d, b.visible =
                                        K(b.options.visible, d.options.visible, b.visible))
                            });
                    ...
                    render: function() {
                        ...
                        e(a, function(a) { a.setScale() });
                        this.getAxisMargins();
                        k = 1.1 < d / this.plotWidth;
                        f = 1.05 < c / this.plotHeight;
                        if (k || f)
                            e(a, function(a) { (a.horiz && k || !a.horiz && f) && a.setTickInterval(!0) }), this
                                .getMargins();
                        this.drawChartBox();
                        this.hasCartesianSeries && e(a, function(a) { a.visible && a.render() });
                    ...
                    addCredits: function(a) {
                        ...
                        a.enabled &&
                            !this.credits &&
                            (this.credits = this.renderer.text(a.text + (this.mapCredits || ""), 0, 0)
                                .addClass("highcharts-credits").on("click",
                                    function() {
                                        a.href &&
                                            (P.location.href = a.href)
                                    }).attr({ align: a.position.align, zIndex: 8 }).css(a.style).add()
                                .align(a.position), this.credits.update = function(a) {
                    ...
                    firstRender: function() {
                        ...
                        if (!a.isReadyToRender || a.isReadyToRender()) {
                            ...
                            a.propFromSeries();
                            a.getAxes();
                            e(b.series || [], function(b) { a.initSeries(b) });
                            a.linkSeries();
                            f(a, "beforeRender");
                    ...
                    onload: function() {
                        e([this.callback].concat(this.callbacks),
                            function(a) { a && void 0 !== this.index && a.apply(this, [this]) },
                            this);
                        f(this, "load");
                        f(this, "render");
                ...
                function(p) {
                    ...
                    if (m = m && m.minWidth)
                        if (this.scrollablePixels = m = Math.max(0, m - this.chartWidth))
                            this.plotWidth += m, this.clipBox.width += m, p.skipAxes ||
                                G(this.axes,
                                    function(g) {
                                        1 === g.side
            ...
            C.prototype.applyFixed = function() {
                ...
                (this.fixedDiv =
                    a.createElement("div",
                        ...
                        null,
                        !0), this.renderTo.insertBefore(this.fixedDiv, this.renderTo.firstChild), this.fixedRenderer =
                    m = new a.Renderer(this.fixedDiv, 0, 0), this.scrollableMask =
                    m.path().attr({
                        fill: a.color(this.options.chart.backgroundColor || "#fff").setOpacity(.85).get(),
                        zIndex: -1
                    }).addClass("highcharts-scrollable-mask").add(), a.each(
                    [
                        this.inverted ? ".highcharts-xaxis" : ".highcharts-yaxis",
                        this.inverted ? ".highcharts-xaxis-labels" : ".highcharts-yaxis-labels",
                        ".highcharts-contextbutton", ".highcharts-credits", ".highcharts-legend",
                        ".highcharts-subtitle", ".highcharts-title"
                    ],
                    function(g) {
                        a.each(p.querySelectorAll(g),
                            function(a) {
                                m.box.appendChild(a);
                ...
                this.scrollableMask.attr({
                    d: this.scrollablePixels
                        ? [
                            "M", 0, g, "L", this.plotLeft - 1, g, "L", this.plotLeft - 1, v, "L", 0, v, "Z", "M", z, g,
                            "L", this.chartWidth, g, "L", this.chartWidth, v, "L", z, v, "Z"
                        ]
                        : ["M", 0, 0]
                })
            }
            ...
            a.Point.prototype = {
                init: function(a, b, e) {
                    ...
                    a.options.colorByPoint
                        ? (b = a.options.colors || a.chart.options.colors, this.color =
                            this.color || b[a.colorCounter], b = b.length, e =
                            a.colorCounter, a.colorCounter++, a.colorCounter === b && (a.colorCounter = 0))
                        : e = a.colorIndex;
                ...
                optionsToObject: function(l) {
                    ...
                    if (z(l) || null === l) b[n[0]] = l;
                        ...
                        for (!t &&
                                l.length > f &&
                                (e = typeof l[0], "string" === e ? b.name = l[0] : "number" === e && (b.x = l[0]), c++);
                            h < f;
                        )
                            t && void 0 === l[c] ||
                            (0 < n[h].indexOf(".")
                                ? a.Point.prototype.setNestedProperty(b, l[c], n[h])
                                : b[n[h]] =
                                l[c]), c++, h++;
                    else
                        "object" === typeof l &&
                            (b = l, l.dataLabels && (e._hasPointLabels = !0), l.marker && (e._hasPointMarkers = !0));
                    return b
                },
                ...
                destroyElements: function() {
                    for (var a = ["graphic", "dataLabel", "dataLabelUpper", "connector", "shadowGroup"], b, e = 6; e--;)
                        b = a[e], this[b] && (this[b] = this[b].destroy())
                },
            ...
            a.Series = a.seriesType("line",
                ...
                },
                {
                    ...
                    autoIncrement: function() {
                        ...
                        c &&
                        (a = new f.Date(b), "day" === c
                            ? f.set("Date", a, f.get("Date", a) + d)
                            : "month" === c
                            ? f.set("Month", a, f.get("Month", a) + d)
                            : "year" === c && f.set("FullYear", a, f.get("FullYear", a) + d), d = a.getTime() -
                            b);
                        this.xIncrement = b + d;
                        return b
                    },
                    setOptions: function(a) {
                        ...
                        this.userOptions = a;
                        f = c(k, e.series, a);
                        this.tooltipOptions = c(g.tooltip,
                    ...
                    getCyclic: function(a, b, d) {
                        ...
                        b ||
                        (c = w(k[e], k["_" + e]), z(c) ||
                            (f.series.length || (f[h] = 0), k["_" + e] = c = f[h] % x, f[h] += 1), d && (b = d[c]));
                        void 0 !== c && (this[e] = c);
                        this[a] = b
                    },
                    getColor: function() {
                    ...
                    updateData: function(b) {
                        ...
                        u(b,
                            function(b) {
                                var k;
                                k = a.defined(b) &&
                                    this.pointClass.prototype.optionsToObject.call({ series: this }, b).x;
                                n(k) &&
                                (k = a.inArray(k, this.xData, h), -1 === k
                                    ? f.push(b)
                                    : b !== c.data[k]
                                    ? (d[k].update(b, !1, null, !1), d[k].touched = !0, x && (h = k))
                                    : d[k] && (d[k].touched = !0), e = !0)
                            },
                            this);
                        if (e)
                            for (b = d.length; b--;)
                                k = d[b], k.touched || k.remove(!1),
                                    k.touched = !1;
                        else if (b.length === d.length)
                            u(b, function(a, b) { d[b].update && a !== c.data[b] && d[b].update(a, !1, null, !1) });
                        else return!1;
                        u(f, function(a) { this.addPoint(a, !1) }, this);
                        return!0
                    },
                    setData: function(b, c, d, e) {
                        ...
                        if (!J) {
                            ...
                            if (F && q > F) {
                                ...
                                if (n(g)) for (d = 0; d < q; d++) m[d] = this.autoIncrement(), D[d] = b[d];
                                else if (t(g))
                                    if (K) for (d = 0; d < q; d++) g = b[d], m[d] = g[0], D[d] = g.slice(1, K + 1);
                                    else for (d = 0; d < q; d++) g = b[d], m[d] = g[0], D[d] = g[1];
                                else a.error(12)
                            } else
                                for (d = 0; d < q; d++)
                                    void 0 !== b[d] &&
                                    (g = { series: h }, h.pointClass.prototype.applyOptions.apply(g, [b[d]]), h
                                        .updateParallelArrays(g, d));
                    ...
                    processData: function(b) {
                        ...
                        if (n && this.sorted && !r && (!q || f > q || this.forceCrop))
                            if (c[f - 1] < w || c[0] > F) c = [], d = [];
                                ...
                                e = this.cropData(this.xData, this.yData, w, F), c = e.xData, d = e.yData, e =
                                    e.start, k = !0;
                        for (q = c.length || 1; --q;)
                            f = g ? l(c[q]) - l(c[q - 1]) : c[q] - c[q - 1], 0 < f && (void 0 === h || f < h)
                                ? h = f
                                : 0 > f && t && (a.error(15), t = !1);
                        this.cropped = k;
                        this.cropStart = e;
                    ...
                    generatePoints: function() {
                        ...
                        for (w = 0; w < h; w++)
                            l = q + w, n
                                ? (g = (new e).init(this, [f[w]].concat(r(k[w]))),
                                    g.dataGroup = this.groupMap[w])
                                : (g = d[l]) || void 0 === b[l] || (d[l] = g = (new e).init(this, b[l], f[w])), g &&
                                (g.index = l, t[w] = g);
                        this.options.keys = a;
                        if (d && (h !== (c = d.length) || n))
                            for (w = 0; w < c; w++)
                                w !== q || n || (w += h), d[w] && (d[w].destroyElements(), d[w].plotX = void 0);
                        this.data = d;
                        this.points = t
                    },
                    getExtremes: function(a) {
                        ...
                        for (g = 0; g < c; g++)
                            if (x =
                                d[g], r = a[g], q =
                                (n(r, !0) || t(r)) && (!b.positiveValuesOnly || r.length || 0 < r), x =
                                this.getExtremesFromAll ||
                                this.options.getExtremesFromAll ||
                                this.cropped ||
                                (d[g + l] || x) >= e && (d[g - l] || x) <= h, q && x)
                                if (q = r.length) for (; q--;) "number" === typeof r[q] && (f[k++] = r[q]);
                                else f[k++] = r;
                        this.dataMin = p(f);
                        this.dataMax = G(f)
                    },
                    translate: function() {
                        ...
                        for (a = 0; a < h; a++) {
                            ...
                            p.plotX = F =
                                m(Math.min(Math.max(-1E5, d.translate(y, 0, 0, 0, 1, l, "flags" === this.type)), 1E5));
                            c &&
                                this.visible &&
                                !p.isNull &&
                                B &&
                                B[y] &&
                                (u = this.getStackIndicator(u, y, this.index), G = B[y], C = G.points[u.key],
                                    D = C[0], C =
                                        C[1], D === t && u.key === B[y].base && (D = w(n(g) && g, e.min)),
                                    e.positiveValuesOnly && 0 >= D && (D = null), p.total = p.stackTotal =
                                        G.total, p.percentage = G.total && p.y / G.total * 100, p.stackY =
                                        C, G.setOffset(this.pointXOffset || 0, this.barW || 0));
                            p.yBottom = z(D) ? Math.min(Math.max(-1E5, e.translate(D, 0, 1, 0, 1)), 1E5) : null;
                            q && (C = this.modifyValue(C, p));
                            p.plotY = D =
                                "number" === typeof C && Infinity !== C
                                ? Math.min(Math.max(-1E5, e.translate(C, 0, 1, 0, 1)), 1E5)
                                : void 0;
                    ...
                    getValidPoints: function(a, b) {
                        var d = this.chart;
                        return e(a || this.points || [],
                            function(a) { return b && !d.isInsidePlot(a.plotX, a.plotY, d.inverted) ? !1 : !a.isNull })
                    },
                    setClip: function(a) {
                        var b = this.chart,
                            d = this.options,
                        ...
                        q ||
                        (a &&
                        (e.width = 0, f && (e.x = b.plotSizeX), b[h + "m"] = l = c.clipRect(
                            f ? b.plotSizeX + 99 : -99,
                            f ? -b.plotLeft : -b.plotTop,
                            99,
                            f ? b.chartWidth : b.chartHeight)), b[h] = q = c.clipRect(e), q.count = { length: 0 });
                        a && !q.count[this.index] && (q.count[this.index] = !0, q.count.length += 1);
                        !1 !== d.clip &&
                        (this.group.clip(a || k ? q : b.clipRect), this.markerGroup.clip(l), this.sharedClipKey =
                            h);
                        a ||
                        (q.count[this.index] && (delete q.count[this.index], --q.count.length),
                            0 === q.count.length &&
                                h &&
                                b[h] &&
                                (k || (b[h] = b[h].destroy()), b[h + "m"] && (b[h + "m"] = b[h + "m"].destroy())))
                    },
                    animate: function(a) {
                        ...
                        a
                            ? this.setClip(d)
                            : (c =
                                    this.sharedClipKey, (a = b[c]) && a.animate({ width: b.plotSizeX, x: 0 }, d),
                                b[c + "m"] && b[c + "m"].animate({ width: b.plotSizeX + 99, x: 0 }, d), this.animate =
                                    null)
                    },
                    ...
                    drawPoints: function() {
                        ...
                        if (!1 !== e.enabled || this._hasPointMarkers)
                            for (d = 0; d < a.length; d++)
                                c = a[d], k = c.graphic, h = c.marker || {}, q = !!c.marker, f =
                                    n && void 0 === h.enabled || h.enabled, l = c.isInside, f && !c.isNull
                                    ? (f = w(h.symbol, this.symbol), g =
                                        this.markerAttribs(c, c.selected && "select"), k
                                        ? k[l ? "show" : "hide"](!0).animate(g)
                                        : l &&
                                        (0 < g.width || c.hasImage) &&
                                        (c.graphic = k = b.renderer.symbol(f,
                                            g.x,
                                            g.y,
                                            g.width,
                                            g.height,
                                            q ? h : e).add(r)), k &&
                                        k.attr(this.pointAttribs(c, c.selected && "select")), k &&
                                        k.addClass(c.getClassName(), !0))
                    ...
                    markerAttribs: function(a, b) {
                        ...
                        b &&
                        (d = d.states[b], b = c.states && c.states[b], k = w(b && b.radius,
                            d && d.radius,
                            k + (d && d.radiusPlus || 0)));
                    ...
                    pointAttribs: function(a,
                        ...
                        b &&
                        (d = d.states[b], b = f.states && f.states[b] || {}, c =
                            w(b.lineWidth, d.lineWidth, c + w(b.lineWidthPlus, d.lineWidthPlus, 0)), a =
                            b.fillColor || d.fillColor || a, k = b.lineColor || d.lineColor || k);
                    ...
                    destroy: function() {
                        ...
                        D(c);
                        u(c.axisTypes || [],
                            function(a) { (r = c[a]) && r.series && (y(r.series, c), r.isDirty = r.forceRedraw = !0) });
                            ...
                            function(e, r) {
                                ...
                                e.isNull && !z(b) && 0 < r
                                    ...
                                    : (0 === r || l
                                        ? r = ["M", e.plotX, e.plotY]
                                        : c.getPointSpline
                                        ? r = c.getPointSpline(a, e, r)
                                        : k
                                        ? (r = 1 === k
                                            ? ["L", n.plotX, g]
                                            : 2 === k
                                            ? ["L", (n.plotX + x) / 2, n.plotY, "L", (n.plotX + x) / 2, g]
                                            : [
                                                "L", x,
                                                n.plotY
                                            ], r.push("L", x, g))
                                        : r = ["L", x, g], q.push(e.x), k && (q.push(e.x), 2 === k && q.push(e.x)), h
                                        .push
                                        .apply(h, r), l = !1)
                            });
                        h.xMap = q;
                    ...
                    drawGraph: function() {
                        ...
                        u(c,
                            function(c, f) {
                                var k = c[0], e = a[k];
                                e
                                    ? (e.endX = a.preventGraphAnimation ? null : d.xMap, e.animate({ d: d }))
                                    : d.length &&
                                    (a[k] = a.chart.renderer.path(d).addClass(c[1]).attr({ zIndex: 1 }).add(a.group),
                                        e = {
                                            stroke: c[2],
                                            ...
                                            ? e.dashstyle = c[3]
                                            : "square" !== b.linecap &&
                                            (e["stroke-linecap"] = e["stroke-linejoin"] = "round"), e =
                                            a[k].attr(e).shadow(2 > f && b.shadow));
                        ...
                        u(this.zones,
                            function(b, d) {
                                a.push([
                                    ...
                                    b.color || this.color, b.dashStyle || this.options.dashStyle
                                ])
                            },
                            this);
                        return a
                    ...
                    applyZones: function() {
                        ...
                        c.length &&
                            ...
                            g &&
                            void 0 !== g.min &&
                            (t = g.reversed, D = g.horiz, q && !this.showLine && q.hide(), l && l.hide(), n =
                                g.getExtremes(), u(c,
                                function(c, x) {
                                    ...
                                    g.isXAxis
                                        ? (h =
                                                { x: F ? p : J, y: 0, width: m, height: r }, D ||
                                                (h.x = b.plotHeight - h.x)
                                        )
                                        : (h = { x: 0, y: F ? p : J, width: r, height: m }, D &&
                                            (h.y = b.plotWidth - h.y));
                                    F &&
                                        d.isVML &&
                                        (h = g.isXAxis
                                            ? { x: 0, y: t ? J : p, height: h.width, width: b.chartWidth }
                                            : {
                                    ...
                                    e[x]
                                        ? e[x].animate(h)
                                        : (e[x] = d.clipRect(h), q && a["zone-graph-" + x].clip(e[x]), l &&
                                            a["zone-area-" + x].clip(e[x]));
                                    v = c.value > n.max;
                    ...
                    render: function() {
                        ...
                        e && a.animate();
                        l ||
                        (a.animationTimeout = q(function() { a.afterAnimate() },
                            e));
                        a.isDirty = !1;
                        a.hasRendered = !0;
                        b(a, "afterRender")
                    ...
                    redraw: function() {
                        var a = this.chart,
                            ...
                            f = this.yAxis;
                        d &&
                        (a.inverted && d.attr({ width: a.plotWidth, height: a.plotHeight }), d.animate({
                    ...
                    buildKDTree: function() {
                        function a(d, c, f) {
                            var k, e;
                            if (e = d && d.length)
                                return k = b.kdAxisArray[c % f], d.sort(function(a, b) { return a[k] - b[k] }), e =
                                    Math.floor(e / 2), {
                                    point: d[e],
        ...
        (function(a) {
            ...
            a.StackItem.prototype = {
                ...
                setOffset: function(a, b) {
                    ...
                    if (b = this.label)
                        b.align(this.alignOptions, null, e), e =
                            b.alignAttr, b[!1 === this.options.crop || l.isInsidePlot(e.x, e.y) ? "show" : "hide"](!0)
                },
                ...
                g(a.series,
                    function(b) {
                        !b.options.stacking ||
                            ...
                            (b.stackKey = b.type + u(b.options.stack, ""))
                    })
            };
            ...
            B.prototype.renderStackTotals = function() {
                ...
                z(e, function(a) { z(a, function(a) { a.render(g) }) })
            };
            ...
            B.prototype.cleanStacks = function() {
                var a;
                this.isXAxis ||
                (this.oldStacks && (a = this.stacks = this.oldStacks), z(a,
                    function(a) { z(a, function(a) { a.cumulative = a.total }) }))
            };
            y.prototype.setStackedPoints = function() {
                if (this.options.stacking &&
                    ...
                    m.stacksTouched += 1;
                    for (E = 0; E < g; E++)
                        k = l[E], A = b[E], x = this.getStackIndicator(x, k, this.index), H = x.key, d =
                            (v = r && A < (c ? 0 : f)) ? D : w, q[d] || (q[d] = {}), q[d][k] ||
                        (F[d] && F[d][k]
                            ? (q[d][k] = F[d][k], q[d][k].total = null)
                            : q[d][k] = new a.StackItem(m, m.options.stackLabels, v, k, h)), d = q[d][k], null !== A
                            ? (d.points[H] = d.points[this.index] =
                                [u(d.cumulative, c)], p(d.cumulative) || (d.base = H), d.touched =
                                m.stacksTouched, 0 < x.index &&
                                !1 === this.singleStacks &&
                                (d.points[H][0] =
                                    d.points[this.index + "," + k + ",0"][0]))
                            : d.points[H] = d.points[this.index] = null, "percent" === n
                            ? (v = v ? w : D, r && q[v] && q[v][k]
                                ? (v = q[v][k], d.total = v.total = Math.max(v.total, d.total) + Math.abs(A) || 0)
                                : d.total = G(d.total + (Math.abs(A) || 0)))
                            : d.total = G(d.total + (A || 0)), d.cumulative =
                            u(d.cumulative, c) + (A || 0), null !== A &&
                            (d.points[H].push(d.cumulative), e[E] = d.cumulative);
                    ...
                    g([b, "-" + b],
                        function(b) {
                            for (var c = t.length, l, g; c--;)
                                if (l = t[c], n = a.getStackIndicator(n, l, a.index, b), g =
                                    (l = e[b] && e[b][l]) && l.points[n.key]) a[f + "Stacker"](g, l, c)
                        })
            };
            ...
            u(a.Chart.prototype,
                {
                    ...
                    addAxis: function(a, b, f, e) {
                        var d = b ? "xAxis" : "yAxis", h = this.options;
                    ...
                    showLoading: function(a) {
                        ...
                        (b.loadingDiv = f =
                                p("div",
                                    ...
                                    null,
                                    b.container),
                            b.loadingSpan = p("span", { className: "highcharts-loading-inner" }, null, f), B(b,
                                "redraw",
                                e));
                    ...
                    hideLoading: function() {
                        ...
                        b &&
                        (b.className = "highcharts-loading highcharts-loading-hidden", C(b,
                            { opacity: 0 },
                            {
                                duration: a.loading.hideDuration || 100,
                                complete: function() { m(b, { display: "none" }) }
                            }));
                        this.loadingShown = !1
                    },
                    propsRequireDirtyBox:
                        "backgroundColor borderColor borderWidth margin marginTop marginRight marginBottom marginLeft spacing spacingTop spacingRight spacingBottom spacingLeft borderRadius plotBackgroundColor plotBackgroundImage plotBorderColor plotBorderWidth plotShadow shadow"
                            .split(" "),
                    propsRequireUpdateSeries:
                        "chart.inverted chart.polar chart.ignoreHiddenSeries chart.type colors plotOptions time tooltip"
                            .split(" "),
                    update: function(a, e, h, r) {
                        ...
                        v("xAxis yAxis zAxis series colorAxis pane".split(" "),
                            function(b) {
                                a[b] &&
                                (v(J(a[b]),
                                    function(a, c) {
                                        (c = g(a.id) && d.get(a.id) || d[b][c]) &&
                                            c.coll === b &&
                                            (c.update(a, !1), h && (c.touched = !0));
                                        if (!c && h)
                                            if ("series" === b) d.addSeries(a, !1).touched = !0;
                                                ...
                                                d.addAxis(a,
                                                    "xAxis" === b,
                                                    !1).touched = !0
                                    }), h && v(d[b], function(a) { a.touched ? delete a.touched : w.push(a) }))
                            });
                        v(w, function(a) { a.remove(!1) });
                        k && v(d.axes, function(a) { a.update({}, !1) });
                        t && v(d.series, function(a) { a.update({}, !1) });
                        a.loading && n(!0, d.options.loading, a.loading);
                        k = x && x.width;
                        x = x && x.height;
                        b(k) && k !== d.chartWidth || b(x) && x !== d.chartHeight
                            ? d.setSize(k, x, r)
                            : c(e, !0) && d.redraw(r)
                    },
            ...
            u(h.prototype,
                {
                    update: function(a, b, f, h) {
                        function d() {
                            ...
                            (k &&
                                ...
                                (q.graphic = k.destroy()), a &&
                                a.dataLabels &&
                                q.dataLabel &&
                                (q.dataLabel = q.dataLabel.destroy()), q.connector &&
                                (q.connector = q.connector.destroy()));
                            g = q.index;
                    ...
                    remove: function(a, b) { this.series.removePoint(l(this, this.series.data), a, b) }
                });
            u(w.prototype,
                {
                    addPoint: function(a, b, f, e) {
                        ...
                        (h[0] && h[0].remove
                            ? h[0].remove(!1)
                            : (h.shift(), this.updateParallelArrays(g, "shift"), l.shift()));
                    ...
                    update: function(b, f) {
                        ...
                        if (p) b.data && this.setData(b.data, !1), b.name && this.setName(b.name, !1);
                            ...
                            b = n(d,
                                m,
                                { index: e.index, pointStart: c(d.pointStart, e.xData[0]) },
                                { data: e.options.data },
                                b);
                            e.remove(!1, null, !1);
                            for (r in k) e[r] = void 0;
                            D[g || q] ? u(e, D[g || q].prototype) : a.error(17, !0);
                            v(w, function(a) { e[a] = w[a] });
                            e.init(h, b);
                            b.zIndex !==
                                d.zIndex &&
                                v(t, function(a) { e[a] && e[a].attr({ zIndex: b.zIndex }) });
                            e.oldType = q;
                            h.linkSeries()
                        }
                        y(this, "afterUpdate");
            ...
            u(G.prototype,
                {
                    ...
                    remove: function(a) {
                        ...
                        v(b[f], function(a, b) { a.options.index = a.userOptions.index = b });
                        this.destroy();
                        b.isDirtyBox = !0;
                        c(a, !0) && b.redraw()
                    },
                ...
                { softThreshold: !1, threshold: 0 },
                {
                    ...
                    getStackPoints: function(g) {
                        var m = [],
                            ...
                            f = n.length,
                            c,
                            h = p(l.options.reversedStacks, !0) ? 1 : -1,
                            w;
                        g = g || this.points;
                        if (this.options.stacking) {
                            for (w = 0; w < g.length; w++) g[w].leftNull = g[w].rightNull = null, e[g[w].x] = g[w];
                            a.objectEach(b, function(a, b) { null !== a.total && u.push(b) });
                            u.sort(function(a, b) { return a - b });
                            c = G(n, function() { return this.visible });
                            C(u,
                                function(a, g) {
                                    var r = 0, q, n;
                                    if (e[a] && !e[a].isNull)
                                            ...
                                            function(l) {
                                                ...
                                                if (x)
                                                    for (w = t; 0 <= w && w < f;)
                                                        ...
                                                        (w === t
                                                            ? e[a][r] = !0
                                                            : c[w] && (n = b[a].points[w]) && (d -= n[1] - n[0])), w +=
                                                            h;
                    ...
                    getGraphPath: function(a) {
                        var g = m.prototype.getGraphPath,
                            ...
                            J = function(b, e, g) {
                                ...
                                var r, x, q = !0;
                                g || d
                                    ? (r = (d ? b[0] : b[1]) + g, x = b[0] + g, q = !!d)
                                    : !v && a[e] && a[e].isNull && (r = x = w);
                                void 0 !== r &&
                                (n.push({
                                    plotX: c,
                        ...
                        for (b = 0; b < a.length; b++)
                            if (e = a[b].isNull, c = p(a[b].rectPlotX, a[b].plotX), r =
                                p(a[b].yBottom, D), !e || u)
                                u || J(b, b - 1, "left"), e && !v && u ||
                                    (n.push(a[b]), t.push({ x: b, plotX: c, plotY: r })), u || J(b, b + 1, "right");
                        b = g.call(this, n, !0, !0);
                        t.reversed = !0;
                        e = g.call(this, t, !0, !0);
                        e.length && (e[0] = "L");
                    ...
                    drawGraph: function() {
                        ...
                        C(this.zones,
                            function(g, b) {
                                y.push([
                                    "zone-area-" + b, "highcharts-area highcharts-zone-area-" + b + " " + g.className,
                                    g.color || a.color, g.fillColor || u.fillColor
                                ])
                            });
                        C(y,
                            function(l) {
                                var b = l[0], e = a[b];
                                e
                                    ? (e.endX = a.preventGraphAnimation ? null : g.xMap, e.animate({ d: g }))
                ...
                {},
                {
                    getPointSpline: function(a, G, p) {
                        ...
                        if (v &&
                            ...
                            l += b;
                            u > a && u > g
                                ? (u = Math.max(a, g), l = 2 * g - u)
                                : u < a && u < g && (u = Math.min(a, g), l = 2 * g - u);
                            l > p && l > g
                                ? (l = Math.max(p, g), u = 2 * g - l)
                                : l < p &&
                                l < g &&
            ...
            u("column",
                ...
                },
                {
                    ...
                    init: function() {
                        ...
                        b.hasRendered && G(b.series, function(b) { b.type === a.type && (b.isDirty = !0) })
                    },
                            ...
                            : G(a.chart.series,
                                function(b) {
                                    ...
                                    b.type !== a.type ||
                                        ...
                                        g.pos !== l.pos ||
                                        (e.stacking
                                            ? (f = b.stackKey, void 0 === c[f] && (c[f] = h++), r = c[f])
                                            : !1 !== e.grouping &&
                                            (r = h++), b.columnIndex = r)
                                });
                        var w = Math.min(Math.abs(e.transA) *
                                (e.ordinalSlope || b.pointRange || e.closestPointRange || e.tickInterval || 1),
                                e.len),
                            m = w * b.groupPadding,
                            r = (w - 2 * m) / (h || 1),
                        ...
                        G(a.points,
                            function(e) {
                                ...
                                h &&
                                    Math.abs(k) < h &&
                                    (k = h, w =
                                        !n.reversed && !e.negative || n.reversed && e.negative, e.y === f &&
                                        a.dataMax <= f &&
                                        n.min < f &&
                                        (w = !w), t = Math.abs(t - c) > h ? g - h : c - (w ? h : 0));
                                e.barX = l;
                                e.pointWidth = m;
                                e.tooltipPos =
                                    b.inverted
                                    ? [n.len + n.pos - b.plotLeft - q, a.xAxis.len - l - d / 2, k]
                                    : [l + d / 2, q + n.pos - b.plotTop, k];
                                e.shapeType = "rect";
                                e.shapeArgs =
                    ...
                    pointAttribs: function(a, b) {
                        ...
                        a &&
                            this.zones.length &&
                            (c = a.getZone(), c = a.options.color ||
                                c && c.color ||
                                this.color);
                        b &&
                        (a = g(e.states[b], a.options.states && a.options.states[b] || {}), b = a.brightness, c =
                            a.color || void 0 !== b && C(c).brighten(a.brightness).get() || c, h = a[l] || h, w =
                            a[f] || w, n = a.dashStyle || n);
                        ...
                        G(a.points,
                            function(c) {
                                ...
                                if (m(c.plotY) && null !== c.y) {
                                    ...
                                    h[l](a.pointAttribs(c, c.selected && "select"))
                                        .shadow(e.shadow, null, e.stacking && !e.borderRadius);
                    ...
                    animate: function(a) {
                        ...
                        (a
                            ? (f.scaleY = .001, a =
                                    Math.min(e.pos + e.len, Math.max(e.pos, e.toPixels(g.threshold))),
                                l ? f.translateX = a - e.len : f.translateY = a, b.group.attr(f))
                            : (h = b.group.attr(c), b.group.animate({ scaleY: 1 },
        ...
        (function(a) {
            ...
            a("scatter",
                ...
                },
                {
                    ...
                    drawGraph: function() { this.options.lineWidth && B.prototype.drawGraph.call(this) }
                })
        })(L);
        (function(a) {
            ...
            a.CenteredSeriesMixin = {
                getCenter: function() {
                    var a = this.options,
                        ...
                        b;
                    for (l = 0; 4 > l; ++l)
                        b = u[l], a = 2 > l || 2 === l && /%$/.test(b), u[l] = p(b, [z, g, y, u[2]][l]) + (a ? v : 0);
                    u[3] > u[2] && (u[3] = u[2]);
                    return u
                },
            ...
            b("pie",
                ...
                },
                {
                    ...
                    animate: function(a) {
                        ...
                        (p(f,
                            function(a) {
                                ...
                                f &&
                                (f.attr({ r: a.startR || b.center[3] / 2, start: c, end: c }), f.animate(
                    ...
                    updateTotals: function() {
                        ...
                        for (a =
                                0;
                            a < c;
                            a++) e = f[a], e.percentage = 0 < b && (e.visible || !g) ? e.y / b * 100 : 0, e.total = b
                    },
                    generatePoints: function() {
                    ...
                    translate: function(a) {
                        ...
                        for (d = 0; d < H; d++) {
                            ...
                            E.labelPos = [
                                a[0] + m + Math.cos(r) * E.labelDistance, a[1] + x + Math.sin(r) * E.labelDistance,
                                a[0] + m + Math.cos(r) * l, a[1] + x + Math.sin(r) * l, a[0] + m, a[1] + x,
                                0 > E.labelDistance ? "center" : E.half ? "right" : "left", r
                            ]
                        }
                    },
                    drawGraph: null,
                        ...
                        p(a.points,
                            function(h) {
                                ...
                                if (h.isNull) c && (h.graphic = c.destroy());
                                    ...
                                    c
                                        ? c.setRadialReference(a.center).attr(e).animate(m(g, f))
                                        : (h.graphic = c =
                                                b[h.shapeType](g).setRadialReference(a.center).attr(f).add(a.group), h
                                                .visible ||
                    ...
                    sortByAngle: function(a, b) {
                        a.sort(function(a, c) { return void 0 !== a.angle && (c.angle - a.angle) * b })
                    },
                    drawLegendSymbol: a.LegendSymbolMixin.drawRectangle,
                ...
                },
                {
                    init: function() {
                        ...
                        b = function(b) { a.slice("select" === b.type) };
                        B(a, "select", b);
                        B(a, "unselect", b);
                        return a
                    },
                    ...
                    setVisible: function(a, b) {
                        ...
                        b = u(b, g);
                        a !== f.visible &&
                        (f.visible = f.options.visible = a =
                            void 0 === a ? !f.visible : a, c.options.data[v(f, c.data)] =
                            f.options, p(["graphic", "dataLabel", "connector", "shadowGroup"],
                            function(b) { if (f[b]) f[b][a ? "show" : "hide"](!0) }), f.legendItem &&
                            e.legend.colorizeItem(f, a), a || "hover" !== f.state || f.setState(""), g &&
                            (c.isDirty = !0), b && e.redraw())
                    },
                    ...
                    haloPath: function(a) {
                        ...
                        return this.sliced || !this.visible
                            ? []
                            : this.series.chart.renderer.symbols.arc(b.x,
                                b.y,
                                b.r + a,
                                b.r + a,
        ...
        (function(a) {
            ...
            a.distribute = function(b, c, e) {
                function f(a, b) { return a.target - b.target }
                ...
                if (m > x) {
                    n(b, function(a, b) { return(b.rank || 0) - (a.rank || 0) });
                ...
                for (b = v(b,
                    ...
                    for (h = b.length; h--;)
                        g = b[h], m = (Math.min.apply(0, g.targets) + Math.max.apply(0, g.targets)) / 2, g.pos =
                            Math.min(Math.max(0, m - g.size * g.align), c - g.size);
                    h = b.length;
                    for (g = !1; h--;)
                        0 < h &&
                            b[h - 1].pos + b[h - 1].size > b[h].pos &&
                            (b[h - 1].size += b[h].size, b[h - 1].targets =
                                b[h - 1].targets.concat(b[h].targets), b[h - 1].align =
                                .5, b[h - 1].pos + b[h - 1].size > c && (b[h - 1].pos = c - b[h - 1].size), b.splice(h,
                                1), g = !0)
                }
                l.push.apply(l, q);
                h = 0;
                        ...
                        if (t(b.targets,
                            function() {
                                ...
                                if (Math.abs(l[h].pos -
                                        l[h].target) >
                                    e)
                                    return p(l.slice(0, h + 1), function(a) { delete a.pos }), l.reducedLen =
                                        (l.reducedLen || c) - .1 * c, l.reducedLen > .1 * c && a.distribute(l, c, e), !
                                        0;
                                d += l[h].size;
                                h++
                            })) return!0
            ...
            b.prototype.drawDataLabels = function() {
                function b(a, b) {
                    var d = b.filter;
                    return d
                        ? (b = d.operator, a = a[d.property], d = d.value, "\x3e" === b && a > d ||
                            "\x3c" === b && a < d ||
                            "\x3e\x3d" === b && a >= d ||
                            "\x3c\x3d" === b && a <= d ||
                            "\x3d\x3d" === b && a == d ||
                ...
                var c = this,
                    ...
                    x,
                    u,
                    d = y(n.defer, !!l.animation),
                    H = e.renderer;
                if (n.enabled || c._hasPointLabels)
                    c.dlProcessOptions && c.dlProcessOptions(n), u =
                            c.plotGroup("dataLabelsGroup",
                                "data-labels",
                                d && !t ? "hidden" : "visible",
                                n.zIndex || 6),
                        d &&
                        (u.attr({ opacity: +t }), t ||
                            ...
                            function(d) {
                                ...
                                (f = y(m && m.enabled, q.enabled) &&
                                    ...
                                    (f = !0 === b(d, m || n));
                                f &&
                                (n = z(q, m), r = d.getLabelConfig(), E = n[d.formatPrefix + "Format"] || n.format, x =
                                        G(E)
                                        ? g(E, r, e.time)
                                        : (n[d.formatPrefix + "Formatter"] || n.formatter).call(r, n),
                                    E = n.style, r = n.rotation, E.color =
                                        y(n.color, E.color, c.color, "#000000"), "contrast" === E.color &&
                                    (d.contrastColor = H.getContrast(d.color || c.color), E.color =
                                        n.inside || 0 > y(d.labelDistance, n.distance) || l.stacking
                                        ? d.contrastColor
                                        : "#000000"), l.cursor && (E.cursor = l.cursor), w = {
                                        ...
                                        padding: n.padding,
                                        zIndex: 1
                                    }, a.objectEach(w, function(a, b) { void 0 === a && delete w[b] }));
                                !h || f && G(x)
                                    ? f &&
                                    G(x) &&
                                    (h
                                            ...
                                            : (h = d.dataLabel =
                                                    r
                                                    ? H.text(x, 0, -9999).addClass("highcharts-data-label")
                                                    : H.label(x,
                                                        0,
                                                        -9999,
                                                        n.shape,
                                                ...
                                                h.addClass(" highcharts-data-label-color-" +
                                                    ...
                                                    " " +
                                                    (n.className || "") +
                                                    (n.useHTML ? "highcharts-tracker" : ""))), h.attr(w), h.css(E)
                                            .shadow(n.shadow),
                                        h.added || h.add(u), c.alignDataLabel(d, h, n, null, F))
                                    : (d.dataLabel = h = h.destroy(),
            ...
            b.prototype.alignDataLabel = function(a, b, e, g, l) {
                var c = this.chart,
                    ...
                    E = this.visible &&
                    (a.series.forceDL ||
                        c.isInsidePlot(h, Math.round(n), f) ||
                        g && c.isInsidePlot(h, f ? g.x + 1 : g.y + g.height - 1, f)),
                    k = "justify" === y(e.overflow, "justify");
                if (E &&
                (w = e.style.fontSize, w = c.renderer.fontMetrics(w, b).b, g =
                        m({
                            ...
                            g), m(e, { width: x.width, height: x.height }), d
                        ? (k = !1, h = c.renderer.rotCorr(w, d), h =
                        {
                            x: g.x + e.x + g.width / 2 + h.x,
                            y: g.y + e.y + { top: 0, middle: .5, bottom: 1 }[e.verticalAlign] * g.height
                        }, b[l ? "attr" : "animate"](h).attr({ align: t }), n = (d + 720) % 360, n =
                            180 < n && 360 > n, "left" === t
                            ? h.y -= n ? x.height : 0
                            : "center" === t
                            ? (h.x -= x.width / 2, h.y -= x.height / 2)
                            : "right" === t && (h.x -= x.width, h.y -= n ? 0 : x.height), b.placed = !0, b.alignAttr =
                            h)
                        : (b.align(e, null, g), h = b.alignAttr), k
                        ? a.isLabelJustified = this.justifyDataLabel(b,
                            e,
                            h,
                            x,
                            g,
                            l)
                        : y(e.crop, !0) &&
                        (E = c.isInsidePlot(h.x, h.y) && c.isInsidePlot(h.x + x.width, h.y + x.height)),
                    e.shape && !d))
                    b[l ? "attr" : "animate"]({
            ...
            (e.pie.prototype.drawDataLabels = function() {
                    ...
                    (p(c,
                            function(a) {
                                a.dataLabel &&
                                    ...
                                    (a.dataLabel.attr({ width: "auto" }).css({ width: "auto", textOverflow: "clip" }), a
                                        .dataLabel.shortened = !1)
                            }), b.prototype.drawDataLabels.apply(f), p(c,
                            function(a) {
                                a.dataLabel &&
                                    a.visible &&
                                    (z[a.half].push(a), a.dataLabel._pos = null, !G(l.style.width) &&
                                        !G(a.options.dataLabels &&
                                            a.options.dataLabels.style &&
                                            a.options.dataLabels.style.width) &&
                                        a.dataLabel.getBBox().width > x &&
                                        (a.dataLabel.css({ width: .7 * x }), a.dataLabel.shortened = !0))
                            }),
                        p(z,
                            function(b, c) {
                                var h, n, x = b.length, t = [], w;
                                if (x)
                                    for (f.sortByAngle(b, c - .5), 0 < f.maxLabelDistance &&
                                        (h = Math.max(0, E - H - f.maxLabelDistance), n =
                                            Math.min(E + H + f.maxLabelDistance, g.plotHeight), p(b,
                                            function(a) {
                                                0 < a.labelDistance &&
                                                    a.dataLabel &&
                                                    (a.top = Math.max(0, E - H - a.labelDistance), a.bottom =
                                                        Math.min(E + H + a.labelDistance, g.plotHeight), w =
                                                        a.dataLabel.getBBox().height || 21, a.positionsIndex = t.push({
                                                            target: a.labelPos[1] - a.top + w / 2,
                                                            size: w,
                                                            rank: a.y
                                                        }) -
                                                        1)
                                            }), h = n + w - h, a.distribute(t, h, h / 5)), S = 0;
                                        S < x;
                                        S++)
                                        e = b[S], n = e.positionsIndex,
                                            u = e.labelPos, k = e.dataLabel, M =
                                                !1 === e.visible ? "hidden" : "inherit", N = h =
                                                u[1], t &&
                                                G(t[n]) &&
                                                (void 0 === t[n].pos
                                                    ? M = "hidden"
                                            ...
                                            B =
                                                l.justify
                                                ? d[0] + (c ? -1 : 1) * (H + e.labelDistance)
                                                : f.getX(N < e.top + 2 || N > e.bottom - 2 ? h : N, c, e), k._attr =
                                                { visibility: M, align: u[6] }, k._pos =
                                                { x: B + l.x + ({ left: r, right: -r }[u[6]] || 0), y: N + l.y - 10 }, u
                                                .x =
                                                B, u.y = N, y(l.crop, !0) &&
                                            (A = k.getBBox().width, h = null, B - A < r && 1 === c
                                                ? (h = Math.round(A - B + r), O[3] = Math.max(h, O[3]))
                                                : B + A > q - r &&
                                                0 === c &&
                                                (h = Math.round(B + A - q + r), O[1] =
                                                    Math.max(h, O[1])), 0 > N - v / 2
                                                ? O[0] = Math.max(Math.round(-N + v / 2), O[0])
                                                : N + v / 2 > m && (O[2] = Math.max(Math.round(N + v / 2 - m), O[2])), k
                                                .sideOverflow = h)
                            }), 0 === C(O) || this.verifyDataLabelOverflow(O)) &&
                    (this.placeDataLabels(), n &&
                        p(this.points,
                            function(a) {
                                var b;
                                t = a.connector;
                                if ((k = a.dataLabel) && k._pos && a.visible && 0 < a.labelDistance) {
                                    ...
                                    if (b = !t)
                                        a.connector = t = g.renderer.path()
                                                .addClass("highcharts-data-label-connector  highcharts-color-" +
                                                    a.colorIndex +
                                                    (a.className ? " " + a.className : "")).add(f.dataLabelsGroup),
                                            t.attr({
                                                "stroke-width": n,
                ...
                return y(this.options.dataLabels.softConnector, !0)
                    ? [
                        "M", b + ("left" === a[6] ? 5 : -5), f, "C", b, f, 2 * a[2] - a[4], 2 * a[3] - a[5], a[2], a[3],
                        "L", a[4], a[5]
                    ]
                    : ["M", b + ("left" === a[6] ? 5 : -5), f, "L", a[2], a[3], "L", a[4], a[5]]
                ...
                (null !== f[0]
                    ? r = Math.max(b[2] -
                        Math.max(a[1], a[3]),
                        g)
                    : (r = Math.max(b[2] - a[1] - a[3], g), b[0] += (a[3] - a[1]) / 2), null !== f[1]
                    ? r = Math.max(Math.min(r, b[2] - Math.max(a[0], a[2])), g)
                    : (r = Math.max(Math.min(r, b[2] - a[0] - a[2]), g), b[1] += (a[0] - a[2]) / 2), r < b[2]
                    ? (b[2] = r, b[3] =
                        Math.min(l(e.innerSize || 0, r), r), this.translate(b), this.drawDataLabels &&
                        this.drawDataLabels())
                    : n = !0);
                return n
            });
            e.column &&
            (e.column.prototype.alignDataLabel = function(a, c, e, g, l) {
                var f = this.chart.inverted,
                    h = a.series,
                    q = a.dlBox || a.shapeArgs,
                    n = y(a.below,
                        a.plotY >
                        y(this.translatedThreshold,
                            h.yAxis.len)),
                    m = y(e.inside, !!this.options.stacking);
                q &&
                (g = z(q), 0 > g.y && (g.height += g.y, g.y = 0), q =
                    g.y + g.height - h.yAxis.len, 0 < q && (g.height -= q), f &&
                (g = {
        ...
        (function(a) {
            ...
            a(B,
                ...
                function() {
                    var a = [];
                    C(this.labelCollectors || [], function(g) { a = a.concat(g()) });
                    C(this.yAxis || [],
                        function(g) {
                            g.options.stackLabels &&
                                !g.options.stackLabels.allowOverlap &&
                                G(g.stacks, function(g) { G(g, function(g) { a.push(g.label) }) })
                        });
                    C(this.series || [],
                        function(g) {
                            var m = g.options.dataLabels, z = g.dataLabelCollections || ["dataLabel"];
                            (m.enabled || g._hasPointLabels) &&
                                !m.allowOverlap &&
                                g.visible &&
                                C(z,
                                    function(m) {
                                        C(g.points,
                                            function(g) {
                                                g[m] &&
                                                (g[m].labelrank =
                                                    p(g.labelrank, g.shapeArgs && g.shapeArgs.height), a.push(g[m]))
                                            })
                                    })
                        });
            ...
            B.prototype.hideOverlappingLabels = function(a) {
                var g = a.length,
                    ...
                    t,
                    n,
                    f = function(a, b, e, f, g, l, q, n) { return!(g > a + e || g + q < a || l > b + f || l + n < b) };
                for (p = 0; p < g; p++)
                    if (m = a[p])
                        m.oldOpacity = m.opacity, m.newOpacity =
                            1, m.width || (u = m.getBBox(), m.width = u.width, m.height = u.height);
                ...
                for (p = 0; p < g; p++)
                    for (u = a[p], m = p + 1; m < g; ++m)
                        if (y = a[m], u &&
                            ...
                            0 !== u.newOpacity &&
                            0 !== y.newOpacity &&
                            (l = u.alignAttr, b = y.alignAttr, e = u.parentGroup, t = y.parentGroup, n =
                                2 * (u.box ? 0 : u.padding || 0), l = f(l.x + e.translateX,
                                l.y + e.translateY,
                                u.width - n,
                                u.height - n,
                                b.x + t.translateX,
                                b.y + t.translateY,
                                y.width - n,
                                y.height - n))) (u.labelrank < y.labelrank ? u : y).newOpacity = 0;
                C(a,
                    function(a) {
                        var b, c;
                        a &&
                        (c = a.newOpacity, a.oldOpacity !== c &&
                            a.placed &&
                            (c ? a.show(!0) : b = function() { a.hide() }, a.alignAttr.opacity =
                                c, a[a.isOld ? "animate" : "attr"](a.alignAttr, null, b)), a.isOld = !0)
                    })
            }
        })(L);
        (function(a) {
            ...
            D = a.TrackerMixin = {
                drawTrackerPoint: function() {
                    ...
                    (v(a.trackerGroups,
                        function(e) {
                            if (a[e]) {
                                a[e].addClass("highcharts-tracker").on("mouseover", c)
                                    .on("mouseout", function(a) { b.onTrackerMouseOut(a) });
                ...
                drawTrackerGraph: function() {
                    var a = this,
                        ...
                        k = a.tracker,
                        n,
                        m = function() { if (h.hoverSeries !== a) a.onMouseOver() },
                        t = "rgba(192,192,192," + (w ? .0001 : .002) + ")";
                    if (f && !c)
                        for (n = f + 1; n--;)
                            "M" === e[n] && e.splice(n + 1, 0, e[n + 1] - l, e[n + 2], "L"), (n && "M" === e[n] ||
                                    n === f) &&
                                e.splice(n, 0, "L", e[n - 2] + l, e[n - 1]);
                    k
                        ? k.attr({ d: e })
                        : a.graph &&
                        (a.tracker = g.path(e).attr({
                            "stroke-linejoin": "round",
                            ...
                            function(a) {
                                a.addClass("highcharts-tracker").on("mouseover", m)
                                    .on("mouseout", function(a) { d.onTrackerMouseOut(a) });
            ...
            z(C.prototype,
                {
                    showResetZoom: function() {
                        ...
                        u(this,
                            ...
                            null,
                            function() {
                                b.resetZoomButton = b.renderer.button(c.resetZoom, null, null, a, f, h && h.hover)
                    ...
                    zoom: function(a) {
                        ...
                        !a || a.resetSelection
                            ? (v(this.axes, function(a) { c = a.zoom() }), e.initiated = !1)
                            : v(a.xAxis.concat(a.yAxis),
                                function(a) {
                                    var b = a.axis;
                                    e[b.isXAxis ? "zoomX" : "zoomY"] &&
                                    (c = b.zoom(a.min, a.max), b.displayBtn &&
                                        (f = !0))
                                });
                        ...
                        v("xy" === b ? [1, 0] : [1],
                            function(b) {
                                ...
                                var d = b.horiz,
                                    ...
                                    h = q ? g : n,
                                    n = q ? n : g,
                                    g = Math.min(l.dataMin,
                                        k ? l.min : b.toValue(b.toPixels(l.min) - b.minPixelPadding)),
                                    k = Math.max(l.dataMax,
                                        k ? l.max : b.toValue(b.toPixels(l.max) + b.minPixelPadding)),
                                    q = g - h;
                                0 < q && (n += q, h = g);
                                q = n - k;
                                0 < q && (n = k, h -= q);
                                b.series.length &&
                                    h !== l.min &&
                                    n !== l.max &&
                                    (b.setExtremes(h, n, !1, !1, { trigger: "pan" }), f = !0);
                                c[d] = e
                            });
                        f && c.redraw(!1);
            ...
            z(f.prototype,
                {
                    select: function(a, b) {
                        ...
                        c.firePointEvent(a ? "select" : "unselect",
                            ...
                            function() {
                                ...
                                c.setState(a && "select");
                                b ||
                                    v(f.getSelectedPoints(),
                                        function(a) {
                                            a.selected &&
                                                a !== c &&
                                                (a.selected = a.options.selected = !1, e.options.data[l(a, e.data)] =
                    ...
                    importEvents: function() {
                        if (!this.hasImportedEvents) {
                            ...
                            b.events = c;
                            a.objectEach(c, function(a, c) { B(b, c, a) });
                    ...
                    setState: function(a, b) {
                        ...
                        if (!(a === this.state && !b ||
                            ...
                            if (this.graphic)
                                this.state && this.graphic.removeClass("highcharts-point-" + this.state), a &&
                                    this.graphic.addClass("highcharts-point-" + a), this.graphic.animate(
                                    f.pointAttribs(this, a),
                                    n(w.options.chart.animation,
                                        h.animation)), D &&
                                    this.graphic.animate(D,
                                        n(w.options.chart.animation, r.animation, d.animation)), m && m.hide();
                            else {
                                if (a && r) {
                                    d = t.symbol || f.symbol;
                                    m && m.currentSymbol !== d && (m = m.destroy());
                                    if (m) m[b ? "animate" : "attr"]({ x: D.x, y: D.y });
                                    else
                                        d &&
                                        (f.stateMarkerGraphic = m =
                                            w.renderer.symbol(d, D.x, D.y, D.width, D.height).add(f.markerGroup), m
                                            .currentSymbol = d);
                                    m && m.attr(f.pointAttribs(this, a))
                                }
                                m &&
                                (m[a && w.isInsidePlot(c, e, w.inverted) ? "show" : "hide"](), m.element.point =
                                    this)
                            }
                            (c = h.halo) && c.size
                                ? (p ||
                                    (f.halo = p = w.renderer.path().add((this.graphic ||
            ...
            z(c.prototype,
                {
                    ...
                    setState: function(a) {
                        ...
                        a = a || "";
                        if (b.state !== a &&
                            (v([b.group, b.markerGroup, b.dataLabelsGroup],
                                function(d) {
                                    d &&
                                    (b.state && d.removeClass("highcharts-series-" + b.state), a &&
                                        d.addClass("highcharts-series-" + a))
                                }), b.state = a, !f[a] || !1 !== f[a].enabled) &&
                            (a && (h = f[a].lineWidth || h + (f[a].lineWidthPlus || 0)), e && !e.dashstyle))
                            for (h = { "stroke-width": h }, e.animate(h,
                                    n(f[a || "normal"] && f[a || "normal"].animation, b.chart.options.chart.animation));
                                b["zone-graph-" + c];
                    ...
                    setVisible: function(a, b) {
                        var c = this,
                            ...
                            g = c.visible;
                        h = (c.visible = a = c.options.visible = c.userOptions.visible = void 0 === a ? !g : a)
                            ? "show"
                            : "hide";
                        v(["group", "dataLabelsGroup", "markerGroup", "tracker", "tt"],
                            function(a) { if (c[a]) c[a][h]() });
                        if (e.hoverSeries === c || (e.hoverPoint && e.hoverPoint.series) === c) c.onMouseOut();
                        f && e.legend.colorizeItem(c, a);
                        c.isDirty = !0;
                        c.options.stacking &&
                            v(e.series, function(a) { a.options.stacking && a.visible && (a.isDirty = !0) });
                        v(c.linkedSeries,
        ...
        (function(a) {
            ...
            B.prototype.setResponsive = function(g) {
                ...
                m &&
                    ...
                    C(m.rules,
                        ...
                        this);
                var b = a.merge.apply(0,
                        a.map(p,
                            function(b) { return a.find(m.rules, function(a) { return a._id === b }).chartOptions })),
                    p = p.toString() || void 0;
                p !== (l && l.ruleIds) &&
                (l && this.update(l.undoOptions, g), p
                    ? (this.currentResponsive =
                        { ruleIds: p, mergedOptions: b, undoOptions: this.currentOptions(b) }, this.update(b, g))
            ...
            B.prototype.matchResponsiveRule = function(a, m) {
                ...
                (p.callback ||
                        function() {
                            return this.chartWidth <= g(p.maxWidth, Number.MAX_VALUE) &&
                                this.chartHeight <= g(p.maxHeight, Number.MAX_VALUE) &&
                                this.chartWidth >= g(p.minWidth, 0) &&
                                this.chartHeight >= g(p.minHeight, 0)
                        }).call(this) &&
                    m.push(a._id)
            };
                    ...
                    a.objectEach(g,
                        function(a, c) {
                            if (!t && -1 < G(c, ["series", "xAxis", "yAxis"]))
                                for (a = v(a), e[c] = [], l = 0; l < a.length; l++)
                                    b[c][l] && (e[c][l] = {}, u(a[l], b[c][l], e[c][l], t + 1));
                            else m(a) ? (e[c] = p(a) ? [] : {}, u(a, b[c] || {}, e[c], t + 1)) : e[c] = b[c] || null
                        })
                }
        ...
        (function(a) {
            ...
            l(a.Series.prototype,
                ...
                function(a) {
                    ...
                    (b = this.xAxis) &&
                        b.options.ordinal &&
                        B(this, "updatedData", function() { delete b.ordinalIndex })
                });
            l(C.prototype,
                "getTimeTicks",
                function(a, e, g, l, f, c, h, w) {
                    var b = 0,
                        n,
                        t,
                        q = {},
                    ...
                    if (w && a.unitRange <= y.hour) {
                        n = d.length - 1;
                        for (b = 1; b < n; b++)
                            k.dateFormat("%d", d[b]) !== k.dateFormat("%d", d[b - 1]) && (q[d[b]] = "day", p = !0);
                        p && (q[d[0]] = "day");
                        a.higherRanks =
                            q
                    }
                    ...
                    if (w && m(E)) {
                        ...
                        w = d[k - 1] > l ? k - 1 : k;
                        for (A = void 0; w--;)
                            b = n[w], l = Math.abs(A - b), A && l < .8 * E && (null === p || l < .8 * p)
                                ? (q[d[w]] && !q[d[w + 1]] ? (l = w + 1, A = b) : l = w, d.splice(l, 1))
                                : A = b
                    }
                    return d
                });
            v(C.prototype,
                {
                    beforeSetTickPositions: function() {
                        ...
                        !this.options.overscroll ||
                            ...
                            this.chart.mouseIsDown && !n ||
                            this.eventArgs && (!this.eventArgs || "navigator" === this.eventArgs.trigger) ||
                            (this.max += this.options.overscroll, !n &&
                                m(this.userMin) &&
                                (this.min += this.options.overscroll));
                        if (f || p) {
                            g(this.series,
                                function(b, c) {
                                    if (!(v && !1 === b.visible || !1 === b.takeOrdinalPosition && !p) &&
                                    (e = e.concat(b.processedXData), a = e.length, e.sort(function(a, b) {
                                        return a -
                                            b
                            ...
                            if (2 < a) {
                                ...
                                (2 === a
                                    ? r = e[1] - e[0]
                                    : 1 === a
                                    ? (r = this.options.overscroll, e = [e[0], e[0] + r])
                                    : r = this.overscrollPointsRange);
                            l
                                ? (this.options.overscroll &&
                                    (this.overscrollPointsRange = r, e = e.concat(this.getOverscrollPositions())), this
                                    .ordinalPositions = e, n = this.ordinal2lin(Math.max(c,
                                        e[0]),
                                    !0), w =
                                    Math.max(this.ordinal2lin(Math.min(h, e[e.length - 1]), !0), 1), this.ordinalSlope =
                                    h = (h - c) / (w - n), this.ordinalOffset = c - n * h)
                                : (this.overscrollPointsRange =
                                    u(this.closestPointRange, this.overscrollPointsRange), this.ordinalPositions =
                    ...
                    getExtendedPositions: function() {
                        ...
                        (m = {
                            series: [],
                            chart: e,
                            getExtremes: function() { return{ min: h.dataMin, max: h.dataMax + c } },
                            options: { ordinal: !0 },
            ...
            l(G.prototype,
                ...
                function(a, e) {
                    ...
                    if (b.options.ordinal && b.series.length) {
                        ...
                        x.ordinalPositions
                            ? 1 < Math.abs(h) &&
                            (q && g(q, function(a) { a.setState() }),
                                0 > h
                                    ? (q = x, d = b.ordinalPositions ? b : x)
                                    : (q = b.ordinalPositions ? b : x, d = x), x =
                                    d.ordinalPositions, u > x[x.length - 1] && x.push(u), this.fixedRange = v - r, h =
                                    b.toFixedRange(null,
                                        null,
                                        F.apply(q, [y.apply(q, [r, !0]) + h, !0]),
                                        F.apply(d, [y.apply(d, [v, !0]) + h, !0])), h.min >= Math.min(m.dataMin, r) &&
                                    h.max <= Math.max(u, v) + l &&
                                    b.setExtremes(h.min, h.max, !0, !1, { trigger: "pan" }), this.mouseDownX =
                                    f, p(this.container, { cursor: "move" }))
                            : c = !0
                    } else c = !0;
        ...
        (function(a) {
            ...
            v(y.prototype,
                {
                    ...
                    isInAnyBreak: function(a, e) {
                        ...
                        if (g) {
                            for (; g--;)
                                this.isInBreak(b[g], a) &&
                                    (f = !0, c || (c = p(b[g].showPoints, this.isXAxis ? !1 : !0)));
                            h = f && e ? f && !c : f
                        }
                        return h
                    }
            ...
            G(y,
                "afterSetOptions",
                function() { this.options.breaks && this.options.breaks.length && (this.options.ordinal = !1) });
            G(y,
                "afterInit",
                function() {
                    var a = this, e;
                    ...
                    (a.val2lin = function(b) {
                        ...
                        var e, f;
                        for (f = 0;
                            f < a.breakArray.length &&
                                !(e = a.breakArray[f], e.from >= b);
                            f++) e.to < b ? b += e.len : a.isInBreak(e, b) && (b += e.len);
                        return b
                        ...
                        g(e,
                            function(a) {
                                ...
                                0 === h &&
                                (f.push({ from: q, to: a.value, len: a.value - q - (a.size || 0) }), c += a.value -
                                    q -
                                    (a.size || 0))
                            });
                        a.breakArray = f;
                        ...
                        a.options.staticScale
                            ...
                            : a.unitLength && (a.transA *= (r - a.min + t) / a.unitLength);
            ...
            m(l.prototype,
                ...
                function(a) {
                    ...
                    if (b && g && (b.options.breaks || g.options.breaks))
                        for (; c--;)
                            f = l[c], m = null === f.y && !1 === h, m ||
                                !b.isInAnyBreak(f.x,
                                    !0) &&
                                !g.isInAnyBreak(f.y, !0) ||
                                (l.splice(c, 1), this.data[c] && this.data[c].destroyElements())
                });
                                ...
                                function(b) {
                                    ...
                                    g(f,
                                        function(e) {
                                            ...
                                            else if (c < e.from && m > e.from && m < e.to ||
                                                c > e.from && m > e.to && m < e.from) h = "pointInBreak";
            ...
            a.Series.prototype.gappedPath =
                function() {
                    var b = this.currentDataGrouping,
                        ...
                        f = this.yAxis;
                    if (b && 0 < l)
                        for ("value" !== this.options.gapUnit && (b *= this.closestPointRange), e && e > b && (b = e);
                            l--;
                        )
                            g[l + 1].x - g[l].x > b &&
                            (e = (g[l].x + g[l + 1].x) / 2, g.splice(l + 1, 0, { isNull: !0, x: e }),
                                this.options.stacking &&
                                (e = f.stacks[this.stackKey][e] =
                                    new a.StackItem(f, f.options.stackLabels, !1, e, this.stack), e.total = 0));
        ...
        (function(a) {
            var B = a.addEvent,
                ...
                J = a.defaultDataGroupingUnits = [
                    ...
                    ["minute", [1, 2, 5, 10, 15, 30]], ["hour", [1, 2, 3, 4, 6, 8, 12]], ["day", [1]], ["week", [1]],
                ...
                q = a.approximations = {
                    ...
                    averages: function() {
                        var a =
                            [];
                        v(arguments, function(b) { a.push(q.average(b)) });
                        return void 0 === a[0] ? void 0 : a
                    },
                    open: function(a) { return a.length ? a[0] : a.hasNulls ? null : void 0 },
                    high: function(a) { return a.length ? C(a) : a.hasNulls ? null : void 0 },
                    low: function(a) { return a.length ? G(a) : a.hasNulls ? null : void 0 },
            ...
            c.groupData = function(a, b, c, d) {
                ...
                d = "function" === typeof d
                    ? d
                    : q[d] || r[this.type] && q[r[this.type].approximation] || q[D.approximation];
                var x = this.pointArrayMap, t = x && x.length, u = 0;
                n = 0;
                var F, z;
                t ? v(x, function() { w.push([]) }) : w.push([]);
                F = t || 1;
            ...
            c.processData = function() {
                ...
                if (!1 !== h.apply(this, arguments) && f) {
                    ...
                    var n,
                        q = e.groupAll ? this.xData : this.processedXData,
                    ...
                    if (t) {
                        ...
                        t = t * (f - k) / p * w;
                        p = a.getTimeTicks(a.normalizeTimeTickInterval(t, e.units || J),
                            Math.min(k, q[0]),
                            Math.max(f, q[q.length - 1]),
                        ...
                        g(q[0]) &&
                            q[0] < a.dataMin &&
                            d &&
                            (a.min <= a.dataMin && (a.min = q[0]), a.dataMin = q[0]);
            ...
            c.destroyGroupedData = function() {
                ...
                v(a || [], function(b, c) { b && (a[c] = b.destroy ? b.destroy() : null) });
            ...
            B(e, "update", function() { if (this.dataGroup) return a.error(24), !1 });
            f(n.prototype,
                ...
                function(a, b, c) {
                    var d = this.chart.time,
                        ...
                        g,
                        l = e.xAxis;
                    return l && "datetime" === l.options.type && k && y(b.key)
                        ? (a = e.currentDataGrouping, k =
                                k.dateTimeLabelFormats, a
                                ? (l = k[a.unitName], 1 === a.count ? h = l[0] : (h = l[1], g = l[2]))
                                : !h && k && (h = this.getXDateFormat(b, f, l)), h = d.dateFormat(h, b.key),
                            g && (h += d.dateFormat(g, b.key + a.totalRange - 1)), u(
                                f[(c ? "footer" : "header") + "Format"],
                                { point: z(b.point, { key: h }), series: e },
                                d))
                        : a.call(this, b, c)
                });
            ...
            B(t,
                ...
                function(a) {
                    ...
                    if (r[b] || e)
                        d || (d = l(D, r[b])), a.dataGrouping = l(e,
                            d,
            ...
            B(p, "afterSetScale", function() { v(this.series, function(a) { a.hasProcessed = !1 }) });
            p.prototype.getGroupPixelWidth = function() {
                ...
                for (c = b; c--;)
                    (f = a[c].options.dataGrouping) &&
                        a[c].hasProcessed &&
                        (b = (a[c].processedXData || a[c].data).length, a[c].groupPixelWidth ||
            ...
            p.prototype.setDataGrouping = function(a, c) {
                ...
                else v(this.chart.options.series, function(b) { b.dataGrouping = a }, !1);
            ...
            G("ohlc",
                ...
                },
                {
                    ...
                    translate: function() {
                        ...
                        B(a.points,
                            function(m) {
                                B([m.open, m.high, m.low, m.close, m.low],
                                    function(p, l) {
                    ...
                    drawPoints: function() {
                        ...
                        B(a.points,
                            function(m) {
                                ...
                                void 0 !== m.plotY &&
                                (b || (m.graphic = b = g.renderer.path().add(a.group)), b.attr(a.pointAttribs(m,
                                        m.selected && "select")), u = b.strokeWidth() %
                                        2 /
                                        2, e = Math.round(m.plotX) - u, v = Math.round(m.shapeArgs.width / 2), l =
                                        ["M", e, Math.round(m.yBottom), "L", e, Math.round(m.plotHigh)],
                                    null !== m.open &&
                                        (p = Math.round(m.plotOpen) + u, l.push("M", e, p, "L", e - v, p)),
                                    null !== m.close &&
                                        (p = Math.round(m.plotClose) + u, l.push("M", e, p, "L", e + v, p)),
                                    b[t ? "attr" : "animate"]({ d: l }).addClass(m.getClassName(), !0))
                            })
                    },
                    animate: null
                },
                {
                    getClassName: function() {
                        return C.prototype.getClassName.call(this) +
            ...
            p("candlestick",
                    ...
                    }),
                {
                    pointAttribs: function(a, p) {
                        ...
                        g.stroke = a.lineColor ||
                        (v
                            ? u.upLineColor ||
                            l
                            : l);
                        p &&
                        (a = u.states[p], g.fill = a.color || g.fill, g.stroke =
                            a.lineColor || g.stroke, g["stroke-width"] = a.lineWidth || g["stroke-width"]);
                        return g
                    },
                    drawPoints: function() {
                        ...
                        C(a.points,
                            function(g) {
                                ...
                                void 0 !== g.plotY &&
                                (p || (g.graphic = p = m.renderer.path().add(a.group)), p
                                    .attr(a.pointAttribs(g, g.selected && "select")).shadow(a.options.shadow), t =
                                    p.strokeWidth() % 2 / 2, n = Math.round(g.plotX) - t, v = g.plotOpen, l =
                                    g.plotClose, b = Math.min(v, l), v = Math.max(v, l), f = Math.round(
                                    g.shapeArgs.width /
                                    2), l = Math.round(b) !== Math.round(g.plotHigh), e = v !== g.yBottom, b =
                                    Math.round(b) + t, v = Math.round(v) + t, t = [], t.push("M",
                                    n - f,
                                    v,
                                    "L",
                                    n - f,
                                    ...
                                    "L",
                                    n,
                                    l ? Math.round(g.plotHigh) : b,
                                    "M",
                                    n,
                                    v,
                                    "L",
                                    n,
                                    e ? Math.round(g.yBottom) : v), p[c ? "attr" : "animate"]({ d: t })
            ...
            return{
                ...
                translate: function() {
                    ...
                    var a = this.options,
                        ...
                        J;
                    if (l && l.visible && t)
                        for (h = (l.pointXOffset || 0) + (l.barW || 0) / 2, u = l.currentDataGrouping, D =
                                e[t - 1].x + (u ? u.totalRange : 0), p(v, function(a, b) { return a.x - b.x }), a =
                                "plot" + a[0].toUpperCase() + a.substr(1);
                            t-- &&
                                v[z] &&
                                !(w = e[t], u = v[z], u.y = w.y, w.x <=
                                    u.x &&
                                    void 0 !== w[a] &&
                                    (u.x <= D &&
                                    (u.plotY = w[a], w.x < u.x &&
                                        ...
                                        (r = e[t + 1]) &&
                                        void 0 !== r[a] &&
                                        (J = (u.x - w.x) / (r.x - w.x), u.plotY += J * (r[a] - w[a]), u.y += J *
                                            (r.y - w.y)
                                        )), z--, t++, 0 > z));
                        );
                    B(v,
                        function(a, b) {
                            ...
                            a.plotX += h;
                            if (void 0 === a.plotY || n)
                                0 <= a.plotX && a.plotX <= f.len
                                    ? n
                                    ? (a.plotY = f.translate(a.x, 0, 1, 0, 1), a.plotX =
                                        C(a.y) ? c.translate(a.y, 0, 0, 0, 1) : 0)
                                    : a.plotY = g.chartHeight -
                                    f.bottom -
                                    (f.opposite ? f.height : 0) +
                                    f.offset -
                                    c.top
                                    : a.shapeArgs = {};
                            (y = v[b - 1]) &&
        ...
        (function(a, B) {
            function C(a) {
                l[a + "pin"] = function(b, g, m, f, c) {
                    ...
                    e &&
                        c &&
                        (b.push("M", "circle" === a ? b[1] - b[4] : b[1] + b[4] / 2, g > c ? g : g + f, "L", e, c), b =
                            b.concat(l.circle(e - 1, c - 1, 2, 2)));
                    return b
                }
            }
                ...
                },
                {
                    ...
                    drawPoints: function() {
                        var b = this.points,
                            ...
                            H = [];
                        for (r = b.length; r--;)
                            v = b[r], x = (c ? v.plotY : v.plotX) > this.xAxis.len, l = v.plotX, q = v.stackIndex, u =
                                v.options.shape || h.shape, f = v.plotY, void 0 !== f &&
                            (f = v.plotY +
                                w -
                                (void 0 !== q &&
                                    q * h.stackDistance)), v.anchorX = q ? void 0 : v.plotX, y =
                                q ? void 0 : v.plotY, q = v.graphic, void 0 !== f && 0 <= l && !x
                                ? (q ||
                                (q = v.graphic =
                                    g.label("", null, null, u, null, null, h.useHTML).attr(this.pointAttribs(v))
                                    .css(m(h.style, v.style))
                                    .attr({
                                    ...
                                    .add(this.markerGroup), v.graphic.div && (v.graphic.div.point = v), q.shadow(
                                    h.shadow), q.isNew = !0), 0 < l && (l -= q.strokeWidth() % 2), u =
                                    { y: f, anchorY: y }, h.allowOverlapX &&
                                (u.x = l, u.anchorX =
                                    v.anchorX), q.attr({ text: v.options.title || h.title || "A" })[
                                    q.isNew ? "attr" : "animate"](u), h.allowOverlapX ||
                                (d[v.plotX]
                                    ? d[v.plotX].size = Math.max(d[v.plotX].size, q.width)
                                    : d[v.plotX] = { align: 0, size: q.width, target: l, anchorX: l }), v.tooltipPos =
                                    [l, f + z.pos - e.plotTop])
                                : q && (v.graphic = q.destroy());
                        h.allowOverlapX ||
                        (a.objectEach(d,
                            function(a) {
                                a.plotX = a.anchorX;
                                H.push(a)
                            }), a.distribute(H, c ? z.len : this.xAxis.len, 100), p(b,
                            function(a) {
                        ...
                        h.useHTML &&
                            a.wrap(this.markerGroup,
                                "on",
                                function(b) {
                                    return a.SVGElement.prototype.on.apply(b.apply(this, [].slice.call(arguments, 1)),
                                ...
                                e &&
                                    G(e.element,
                                        ...
                                        function() {
                                            0 < b.stackIndex &&
                                                !b.raised &&
                                                (b._y = e.y, e.attr({ y: b._y - 8 }), b.raised = !0);
                                            p(a,
                                                function(a) {
                                                    a !== b &&
                                                        a.raised &&
            ...
            l.flag = function(a, e, g, m, f) {
                var b = f && f.anchorX || a;
                f = f && f.anchorY || e;
                return l.circle(b - 1, f - 1, 2, 2)
                    .concat(["M", b, f, "L", a, e + m, a, e, a + g, e, a + g, e + m, a, e + m, "Z"])
            };
            C("circle");
            C("square");
            v === y && p(["flag", "circlepin", "squarepin"], function(a) { y.prototype.symbols[a] = l[a] })
        })(L, da);
        (function(a) {
            function B(a, b, c) { this.init(a, b, c) }
            ...
            B.prototype = {
                ...
                render: function() {
                    ...
                    this.scrollbar = a.rect().addClass("highcharts-scrollbar-thumb")
                        .attr({ height: c, width: c, r: b.barBorderRadius || 0 }).add(this.scrollbarGroup);
                    this.scrollbarRifles = a.path(f([
                            "M", -3, c / 4, "L", -3, 2 * c / 3, "M", 0, c / 4, "L", 0, 2 * c / 3, "M",
                            3, c / 4, "L", 3, 2 * c / 3
                        ],
                    ...
                    this.scrollbarGroup.translate(-this.scrollbarStrokeWidth % 2 / 2,
                ...
                position: function(a, b, c, e) {
                    ...
                    this.yOffset = h;
                    f
                        ? (this.width = this.yOffset = c = h = this.size, this.xOffset = b = 0, this.barWidth =
                            e - 2 * c, this.x = a += this.options.margin)
                        : (this.height = this.xOffset = e = b = this.size, this.barWidth =
                            c - 2 * e, this.y += this.options.margin);
                ...
                drawScrollbarButton: function(a) {
                    ...
                    g.attr(g.crisp({ x: -.5, y: -.5, width: h + 1, height: h + 1, r: e.buttonBorderRadius },
                        g.strokeWidth()));
                    g = b.path(f([
                            "M", h / 2 + (a ? -1 : 1), h / 2 - 3, "L", h / 2 + (a ? -1 : 1), h / 2 + 3, "L",
                            h / 2 + (a ? 2 : -2), h / 2
                        ],
                        e.vertical)).addClass("highcharts-scrollbar-arrow").add(c[a]);
                ...
                setRange: function(a, b) {
                    ...
                    g(h) &&
                    (a = Math.max(a, 0), l = Math.ceil(h * a), this.calculatedWidth = m =
                            p(h * Math.min(b, 1) - l), m < f && (l = (h - f + m) * a, m = f), f =
                            Math.floor(l + this.xOffset + this.yOffset), h = m / 2 - .5, this.from = a, this.to = b, e
                            ? (this.scrollbarGroup[n]({ translateY: f }), this.scrollbar[n]({ height: m }),
                                this.scrollbarRifles[n]({ translateY: h }), this.scrollbarTop = f, this.scrollbarLeft =
                                    0)
                            : (this.scrollbarGroup[n]({ translateX: f }), this.scrollbar[n]({ width: m }),
                                this.scrollbarRifles[n]({ translateX: h }), this.scrollbarLeft = f, this.scrollbarTop =
                                    0),
                        12 >= m ? this.scrollbarRifles.hide() : this.scrollbarRifles.show(!0), !1 === c.showFull &&
                            (0 >= a && 1 <= b ? this.group.hide() : this.group.show()), this.rendered = !0)
                },
                initEvents: function() {
                    var a = this;
                    a.mouseMoveHandler = function(b) {
                        ...
                        !a.grabbedCenter ||
                            ...
                            (c = a.cursorToScrollbarPosition(c)[e], e = a[e], e = c - e, a.hasDragged =
                                !0, a.updatePosition(f[0] + e, f[1] + e), a.hasDragged &&
                                u(a,
                                    "changed",
                    ...
                    a.trackClick = function(b) {
                        ...
                        a.options.vertical && c.chartY > f || !a.options.vertical && c.chartX > g
                ...
                addEvents: function() {
                    var a = this.options.inverted ? [1, 0] : [0, 1],
                        ...
                        a = [
                            ...
                            [this.track.element, "click", this.trackClick], [c, "mousedown", e],
                    ...
                    y &&
                        a.push([c, "touchstart", e],
                            [c.ownerDocument, "touchmove", f],
                            [c.ownerDocument, "touchend", g]);
                    z(a, function(a) { C.apply(null, a) });
                    this._events = a
                },
                removeEvents: function() {
                    z(this._events, function(a) { t.apply(null, a) });
                    this._events.length = 0
                },
                destroy: function() {
                    var a = this.chart.scroller;
                    this.removeEvents();
                    z(["track", "scrollbarRifles", "scrollbar", "scrollbarGroup", "group"],
                        function(a) { this[a] && this[a].destroy && (this[a] = this[a].destroy()) },
                        this);
            ...
            n(G.prototype,
                ...
                function(a) {
                    ...
                    b.options.scrollbar &&
                        ...
                        (b.options.scrollbar.vertical = !b.horiz, b.options.startOnTick = b.options.endOnTick =
                            !1, b.scrollbar = new B(b.chart.renderer, b.options.scrollbar, b.chart), C(b.scrollbar,
                            "changed",
                            function(a) {
                                ...
                                b.horiz && !b.reversed || !b.horiz && b.reversed
                                    ? (g = c + f * this.to, c += f *
                                        this.from)
                                    : (g = c + f * (1 - this.from), c += f * (1 - this.to));
            ...
            n(G.prototype,
                ...
                function(a) {
                    ...
                    if (f) {
                        this.horiz
                            ? (f.position(this.left,
                                this.top +
                                this.height +
                                2 +
                                this.chart.scrollbarsOffsets[1] +
                                (this.opposite ? 0 : h + this.axisTitleMargin + this.offset),
                                this.width,
                                this.height), h = 1)
                            : (f.position(
                                this.left +
                                ...
                                (this.opposite ? h + this.axisTitleMargin + this.offset : 0),
                                this.top,
                                this.width,
                                this.height), h = 0);
                        ...
                        isNaN(b) || isNaN(c) || !g(this.min) || !g(this.max)
                            ? f.setRange(0, 0)
                            : (h = (this.min - b) / (c - b), b =
                                (this.max - b) / (c - b), this.horiz && !this.reversed || !this.horiz && this.reversed
                                ? f.setRange(h,
                                    b)
                                : f.setRange(1 - b, 1 - h))
                    }
        ...
        (function(a) {
            ...
            b(g,
                {
                    navigator: {
                        ...
                        series: {
                            ...
                            compare: null,
                            dataGrouping:
                                { approximation: "average", enabled: !0, groupPixelWidth: 2, smoothed: !0, units: x },
            ...
            a.Renderer.prototype.symbols["navigator-handle"] = function(a, b, c, e, f) {
                ...
                f = f.height;
                return[
                    "M", -a - 1, .5, "L", a, .5, "L", a, f + .5, "L", -a - 1, f + .5, "L", -a - 1, .5, "M", -b, 4, "L",
                    -b, f - 3, "M", b - 1, 4, "L", b - 1, f - 3
                ]
            };
            B.prototype = {
                ...
                drawOutline: function(a, b, c, e) {
                    var d = this.navigatorOptions.maskInside,
                        ...
                        n = this.top;
                    c
                        ? (m -= k, c = n + b + f, b = n + a + f, a =
                        [
                            "M", m + g, n - h - f, "L", m + g, c, "L", m, c, "L", m, b, "L", m + g, b, "L", m + g,
                            n + l + h
                        ].concat(d ? ["M", m + g, c - k, "L", m + g, b + k] : []))
                        : (a += m + h - f, b += m + h - f, n += k, a =
                            ["M", m, n, "L", a, n, "L", a, n + g, "L", b, n + g, "L", b, n, "L", m + l + 2 * h, n]
                            .concat(d ? ["M", a - k, n, "L", b + k, n] : []));
                    this.outline[e]({ d: a })
                },
                drawMasks: function(a, b, c, e) {
                    ...
                    c
                        ? (l = [d, d, d], m = [
                            f, f + a,
                            f + b
                        ], h = [k, k, k], g = [a, b - a, this.size - b])
                        : (l = [d, d + a, d + b], m = [f, f, f], h = [a, b - a, this.size - b], g = [k, k, k]);
                    u(this.shades, function(a, b) { a[e]({ x: l[b], y: m[b], width: h[b], height: g[b] }) })
                },
                renderElements: function() {
                    ...
                    u([!c, c, !c],
                        function(d, c) {
                            a.shades[c] =
                                g.rect().addClass("highcharts-navigator-mask" + (1 === c ? "-inside" : "-outside"))
                                .attr({ fill: d ? b.maskFill : "rgba(0,0,0,0)" }).css(1 === c && l).add(h)
                        });
                    a.outline = g.path().addClass("highcharts-navigator-outline")
                        .attr({ "stroke-width": b.outlineWidth, stroke: b.outlineColor }).add(h);
                    b.handles.enabled &&
                        u([0, 1],
                            function(d) {
                                b.handles.inverted = e.inverted;
                                a.handles[d] = g.symbol(b.handles.symbols[d],
                                    -b.handles.width / 2 - 1,
                                    0,
                                    b.handles.width,
                                    b.handles.height,
                                    b.handles);
                                a.handles[d].attr({ zIndex: 7 - d })
                ...
                update: function(a) {
                    u(this.series || [], function(a) { a.baseSeries && delete a.baseSeries.navigatorSeries });
                    this.destroy();
                ...
                render: function(b, c, e, k) {
                    ...
                    if (!this.hasDragged || v(e)) {
                        ...
                        t < x
                            ? this.grabbedLeft
                            ? e = n.toPixels(c - x, !0)
                            : this.grabbedRight && (k = n.toPixels(b + x, !0))
                            : v(u) &&
                            t > u &&
                            (this.grabbedLeft
                                ? e = n.toPixels(c - u, !0)
                                : this.grabbedRight && (k = n.toPixels(b + u, !0)));
                        this.zoomedMax = Math.min(Math.max(e, k, 0), p);
                        this.zoomedMin =
                            Math.min(Math.max(this.fixedWidth ? this.zoomedMax - this.fixedWidth : Math.min(e, k), 0),
                                p);
                        this.range = this.zoomedMax - this.zoomedMin;
                        p = Math.round(this.zoomedMax);
                        e = Math.round(this.zoomedMin);
                        q &&
                        (this.navigatorGroup.attr({ visibility: "visible" }), r =
                                r && !this.hasDragged ? "animate" : "attr", this.drawMasks(e, p, h, r),
                            this.drawOutline(e, p, h, r), this.navigatorOptions.handles.enabled &&
                            (this.drawHandle(e,
                                0,
                                h,
                                r), this.drawHandle(p, 1, h, r)));
                        this.scrollbar &&
                        (h
                                ? (h = this.top - l, g =
                                    this.left -
                                    l +
                                    (q || !g.opposite ? 0 : (g.titleOffset || 0) + g.axisTitleMargin), l =
                                    m + 2 * l)
                                : (h = this.top + (q ? this.height : -l), g = this.left - l),
                            this.scrollbar.position(g, h, d, l), this.scrollbar.setRange(this.zoomedMin / m,
                                this.zoomedMax / m));
                        this.rendered = !0
                    }
                },
                addMouseEvents: function() {
                    ...
                    t &&
                    (e.push(C(c, "touchmove", f), C(c.ownerDocument, "touchend", g)), e.concat(
                        a.getPartsEvents("touchstart")));
                    a.eventsToUnbind = e;
                    a.series &&
                        a.series[0] &&
                        e.push(C(a.series[0].xAxis,
                            "foundExtremes",
                ...
                getPartsEvents: function(a) {
                    ...
                    u(["shades", "handles"],
                        function(c) {
                            u(b[c],
                                function(e, f) { d.push(C(e.element, a, function(a) { b[c + "Mousedown"](a, f) })) })
                        });
                    return d
                },
                shadesMousedown: function(a,
                    ...
                    1 === b
                        ? (this.grabbedCenter = l, this.fixedWidth = h, this.dragOffset = l - e)
                        : (a = l - f - h / 2, 0 === b
                            ? a = Math.max(0, a)
                            : 2 === b &&
                            a + h >= g &&
                            (a = g - h, c.reversed
                                ? (a -= h, n = this.getUnionExtremes().dataMin)
                                : m = this.getUnionExtremes().dataMax), a !== e &&
                        (this.fixedWidth = h, b = c.toFixedRange(a, a + h, n, m), v(b.min) &&
                            d.xAxis[0].setExtremes(Math.min(b.min, b.max),
                                Math.max(b.min,
                                    b.max),
                                !0,
                                null,
                ...
                handlesMousedown: function(a, b) {
                    ...
                    0 === b
                        ? (this.grabbedLeft = !0, this.otherHandlePos = this.zoomedMax, this.fixedExtreme =
                            c ? d.min : d.max)
                        : (this.grabbedRight = !0, this.otherHandlePos = this.zoomedMin, this.fixedExtreme =
                            c ? d.max : d.min);
                    a.fixedRange = null
                },
                onMouseMove: function(a) {
                    ...
                    a.touches &&
                        0 === a.touches[0].pageX ||
                        (a = d.pointer.normalize(a), d = a.chartX, h && (c = b.top, d = a.chartY), b.grabbedLeft
                                ? (b.hasDragged = !0, b.render(0, 0, d - c, b.otherHandlePos))
                                : b.grabbedRight
                                ? (b.hasDragged = !0, b.render(0, 0, b.otherHandlePos, d - c))
                                : b.grabbedCenter &&
                                (b.hasDragged =
                                    !0, d < g ? d = g : d > e + g - f && (d = e + g - f), b.render(0,
                                    0,
                                    d - g,
                                    d - g + f)),
                            b.hasDragged &&
                                ...
                                (a.DOMType = a.type, setTimeout(function() { b.onMouseUp(a) }, 0)))
                },
                onMouseUp: function(a) {
                    var b = this.chart,
                        ...
                        g,
                        h = a.DOMEvent || a;
                    (!this.hasDragged || e && e.hasDragged) && "scrollbar" !== a.trigger ||
                    (e = this.getUnionExtremes(),
                        this.zoomedMin === this.otherHandlePos
                            ? f = this.fixedExtreme
                            : this.zoomedMax === this.otherHandlePos && (g = this.fixedExtreme),
                        this.zoomedMax === this.size && (g = c ? e.dataMin : e.dataMax),
                        0 === this.zoomedMin && (f = c ? e.dataMax : e.dataMin), d =
                            d.toFixedRange(this.zoomedMin, this.zoomedMax, f, g), v(d.min) &&
                            b.xAxis[0].setExtremes(Math.min(d.min, d.max),
                    ...
                    "mousemove" !== a.DOMType &&
                    (this.grabbedLeft = this.grabbedRight = this.grabbedCenter = this.fixedWidth =
                        this.fixedExtreme = this.otherHandlePos = this.hasDragged = this.dragOffset = null)
                },
                removeEvents: function() {
                    this.eventsToUnbind && (u(this.eventsToUnbind, function(a) { a() }), this.eventsToUnbind = void 0);
                ...
                init: function(a) {
                    ...
                    l.navigatorEnabled
                        ? (l.xAxis = new G(a,
                                h({ breaks: n.options.breaks, ordinal: n.options.ordinal },
                                    d.xAxis,
                                    {
                                        id: "navigator-x-axis",
                                    ...
                                    a.inverted
                                    ? { offsets: [g, 0, -g, 0], width: b }
                                    : { offsets: [0, -g, 0, g], height: b })),
                            l.yAxis =
                                new G(a,
                                    h(d.yAxis,
                                        {
                                        ...
                                        a.inverted ? { width: b } : { height: b })), e || d.series.data
                    ...
                    (a.scrollbar = l.scrollbar =
                        new r(a.renderer,
                            h(a.options.scrollbar, { margin: l.navigatorEnabled ? 0 : 10, vertical: a.inverted }),
                            a), C(l.scrollbar,
                        "changed",
                        function(b) {
                            var d =
                            ...
                            (a.options.scrollbar.liveRedraw || "mousemove" !== b.DOMType && "touchmove" !== b.DOMType
                                ...
                                setTimeout(function() { l.onMouseUp(b) })
                        }));
                    ...
                    u(d.series || [],
                        function(b, d) {
                            b.options.isInternal ||
                                ...
                                (d !== a && b.options.id !== a || !1 === b.options.showInNavigator) ||
                                c.push(b)
                        });
                ...
                updateNavigatorSeries: function(d, c) {
                    var e = this,
                        ...
                        x = e.series = a.grep(e.series || [],
                            function(b) {
                                var d = b.baseSeries;
                                return 0 > a.inArray(d, l)
                                    ? (d && (D(d, "updatedData", e.updatedDataHandler), delete d.navigatorSeries), b
                                            .destroy(),
                                        !1)
                                    : !0
                            });
                    l &&
                        ...
                        u(l,
                            function(a) {
                                ...
                                d && !1 === e.navigatorOptions.adaptToUpdatedData ||
                                (t.name = "Navigator " + l.length, m = a.options || {}, r =
                                    m.navigatorOptions || {}, q =
                                    h(m, t, k, r), k = r.data || k.data, e.hasNavigatorData =
                                    e.hasNavigatorData || !!k, q.data = k || m.data && m.data.slice(0), d && d.options
                                    ? d.update(q, c)
                                    : (a.navigatorSeries = f.initSeries(q), a.navigatorSeries.baseSeries =
                                        a, x.push(a.navigatorSeries)))
                            });
                    if (p.data && (!l || !l.length) || n(p))
                        e.hasNavigatorData = !1, p = a.splat(p), u(p,
                            function(a, b) {
                                t.name = "Navigator " + (x.length + 1);
                                q = h(g.navigator.series,
                                    {
                                        color: f.series[b] && !f.series[b].options.isInternal && f.series[b].color ||
                                            f.options.colors[b] ||
                                            f.options.colors[0]
                                    },
                                    t,
                ...
                addBaseSeriesEvents: function() {
                    ...
                    u(b,
                        function(b) {
                            C(b,
                                "show",
                                function() { this.navigatorSeries && this.navigatorSeries.setVisible(!0, !1) });
                            C(b,
                                "hide",
                                function() { this.navigatorSeries && this.navigatorSeries.setVisible(!1, !1) });
                            !1 !== this.navigatorOptions.adaptToUpdatedData &&
                                b.xAxis &&
                                C(b, "updatedData", this.updatedDataHandler);
                            C(b,
                                "remove",
                                function() {
                                    this.navigatorSeries &&
                                    (y(a.series, this.navigatorSeries), v(this.navigatorSeries.options) &&
                ...
                modifyBaseAxisExtremes: function() {
                    ...
                    (g && (n = c, m = n + b), h &&
                        (m = e + l, g || (n = Math.max(m - b, q && q.xData ? q.xData[0] : -Number.MAX_VALUE))), p &&
                        (g || h) &&
                        f(n) &&
                ...
                destroy: function() {
                    ...
                    u(
                        ...
                        this);
                    u([this.handles], function(a) { z(a) }, this)
                }
            };
            a.Navigator = B;
            F(G.prototype,
            ...
            C(p,
                ...
                function() {
                    ...
                    b &&
                    (e = a && a.options, f = b.xAxis, g = b.yAxis, c = b.scrollbarHeight, this.inverted
                        ? (b.left = b.opposite ? this.chartWidth - c - b.height : this.spacing[3] + c, b.top =
                            this.plotTop + c)
                        : (b.left = this.plotLeft + c, b.top = b.navigatorOptions.top ||
                            this.chartHeight -
                            b.height -
                            c -
                            this.spacing[2] -
                            ...
                            (e && "bottom" === e.verticalAlign && e.enabled && !e.floating
                                ? a.legendHeight + w(e.margin, 10)
                                : 0)), f &&
                        g &&
                        (this.inverted
                            ? f.options.left =
                            g.options.left = b.left
                            : f.options.top = g.options.top = b.top, f.setAxisSize(), g.setAxisSize()))
                });
            F(J.prototype,
                "addPoint",
                function(a, b, e, f, g) {
            ...
            C(p, "afterAddSeries", function() { this.navigator && this.navigator.setBaseSeries(null, !1) });
            C(J,
                "afterUpdate",
                function() {
        ...
        (function(a) {
            ...
            B.prototype = {
                clickButton: function(a, b) {
                    var c = this,
                        ...
                        p = n.dataMax,
                        r,
                        k = m && Math.round(Math.min(m.max, f(p, m.max))),
                        u = g.type,
                        v,
                        n = g._range,
                        w,
                    ...
                    if (null !== d && null !== p) {
                        ...
                        if ("month" === u || "year" === u)
                            m
                                ? (u = { range: g, max: k, chart: e, dataMin: d, dataMax: p }, r =
                                    m.minFromRange.call(u), t(u.newMax) && (k = u.newMax))
                                : n = g;
                        else if (n) r = Math.max(k - n, d), k = Math.min(r + n, p);
                        else if ("ytd" === u)
                            if (m)
                                void 0 === p &&
                                (d = Number.MAX_VALUE, p = Number.MIN_VALUE, l(e.series,
                                    function(a) {
                                        a = a.xData;
                                        d = Math.min(a[0], d);
                                ...
                                C(e, "beforeRender", function() { c.clickButton(a) });
                                return
                            }
                        ...
                        m
                            ? m.setExtremes(r,
                                ...
                                f(b, 1),
                                null,
                                { trigger: "rangeSelectorButton", rangeSelectorButton: g })
                            : (v = h(e.options.xAxis)[0], y = v.range, v.range = n, D = v.min, v.min = w, C(e,
                                "load",
                                function() {
                                    v.range = y;
                                    v.min = D
                ...
                updateButtonStates: function() {
                    ...
                    l(this.buttonOptions,
                        function(a, f) {
                            ...
                            ("month" === q || "year" === q) &&
                                c + 36E5 >= 864E5 * { month: 28, year: 365 }[q] * r - a &&
                                c - 36E5 <= 864E5 * { month: 31, year: 366 }[q] * r + a
                                ? l = !0
                                : "ytd" === q
                                ? (l = m - d + a === c, A = !f)
                                : "all" === q && (l = b.max - b.min >= h - g, y = !f && k && l);
                            q = !p && (x || w || y || e);
                            r = f && l || l && !k && !A;
                            q ? v = 3 : r && (k = !0, v = 2);
                ...
                drawInput: function(a) {
                    function e() {
                        ...
                        b !== y.previousValue &&
                        (y.previousValue =
                            b, t(b) || (b = a.split("-"), b = Date.UTC(c(b[0]), c(b[1]) - 1, c(b[2]))), t(b) &&
                        (h.time.useUTC || (b += 6E4 * (new Date).getTimezoneOffset()), w
                            ? b > f.maxInput.HCTime
                            ? b = void 0
                            : b < g && (b = g)
                            : b < f.minInput.HCTime
                    ...
                    var f = this,
                        ...
                        A = this.inputGroup;
                    this[a + "Label"] = k =
                        p.label(v.lang[w ? "rangeSelectorFrom" : "rangeSelectorTo"], this.inputGroup.offset)
                        .addClass("highcharts-range-label").attr({ padding: 2 }).add(A);
                    A.offset += k.width + 5;
                    ...
                    m(y,
                        b({
                            ...
                            u.inputStyle));
                    y.onfocus = function() { f.showInput(a) };
                    y.onblur = function() { f.hideInput(a) };
                    y.onchange = e;
                    y.onkeypress = function(a) { 13 === a.keyCode && e() }
                },
                ...
                render: function(a, b) {
                    ...
                    if (!1 !== k.enabled) {
                        L ||
                        (c.group = L = h.g("range-selector-group").attr({ zIndex: 7 }).add(), c.buttonGroup = G =
                            h.g("range-selector-buttons").add(L), c.zoomText =
                            h.text(p.rangeSelectorZoom, f(B + w.x, B), 15).css(k.labelStyle).add(G), C = f(B + w.x, B) +
                            c.zoomText.getBBox().width +
                            5, l(c.buttonOptions,
                            function(a, b) {
                                t[b] = h.button(a.text,
                                    C,
                                    ...
                                    D && D.hover,
                                    D && D.select,
                                    D && D.disabled).attr({ "text-align": "center" }).add(G);
                                C += t[b].width + f(k.buttonSpacing, 5)
                            }), !1 !== z &&
                        (c.div = r =
                                g("div", null, { position: "relative", height: 0, zIndex: 1 }),
                            m.parentNode.insertBefore(r, m), c.inputGroup = r = h.g("input-group").add(L), r.offset =
                                0, c.drawInput("min"), c.drawInput("max")));
                        ...
                        d &&
                            ...
                            "top" === X &&
                            "right" === w.align &&
                            w.y + G.getBBox().height - 12 < (d.y || 0) + d.height &&
                            (W = -40);
                        "left" === w.align
                            ? U = w.x - e.spacing[3]
                            : "right" === w.align && (U = w.x + W - e.spacing[1]);
                        ...
                        (W = d &&
                                ...
                                "top" === X &&
                                "right" === y.align &&
                                y.y - r.getBBox().height - 12 < (d.y || 0) + d.height + e.spacing[0]
                                ? -40
                                : 0, "left" === y.align
                                ? U = B
                                : "right" === y.align &&
                                (U = -Math.max(e.axisOffset[1],
                                    -W)), r.align({ y: y.y, width: r.getBBox().width, align: y.align, x: y.x + U - 2 },
                                !0,
                                e.spacingBox), m =
                                r.alignAttr.translateX + r.alignOptions.x - W + r.getBBox().x + 2, d =
                                r.alignOptions.width, p = G.alignAttr.translateX + G.getBBox().x, U =
                                G.getBBox().width + 20,
                            (y.align === w.align || p + U > m && m + d > p && ba < Y + r.getBBox().height) &&
                                r.attr({
                        ...
                        "bottom" === X &&
                        (Z = aa && "bottom" === aa.verticalAlign && aa.enabled && !aa.floating
                            ? Z.legendHeight + f(aa.margin, 10)
                            : 0, a = a + Z - 20, T = b - a - (n ? 0 : k.y) - 10);
                        if ("top" === X)
                            n && (T = 0), e.titleOffset && (T = e.titleOffset + e.options.title.margin), T +=
                                e.margin[0] - e.spacing[0] || 0;
                        else if ("middle" === X)
                            if (Y === ba) T = 0 > Y ? b + void 0 : b;
                            else if (Y || ba) T = 0 > Y || 0 > ba ? T - Math.min(Y, ba) : b - a + NaN;
                        c.group.translate(k.x, k.y + Math.floor(T));
                        !1 !== z &&
                        (c.minInput.style.marginTop = c.group.translateY +
            ...
            C(p,
                "afterGetContainer",
                function() { this.options.rangeSelector.enabled && (this.rangeSelector = new B(this)) });
            w(p.prototype,
                "render",
                function(a, b, c) {
            ...
            C(p,
                ...
                function(a) {
                    ...
                    a &&
                    (a.render(), b =
                            b.rangeSelector && b.rangeSelector.verticalAlign || a.options && a.options.verticalAlign,
                        a.options.floating ||
                        ("bottom" === b
            ...
            w(p.prototype,
                ...
                function(a, b, c) {
                    ...
                    e &&
                        !e.options.floating &&
                        (e.render(), e = e.options.verticalAlign, "bottom" === e
                            ? this.extraBottomMargin = !0
            ...
            p.prototype.adjustPlotArea = function() {
                ...
                this.rangeSelector &&
                (a = a.getHeight(), this.extraTopMargin && (this.plotTop += a), this.extraBottomMargin &&
                    (this.marginBottom += a))
            };
            p.prototype.callbacks.push(function(a) {
                function b() {
                ...
                e &&
                (g = C(a.xAxis[0], "afterSetExtremes", function(a) { e.render(a.min, a.max) }), f =
                    C(a, "redraw", b), b());
                C(a, "destroy", function() { e && (f(), g()) })
            });
            a.RangeSelector = B
        })(L);
        (function(a) {
            ...
            q(p.prototype,
                ...
                function(c, d, k, h, m, n) {
                    ...
                    D = function(a) {
                        ...
                        a = p.options[c];
                        return b(a) ? [r[c][a]] : e(a) ? [r.get(a)] : t(q, function(a) { return a[c] })
                    }(p.coll);
                    v(p.isXAxis ? r.yAxis : r.xAxis,
                        function(a) {
                    ...
                    v(D,
                        function(b) {
                            -1 !== l(b, C) ||
                                a.find(C, function(a) { return a.pos === b.pos && a.len && b.len }) ||
                                C.push(b)
                        });
                ...
                function(a) {
                    ...
                    if (g(this.crosshair.label) &&
                        ...
                        a = h
                            ...
                            : "center";
                        m ||
                        (m = this.crossLabel = d.renderer.label(null, null, null, e.shape || "callout").addClass(
                                "highcharts-crosshair-label" +
                                (this.series[0] && " highcharts-color-" + this.series[0].colorIndex))
                            .attr({ align: e.align || a, padding: f(e.padding, 8), r: f(e.borderRadius, 3), zIndex: 2 })
                            .add(this.labelGroup), m
                            .attr({
                                fill: e.backgroundColor || this.series[0] && this.series[0].color || "#666666",
                                stroke: e.borderColor || "",
                                "stroke-width": e.borderWidth || 0
                            }).css(z({ color: "#ffffff", fontWeight: "normal", fontSize: "11px", textAlign: "center" },
                                e.style)));
                        h
                            ? (a = r ? w.plotX + c : v.chartX, l += b ? 0 : this.height)
                            : (a = b ? this.width + c : 0, l = r ? w.plotY + l : v.chartY);
                        n ||
                            e.formatter ||
                        ...
                        h
                            ? (b = c - e.x, c = c + this.width - e.x)
                            : (b = "left" === this.labelAlign ? c : 0, c =
                                "right" === this.labelAlign ? c + this.width : d.chartWidth);
                        m.translateX < b && (t = b - m.translateX);
                        m.translateX + e.width >=
                            c &&
                            (t = -(m.translateX + e.width - c));
                        m.attr({
                            x: a + t,
                            y: l,
                ...
                this.modifyValue = "value" === a || "percent" === a
                    ? function(b, c) {
                        ...
                        if (void 0 !== b && void 0 !== d)
                            return b = "value" === a
                                ? b - d
                                : b / d * 100 - (100 === this.options.compareBase ? 0 : 100), c && (c.change = b), b
                    }
                    : null;
            ...
            F.processData = function() {
                ...
                if (this.xAxis && this.processedYData)
                    for (d = this.processedXData, e = this.processedYData, g =
                            e.length, this.pointArrayMap &&
                        (c = l("close", this.pointArrayMap), -1 === c &&
                            (c = l(this.pointValKey || "y", this.pointArrayMap))), a = 0;
                        a < g - f;
                        a++)
                ...
                function(a) {
                    ...
                    a.apply(this,
                        [].slice.call(arguments,
                            1));
                    this.modifyValue &&
                    (b = [this.modifyValue(this.dataMin), this.modifyValue(this.dataMax)], this.dataMin =
                        G(b), this.dataMax = C(b))
                });
            p.prototype.setCompare = function(a, b) {
                this.isXAxis || (v(this.series, function(b) { b.setCompare(a) }), f(b, !0) && this.chart.redraw())
            };
            c.prototype.tooltipFormatter = function(b) {
                b = b.replace("{point.change}",
                    (0 < this.change ? "+" : "") +
                    a.numberFormat(this.change, f(this.series.tooltipOptions.changeDecimals, 2)));
                ...
                function(a) {
                    this.chart.is3d &&
                        ...
                        (!this.clipBox && this.animate
                            ? (this.clipBox = n(this.chart.clipBox), this.clipBox.width =
                                this.xAxis.len, this.clipBox.height = this.yAxis.len)
                            : this.chart[this.sharedClipKey]
                            ? this.chart[this.sharedClipKey].attr({ width: this.xAxis.len, height: this.yAxis.len })
                            : this.clipBox &&
            ...
            q(m.prototype,
                ...
                function(a) {
                    ...
                    v(this.series,
                        function(a) {
                            a.hasGroupedData &&
                                (b = b.concat(y(a.points || [], function(a) { return a.selected })))
                        });
                    return b
                });
            B(m,
                ...
                function(a) {
                    ...
                    "scrollbar" in a &&
                        this.navigator &&
                        (n(!0, this.options.scrollbar, a.scrollbar), this.navigator.update({}, !1), delete a.scrollbar)
                })
        })(L);
        return L
    });