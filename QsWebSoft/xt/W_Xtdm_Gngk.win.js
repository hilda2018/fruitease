...
function W_Xtdm_Gngk() {
    ...
    webReq.SetWebServiceUrl("/Service/Gngk.ashx");
    ...
    this.dw_1_DoubleClicked = function (xPos, yPos, Row, dwoName) {
        if (Row > 0) {
            if (dwoName == "jdrjc") {
                ...
                iw_Wldw_Select.SetData("hddz_dzfs_jdr");
    ...
    this.Save = function () {
        ...
        //            var cname= dw_1.GetItemString(i, "cname");
        //            var li_pos = 0;
        //            var ycyymc_tctsfh = ycyymc;
        //            
        //            ycyymc_tctsfh.replace(/[\ |\~|\`|\!|\@|\#|\$|\%|\^|\&|\*|\(|\)|\-|\_|\+|\=|\||\\|\[|\]|\{|\}|\;|\:|\"|\'|\,|\<|\.|\>|\/|\?]/g, "");

        //            var li_find1 = 0;
        //            if (i > 1) {
        //                li_find1 = dw_1.Find("cname= '" + cname+ "' or cname= '" + ycyymc_tctsfh + "' or ycyymc_tctsfh = '" + cname+ "' or ycyymc_tctsfh = '" + ycyymc_tctsfh + "'", 1, i - 1)
        //            }

        //            var li_find2 = 0;
        //            if (i < dw_1.RowCount()) {
        //                li_find1 = dw_1.Find("cname= '" + cname+ "' or cname= '" + ycyymc_tctsfh + "' or ycyymc_tctsfh = '" + cname+ "' or ycyymc_tctsfh = '" + ycyymc_tctsfh + "'", i + 1, dw_1.RowCount())
        //            }
        ...
        //                    li_find = li_find1;
        //                };
        //                requestor.MessageBox("提示", "异常原因：" + cname+ "在" + li_find.toString() + "行存在重复，不能保存！");
        //                return;
        //            }
        //            if (dw_1.GetItemStatus(i, 0, DWBUFFER.Primary) > 0) {
        //                var port_no = dw_1.GetItemString(i, "port_no");
        ...
        //                dw_log.SetItem(row, "tablename", "t_port_c");
        //                dw_log.SetItem(row, "changecols", "");
        //                dw_log.SetItem(row, "mainid", port_no);
        ...
        webReq.Invoke("Save", "dw_1=" + dw_d_data + "&dw_log=" + dw_log_data);
