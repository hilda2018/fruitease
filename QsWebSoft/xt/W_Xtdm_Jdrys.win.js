...
//#region dw_1 ItemChanged
this.dw_1_ItemChanged = function (row, dwoName, data) {
    if (row > 0) {
        if (dwoName == "ysfs") {
            dw_1.GetChild("ysmxcd", dwc);
           if (data != "") {
                dwc.SetFilter("ysfs = '" + data + "'");
            }
            else {
                dwc.SetFilter("");
            }
...
//        return;
    ...
    webReq.Invoke("Jdrys_Save", "dw_1=" + dw_d_data); //+ "&dw_log=" + dw_log_data
