...
//    }
    ...
    this.Delete = function () {
        ...
        if (requestor.MessageBox("提示", "删除报关单使用编号为<" + sqdbh + ">,是否确定?", ICON.Question, BUTTON.YesNo) == 2)
            return;
    ...
    this.Copy = function () {
        ...
        if (openStyle == "2")
            ...
            ts_1.Open(node, label, "", "/OpenWindow.aspx?FunID=" + node + '&ywbh=' + sqdbh + '&operation=' + operation.toString(), true);
