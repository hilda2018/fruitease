...
function W_Xtdm_Tjxx() {

    var self = this;
    var requestor = new PBWindow();
    var dw_1 = new DataWindow(requestor);
    var tb_1 = new ToolStrip(requestor);
    var sle_tj = new SingleLineEdit(requestor);
    ...
    this.bind = function (win) {
        ...
        if (sle_tj == null) sle_tj = new SingleLineEdit(requestor);
        sle_tj.Attach(win.Control("sle_tj"));
        ...
        if (typeof (self.sle_tj_EditChanged) == "function")
            win.AttachEvent("sle_tj", "EditChanged", self.sle_tj_EditChanged);
    ...
    webReq.SetWebServiceUrl("/Service/Tjxx.ashx");
...
//#region 过滤拖架
this.sle_tj_EditChanged = function (text) {
    dw_1.SetRedraw(false);
    if (text == "")
        dw_1.SetFilter("");
    else
        dw_1.SetFilter("Upper(tjhm) like Upper('%" + text + "%') ");
    dw_1.Filter();
    dw_1.Sort();
    dw_1.SetRedraw(true);
}
