...
function W_Wxlxr_List() {
    ...
    this.Add = function () {
        if (iw_Edit == null) {
            iw_Edit = new W_Wxlxr_Edit();
            iw_Edit.SetListDataWindow(dw_1);
        }
        requestor.Open("/LoadWindow.ashx?WinName=Wldw.W_Wxlxr_Edit", iw_Edit);
    }
     ...
     this.Edit = function () {
            ...
            if (sfszzh == "N") {
                requestor.MessageBox("提示", "本帐户是客户增加的帐户,不能修改！")
                return;
            }

            requestor.Open("/LoadWindow.ashx?WinName=Wldw.W_Wxlxr_Edit&ID=" + id, iw_Edit);
        }
        ...
        this.SetRoles = function () {
            ...
            if (dw_1.GetRow() <= 0)
                return;
            if (iw_SetRoles == null)
                iw_SetRoles = new W_Wxlxr_SetRoles();
            ...
            requestor.Open("/LoadWindow.ashx?WinName=Wldw.W_Wxlxr_SetRoles&ID=" + id, iw_SetRoles);
